...
identity lock runner（离线 · C-FM-48）。

Usage:
    python3 lab/run_cninfo_c_class_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety.py
    python3 lab/run_cninfo_c_class_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety.py \\
      --output-root outputs/validation/_mock_c_fm48_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety
"""
...
REPORT_ROOT_REL = (
    "outputs/validation/"
    "cninfo_c_class_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety"
)
REPORT_MD_REL = (
    "outputs/validation/"
    "cninfo_c_class_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety_20260716.md"
)
REPORT_JSON_REL = (
    "outputs/validation/"
...
TASK_REPORT_REL = (
    "outputs/validation/"
    "cninfo_c_class_fm48_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety_20260716.md"
)
...
def write_reports(payload: Dict[str, Any]) -> Dict[str, str]:
    ...
    for key, name in (
        ...
        (
            "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_path",
    ...
    json_payload = {
        ...
        "overlap_membership_composition_sha256": payload[
            "overlap_membership_composition_sha256"
        ],
        "dry863_extras_composition_sha256": payload[
            "dry863_extras_composition_sha256"
        ],
        "batch_priority_composition_sha256": payload[
            "batch_priority_composition_sha256"
        ],
        "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_sha256": payload[
        ...
        "overlap_membership_formula": payload["overlap_membership_formula"],
        "dry863_extras_formula": payload["dry863_extras_formula"],
        "batch_priority_formula": payload["batch_priority_formula"],
        ...
        "overlap_membership_path": payload["overlap_membership_path"],
        "dry863_extras_path": payload["dry863_extras_path"],
        "batch_priority_path": payload["batch_priority_path"],
        "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_path": payload[
            "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_path"
        ],
    ...
    md_lines = [
        ...
        f"| overlap_membership_formula | **{payload['overlap_membership_formula']}** |",
        f"| dry863_extras_formula | **{payload['dry863_extras_formula']}** |",
        f"| batch_priority_formula | **{payload['batch_priority_formula']}** |",
        ...
        *layer_lines,
        ...
        "## Scale / safety gain",
        "",
        "- FM47 连续：unique=**2249** · dryrun=**1053** · residual=**117** · "
        ...
        "overlap/dry863/batch_priority/repro 墙元捆绑身份锁",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "C-FM-48 scale overlap/dry863/batch_priority/repro-wall-meta-bundle "
            "safety (offline)"
        )
    )
    parser.add_argument(
    ...
    if args.execute:
        print(
            ...
            "C-FM-48 is offline QA only; KEEP_EXECUTE_FALSE",
            file=sys.stderr,
        )
        return 2

    payload = run_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety(
        ...
        json.dumps(
            {
                ...
                "surface_unique": payload["surface_unique"],
                "combined_dryrun_coverage": payload["combined_dryrun_coverage"],
                "overlap_membership_formula": payload[
                    "overlap_membership_formula"
                ],
                "dry863_extras_formula": payload[
                    "dry863_extras_formula"
                ],
                "batch_priority_formula": payload[
