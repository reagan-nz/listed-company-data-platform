...
composition identity lock + cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle
identity lock（离线 · C-FM-50）。

在 C-FM-49（union_status/residual_coverage/resume_taxonomy_disposition /
cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle）已 commit 且 EXECUTE 仍
human-held 之上，继续非 seal 规模/安全能力
（不新增 seal / decision-await / commit-boundary；非 extension↔drift 循环）：
  1) FM49 packet / fingerprint / gate / union·residual·resume disposition·wall ledgers 零漂移连续
  2) risk_band_status_composition_identity_lock：75/14/12/5 组成身份锁
  3) tier_coverage_composition_identity_lock：7/3314 组成身份锁
  4) combined_dryrun_composition_identity_lock：combined_dryrun=1053 组成身份锁
  5) cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock：risk/tier/dryrun 墙元捆绑
  6) output-root：MOCK3–51 冻结 · MOCK52 放行
  7) FM-01..05 + FM-12..49 gate battery（跳过 seal FM06–11）

禁止：CNINFO live · production EXECUTE · 覆盖 MOCK3–51 / 权威 dual-layer 索引 ·
...
from cninfo_c_class_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety import (  # noqa: E402
    FROZEN_UNION_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM49_FROZEN_UNION_STATUS_FP,
    FROZEN_RESIDUAL_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM49_FROZEN_RESIDUAL_FP,
    FROZEN_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM49_FROZEN_RESUME_FP,
    FROZEN_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 as FM49_FROZEN_WALL_META_FP,
    EXPECTED_UNION_STATUS_PRIMARY_COMPOSITION_SHA256 as FM49_EXPECTED_UNION_STATUS_COMP_SHA256,
    EXPECTED_RESIDUAL_COVERAGE_PRIMARY_COMPOSITION_SHA256 as FM49_EXPECTED_RESIDUAL_COMP_SHA256,
    EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_COMPOSITION_SHA256 as FM49_EXPECTED_RESUME_COMP_SHA256,
    EXPECTED_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_SHA256 as FM49_EXPECTED_WALL_META_SHA256,
    EXPECTED_BATCH_PRIORITY as FM49_EXPECTED_BATCH_PRIORITY,
)
...
DEFAULT_MOCK_OUTPUT_ROOT_REL = (
    "outputs/validation/"
    "_mock_c_fm50_scale_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_safety"
)
...
FM49_GATE_JSON_REL = (
    "outputs/validation/"
    "cninfo_c_class_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety_20260716.json"
)
FM49_MOCK_ROOT_REL = (
    "outputs/validation/"
    "_mock_c_fm49_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety"
)
FM49_PACKET_REL = f"{FM49_MOCK_ROOT_REL}/scale_packet.json"
FM49_FINGERPRINT_REL = f"{FM49_MOCK_ROOT_REL}/scale_fingerprint.json"
FM49_UNION_STATUS_REL = (
    f"{FM49_MOCK_ROOT_REL}/union_status_composition_identity_lock_ledger.json"
)
FM49_RESIDUAL_COVERAGE_REL = (
    f"{FM49_MOCK_ROOT_REL}/residual_coverage_composition_identity_lock_ledger.json"
)
FM49_RESUME_TAXONOMY_DISPOSITION_REL = (
    f"{FM49_MOCK_ROOT_REL}/resume_taxonomy_disposition_composition_identity_lock_ledger.json"
)
FM49_WALL_META_REL = (
    f"{FM49_MOCK_ROOT_REL}/"
    "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock_ledger.json"
)
# 兼容旧名
FM48_MOCK_ROOT_REL = FM49_MOCK_ROOT_REL
FM48_PACKET_REL = FM49_PACKET_REL
FM48_FINGERPRINT_REL = FM49_FINGERPRINT_REL
FM48_OVERLAP_MEMBERSHIP_REL = FM49_UNION_STATUS_REL
FM48_DRY863_EXTRAS_REL = FM49_RESIDUAL_COVERAGE_REL
FM48_BATCH_PRIORITY_REL = FM49_RESUME_TAXONOMY_DISPOSITION_REL
FM48_WALL_META_REL = FM49_WALL_META_REL

# C-FM-50 本包冻结指纹（运行后由 fingerprint_* 锁定）
FROZEN_RISK_BAND_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "5933e2e61396dfac8617cca35862ca077c3a660b66a0bfa0f48c9719bc901acc"
)
FROZEN_TIER_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "2a501f4073aa763762dad2b8bb98837f8f258f32624e45f0f8f054d9ceec07db"
)
FROZEN_COMBINED_DRYRUN_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "be2794b5fb93842a50c62b8567cc3036175160941cbf38ef8736c7256b21e681"
)
FROZEN_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 = (
    "b9b493e1859b398545347c84028884e7dba2a2193b05d6447b97fa4804f34140"
)
# FM49 连续锚点（只读）
FROZEN_FM49_UNION_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM49_FROZEN_UNION_STATUS_FP
FROZEN_FM49_RESIDUAL_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM49_FROZEN_RESIDUAL_FP
FROZEN_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM49_FROZEN_RESUME_FP
...
EXPECTED_FM49_UNION_STATUS_COMPOSITION_SHA256 = FM49_EXPECTED_UNION_STATUS_COMP_SHA256
EXPECTED_FM49_RESIDUAL_COVERAGE_COMPOSITION_SHA256 = FM49_EXPECTED_RESIDUAL_COMP_SHA256
EXPECTED_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_SHA256 = FM49_EXPECTED_RESUME_COMP_SHA256
EXPECTED_FM49_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_SHA256 = (
    FM49_EXPECTED_WALL_META_SHA256
)
EXPECTED_RISK_BAND_STATUS_PRIMARY_COMPOSITION_SHA256 = (
    "55cba25490df8e25a2a51bed2dbdf38449e6a6914bd7d2b76592ab53f0ccc354"
)
EXPECTED_TIER_COVERAGE_PRIMARY_COMPOSITION_SHA256 = (
    "e7f80cdccaa8167879a84ba2562939191a358b97c4249f1177c15721c69a975c"
)
EXPECTED_COMBINED_DRYRUN_PRIMARY_COMPOSITION_SHA256 = (
    "30dd7e9b1608185266bcc6b03d09617ae5398d253fba2df9b59a2eca51ffbbef"
)
# 兼容旧名（本包主轴）
...
EXPECTED_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE_SHA256 = (
    "d02889788e77d02b8debe3a34a3314cfb9ee731eea3195a7073080dd1b4647d3"
)
...
EXPECTED_RISK_BAND_STATUS_PRIMARY_FORMULA = "75/14/12/5"
EXPECTED_TIER_COVERAGE_PRIMARY_FORMULA = "7/3314"
EXPECTED_COMBINED_DRYRUN_PRIMARY_FORMULA = "combined_dryrun=1053"
...
EXPECTED_BATCH_PRIORITY = list(FM49_EXPECTED_BATCH_PRIORITY)
EXPECTED_FM50_PROTECTED_ROOT_REGISTRY_FORMULA = "MOCK3-51+MOCK52+resume+auth"
EXPECTED_FM50_PROTECTED_ROOT_REGISTRY_FORMULA = "MOCK3-51+MOCK52+resume+auth"
...
EXPECTED_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE = {
    "risk_band_status_composition": {
        "formula": EXPECTED_RISK_BAND_STATUS_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_RISK_BAND_STATUS_PRIMARY_COMPOSITION_SHA256,
        "p35_heavy": EXPECTED_PARTIAL_RISK_BANDS["p35_heavy"],
        "p3_mid": EXPECTED_PARTIAL_RISK_BANDS["p3_mid"],
        "p2_mid": EXPECTED_PARTIAL_RISK_BANDS["p2_mid"],
        "fu_light": EXPECTED_PARTIAL_RISK_BANDS["fu_light"],
    },
    "tier_coverage_composition": {
        "formula": EXPECTED_TIER_COVERAGE_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_TIER_COVERAGE_PRIMARY_COMPOSITION_SHA256,
    ...
    "combined_dryrun_composition": {
        "formula": EXPECTED_COMBINED_DRYRUN_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_COMBINED_DRYRUN_PRIMARY_COMPOSITION_SHA256,
        "combined_dryrun_coverage": EXPECTED_COMBINED_DRYRUN_COVERAGE,
        "combined_dryrun_formula": EXPECTED_COMBINED_DRYRUN_FORMULA,
    },
    "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle": {
        "bundle_sha256": EXPECTED_FM49_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_SHA256,
    },
    "stable_metrics_wall": {
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "surface_unique": EXPECTED_SURFACE_UNIQUE,
...
THIS_TASK_ROOT_ID = "C-ROOT-MOCK52"
PRIOR_TASK_ROOT_ID = "C-ROOT-MOCK51"
RESUME_HARVEST_ROOT_ID = "C-ROOT-002"

FROZEN_ROOT_IDS_MUST_BLOCK = tuple(f"C-ROOT-MOCK{i}" for i in range(3, 52))
...
class FullMarketRiskBandStatusTierCoverageCombinedDryrunWallMetaBundlePaths:
    """只读输入与隔离写根路径规格。"""
    ...
    fm49_gate_json_rel: str = FM49_GATE_JSON_REL
    fm49_packet_rel: str = FM49_PACKET_REL
    fm49_fingerprint_rel: str = FM49_FINGERPRINT_REL
    fm49_union_status_rel: str = FM49_UNION_STATUS_REL
    fm49_residual_coverage_rel: str = FM49_RESIDUAL_COVERAGE_REL
    fm49_resume_taxonomy_disposition_rel: str = FM49_RESUME_TAXONOMY_DISPOSITION_REL
    fm49_wall_meta_rel: str = FM49_WALL_META_REL
...
def assert_fm50_output_root(
    output_root: str, *, base_dir: str = BASE_DIR
) -> str:
    """
    C-FM-50 写根：须 validation/_mock_*，不得覆盖 MOCK3–51，
    不得写权威 dual-layer 索引；允许本任务 MOCK51 或未登记 ephemeral。
    """
    ...
    if root_id is not None and root_id != THIS_TASK_ROOT_ID:
        raise RuntimeError(
            ...
            f"(C-FM-50 only writes {THIS_TASK_ROOT_ID} or ephemeral _mock_*)"
        )
...
def fingerprint_risk_band_status_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """risk_band_status composition identity lock 指纹（75/14/12/5）。"""
    doc = {
        "kind": "risk_band_status_composition_identity_lock",
        "p35_heavy": EXPECTED_PARTIAL_RISK_BANDS["p35_heavy"],
        "p3_mid": EXPECTED_PARTIAL_RISK_BANDS["p3_mid"],
        "p2_mid": EXPECTED_PARTIAL_RISK_BANDS["p2_mid"],
        "fu_light": EXPECTED_PARTIAL_RISK_BANDS["fu_light"],
        ...
        "composition_sha256": EXPECTED_RISK_BAND_STATUS_PRIMARY_COMPOSITION_SHA256,
        "risk_band_status_formula": EXPECTED_RISK_BAND_STATUS_PRIMARY_FORMULA,
...
def fingerprint_tier_coverage_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """tier_coverage composition identity lock 指纹（7/3314）。"""
    doc = {
        "kind": "tier_coverage_composition_identity_lock",
        "scale_tier_count": EXPECTED_SCALE_TIER_COUNT,
        "company_coverage_sum": EXPECTED_COMPANY_COVERAGE_SUM,
        "tier_coverage_formula": EXPECTED_TIER_COVERAGE_FORMULA,
        "composition_sha256": EXPECTED_TIER_COVERAGE_PRIMARY_COMPOSITION_SHA256,
        "tier_coverage_formula_primary": EXPECTED_TIER_COVERAGE_PRIMARY_FORMULA,
        "deny_composition_mutate": True,
        "deny_inflate": True,
        "deny_deflate": True,
        "hold": "KEEP_EXECUTE_FALSE",
...
def fingerprint_combined_dryrun_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """combined_dryrun composition identity lock 指纹（combined_dryrun=1053）。"""
    doc = {
        "kind": "combined_dryrun_composition_identity_lock",
        "combined_dryrun_coverage": EXPECTED_COMBINED_DRYRUN_COVERAGE,
        "combined_dryrun_formula": EXPECTED_COMBINED_DRYRUN_FORMULA,
        "composition_sha256": EXPECTED_COMBINED_DRYRUN_PRIMARY_COMPOSITION_SHA256,
        "combined_dryrun_formula_primary": EXPECTED_COMBINED_DRYRUN_PRIMARY_FORMULA,
        "deny_composition_mutate": True,
        "deny_inflate": True,
        "deny_deflate": True,
        "hold": "KEEP_EXECUTE_FALSE",
...
def fingerprint_cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """cross risk/tier/dryrun wall-meta bundle identity lock 指纹。"""
    doc = {
        "kind": "cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock",
        "compositions": {
            k: dict(v)
            for k, v in EXPECTED_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE.items()
        },
        "bundle_sha256": EXPECTED_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE_SHA256,
        "deny_composition_mutate": True,
...
# 兼容别名
fingerprint_overlap_membership_composition_identity_lock = fingerprint_risk_band_status_composition_identity_lock
fingerprint_dry863_extras_composition_identity_lock = fingerprint_tier_coverage_composition_identity_lock
fingerprint_batch_priority_composition_identity_lock = fingerprint_combined_dryrun_composition_identity_lock
fingerprint_union_status_composition_identity_lock = fingerprint_risk_band_status_composition_identity_lock
fingerprint_residual_coverage_composition_identity_lock = fingerprint_tier_coverage_composition_identity_lock
fingerprint_resume_taxonomy_disposition_composition_identity_lock = fingerprint_combined_dryrun_composition_identity_lock
...
def evaluate_risk_band_status_composition_mutation(
    *,
    proposed_p35_heavy: int,
    proposed_p3_mid: int,
    proposed_p2_mid: int,
    proposed_fu_light: int,
) -> Dict[str, Any]:
    """评估 75/14/12/5 组成变异；一律拒绝。"""
    matches = (
        proposed_p35_heavy == EXPECTED_PARTIAL_RISK_BANDS["p35_heavy"]
        and proposed_p3_mid == EXPECTED_PARTIAL_RISK_BANDS["p3_mid"]
        and proposed_p2_mid == EXPECTED_PARTIAL_RISK_BANDS["p2_mid"]
        and proposed_fu_light == EXPECTED_PARTIAL_RISK_BANDS["fu_light"]
    )
    return {
        "proposed": {
            "p35_heavy": proposed_p35_heavy,
            "p3_mid": proposed_p3_mid,
            "p2_mid": proposed_p2_mid,
            "fu_light": proposed_fu_light,
        },
        "frozen": dict(EXPECTED_PARTIAL_RISK_BANDS),
        "matches_frozen": matches,
        "mutation_allowed": False,
        "reason": "risk_band_status_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_tier_coverage_composition_mutation(
    *,
    ...
    return {
        ...
        "matches_frozen": matches,
        "mutation_allowed": False,
        "reason": "tier_coverage_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_combined_dryrun_composition_mutation(
    *,
    proposed_combined_dryrun_coverage: int,
    proposed_combined_dryrun_formula: str,
) -> Dict[str, Any]:
    """评估 combined_dryrun=1053 组成变异；一律拒绝。"""
    matches = (
        proposed_combined_dryrun_coverage == EXPECTED_COMBINED_DRYRUN_COVERAGE
        and proposed_combined_dryrun_formula == EXPECTED_COMBINED_DRYRUN_FORMULA
    )
    return {
        "proposed": {
            "combined_dryrun_coverage": proposed_combined_dryrun_coverage,
            "combined_dryrun_formula": proposed_combined_dryrun_formula,
        },
        "frozen": {
            "combined_dryrun_coverage": EXPECTED_COMBINED_DRYRUN_COVERAGE,
            "combined_dryrun_formula": EXPECTED_COMBINED_DRYRUN_FORMULA,
        ...
        "matches_frozen": matches,
        "mutation_allowed": False,
        "reason": "combined_dryrun_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_mutation(
    *, proposed_compositions: Dict[str, Any]
) -> Dict[str, Any]:
    """评估 cross risk/tier/dryrun wall-meta bundle 变异；一律拒绝。"""
    frozen = {
        k: dict(v)
        for k, v in EXPECTED_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE.items()
    }
    ...
    return {
        ...
        "mutation_allowed": False,
        "reason": (
            "cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_frozen_pre_execute"
        ),
        "hold": "KEEP_EXECUTE_FALSE",
    }
...
# 兼容别名
evaluate_overlap_membership_composition_mutation = evaluate_risk_band_status_composition_mutation
evaluate_dry863_extras_composition_mutation = evaluate_tier_coverage_composition_mutation
evaluate_batch_priority_composition_mutation = evaluate_combined_dryrun_composition_mutation
evaluate_union_status_composition_mutation = evaluate_risk_band_status_composition_mutation
evaluate_residual_coverage_composition_mutation = evaluate_tier_coverage_composition_mutation
evaluate_resume_taxonomy_disposition_composition_mutation = evaluate_combined_dryrun_composition_mutation
...
def build_risk_band_status_composition_identity_lock_rows(
    ...
    *,
    ...
    """risk_band_status composition identity lock（75/14/12/5）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_risk_band_status_composition_identity_lock()

    comp_payload = {
        "kind": "risk_band_status_composition",
        "p35_heavy": EXPECTED_PARTIAL_RISK_BANDS["p35_heavy"],
        "p3_mid": EXPECTED_PARTIAL_RISK_BANDS["p3_mid"],
        "p2_mid": EXPECTED_PARTIAL_RISK_BANDS["p2_mid"],
        "fu_light": EXPECTED_PARTIAL_RISK_BANDS["fu_light"],
    ...
    identity_ok = (
        ...
        and comp_sha == EXPECTED_RISK_BAND_STATUS_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_RISK_BAND_STATUS_PRIMARY_COMPOSITION_SHA256
    )
    checks["risk_band_status_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="risk_band_status_composition_identity",
            layer="risk_band_status_composition_identity_lock",
            expected="75/14/12/5",
            observed=(
                f"formula={EXPECTED_RISK_BAND_STATUS_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "risk_band_status_composition_drift",
        )
    )

    sample_denials = [
        evaluate_risk_band_status_composition_mutation(
            proposed_p35_heavy=74,
            proposed_p3_mid=EXPECTED_PARTIAL_RISK_BANDS["p3_mid"],
            proposed_p2_mid=EXPECTED_PARTIAL_RISK_BANDS["p2_mid"],
            proposed_fu_light=EXPECTED_PARTIAL_RISK_BANDS["fu_light"],
        ),
        evaluate_risk_band_status_composition_mutation(
            proposed_p35_heavy=EXPECTED_PARTIAL_RISK_BANDS["p35_heavy"],
            proposed_p3_mid=0,
    ...
    checks["risk_band_status_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="risk_band_status_composition_mutation_denied",
            layer="risk_band_status_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
            notes="ok" if mut_ok else "risk_band_status_mutation_leak",
        )
    )
    ...
    flags_ok = (
        ...
        and fp == FROZEN_RISK_BAND_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["risk_band_status_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="risk_band_status_composition_flags",
            layer="risk_band_status_composition_identity_lock",
            expected=FROZEN_RISK_BAND_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "risk_band_status_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["risk_band_status_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="risk_band_status_composition_identity_lock_all_pass",
            layer="risk_band_status_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "risk_band_status_lock_incomplete",
        )
    )
    meta = {
        "fingerprint": fp,
...
def build_tier_coverage_composition_identity_lock_rows(
    paths: FullMarketRiskBandStatusTierCoverageCombinedDryrunWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """tier_coverage composition identity lock（7/3314）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_tier_coverage_composition_identity_lock()

    comp_payload = {
        "kind": "tier_coverage_composition",
        "scale_tier_count": EXPECTED_SCALE_TIER_COUNT,
        "company_coverage_sum": EXPECTED_COMPANY_COVERAGE_SUM,
        "tier_coverage_formula": EXPECTED_TIER_COVERAGE_FORMULA,
        "formula": EXPECTED_TIER_COVERAGE_PRIMARY_FORMULA,
    ...
    identity_ok = (
        ...
        and comp_sha == EXPECTED_TIER_COVERAGE_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_TIER_COVERAGE_PRIMARY_COMPOSITION_SHA256
    )
    checks["tier_coverage_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="tier_coverage_composition_identity",
            layer="tier_coverage_composition_identity_lock",
            expected="7/3314",
            observed=(
                f"formula={EXPECTED_TIER_COVERAGE_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "tier_coverage_composition_drift",
        )
    )

    sample_denials = [
        evaluate_tier_coverage_composition_mutation(
            proposed_scale_tier_count=6,
            proposed_company_coverage_sum=EXPECTED_COMPANY_COVERAGE_SUM,
        ),
        evaluate_tier_coverage_composition_mutation(
            proposed_scale_tier_count=EXPECTED_SCALE_TIER_COUNT,
            proposed_company_coverage_sum=3313,
        ),
        evaluate_tier_coverage_composition_mutation(
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["tier_coverage_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="tier_coverage_composition_mutation_denied",
            layer="tier_coverage_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_TIER_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["tier_coverage_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="tier_coverage_composition_flags",
            layer="tier_coverage_composition_identity_lock",
            expected=FROZEN_TIER_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "tier_coverage_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["tier_coverage_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="tier_coverage_composition_identity_lock_all_pass",
            layer="tier_coverage_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "tier_coverage_lock_incomplete",
        )
    )
    meta = {
        "fingerprint": fp,
        "composition_sha256": comp_sha,
        "tier_coverage_formula": EXPECTED_TIER_COVERAGE_PRIMARY_FORMULA,
        "sample_denials": sample_denials,
        "doc": doc,
    }
    return rows, checks, meta
...
def build_combined_dryrun_composition_identity_lock_rows(
    paths: FullMarketRiskBandStatusTierCoverageCombinedDryrunWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """combined_dryrun composition identity lock（combined_dryrun=1053）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_combined_dryrun_composition_identity_lock()

    comp_payload = {
        "kind": "combined_dryrun_composition",
        "combined_dryrun_coverage": EXPECTED_COMBINED_DRYRUN_COVERAGE,
        "combined_dryrun_formula": EXPECTED_COMBINED_DRYRUN_FORMULA,
        "formula": EXPECTED_COMBINED_DRYRUN_PRIMARY_FORMULA,
    }
    ...
    identity_ok = (
        ...
        and comp_sha == EXPECTED_COMBINED_DRYRUN_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_COMBINED_DRYRUN_PRIMARY_COMPOSITION_SHA256
    )
    checks["combined_dryrun_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="combined_dryrun_composition_identity",
            layer="combined_dryrun_composition_identity_lock",
            expected="combined_dryrun=1053",
            observed=(
                f"formula={EXPECTED_COMBINED_DRYRUN_PRIMARY_FORMULA};"
                f"n={EXPECTED_COMBINED_DRYRUN_COVERAGE};sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "combined_dryrun_composition_drift",
        )
    )

    sample_denials = [
        evaluate_combined_dryrun_composition_mutation(
            proposed_combined_dryrun_coverage=1052,
            proposed_combined_dryrun_formula=EXPECTED_COMBINED_DRYRUN_FORMULA,
        ),
        evaluate_combined_dryrun_composition_mutation(
            proposed_combined_dryrun_coverage=EXPECTED_COMBINED_DRYRUN_COVERAGE,
            proposed_combined_dryrun_formula="combined_dryrun=0",
        ),
        evaluate_combined_dryrun_composition_mutation(
            proposed_combined_dryrun_coverage=0,
            proposed_combined_dryrun_formula="x",
        ),
        evaluate_combined_dryrun_composition_mutation(
            proposed_combined_dryrun_coverage=EXPECTED_COMBINED_DRYRUN_COVERAGE,
            proposed_combined_dryrun_formula=EXPECTED_COMBINED_DRYRUN_FORMULA,
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["combined_dryrun_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="combined_dryrun_composition_mutation_denied",
            layer="combined_dryrun_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_COMBINED_DRYRUN_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["combined_dryrun_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="combined_dryrun_composition_flags",
            layer="combined_dryrun_composition_identity_lock",
            expected=FROZEN_COMBINED_DRYRUN_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
    ...
    all_ok = all(checks.values()) if checks else False
    checks["combined_dryrun_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="combined_dryrun_composition_identity_lock_all_pass",
            layer="combined_dryrun_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "combined_dryrun_lock_incomplete",
        )
    )
    meta = {
        "fingerprint": fp,
        "composition_sha256": comp_sha,
        "combined_dryrun_formula": EXPECTED_COMBINED_DRYRUN_PRIMARY_FORMULA,
        "sample_denials": sample_denials,
        "doc": doc,
    }
    return rows, checks, meta
...
def build_cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock_rows(
    paths: FullMarketRiskBandStatusTierCoverageCombinedDryrunWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle identity lock。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = (
    ...
    identity_ok = (
        ...
        and compositions["risk_band_status_composition"]["formula"] == "75/14/12/5"
        and compositions["tier_coverage_composition"]["formula"] == "7/3314"
        and compositions["combined_dryrun_composition"]["combined_dryrun_coverage"] == 1053
    )
    checks[
        "cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity"
    ] = identity_ok
    rows.append(
        _row(
            check_id="cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity",
            layer="cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock",
            expected="75/14/12/5+7/3314+combined_dryrun=1053+wall",
    ...
    mutated["risk_band_status_composition"] = {
        "formula": "0/0/0/0",
        "composition_sha256": EXPECTED_RISK_BAND_STATUS_PRIMARY_COMPOSITION_SHA256,
        "p35_heavy": 0,
        "p3_mid": 0,
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks[
        "cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_mutation_denied"
    ] = mut_ok
    rows.append(
        _row(
            check_id="cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_mutation_denied",
            layer="cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    checks[
        "cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_flags"
    ] = flags_ok
    rows.append(
        _row(
            check_id="cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_flags",
            layer="cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock",
            expected=FROZEN_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
    ...
    all_ok = all(checks.values()) if checks else False
    checks[
        "cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock_all_pass"
    ] = all_ok
    rows.append(
        _row(
            check_id="cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock_all_pass",
            layer="cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
# 兼容别名
build_overlap_membership_composition_identity_lock_rows = build_risk_band_status_composition_identity_lock_rows
build_dry863_extras_composition_identity_lock_rows = build_tier_coverage_composition_identity_lock_rows
build_batch_priority_composition_identity_lock_rows = build_combined_dryrun_composition_identity_lock_rows
build_union_status_composition_identity_lock_rows = build_risk_band_status_composition_identity_lock_rows
build_residual_coverage_composition_identity_lock_rows = build_tier_coverage_composition_identity_lock_rows
build_resume_taxonomy_disposition_composition_identity_lock_rows = build_combined_dryrun_composition_identity_lock_rows
...
def build_fm49_continuity_rows(
    paths: FullMarketRiskBandStatusTierCoverageCombinedDryrunWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """FM49 packet / fingerprint / gate / 四 ledger 零漂移。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}

    packet = load_json(_abs(paths.fm49_packet_rel, base_dir=base_dir))
    fp_doc = load_json(_abs(paths.fm49_fingerprint_rel, base_dir=base_dir))
    gate_doc = load_json(_abs(paths.fm49_gate_json_rel, base_dir=base_dir))
    us_led = load_json(_abs(paths.fm49_union_status_rel, base_dir=base_dir))
    od_led = load_json(_abs(paths.fm49_residual_coverage_rel, base_dir=base_dir))
    sd_led = load_json(_abs(paths.fm49_resume_taxonomy_disposition_rel, base_dir=base_dir))
    wall_led = load_json(_abs(paths.fm49_wall_meta_rel, base_dir=base_dir))

    pkt_primary_union = packet.get("overlap_membership_composition_sha256") or packet.get(
        "union_status_composition_sha256"
    )
    pkt_primary_residual = packet.get("dry863_extras_composition_sha256") or packet.get(
        "residual_coverage_composition_sha256"
    )
    pkt_primary_resume = packet.get("batch_priority_composition_sha256") or packet.get(
    ...
    pkt_ok = (
        ...
        and pkt_primary_union == EXPECTED_FM49_UNION_STATUS_COMPOSITION_SHA256
        and pkt_primary_residual == EXPECTED_FM49_RESIDUAL_COVERAGE_COMPOSITION_SHA256
        and pkt_primary_resume == EXPECTED_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_SHA256
        and pkt_cross
        == EXPECTED_FM49_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_SHA256
    ...
    checks["fm49_packet_zero_drift"] = pkt_ok
    rows.append(
        _row(
            check_id="fm49_packet_zero_drift",
            layer="fm49_continuity",
            path=paths.fm49_packet_rel,
            expected="PASS_OFFLINE+stable_metrics+compositions",
            observed=f"gate={packet.get('gate')};unique={packet.get('harvest_unique_union')}",
            ok=pkt_ok,
            notes="ok" if pkt_ok else "fm49_packet_drift",
        )
    )
    ...
    fp_ok = (
        ...
        and (
            fp_doc.get("overlap_membership_composition_sha256")
            or fp_doc.get("union_status_composition_sha256")
        )
        == EXPECTED_FM49_UNION_STATUS_COMPOSITION_SHA256
        and (
            fp_doc.get("dry863_extras_composition_sha256")
            or fp_doc.get("residual_coverage_composition_sha256")
        )
        == EXPECTED_FM49_RESIDUAL_COVERAGE_COMPOSITION_SHA256
        and (
            fp_doc.get("batch_priority_composition_sha256")
            or fp_doc.get("resume_taxonomy_disposition_composition_sha256")
        )
        == EXPECTED_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_SHA256
        and (
            fp_doc.get(
                "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_sha256"
            )
    ...
    checks["fm49_fingerprint_zero_drift"] = fp_ok
    rows.append(
        _row(
            check_id="fm49_fingerprint_zero_drift",
            layer="fm49_continuity",
            path=paths.fm49_fingerprint_rel,
            expected="stable_metrics+fm47_fps",
            observed=f"unique={fp_doc.get('harvest_unique_union')}",
            ok=fp_ok,
            notes="ok" if fp_ok else "fm49_fingerprint_drift",
        )
    )
    ...
    checks["fm49_gate_zero_drift"] = gate_ok
    rows.append(
        _row(
            check_id="fm49_gate_zero_drift",
            layer="fm49_continuity",
            path=paths.fm49_gate_json_rel,
            expected="PASS_OFFLINE+KEEP_EXECUTE_FALSE",
            observed=f"gate={gate_doc.get('gate')}",
            ok=gate_ok,
            notes="ok" if gate_ok else "fm49_gate_drift",
        )
    )

    us_ok = (
        us_led.get("fingerprint_sha256")
        == FROZEN_FM49_UNION_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256
        and us_led.get("composition_sha256")
        == EXPECTED_FM49_UNION_STATUS_COMPOSITION_SHA256
    )
    checks["fm49_union_status_ledger_zero_drift"] = us_ok
    rows.append(
        _row(
            check_id="fm49_union_status_ledger_zero_drift",
            layer="fm49_continuity",
            path=paths.fm49_union_status_rel,
            expected=FROZEN_FM49_UNION_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=str(us_led.get("fingerprint_sha256")),
            ok=us_ok,
            notes="ok" if us_ok else "fm49_union_status_ledger_drift",
        )
    )

    od_ok = (
        od_led.get("fingerprint_sha256")
        == FROZEN_FM49_RESIDUAL_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256
        and od_led.get("composition_sha256")
        == EXPECTED_FM49_RESIDUAL_COVERAGE_COMPOSITION_SHA256
    )
    checks["fm49_residual_coverage_ledger_zero_drift"] = od_ok
    rows.append(
        _row(
            check_id="fm49_residual_coverage_ledger_zero_drift",
            layer="fm49_continuity",
            path=paths.fm49_residual_coverage_rel,
            expected=FROZEN_FM49_RESIDUAL_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=str(od_led.get("fingerprint_sha256")),
            ok=od_ok,
            notes="ok" if od_ok else "fm49_residual_coverage_ledger_drift",
        )
    )

    sd_ok = (
        sd_led.get("fingerprint_sha256")
        == FROZEN_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_IDENTITY_LOCK_FP_SHA256
        and sd_led.get("composition_sha256")
        == EXPECTED_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_SHA256
    )
    checks["fm49_resume_taxonomy_disposition_ledger_zero_drift"] = sd_ok
    rows.append(
        _row(
            check_id="fm49_resume_taxonomy_disposition_ledger_zero_drift",
            layer="fm49_continuity",
            path=paths.fm49_resume_taxonomy_disposition_rel,
            expected=FROZEN_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=str(sd_led.get("fingerprint_sha256")),
            ok=sd_ok,
            notes="ok" if sd_ok else "fm49_resume_ledger_drift",
        )
    )
    ...
    checks["fm49_wall_meta_ledger_zero_drift"] = wall_ok
    rows.append(
        _row(
            check_id="fm49_wall_meta_ledger_zero_drift",
            layer="fm49_continuity",
            path=paths.fm49_wall_meta_rel,
            expected=FROZEN_FM49_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256,
            observed=str(wall_led.get("fingerprint_sha256")),
            ok=wall_ok,
            notes="ok" if wall_ok else "fm48_wall_meta_ledger_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["fm49_continuity_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="fm49_continuity_all_pass",
            layer="fm49_continuity",
            expected="packet+fp+gate+4ledgers",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "fm49_continuity_incomplete",
        )
    )
    return rows, checks
...
def build_output_root_protection_rows(
    ...
    *,
    ...
    """output-root 保护：resume/harvest 写拒绝 + MOCK52 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    ...
    out_detail = ""
    try:
        assert_fm50_output_root(paths.output_root_rel, base_dir=base_dir)
        out_ok = True
        out_detail = "allowed"
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            expected="MOCK52_or_ephemeral_allowed",
            observed=out_detail,
            ok=out_ok,
...
def build_frozen_mock_isolation_rows(
    paths: FullMarketRiskBandStatusTierCoverageCombinedDryrunWallMetaBundlePaths, *, base_dir: str = BASE_DIR
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """冻结 mock cohort 写隔离：MOCK3–51 拒绝 · MOCK52 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    load_frozen_mock_cohort_roots.cache_clear()
    ...
    try:
        assert_fm50_output_root(mock51_rel, base_dir=base_dir)
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            layer="frozen_mock_isolation",
            expected="MOCK3-51_block+MOCK52_allow",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
    ...
    *,
    ...
    rows.append(
        _row(
            ...
            layer="protected_csv_registry",
            expected="MOCK3–51+MOCK51+resume+auth+registered",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
def ensure_protected_roots_csv_fm50(
    *,
    csv_rel: str = PROTECTED_ROOTS_CSV_REL,
    base_dir: str = BASE_DIR,
) -> None:
    """注册 C-ROOT-MOCK52；加固 C-ROOT-002 unique/surface/additive/tier/dryrun 说明。"""
    ...
    _upsert(
        RESUME_HARVEST_ROOT_ID,
        {
            ...
            "notes": (
                ...
                "C-FM-24..49 scale/safety freezes + C-FM-50 full-market risk_band_status/"
    ...
    _upsert(
        THIS_TASK_ROOT_ID,
        {
            ...
            "notes": (
                "C-FM-50 scale risk_band_status composition identity lock "
                "(75/14/12/5) + tier_coverage composition identity lock "
                "(7/3314) + combined_dryrun composition identity lock "
                "(combined_dryrun=1053) + cross_full_market_risk_band_status_"
                "tier_coverage_combined_dryrun_wall_meta_bundle identity lock + "
                "FM49 continuity; never production EXECUTE; "
                "must not overwrite MOCK3-51; seal_chain_extended=false"
            ),
        },
    )
...
def run_scale_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_safety(
    *,
    paths: FullMarketRiskBandStatusTierCoverageCombinedDryrunWallMetaBundlePaths | None = None,
    base_dir: str = BASE_DIR,
) -> Dict[str, Any]:
    """执行 C-FM-50 规模 risk_band_status/tier_coverage/combined_dryrun-wall-meta-bundle 离线 QA。"""
    paths = paths or FullMarketRiskBandStatusTierCoverageCombinedDryrunWallMetaBundlePaths()
    generated_at = _utc_now_iso()
    ensure_protected_roots_csv_fm50(
        csv_rel=paths.protected_roots_csv_rel, base_dir=base_dir
    )
    out_root = assert_fm50_output_root(paths.output_root_rel, base_dir=base_dir)

    matrix: List[Dict[str, str]] = []
    cont_rows, cont_checks = build_fm49_continuity_rows(paths, base_dir=base_dir)
    ...
    layer_gates = {
        "fm49_continuity": (
            "PASS_OFFLINE"
            if cont_checks.get("fm49_continuity_all_pass")
            else "FAIL_OFFLINE"
        ),
        "risk_band_status_composition_identity_lock": (
            "PASS_OFFLINE"
            if rf_checks.get("risk_band_status_composition_identity_lock_all_pass")
            else "FAIL_OFFLINE"
        ),
        "tier_coverage_composition_identity_lock": (
            "PASS_OFFLINE"
            if rt_checks.get("tier_coverage_composition_identity_lock_all_pass")
            else "FAIL_OFFLINE"
        ),
        "combined_dryrun_composition_identity_lock": (
            "PASS_OFFLINE"
            if rb_checks.get(
                "combined_dryrun_composition_identity_lock_all_pass"
            )
            else "FAIL_OFFLINE"
        ),
    ...
    rf_rel = _write_ledger(
        "risk_band_status_composition_identity_lock_ledger.json",
        {
            ...
            "risk_band_status_formula": rf_meta["risk_band_status_formula"],
    ...
    packet_rel = _write_ledger(
        "scale_packet.json",
        {
            ...
            "coverage_formula": EXPECTED_COVERAGE_FORMULA,
            "notes": (
                "risk_band_status composition identity lock (unique=2249) + "
                "tier_coverage composition identity lock (combined_dryrun=1053) + "
                "combined_dryrun composition identity lock (tiers=7;coverage_sum=3314) + "
                "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle identity lock + "
                "FM49 continuity + MOCK52; EXECUTE remains human-held; "
                "does not overwrite MOCK3-51"
            ),
        },
    )
    ...
    with open(_abs(readme_rel, base_dir=base_dir), "w", encoding="utf-8") as fh:
        fh.write(
            "\n".join(
                [
                    "# C-FM-50 mock scale lineage/drift/protected/repro-wall-meta-bundle safety root",
                    "",
                    f"task_id: {TASK_ID}",
                    f"gate: {overall}",
                    "cninfo_calls: 0",
                    ...
                    "",
                    "Isolation: MOCK3-51 frozen; this root is C-ROOT-MOCK52.",
    ...
    return {
        ...
        "cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_path": bundle_rel,
