...
identity lock（离线 · C-FM-48）。

在 C-FM-47（full_market_unique_union / combined_dryrun_cohort / company_coverage_scale /
...
（不新增 seal / decision-await / commit-boundary；非 extension↔drift 循环）：
  1) FM47 packet / fingerprint / gate / unique·dryrun·coverage·wall ledgers 零漂移连续
  ...
  5) cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock：overlap/dry863/batch_priority/repro 墙元捆绑
  6) output-root：MOCK3–49 冻结 · MOCK50 放行
  7) FM-01..05 + FM-12..47 gate battery（跳过 seal FM06–11）

禁止：CNINFO live · production EXECUTE · 覆盖 MOCK3–49 / 权威 dual-layer 索引 ·
...
from cninfo_c_class_scale_full_market_unique_dryrun_coverage_repro_wall_meta_bundle_safety import (  # noqa: E402
    FROZEN_FULL_MARKET_UNIQUE_UNION_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM47_FROZEN_UNIQUE_FP,
    FROZEN_COMBINED_DRYRUN_COHORT_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM47_FROZEN_DRYRUN_FP,
    FROZEN_COMPANY_COVERAGE_SCALE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM47_FROZEN_COVERAGE_FP,
    FROZEN_CROSS_FULL_MARKET_SCALE_REPRO_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 as FM47_FROZEN_WALL_META_FP,
    EXPECTED_FULL_MARKET_UNIQUE_UNION_COMPOSITION_SHA256 as FM47_EXPECTED_UNIQUE_COMP_SHA256,
    EXPECTED_COMBINED_DRYRUN_COHORT_COMPOSITION_SHA256 as FM47_EXPECTED_DRYRUN_COMP_SHA256,
    EXPECTED_COMPANY_COVERAGE_SCALE_COMPOSITION_SHA256 as FM47_EXPECTED_COVERAGE_COMP_SHA256,
    EXPECTED_CROSS_FULL_MARKET_SCALE_REPRO_WALL_META_BUNDLE_SHA256 as FM47_EXPECTED_WALL_META_SHA256,
    EXPECTED_BATCH_PRIORITY as FM47_EXPECTED_BATCH_PRIORITY,
)
...
FM47_PACKET_REL = f"{FM47_MOCK_ROOT_REL}/scale_packet.json"
FM47_FINGERPRINT_REL = f"{FM47_MOCK_ROOT_REL}/scale_fingerprint.json"
FM47_FULL_MARKET_UNIQUE_UNION_REL = (
    f"{FM47_MOCK_ROOT_REL}/full_market_unique_union_composition_identity_lock_ledger.json"
)
FM47_COMBINED_DRYRUN_COHORT_REL = (
    f"{FM47_MOCK_ROOT_REL}/combined_dryrun_cohort_composition_identity_lock_ledger.json"
)
FM47_COMPANY_COVERAGE_SCALE_REL = (
    f"{FM47_MOCK_ROOT_REL}/company_coverage_scale_composition_identity_lock_ledger.json"
)
FM47_WALL_META_REL = (
    f"{FM47_MOCK_ROOT_REL}/"
    "cross_full_market_scale_repro_wall_meta_bundle_identity_lock_ledger.json"
)

# C-FM-48 本包冻结指纹（运行后由 fingerprint_* 锁定）
FROZEN_OVERLAP_MEMBERSHIP_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "012b8200b7e005793b986457bf6ab13dcc23ca99b923df83e3131580fabbe31c"
)
FROZEN_DRY863_EXTRAS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "7e8322b397e89c64b0a37a82988c797aa568364fc919109fdd8896c39ec68b92"
)
FROZEN_BATCH_PRIORITY_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "9feb8279cf49c6c2cb34046e1ad4ab760b7ec99dcdb4508dca5f016adfe8850c"
)
FROZEN_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 = (
    "7e22e11a01709171c57558b0f9922420d2a46db227ccb5a075e8fcb128fb4d02"
)
# FM47 连续锚点（只读）
FROZEN_FM47_FULL_MARKET_UNIQUE_UNION_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM47_FROZEN_UNIQUE_FP
FROZEN_FM47_COMBINED_DRYRUN_COHORT_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM47_FROZEN_DRYRUN_FP
FROZEN_FM47_COMPANY_COVERAGE_SCALE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM47_FROZEN_COVERAGE_FP
FROZEN_FM47_CROSS_FULL_MARKET_SCALE_REPRO_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 = (
    FM47_FROZEN_WALL_META_FP
)
...
EXPECTED_FM47_FULL_MARKET_UNIQUE_UNION_COMPOSITION_SHA256 = FM47_EXPECTED_UNIQUE_COMP_SHA256
EXPECTED_FM47_COMBINED_DRYRUN_COHORT_COMPOSITION_SHA256 = FM47_EXPECTED_DRYRUN_COMP_SHA256
EXPECTED_FM47_COMPANY_COVERAGE_SCALE_COMPOSITION_SHA256 = FM47_EXPECTED_COVERAGE_COMP_SHA256
EXPECTED_FM47_CROSS_FULL_MARKET_SCALE_REPRO_WALL_META_BUNDLE_SHA256 = (
    FM47_EXPECTED_WALL_META_SHA256
)
EXPECTED_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256 = (
    "e52e7caa2d032f3d13eb54748b62ef83c972288f8c2639d2c0bfdb41795769b9"
)
...
EXPECTED_DRY863_EXTRAS_COMPOSITION_SHA256 = (
    "8cae12933694ed7f1d8a060b87920498b91b7a9b4dd072c2efaa11c0dbd0f2ab"
)
...
EXPECTED_BATCH_PRIORITY_COMPOSITION_SHA256 = (
    "cbc73087b39f7073385cfe7da3b6f55f65127f84669f538c22edd35b1a0608b6"
)
...
EXPECTED_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_SHA256 = (
    "8d07e3c52b53bd63e239c01101daea64c9db4d65a6f22464c41c4250ea9fd643"
)
...
EXPECTED_OVERLAP_MEMBERSHIP_FORMULA = "overlap_delta=12"
EXPECTED_DRY863_EXTRAS_FORMULA = "dry863=2"
EXPECTED_BATCH_PRIORITY_FORMULA = "h863>p35>p3>p2>fu"
EXPECTED_BATCH_PRIORITY = list(FM47_EXPECTED_BATCH_PRIORITY)
EXPECTED_FM47_PROTECTED_ROOT_REGISTRY_FORMULA = "MOCK3-48+MOCK49+resume+auth"
EXPECTED_FM48_PROTECTED_ROOT_REGISTRY_FORMULA = "MOCK3-49+MOCK50+resume+auth"
...
EXPECTED_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE = {
    "overlap_membership_composition": {
        "formula": EXPECTED_OVERLAP_MEMBERSHIP_FORMULA,
        "composition_sha256": EXPECTED_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256,
        "overlap_delta": EXPECTED_OVERLAP_DELTA,
        "overlap_codes_sha256": EXPECTED_OVERLAP_CODES_SHA256,
    },
    "dry863_extras_composition": {
        "formula": EXPECTED_DRY863_EXTRAS_FORMULA,
        "composition_sha256": EXPECTED_DRY863_EXTRAS_COMPOSITION_SHA256,
        "n": EXPECTED_SURFACE_HARVEST_DELTA_N,
        "dry863_extras_sha256": EXPECTED_DRY863_EXTRAS_SHA256,
    },
    "batch_priority_composition": {
        "formula": EXPECTED_BATCH_PRIORITY_FORMULA,
        "composition_sha256": EXPECTED_BATCH_PRIORITY_COMPOSITION_SHA256,
        "batch_priority": list(EXPECTED_BATCH_PRIORITY),
    },
    "cross_full_market_scale_repro_wall_meta_bundle": {
        "bundle_sha256": EXPECTED_FM47_CROSS_FULL_MARKET_SCALE_REPRO_WALL_META_BUNDLE_SHA256,
    },
    "stable_metrics_wall": {
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "surface_unique": EXPECTED_SURFACE_UNIQUE,
        ...
        "risk_band": EXPECTED_RISK_BAND_STATUS_FORMULA,
        "coverage": EXPECTED_RESIDUAL_SAFETY_COVERAGE,
        "dry863_extra_n": EXPECTED_SURFACE_HARVEST_DELTA_N,
        "batch_priority": list(EXPECTED_BATCH_PRIORITY),
    },
}
...
THIS_TASK_ROOT_ID = "C-ROOT-MOCK50"
PRIOR_TASK_ROOT_ID = "C-ROOT-MOCK49"
RESUME_HARVEST_ROOT_ID = "C-ROOT-002"

FROZEN_ROOT_IDS_MUST_BLOCK = tuple(f"C-ROOT-MOCK{i}" for i in range(3, 50))
...
class FullMarketOverlapDry863BatchPriorityReproWallMetaBundlePaths:
    """只读输入与隔离写根路径规格。"""
    ...
    fm47_packet_rel: str = FM47_PACKET_REL
    fm47_fingerprint_rel: str = FM47_FINGERPRINT_REL
    fm47_full_market_unique_union_rel: str = FM47_FULL_MARKET_UNIQUE_UNION_REL
    fm47_combined_dryrun_cohort_rel: str = FM47_COMBINED_DRYRUN_COHORT_REL
    fm47_company_coverage_scale_rel: str = FM47_COMPANY_COVERAGE_SCALE_REL
    fm47_wall_meta_rel: str = FM47_WALL_META_REL
...
def assert_fm48_output_root(
    output_root: str, *, base_dir: str = BASE_DIR
) -> str:
    """
    C-FM-48 写根：须 validation/_mock_*，不得覆盖 MOCK3–49，
    不得写权威 dual-layer 索引；允许本任务 MOCK50 或未登记 ephemeral。
    """
    ...
    if root_id is not None and root_id != THIS_TASK_ROOT_ID:
        raise RuntimeError(
            ...
            f"(C-FM-48 only writes {THIS_TASK_ROOT_ID} or ephemeral _mock_*)"
        )
...
def fingerprint_overlap_membership_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """overlap_membership composition identity lock 指纹（overlap_delta=12）。"""
    doc = {
        "kind": "overlap_membership_composition_identity_lock",
        "overlap_delta": EXPECTED_OVERLAP_DELTA,
        "overlap_codes_sha256": EXPECTED_OVERLAP_CODES_SHA256,
...
def fingerprint_dry863_extras_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """dry863_extras composition identity lock 指纹（dry863=2）。"""
    doc = {
        "kind": "dry863_extras_composition_identity_lock",
        "dry863_extra_n": EXPECTED_SURFACE_HARVEST_DELTA_N,
...
def fingerprint_batch_priority_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """batch_priority composition identity lock 指纹（h863>p35>p3>p2>fu）。"""
    doc = {
        "kind": "batch_priority_composition_identity_lock",
        "batch_priority": list(EXPECTED_BATCH_PRIORITY),
        "composition_sha256": EXPECTED_BATCH_PRIORITY_COMPOSITION_SHA256,
...
def fingerprint_cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle identity lock 指纹。"""
    doc = {
        "kind": "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock",
        "compositions": {
            k: dict(v)
            for k, v in EXPECTED_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE.items()
        },
        "bundle_sha256": EXPECTED_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_SHA256,
        "deny_composition_mutate": True,
...
def evaluate_overlap_membership_composition_mutation(
    *,
    proposed_overlap_delta: int,
    proposed_overlap_codes_sha256: str,
) -> Dict[str, Any]:
    """评估 overlap_delta=12 组成变异；一律拒绝。"""
    matches = (
        proposed_overlap_delta == EXPECTED_OVERLAP_DELTA
        and proposed_overlap_codes_sha256 == EXPECTED_OVERLAP_CODES_SHA256
    )
    return {
        "proposed": {
            "overlap_delta": proposed_overlap_delta,
            "overlap_codes_sha256": proposed_overlap_codes_sha256,
        },
        "frozen": {
            "overlap_delta": EXPECTED_OVERLAP_DELTA,
            "overlap_codes_sha256": EXPECTED_OVERLAP_CODES_SHA256,
        ...
        "reason": "overlap_membership_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_dry863_extras_composition_mutation(
    *,
    proposed_dry863_extra_n: int,
    proposed_dry863_extras_sha256: str,
) -> Dict[str, Any]:
    """评估 dry863=2 组成变异；一律拒绝。"""
    matches = (
        proposed_dry863_extra_n == EXPECTED_SURFACE_HARVEST_DELTA_N
        and proposed_dry863_extras_sha256 == EXPECTED_DRY863_EXTRAS_SHA256
    )
    return {
        "proposed": {
            "dry863_extra_n": proposed_dry863_extra_n,
            "dry863_extras_sha256": proposed_dry863_extras_sha256,
        },
        "frozen": {
            "dry863_extra_n": EXPECTED_SURFACE_HARVEST_DELTA_N,
            "dry863_extras_sha256": EXPECTED_DRY863_EXTRAS_SHA256,
        ...
        "matches_frozen": matches,
        "mutation_allowed": False,
        "reason": "dry863_extras_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_batch_priority_composition_mutation(
    *,
    proposed_batch_priority: Sequence[str],
) -> Dict[str, Any]:
    """评估 h863>p35>p3>p2>fu 组成变异；一律拒绝。"""
    proposed = list(proposed_batch_priority)
    matches = proposed == list(EXPECTED_BATCH_PRIORITY)
    return {
        "proposed": {"batch_priority": proposed},
        "frozen": {"batch_priority": list(EXPECTED_BATCH_PRIORITY)},
        "matches_frozen": matches,
        "mutation_allowed": False,
        "reason": "batch_priority_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_mutation(
    *, proposed_compositions: Dict[str, Any]
) -> Dict[str, Any]:
    """评估 cross full-market overlap/dry863/batch_priority wall meta bundle 变异；一律拒绝。"""
    frozen = {
        k: dict(v)
        for k, v in EXPECTED_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE.items()
    }
    ...
    return {
        ...
        "mutation_allowed": False,
        "reason": (
            "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_frozen_pre_execute"
        ),
        "hold": "KEEP_EXECUTE_FALSE",
    }


def build_overlap_membership_composition_identity_lock_rows(
    paths: FullMarketOverlapDry863BatchPriorityReproWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """overlap_membership composition identity lock（overlap_delta=12）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_overlap_membership_composition_identity_lock()

    comp_payload = {
        "kind": "overlap_membership_composition",
        "overlap_delta": EXPECTED_OVERLAP_DELTA,
        "overlap_codes_sha256": EXPECTED_OVERLAP_CODES_SHA256,
        "overlap_delta_composition_sha256": EXPECTED_OVERLAP_DELTA_COMPOSITION_SHA256,
        "formula": EXPECTED_OVERLAP_MEMBERSHIP_FORMULA,
    ...
    identity_ok = (
        ...
        and len(EXPECTED_OVERLAP_CODES) == EXPECTED_OVERLAP_DELTA
        and comp_sha == EXPECTED_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256
    )
    checks["overlap_membership_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="overlap_membership_composition_identity",
            layer="overlap_membership_composition_identity_lock",
            expected="overlap_delta=12",
            observed=(
                f"formula={EXPECTED_OVERLAP_MEMBERSHIP_FORMULA};"
                f"n={EXPECTED_OVERLAP_DELTA};sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "overlap_membership_composition_drift",
        )
    )

    sample_denials = [
        evaluate_overlap_membership_composition_mutation(
            proposed_overlap_delta=11,
            proposed_overlap_codes_sha256=EXPECTED_OVERLAP_CODES_SHA256,
        ),
        evaluate_overlap_membership_composition_mutation(
            proposed_overlap_delta=EXPECTED_OVERLAP_DELTA,
            proposed_overlap_codes_sha256="0" * 64,
        ),
        evaluate_overlap_membership_composition_mutation(
            proposed_overlap_delta=0,
            proposed_overlap_codes_sha256="a" * 64,
        ),
        evaluate_overlap_membership_composition_mutation(
            proposed_overlap_delta=EXPECTED_OVERLAP_DELTA,
            proposed_overlap_codes_sha256=EXPECTED_OVERLAP_CODES_SHA256,
    ...
    checks["overlap_membership_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="overlap_membership_composition_mutation_denied",
            layer="overlap_membership_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
            notes="ok" if mut_ok else "overlap_membership_mutation_leak",
        )
    )
    ...
    flags_ok = (
        ...
        and fp == FROZEN_OVERLAP_MEMBERSHIP_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["overlap_membership_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="overlap_membership_composition_flags",
            layer="overlap_membership_composition_identity_lock",
            expected=FROZEN_OVERLAP_MEMBERSHIP_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "overlap_membership_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["overlap_membership_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="overlap_membership_composition_identity_lock_all_pass",
            layer="overlap_membership_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "overlap_membership_lock_incomplete",
        )
    )
    meta = {
        "fingerprint": fp,
...
def build_dry863_extras_composition_identity_lock_rows(
    paths: FullMarketOverlapDry863BatchPriorityReproWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """dry863_extras composition identity lock（dry863=2）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_dry863_extras_composition_identity_lock()

    comp_payload = {
        "kind": "dry863_extras_composition",
        "dry863_extra_n": EXPECTED_SURFACE_HARVEST_DELTA_N,
        "dry863_extras": sorted(EXPECTED_DRY863_EXTRA),
        "dry863_extras_sha256": EXPECTED_DRY863_EXTRAS_SHA256,
        "formula": EXPECTED_DRY863_EXTRAS_FORMULA,
    ...
    identity_ok = (
        ...
        and len(EXPECTED_DRY863_EXTRA) == 2
        and sorted(EXPECTED_DRY863_EXTRA) == ["000037", "000055"]
        and comp_sha == EXPECTED_DRY863_EXTRAS_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_DRY863_EXTRAS_COMPOSITION_SHA256
    )
    checks["dry863_extras_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="dry863_extras_composition_identity",
            layer="dry863_extras_composition_identity_lock",
            expected="dry863=2",
            observed=(
                f"formula={EXPECTED_DRY863_EXTRAS_FORMULA};"
                f"n={EXPECTED_SURFACE_HARVEST_DELTA_N};sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "dry863_extras_composition_drift",
        )
    )

    sample_denials = [
        evaluate_dry863_extras_composition_mutation(
            proposed_dry863_extra_n=1,
            proposed_dry863_extras_sha256=EXPECTED_DRY863_EXTRAS_SHA256,
        ),
        evaluate_dry863_extras_composition_mutation(
            proposed_dry863_extra_n=EXPECTED_SURFACE_HARVEST_DELTA_N,
            proposed_dry863_extras_sha256="0" * 64,
        ),
        evaluate_dry863_extras_composition_mutation(
            proposed_dry863_extra_n=0,
            proposed_dry863_extras_sha256="a" * 64,
        ),
        evaluate_dry863_extras_composition_mutation(
            proposed_dry863_extra_n=EXPECTED_SURFACE_HARVEST_DELTA_N,
            proposed_dry863_extras_sha256=EXPECTED_DRY863_EXTRAS_SHA256,
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["dry863_extras_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="dry863_extras_composition_mutation_denied",
            layer="dry863_extras_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
            notes="ok" if mut_ok else "dry863_extras_mutation_leak",
        )
    )
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_DRY863_EXTRAS_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["dry863_extras_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="dry863_extras_composition_flags",
            layer="dry863_extras_composition_identity_lock",
            expected=FROZEN_DRY863_EXTRAS_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "dry863_extras_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["dry863_extras_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="dry863_extras_composition_identity_lock_all_pass",
            layer="dry863_extras_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "dry863_extras_lock_incomplete",
        )
    )
    meta = {
        "fingerprint": fp,
...
def build_batch_priority_composition_identity_lock_rows(
    paths: FullMarketOverlapDry863BatchPriorityReproWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """batch_priority composition identity lock（h863>p35>p3>p2>fu）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_batch_priority_composition_identity_lock()

    comp_payload = {
        "kind": "batch_priority_composition",
        "batch_priority": list(EXPECTED_BATCH_PRIORITY),
        "formula": EXPECTED_BATCH_PRIORITY_FORMULA,
    }
    comp_sha = hashlib.sha256(
    ...
    identity_ok = (
        EXPECTED_BATCH_PRIORITY_FORMULA == "h863>p35>p3>p2>fu"
        and list(EXPECTED_BATCH_PRIORITY) == ["h863", "p35", "p3", "p2", "fu"]
        and comp_sha == EXPECTED_BATCH_PRIORITY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_BATCH_PRIORITY_COMPOSITION_SHA256
    )
    checks["batch_priority_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="batch_priority_composition_identity",
            layer="batch_priority_composition_identity_lock",
            expected="h863>p35>p3>p2>fu",
            observed=(
                f"formula={EXPECTED_BATCH_PRIORITY_FORMULA};"
                f"order={'>'.join(EXPECTED_BATCH_PRIORITY)};sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "batch_priority_composition_drift",
        )
    )

    sample_denials = [
        evaluate_batch_priority_composition_mutation(
            proposed_batch_priority=["p35", "h863", "p3", "p2", "fu"],
        ),
        evaluate_batch_priority_composition_mutation(
            proposed_batch_priority=["h863", "p35", "p3", "p2"],
        ),
        evaluate_batch_priority_composition_mutation(
            proposed_batch_priority=[],
        ),
        evaluate_batch_priority_composition_mutation(
            proposed_batch_priority=list(EXPECTED_BATCH_PRIORITY),
        ),
    ]
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["batch_priority_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="batch_priority_composition_mutation_denied",
            layer="batch_priority_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_BATCH_PRIORITY_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["batch_priority_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="batch_priority_composition_flags",
            layer="batch_priority_composition_identity_lock",
            expected=FROZEN_BATCH_PRIORITY_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "batch_priority_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["batch_priority_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="batch_priority_composition_identity_lock_all_pass",
            layer="batch_priority_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "batch_priority_lock_incomplete",
        )
    )
    meta = {
        "fingerprint": fp,
...
def build_cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock_rows(
    paths: FullMarketOverlapDry863BatchPriorityReproWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle identity lock。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = (
    ...
    identity_ok = (
        ...
        and compositions["overlap_membership_composition"]["overlap_delta"] == 12
        and compositions["dry863_extras_composition"]["n"] == 2
        and compositions["batch_priority_composition"]["formula"]
        == "h863>p35>p3>p2>fu"
    )
    checks[
        "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity"
    ] = identity_ok
    rows.append(
        _row(
            check_id="cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity",
            layer="cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock",
            expected="overlap12+dry863=2+batch_priority+repro_bundle",
    ...
    mutated["overlap_membership_composition"] = {
        "formula": "overlap_delta=0",
        "composition_sha256": EXPECTED_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256,
        "overlap_delta": 0,
        "overlap_codes_sha256": EXPECTED_OVERLAP_CODES_SHA256,
    }
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks[
        "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_mutation_denied"
    ] = mut_ok
    rows.append(
        _row(
            check_id="cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_mutation_denied",
            layer="cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    checks[
        "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_flags"
    ] = flags_ok
    rows.append(
        _row(
            check_id="cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_flags",
            layer="cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock",
            expected=FROZEN_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
    ...
    all_ok = all(checks.values()) if checks else False
    checks[
        "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock_all_pass"
    ] = all_ok
    rows.append(
        _row(
            check_id="cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock_all_pass",
            layer="cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
def build_fm47_continuity_rows(
    paths: FullMarketOverlapDry863BatchPriorityReproWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """FM47 packet / fingerprint / gate / 四 ledger 零漂移。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}

    packet = load_json(_abs(paths.fm47_packet_rel, base_dir=base_dir))
    fp_doc = load_json(_abs(paths.fm47_fingerprint_rel, base_dir=base_dir))
    gate_doc = load_json(_abs(paths.fm47_gate_json_rel, base_dir=base_dir))
    us_led = load_json(_abs(paths.fm47_full_market_unique_union_rel, base_dir=base_dir))
    od_led = load_json(_abs(paths.fm47_combined_dryrun_cohort_rel, base_dir=base_dir))
    sd_led = load_json(_abs(paths.fm47_company_coverage_scale_rel, base_dir=base_dir))
    wall_led = load_json(_abs(paths.fm47_wall_meta_rel, base_dir=base_dir))
    ...
    pkt_ok = (
        ...
        and packet.get("full_market_unique_union_composition_sha256")
        == EXPECTED_FM47_FULL_MARKET_UNIQUE_UNION_COMPOSITION_SHA256
        and packet.get("combined_dryrun_cohort_composition_sha256")
        == EXPECTED_FM47_COMBINED_DRYRUN_COHORT_COMPOSITION_SHA256
        and packet.get("company_coverage_scale_composition_sha256")
        == EXPECTED_FM47_COMPANY_COVERAGE_SCALE_COMPOSITION_SHA256
        and packet.get("cross_full_market_scale_repro_wall_meta_bundle_sha256")
        == EXPECTED_FM47_CROSS_FULL_MARKET_SCALE_REPRO_WALL_META_BUNDLE_SHA256
    ...
    checks["fm47_packet_zero_drift"] = pkt_ok
    rows.append(
        _row(
            check_id="fm47_packet_zero_drift",
            layer="fm47_continuity",
            path=paths.fm47_packet_rel,
            expected="PASS_OFFLINE+stable_metrics+compositions",
            observed=f"gate={packet.get('gate')};unique={packet.get('harvest_unique_union')}",
            ok=pkt_ok,
            notes="ok" if pkt_ok else "fm47_packet_drift",
        )
    )
    ...
    fp_ok = (
        ...
        and fp_doc.get("full_market_unique_union_composition_sha256")
        == EXPECTED_FM47_FULL_MARKET_UNIQUE_UNION_COMPOSITION_SHA256
        and fp_doc.get("combined_dryrun_cohort_composition_sha256")
        == EXPECTED_FM47_COMBINED_DRYRUN_COHORT_COMPOSITION_SHA256
        and fp_doc.get("company_coverage_scale_composition_sha256")
        == EXPECTED_FM47_COMPANY_COVERAGE_SCALE_COMPOSITION_SHA256
        and fp_doc.get("cross_full_market_scale_repro_wall_meta_bundle_sha256")
        == EXPECTED_FM47_CROSS_FULL_MARKET_SCALE_REPRO_WALL_META_BUNDLE_SHA256
        and fp_doc.get("seal_chain_extended") is False
    )
    checks["fm47_fingerprint_zero_drift"] = fp_ok
    rows.append(
        _row(
            check_id="fm47_fingerprint_zero_drift",
            layer="fm47_continuity",
            path=paths.fm47_fingerprint_rel,
            expected="stable_metrics+fm47_fps",
            observed=f"unique={fp_doc.get('harvest_unique_union')}",
            ok=fp_ok,
            notes="ok" if fp_ok else "fm47_fingerprint_drift",
        )
    )
    ...
    gate_ok = (
        ...
        and gate_doc.get("cross_full_market_scale_repro_wall_meta_bundle_sha256")
        == EXPECTED_FM47_CROSS_FULL_MARKET_SCALE_REPRO_WALL_META_BUNDLE_SHA256
        and gate_doc.get("seal_chain_extended") is False
    )
    checks["fm47_gate_zero_drift"] = gate_ok
    rows.append(
        _row(
            check_id="fm47_gate_zero_drift",
            layer="fm47_continuity",
            path=paths.fm47_gate_json_rel,
            expected="PASS_OFFLINE+KEEP_EXECUTE_FALSE",
            observed=f"gate={gate_doc.get('gate')}",
            ok=gate_ok,
            notes="ok" if gate_ok else "fm47_gate_drift",
        )
    )

    us_ok = (
        us_led.get("fingerprint_sha256")
        == FROZEN_FM47_FULL_MARKET_UNIQUE_UNION_COMPOSITION_IDENTITY_LOCK_FP_SHA256
        and us_led.get("composition_sha256")
        == EXPECTED_FM47_FULL_MARKET_UNIQUE_UNION_COMPOSITION_SHA256
    )
    checks["fm47_full_market_unique_union_ledger_zero_drift"] = us_ok
    rows.append(
        _row(
            check_id="fm47_full_market_unique_union_ledger_zero_drift",
            layer="fm47_continuity",
            path=paths.fm47_full_market_unique_union_rel,
            expected=FROZEN_FM47_FULL_MARKET_UNIQUE_UNION_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=str(us_led.get("fingerprint_sha256")),
            ok=us_ok,
            notes="ok" if us_ok else "fm47_unique_ledger_drift",
        )
    )

    od_ok = (
        od_led.get("fingerprint_sha256")
        == FROZEN_FM47_COMBINED_DRYRUN_COHORT_COMPOSITION_IDENTITY_LOCK_FP_SHA256
        and od_led.get("composition_sha256")
        == EXPECTED_FM47_COMBINED_DRYRUN_COHORT_COMPOSITION_SHA256
    )
    checks["fm47_combined_dryrun_cohort_ledger_zero_drift"] = od_ok
    rows.append(
        _row(
            check_id="fm47_combined_dryrun_cohort_ledger_zero_drift",
            layer="fm47_continuity",
            path=paths.fm47_combined_dryrun_cohort_rel,
            expected=FROZEN_FM47_COMBINED_DRYRUN_COHORT_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=str(od_led.get("fingerprint_sha256")),
            ok=od_ok,
            notes="ok" if od_ok else "fm47_dryrun_ledger_drift",
        )
    )

    sd_ok = (
        sd_led.get("fingerprint_sha256")
        == FROZEN_FM47_COMPANY_COVERAGE_SCALE_COMPOSITION_IDENTITY_LOCK_FP_SHA256
        and sd_led.get("composition_sha256")
        == EXPECTED_FM47_COMPANY_COVERAGE_SCALE_COMPOSITION_SHA256
    )
    checks["fm47_company_coverage_scale_ledger_zero_drift"] = sd_ok
    rows.append(
        _row(
            check_id="fm47_company_coverage_scale_ledger_zero_drift",
            layer="fm47_continuity",
            path=paths.fm47_company_coverage_scale_rel,
            expected=FROZEN_FM47_COMPANY_COVERAGE_SCALE_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=str(sd_led.get("fingerprint_sha256")),
            ok=sd_ok,
            notes="ok" if sd_ok else "fm47_coverage_ledger_drift",
        )
    )
    ...
    checks["fm47_wall_meta_ledger_zero_drift"] = wall_ok
    rows.append(
        _row(
            check_id="fm47_wall_meta_ledger_zero_drift",
            layer="fm47_continuity",
            path=paths.fm47_wall_meta_rel,
            expected=FROZEN_FM47_CROSS_FULL_MARKET_SCALE_REPRO_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256,
            observed=str(wall_led.get("fingerprint_sha256")),
            ok=wall_ok,
            notes="ok" if wall_ok else "fm47_wall_meta_ledger_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["fm47_continuity_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="fm47_continuity_all_pass",
            layer="fm47_continuity",
            expected="packet+fp+gate+4ledgers",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "fm47_continuity_incomplete",
        )
    )
    return rows, checks
...
def build_output_root_protection_rows(
    ...
    *,
    ...
    """output-root 保护：resume/harvest 写拒绝 + MOCK50 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    ...
    out_detail = ""
    try:
        assert_fm48_output_root(paths.output_root_rel, base_dir=base_dir)
        out_ok = True
        out_detail = "allowed"
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            expected="MOCK50_or_ephemeral_allowed",
            observed=out_detail,
            ok=out_ok,
...
def build_frozen_mock_isolation_rows(
    paths: FullMarketOverlapDry863BatchPriorityReproWallMetaBundlePaths, *, base_dir: str = BASE_DIR
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """冻结 mock cohort 写隔离：MOCK3–49 拒绝 · MOCK50 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    load_frozen_mock_cohort_roots.cache_clear()
    ...
    mock48_rel = FM47_MOCK_ROOT_REL
    mock48_blocked = False
    try:
        assert_fm48_output_root(mock48_rel, base_dir=base_dir)
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            layer="frozen_mock_isolation",
            expected="MOCK3-49_block+MOCK50_allow",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
def build_protected_csv_registry_rows(
    *,
    ...
    """protected_output_roots.csv：MOCK50 已登记。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    ...
    rows.append(
        _row(
            ...
            layer="protected_csv_registry",
            expected="MOCK3–49+MOCK50+resume+auth+registered",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
def build_fm_gate_battery_rows(
    *, gates: Dict[str, Dict[str, Any]]
    ...
    seal_skip_keys = {
        ...
        "fm36", "fm37", "fm38", "fm39", "fm40", "fm41", "fm42", "fm43", "fm44", "fm45", "fm46", "fm47",
    }
    for check_id, key in specs:
        ...
        if key in (
            ...
            "fm33", "fm34", "fm35", "fm36", "fm37", "fm38", "fm39", "fm40", "fm41", "fm42", "fm43", "fm44", "fm45", "fm46", "fm47",
        ):
            ok = (
                ok
                and payload.get("harvest_unique_union") == EXPECTED_HARVEST_UNIQUE_UNION
        ...
        if key in (
            ...
            "fm34", "fm35", "fm36", "fm37", "fm38", "fm39", "fm40", "fm41", "fm42", "fm43", "fm44", "fm45", "fm46", "fm47",
        ):
            ok = (
                ok
        ...
        if key in (
            ...
            "fm35", "fm36", "fm37", "fm38", "fm39", "fm40", "fm41", "fm42", "fm43", "fm44", "fm45", "fm46", "fm47",
        ):
            ok = (
                ok
...
def ensure_protected_roots_csv_fm48(
    *,
    csv_rel: str = PROTECTED_ROOTS_CSV_REL,
    base_dir: str = BASE_DIR,
) -> None:
    """注册 C-ROOT-MOCK50；加固 C-ROOT-002 unique/surface/additive/tier/dryrun 说明。"""
    ...
    _upsert(
        RESUME_HARVEST_ROOT_ID,
        {
            ...
            "notes": (
                ...
                "C-FM-24..47 scale/safety freezes + C-FM-48 full-market overlap/dry863/"
                "batch_priority-repro-wall-meta-bundle; 只读直至人批重跑"
            ),
        },
    )
    _upsert(
        THIS_TASK_ROOT_ID,
        {
            ...
            "notes": (
                "C-FM-48 scale overlap_membership composition identity lock "
                "(overlap_delta=12) + dry863_extras composition identity lock "
                ...
                "identity lock + FM47 continuity; never production EXECUTE; "
                "must not overwrite MOCK3-49; seal_chain_extended=false"
            ),
        },
    )
...
def run_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety(
    *,
    paths: FullMarketOverlapDry863BatchPriorityReproWallMetaBundlePaths | None = None,
    base_dir: str = BASE_DIR,
) -> Dict[str, Any]:
    """执行 C-FM-48 规模 unique/surface/additive/tier/dryrun-wall-meta-bundle 离线 QA。"""
    paths = paths or FullMarketOverlapDry863BatchPriorityReproWallMetaBundlePaths()
    generated_at = _utc_now_iso()
    ensure_protected_roots_csv_fm48(
        csv_rel=paths.protected_roots_csv_rel, base_dir=base_dir
    )
    out_root = assert_fm48_output_root(paths.output_root_rel, base_dir=base_dir)

    matrix: List[Dict[str, str]] = []
    cont_rows, cont_checks = build_fm47_continuity_rows(paths, base_dir=base_dir)
    ...
    layer_gates = {
        "fm47_continuity": (
            "PASS_OFFLINE"
            if cont_checks.get("fm47_continuity_all_pass")
            else "FAIL_OFFLINE"
        ),
        "overlap_membership_composition_identity_lock": (
            "PASS_OFFLINE"
            if rf_checks.get("overlap_membership_composition_identity_lock_all_pass")
            else "FAIL_OFFLINE"
        ),
        "dry863_extras_composition_identity_lock": (
            "PASS_OFFLINE"
            if rt_checks.get("dry863_extras_composition_identity_lock_all_pass")
            else "FAIL_OFFLINE"
        ),
        "batch_priority_composition_identity_lock": (
            "PASS_OFFLINE"
            if rb_checks.get("batch_priority_composition_identity_lock_all_pass")
            else "FAIL_OFFLINE"
        ),
        "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock": (
            "PASS_OFFLINE"
    ...
    rf_rel = _write_ledger(
        "overlap_membership_composition_identity_lock_ledger.json",
        {
            "generated_at": generated_at,
            "task_id": TASK_ID,
            "fingerprint_sha256": rf_meta["fingerprint"],
            "composition_sha256": rf_meta["composition_sha256"],
            "overlap_membership_formula": rf_meta[
                "overlap_membership_formula"
            ],
    ...
    packet_rel = _write_ledger(
        "scale_packet.json",
        {
            ...
            "notes": (
                ...
                "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle identity lock + "
                "FM47 continuity + MOCK50; EXECUTE remains human-held; "
                "does not overwrite MOCK3-49"
            ),
        },
    )
    ...
    with open(_abs(readme_rel, base_dir=base_dir), "w", encoding="utf-8") as fh:
        fh.write(
            "\n".join(
                [
                    "# C-FM-48 mock scale lineage/drift/protected/repro-wall-meta-bundle safety root",
                    "",
                    f"task_id: {TASK_ID}",
                    f"gate: {overall}",
                    "cninfo_calls: 0",
                    ...
                    "",
                    "Isolation: MOCK3-49 frozen; this root is C-ROOT-MOCK50.",
    ...
    return {
        ...
        "observed_fps": observed_fps,
        "inputs": {
            "fm47_packet": paths.fm47_packet_rel,
            "fm47_fingerprint": paths.fm47_fingerprint_rel,
            "fm47_gate": paths.fm47_gate_json_rel,
