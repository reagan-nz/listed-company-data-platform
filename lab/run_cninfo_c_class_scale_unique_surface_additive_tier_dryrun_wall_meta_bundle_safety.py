...
identity lock runner（离线 · C-FM-45）。

Usage:
    python3 lab/run_cninfo_c_class_scale_unique_surface_additive_tier_dryrun_wall_meta_bundle_safety.py
    python3 lab/run_cninfo_c_class_scale_unique_surface_additive_tier_dryrun_wall_meta_bundle_safety.py \\
      --output-root outputs/validation/_mock_c_fm45_scale_unique_surface_additive_tier_dryrun_wall_meta_bundle_safety
"""
...
REPORT_ROOT_REL = (
    "outputs/validation/"
    "cninfo_c_class_scale_unique_surface_additive_tier_dryrun_wall_meta_bundle_safety"
)
REPORT_MD_REL = (
    "outputs/validation/"
    "cninfo_c_class_scale_unique_surface_additive_tier_dryrun_wall_meta_bundle_safety_20260715.md"
)
REPORT_JSON_REL = (
    "outputs/validation/"
...
TASK_REPORT_REL = (
    "outputs/validation/"
    "cninfo_c_class_fm45_scale_unique_surface_additive_tier_dryrun_wall_meta_bundle_safety_20260715.md"
)
...
def write_reports(payload: Dict[str, Any]) -> Dict[str, str]:
    ...
    json_payload = {
        ...
        "unique_surface_additive_composition_sha256": payload[
            "unique_surface_additive_composition_sha256"
        ],
        "tier_coverage_status_composition_sha256": payload[
            "tier_coverage_status_composition_sha256"
        ],
        "combined_dryrun_status_composition_sha256": payload[
            "combined_dryrun_status_composition_sha256"
        ],
        "cross_unique_surface_additive_tier_dryrun_wall_meta_bundle_sha256": payload[
        ...
        "unique_surface_additive_formula": payload["unique_surface_additive_formula"],
        "tier_coverage_status_formula": payload["tier_coverage_status_formula"],
        "combined_dryrun_status_formula": payload["combined_dryrun_status_formula"],
        ...
        "unique_surface_additive_path": payload["unique_surface_additive_path"],
        "tier_coverage_status_path": payload["tier_coverage_status_path"],
        "combined_dryrun_status_path": payload["combined_dryrun_status_path"],
        "cross_unique_surface_additive_tier_dryrun_wall_meta_bundle_path": payload[
            "cross_unique_surface_additive_tier_dryrun_wall_meta_bundle_path"
        ],
    ...
    md_lines = [
        ...
        f"| unique_surface_additive_formula | **{payload['unique_surface_additive_formula']}** |",
        f"| tier_coverage_status_formula | **{payload['tier_coverage_status_formula']}** |",
        f"| combined_dryrun_status_formula | **{payload['combined_dryrun_status_formula']}** |",
        ...
        *layer_lines,
        ...
        "## Scale / safety gain",
        "",
        "- FM44 连续：unique=**2249** · dryrun=**1053** · residual=**117** · "
        ...
        "unique/surface/additive/tier/dryrun 墙元捆绑身份锁",
        "- MOCK3–46 冻结 · MOCK47 放行",
        "",
        "## Hold",
        "",
        "```",
        f"c_fm_45_scale_unique_surface_additive_tier_dryrun_wall_meta_bundle_safety_gate = "
        f"{payload['gate']}",
        "execute_production_snapshot_rebuild = false",
        "approved_for_snapshot_rebuild = false",
        "cninfo_calls = 0",
    ...
    task_lines = [
        ...
        "## Task",
        "",
        "在 C-FM-44 已 commit 且 EXECUTE 仍 human-held 之上，继续 **非 seal** "
        "规模/安全能力（非 extension↔drift / seal-chain）：**unique_surface_additive "
        "composition identity lock（2249/2251/2261）**、**tier_coverage_status composition "
        "identity lock（7/3314）**、**combined_dryrun_status composition identity "
        "lock（dryrun=1053）**、**cross_unique_surface_additive_tier_dryrun_wall_meta_bundle "
        "identity lock（unique/surface/additive/tier/dryrun 墙元捆绑）**、**FM44 连续 + MOCK47 隔离**；"
        "产物写入隔离 MOCK47（不覆盖 MOCK3–46）。",
        "",
        "## Capability gain",
        "",
        "1. FM44 packet/fingerprint/gate/ledger 零漂移连续（unique=2249 · 1053 · "
        ...
        "5. cross_unique_surface_additive_tier_dryrun_wall_meta_bundle_identity_lock："
        "unique/surface/additive/tier/dryrun 墙元捆绑 · 组成变异拒绝",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.execute:
        print(
            ...
            "C-FM-45 is offline QA only; KEEP_EXECUTE_FALSE",
            file=sys.stderr,
        )
        return 2

    payload = run_scale_unique_surface_additive_tier_dryrun_wall_meta_bundle_safety(
        ...
        json.dumps(
            {
                ...
                "surface_unique": payload["surface_unique"],
                "combined_dryrun_coverage": payload["combined_dryrun_coverage"],
                "unique_surface_additive_formula": payload[
                    "unique_surface_additive_formula"
                ],
                "tier_coverage_status_formula": payload[
                    "tier_coverage_status_formula"
                ],
                "combined_dryrun_status_formula": payload[
