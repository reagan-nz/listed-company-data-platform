...
（不新增 seal / decision-await / commit-boundary；非 extension↔drift 循环）：
  1) FM51 packet / fingerprint / gate / residual·resume·coverage·wall ledgers 零漂移连续
  ...
  5) cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock：unique_surface_additive/overlap_delta/surface_delta 墙元捆绑
  6) output-root：MOCK3–53 冻结 · MOCK54 放行
  7) FM-01..05 + FM-12..51 gate battery（跳过 seal FM06–11）

禁止：CNINFO live · production EXECUTE · 覆盖 MOCK3–53 / 权威 dual-layer 索引 ·
...
from cninfo_c_class_scale_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_safety import (  # noqa: E402
    FROZEN_RESIDUAL_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM51_FROZEN_RESIDUAL_FORMULA_FP,
    FROZEN_RESUME_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM51_FROZEN_RESUME_FORMULA_FP,
    FROZEN_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM51_FROZEN_COVERAGE_FP,
    FROZEN_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 as FM51_FROZEN_WALL_META_FP,
    EXPECTED_RESIDUAL_FORMULA_PRIMARY_COMPOSITION_SHA256 as FM51_EXPECTED_RESIDUAL_FORMULA_COMP_SHA256,
    EXPECTED_RESUME_FORMULA_PRIMARY_COMPOSITION_SHA256 as FM51_EXPECTED_RESUME_FORMULA_COMP_SHA256,
    EXPECTED_COVERAGE_PRIMARY_COMPOSITION_SHA256 as FM51_EXPECTED_COVERAGE_COMP_SHA256,
    EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_SHA256 as FM51_EXPECTED_WALL_META_SHA256,
    EXPECTED_BATCH_PRIORITY as FM51_EXPECTED_BATCH_PRIORITY,
)
...
FM51_PACKET_REL = f"{FM51_MOCK_ROOT_REL}/scale_packet.json"
FM51_FINGERPRINT_REL = f"{FM51_MOCK_ROOT_REL}/scale_fingerprint.json"
FM51_RESIDUAL_FORMULA_REL = (
    f"{FM51_MOCK_ROOT_REL}/residual_formula_composition_identity_lock_ledger.json"
)
FM51_RESUME_FORMULA_REL = (
    f"{FM51_MOCK_ROOT_REL}/resume_formula_composition_identity_lock_ledger.json"
)
FM51_COVERAGE_REL = (
    f"{FM51_MOCK_ROOT_REL}/coverage_composition_identity_lock_ledger.json"
)
FM51_WALL_META_REL = (
    f"{FM51_MOCK_ROOT_REL}/"
    "cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock_ledger.json"
)# 兼容旧名（连续性别名）
FM49_GATE_JSON_REL = FM51_GATE_JSON_REL
FM49_MOCK_ROOT_REL = FM51_MOCK_ROOT_REL
FM49_PACKET_REL = FM51_PACKET_REL
FM49_FINGERPRINT_REL = FM51_FINGERPRINT_REL
FM49_UNION_STATUS_REL = FM51_RESIDUAL_FORMULA_REL
FM49_RESIDUAL_COVERAGE_REL = FM51_RESUME_FORMULA_REL
FM49_RESUME_TAXONOMY_DISPOSITION_REL = FM51_COVERAGE_REL
FM49_WALL_META_REL = FM51_WALL_META_REL
FM48_GATE_JSON_REL = FM51_GATE_JSON_REL
FM48_MOCK_ROOT_REL = FM51_MOCK_ROOT_REL
FM48_PACKET_REL = FM51_PACKET_REL
FM48_FINGERPRINT_REL = FM51_FINGERPRINT_REL
FM48_OVERLAP_MEMBERSHIP_REL = FM51_RESIDUAL_FORMULA_REL
FM48_DRY863_EXTRAS_REL = FM51_RESUME_FORMULA_REL
FM48_BATCH_PRIORITY_REL = FM51_COVERAGE_REL
FM48_WALL_META_REL = FM51_WALL_META_REL

# C-FM-52 本包冻结指纹（运行后由 fingerprint_* 锁定）
FROZEN_UNIQUE_SURFACE_ADDITIVE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "691004dc6e301474362fffd1670a34f19453770fa63623e1c7723bba17ebafc8"
)
FROZEN_OVERLAP_DELTA_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "34cdc5d8d0792d8a95b3cb54306200ee9d5cdf7dc6c1d421af3edb65705a4409"
)
FROZEN_SURFACE_DELTA_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "2c522489946bcb6906c3b8a4dddd814d6116868208f51a961dcab3239b163833"
)
FROZEN_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 = (
    "81879db467924098c4527a1c6b8717259a3631aa625e71d01325a8128fe47205"
)

# 兼容旧主轴冻结名（FM50 风格别名 → 本包 unique_surface_additive/overlap_delta/surface_delta）
...
# FM50 连续锚点（只读）
FROZEN_FM51_RESIDUAL_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM51_FROZEN_RESIDUAL_FORMULA_FP
FROZEN_FM51_RESUME_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM51_FROZEN_RESUME_FORMULA_FP
FROZEN_FM51_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM51_FROZEN_COVERAGE_FP
FROZEN_FM51_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 = (
    FM51_FROZEN_WALL_META_FP
)
# 兼容旧名
FROZEN_FM49_UNION_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FROZEN_FM51_RESIDUAL_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256
FROZEN_FM49_RESIDUAL_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FROZEN_FM51_RESUME_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256
FROZEN_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FROZEN_FM51_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256
...
EXPECTED_FM51_RESIDUAL_FORMULA_COMPOSITION_SHA256 = FM51_EXPECTED_RESIDUAL_FORMULA_COMP_SHA256
EXPECTED_FM49_UNION_STATUS_COMPOSITION_SHA256 = EXPECTED_FM51_RESIDUAL_FORMULA_COMPOSITION_SHA256
EXPECTED_FM51_RESUME_FORMULA_COMPOSITION_SHA256 = FM51_EXPECTED_RESUME_FORMULA_COMP_SHA256
EXPECTED_FM49_RESIDUAL_COVERAGE_COMPOSITION_SHA256 = EXPECTED_FM51_RESUME_FORMULA_COMPOSITION_SHA256
EXPECTED_FM51_COVERAGE_COMPOSITION_SHA256 = FM51_EXPECTED_COVERAGE_COMP_SHA256
EXPECTED_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_SHA256 = EXPECTED_FM51_COVERAGE_COMPOSITION_SHA256
EXPECTED_FM51_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_SHA256 = (
    FM51_EXPECTED_WALL_META_SHA256
)
...
EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_COMPOSITION_SHA256 = (
    "8b9336b0fbc684b285ad90558870c65313c38cbf1ae3154317efd806166bbb0b"
)
EXPECTED_OVERLAP_DELTA_PRIMARY_COMPOSITION_SHA256 = (
    "1224d2cd3123f9e53725bfa0cedda87e9202d130cbf4066107677e0079534a8e"
)
EXPECTED_SURFACE_DELTA_PRIMARY_COMPOSITION_SHA256 = (
    "74673c57d8a566efaea8d0f40567d4d4d89965c884c54fd1bea971840fde8f8a"
)
# 兼容旧主轴名
EXPECTED_RISK_BAND_STATUS_PRIMARY_COMPOSITION_SHA256 = EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_COMPOSITION_SHA256
EXPECTED_TIER_COVERAGE_PRIMARY_COMPOSITION_SHA256 = EXPECTED_OVERLAP_DELTA_PRIMARY_COMPOSITION_SHA256
EXPECTED_COMBINED_DRYRUN_PRIMARY_COMPOSITION_SHA256 = EXPECTED_SURFACE_DELTA_PRIMARY_COMPOSITION_SHA256
EXPECTED_RESIDUAL_FORMULA_PRIMARY_COMPOSITION_SHA256 = EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_COMPOSITION_SHA256
EXPECTED_RESUME_FORMULA_PRIMARY_COMPOSITION_SHA256 = EXPECTED_OVERLAP_DELTA_PRIMARY_COMPOSITION_SHA256
# 兼容旧名（本包主轴）
...
EXPECTED_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE_SHA256 = (
    "bd91376cc24d0e76389aad62d547e5eb05fd1698bb32cbe72007f3b8835fab65"
)
...
EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_FORMULA = "2249/2251/2261"
EXPECTED_OVERLAP_DELTA_PRIMARY_FORMULA = "overlap_delta=12"
EXPECTED_SURFACE_DELTA_PRIMARY_FORMULA = "surface_delta=2"
EXPECTED_RESIDUAL_FORMULA_PRIMARY_FORMULA = EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_FORMULA
EXPECTED_RESUME_FORMULA_PRIMARY_FORMULA = EXPECTED_OVERLAP_DELTA_PRIMARY_FORMULA
EXPECTED_RISK_BAND_STATUS_PRIMARY_FORMULA = EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_FORMULA
EXPECTED_TIER_COVERAGE_PRIMARY_FORMULA = EXPECTED_OVERLAP_DELTA_PRIMARY_FORMULA
EXPECTED_COMBINED_DRYRUN_PRIMARY_FORMULA = EXPECTED_SURFACE_DELTA_PRIMARY_FORMULA
...
EXPECTED_BATCH_PRIORITY = list(FM51_EXPECTED_BATCH_PRIORITY)
EXPECTED_FM52_PROTECTED_ROOT_REGISTRY_FORMULA = "MOCK3-53+MOCK54+resume+auth"
...
EXPECTED_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE = {
    "unique_surface_additive_composition": {
        "formula": EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_COMPOSITION_SHA256,
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "surface_unique": EXPECTED_SURFACE_UNIQUE,
        "harvest_additive": EXPECTED_HARVEST_ADDITIVE,
    ...
    "overlap_delta_composition": {
        "formula": EXPECTED_OVERLAP_DELTA_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_OVERLAP_DELTA_PRIMARY_COMPOSITION_SHA256,
        "overlap_delta": EXPECTED_OVERLAP_DELTA,
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "harvest_additive": EXPECTED_HARVEST_ADDITIVE,
    ...
    "surface_delta_composition": {
        "formula": EXPECTED_SURFACE_DELTA_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_SURFACE_DELTA_PRIMARY_COMPOSITION_SHA256,
    ...
    "cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle": {
        "bundle_sha256": EXPECTED_FM51_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_SHA256,
    },
    "stable_metrics_wall": {
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "surface_unique": EXPECTED_SURFACE_UNIQUE,
...
THIS_TASK_ROOT_ID = "C-ROOT-MOCK54"
PRIOR_TASK_ROOT_ID = "C-ROOT-MOCK53"
RESUME_HARVEST_ROOT_ID = "C-ROOT-002"

FROZEN_ROOT_IDS_MUST_BLOCK = tuple(f"C-ROOT-MOCK{i}" for i in range(3, 54))
...
class FullMarketUniqueSurfaceAdditiveOverlapDeltaSurfaceDeltaWallMetaBundlePaths:
    """只读输入与隔离写根路径规格。"""
    ...
    fm51_packet_rel: str = FM51_PACKET_REL
    fm49_packet_rel: str = FM49_PACKET_REL
    fm51_fingerprint_rel: str = FM51_FINGERPRINT_REL
...
def assert_fm52_output_root(
    output_root: str, *, base_dir: str = BASE_DIR
) -> str:
    """
    C-FM-52 写根：须 validation/_mock_*，不得覆盖 MOCK3–53，
    ...
    if root_id is not None and root_id != THIS_TASK_ROOT_ID:
        raise RuntimeError(
            ...
            f"(C-FM-52 only writes {THIS_TASK_ROOT_ID} or ephemeral _mock_*)"
        )
...
def fingerprint_overlap_delta_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """overlap_delta composition identity lock 指纹（overlap_delta=12）。"""
    doc = {
...
def fingerprint_surface_delta_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """surface_delta composition identity lock 指纹（surface_delta=2）。"""
    doc = {
...
def fingerprint_cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """cross unique_surface_additive/overlap_delta/surface_delta wall-meta bundle identity lock 指纹。"""
    doc = {
        "kind": "cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock",
        "compositions": {
            k: dict(v)
            for k, v in EXPECTED_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE.items()
        },
        "bundle_sha256": EXPECTED_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE_SHA256,
        "deny_composition_mutate": True,
...
fingerprint_overlap_membership_composition_identity_lock = fingerprint_unique_surface_additive_composition_identity_lock
fingerprint_dry863_extras_composition_identity_lock = fingerprint_overlap_delta_composition_identity_lock
fingerprint_batch_priority_composition_identity_lock = fingerprint_surface_delta_composition_identity_lock
fingerprint_union_status_composition_identity_lock = fingerprint_unique_surface_additive_composition_identity_lock
fingerprint_residual_coverage_composition_identity_lock = fingerprint_overlap_delta_composition_identity_lock
fingerprint_resume_taxonomy_disposition_composition_identity_lock = fingerprint_surface_delta_composition_identity_lock
fingerprint_unique_surface_additive_composition_identity_lock = fingerprint_unique_surface_additive_composition_identity_lock
fingerprint_overlap_delta_composition_identity_lock = fingerprint_overlap_delta_composition_identity_lock
fingerprint_surface_delta_composition_identity_lock = fingerprint_surface_delta_composition_identity_lock
fingerprint_cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock = (
    fingerprint_cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock
)
...
def evaluate_cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_mutation(
    *, proposed_compositions: Dict[str, Any]
) -> Dict[str, Any]:
    """评估 cross unique_surface_additive/overlap_delta/surface_delta wall-meta bundle 变异；一律拒绝。"""
    frozen = {
        k: dict(v)
        for k, v in EXPECTED_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE.items()
    }
    ...
    return {
        ...
        "mutation_allowed": False,
        "reason": (
            "cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_frozen_pre_execute"
        ),
        "hold": "KEEP_EXECUTE_FALSE",
    }


evaluate_overlap_membership_composition_mutation = evaluate_unique_surface_additive_composition_mutation
evaluate_dry863_extras_composition_mutation = evaluate_overlap_delta_composition_mutation
evaluate_batch_priority_composition_mutation = evaluate_surface_delta_composition_mutation
evaluate_union_status_composition_mutation = evaluate_unique_surface_additive_composition_mutation
evaluate_residual_coverage_composition_mutation = evaluate_overlap_delta_composition_mutation
evaluate_resume_taxonomy_disposition_composition_mutation = evaluate_surface_delta_composition_mutation
evaluate_risk_band_status_composition_mutation = evaluate_unique_surface_additive_composition_mutation
evaluate_tier_coverage_composition_mutation = evaluate_overlap_delta_composition_mutation
evaluate_combined_dryrun_composition_mutation = evaluate_surface_delta_composition_mutation
...
def build_unique_surface_additive_composition_identity_lock_rows(
    ...
    *,
    ...
    comp_payload = {
        "kind": "unique_surface_additive_composition",
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "surface_unique": EXPECTED_SURFACE_UNIQUE,
        "harvest_additive": EXPECTED_HARVEST_ADDITIVE,
        "unique_surface_additive_formula": EXPECTED_UNIQUE_SURFACE_ADDITIVE_FORMULA,
    ...
    identity_ok = (
        ...
        and comp_sha == EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_COMPOSITION_SHA256
    )
    ...
    rows.append(
        _row(
            ...
            observed=(
                f"formula={EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
    ...
    rows.append(
        _row(
            ...
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "unique_surface_additive_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["unique_surface_additive_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            ...
            ok=all_ok,
            notes="ok" if all_ok else "unique_surface_additive_lock_incomplete",
        )
    )
    meta_out = {
        "fingerprint": fp,
        "composition_sha256": comp_sha,
        "unique_surface_additive_formula": EXPECTED_UNIQUE_SURFACE_ADDITIVE_PRIMARY_FORMULA,
...
def build_overlap_delta_composition_identity_lock_rows(
    ...
    *,
    ...
    comp_payload = {
        "kind": "overlap_delta_composition",
        "overlap_delta": EXPECTED_OVERLAP_DELTA,
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "harvest_additive": EXPECTED_HARVEST_ADDITIVE,
        "overlap_delta_formula": EXPECTED_OVERLAP_DELTA_FORMULA,
    ...
    identity_ok = (
        ...
        and comp_sha == EXPECTED_OVERLAP_DELTA_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_OVERLAP_DELTA_PRIMARY_COMPOSITION_SHA256
    )
    ...
    rows.append(
        _row(
            ...
            observed=(
                f"formula={EXPECTED_OVERLAP_DELTA_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_OVERLAP_DELTA_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["overlap_delta_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="overlap_delta_composition_flags",
            layer="overlap_delta_composition_identity_lock",
    ...
    rows.append(
        _row(
            ...
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "overlap_delta_lock_incomplete",
        )
    )
    meta_out = {
        "fingerprint": fp,
        "composition_sha256": comp_sha,
        "overlap_delta_formula": EXPECTED_OVERLAP_DELTA_PRIMARY_FORMULA,
        "sample_denials": sample_denials,
        "doc": doc,
    }
    return rows, checks, meta_out
...
def build_surface_delta_composition_identity_lock_rows(
    ...
    *,
    ...
    comp_payload = {
        "kind": "surface_delta_composition",
        "surface_harvest_delta_n": EXPECTED_SURFACE_HARVEST_DELTA_N,
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "surface_unique": EXPECTED_SURFACE_UNIQUE,
        "surface_delta_formula": EXPECTED_SURFACE_DELTA_FORMULA,
    ...
    identity_ok = (
        ...
        and comp_sha == EXPECTED_SURFACE_DELTA_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_SURFACE_DELTA_PRIMARY_COMPOSITION_SHA256
    )
    ...
    rows.append(
        _row(
            ...
            observed=(
                f"formula={EXPECTED_SURFACE_DELTA_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_SURFACE_DELTA_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["surface_delta_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="surface_delta_composition_flags",
            layer="surface_delta_composition_identity_lock",
    ...
    rows.append(
        _row(
            ...
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "surface_delta_lock_incomplete",
        )
    )
    meta_out = {
        "fingerprint": fp,
        "composition_sha256": comp_sha,
        "surface_delta_formula": EXPECTED_SURFACE_DELTA_PRIMARY_FORMULA,
        "sample_denials": sample_denials,
        "doc": doc,
    }
    return rows, checks, meta_out
...
def build_cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock_rows(
    paths: FullMarketUniqueSurfaceAdditiveOverlapDeltaSurfaceDeltaWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """cross unique_surface_additive/overlap_delta/surface_delta wall-meta bundle identity lock。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock()
    ...
    identity_ok = (
        bundle_sha == EXPECTED_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE_SHA256
        and doc["bundle_sha256"] == EXPECTED_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE_SHA256
        and bundle["unique_surface_additive_composition"]["formula"] == "2249/2251/2261"
        and bundle["overlap_delta_composition"]["formula"] == "overlap_delta=12"
        and bundle["surface_delta_composition"]["formula"] == "surface_delta=2"
    )
    checks["cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity"] = identity_ok
    rows.append(
        _row(
            check_id="cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity",
            layer="cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock",
            expected=EXPECTED_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE_SHA256,
            observed=bundle_sha,
            ok=identity_ok,
    ...
    inflated["surface_delta_composition"] = dict(inflated["surface_delta_composition"])
    inflated["surface_delta_composition"]["surface_harvest_delta_n"] = 3
    deflated = {
        k: dict(v)
        for k, v in EXPECTED_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE.items()
    ...
    mutated["unique_surface_additive_composition"] = dict(mutated["unique_surface_additive_composition"])
    mutated["unique_surface_additive_composition"]["composition_sha256"] = "0" * 64
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_mutation_denied",
            layer="cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    flags_ok = (
        ...
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256
    )
    checks["cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_flags"] = flags_ok
    rows.append(
        _row(
            check_id="cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_flags",
            layer="cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock",
            expected=FROZEN_CROSS_FULL_MARKET_UNIQUE_SURFACE_ADDITIVE_OVERLAP_DELTA_SURFACE_DELTA_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
    ...
    all_ok = all(checks.values()) if checks else False
    checks["cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock_all_pass",
            layer="cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
def build_fm51_continuity_rows(
    paths: FullMarketUniqueSurfaceAdditiveOverlapDeltaSurfaceDeltaWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """FM51 packet / fingerprint / gate / residual_formula·resume_formula·coverage ledgers 零漂移。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}

    packet = load_json(_abs(paths.fm51_packet_rel, base_dir=base_dir))
    fp_doc = load_json(_abs(paths.fm51_fingerprint_rel, base_dir=base_dir))
    gate_doc = load_json(_abs(paths.fm49_gate_json_rel, base_dir=base_dir))
    rf_led = load_json(_abs(paths.fm49_union_status_rel, base_dir=base_dir))
    rt_led = load_json(_abs(paths.fm49_residual_coverage_rel, base_dir=base_dir))
    cov_led = load_json(_abs(paths.fm49_resume_taxonomy_disposition_rel, base_dir=base_dir))
    wall_led = load_json(_abs(paths.fm49_wall_meta_rel, base_dir=base_dir))

    pkt_primary_residual_formula = packet.get("risk_band_status_composition_sha256")
    pkt_primary_resume_formula = packet.get("tier_coverage_composition_sha256")
    pkt_primary_coverage = packet.get("combined_dryrun_composition_sha256")
    ...
    pkt_ok = (
        ...
        and pkt_primary_residual_formula == FM51_EXPECTED_RESIDUAL_FORMULA_COMP_SHA256
        and pkt_primary_resume_formula == FM51_EXPECTED_RESUME_FORMULA_COMP_SHA256
        and pkt_primary_coverage == FM51_EXPECTED_COVERAGE_COMP_SHA256
        and pkt_cross == FM51_EXPECTED_WALL_META_SHA256
    ...
    checks["fm51_packet_zero_drift"] = pkt_ok
    rows.append(
        _row(
            check_id="fm51_packet_zero_drift",
            layer="fm51_continuity",
            path=paths.fm51_packet_rel,
            expected="PASS_OFFLINE+residual_formula+resume_formula+coverage",
            observed=f"gate={packet.get('gate')};unique={packet.get('harvest_unique_union')}",
            ok=pkt_ok,
            notes="ok" if pkt_ok else "fm51_packet_drift",
        )
    )

    fp_primary_residual_formula = fp_doc.get("risk_band_status_composition_sha256")
    fp_primary_resume_formula = fp_doc.get("tier_coverage_composition_sha256")
    fp_primary_coverage = fp_doc.get("combined_dryrun_composition_sha256")
    fp_cross = fp_doc.get(
        "cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_sha256"
    )
    fp_ok = (
        ...
        and fp_primary_residual_formula == FM51_EXPECTED_RESIDUAL_FORMULA_COMP_SHA256
        and fp_primary_resume_formula == FM51_EXPECTED_RESUME_FORMULA_COMP_SHA256
        and fp_primary_coverage == FM51_EXPECTED_COVERAGE_COMP_SHA256
        and fp_cross == FM51_EXPECTED_WALL_META_SHA256
        and fp_doc.get("seal_chain_extended") is False
    )
    checks["fm51_fingerprint_zero_drift"] = fp_ok
    rows.append(
        _row(
            check_id="fm51_fingerprint_zero_drift",
            layer="fm51_continuity",
            path=paths.fm51_fingerprint_rel,
            expected="stable_metrics+fm51_fps",
            observed=f"unique={fp_doc.get('harvest_unique_union')}",
            ok=fp_ok,
            notes="ok" if fp_ok else "fm51_fingerprint_drift",
        )
    )
    ...
    checks["fm51_gate_zero_drift"] = gate_ok
    rows.append(
        _row(
            check_id="fm51_gate_zero_drift",
            layer="fm51_continuity",
            path=paths.fm49_gate_json_rel,
            expected="PASS_OFFLINE+KEEP_EXECUTE_FALSE",
            observed=f"gate={gate_doc.get('gate')}",
            ok=gate_ok,
            notes="ok" if gate_ok else "fm51_gate_drift",
        )
    )

    rf_ok = (
        rf_led.get("fingerprint_sha256") == FM51_FROZEN_RESIDUAL_FORMULA_FP
        and rf_led.get("composition_sha256") == FM51_EXPECTED_RESIDUAL_FORMULA_COMP_SHA256
    )
    checks["fm51_residual_formula_ledger_zero_drift"] = rf_ok
    rows.append(
        _row(
            check_id="fm51_residual_formula_ledger_zero_drift",
            layer="fm51_continuity",
            path=paths.fm49_union_status_rel,
            expected=FM51_FROZEN_RESIDUAL_FORMULA_FP,
            observed=str(rf_led.get("fingerprint_sha256")),
            ok=rf_ok,
            notes="ok" if rf_ok else "fm51_residual_formula_ledger_drift",
        )
    )

    rt_ok = (
        rt_led.get("fingerprint_sha256") == FM51_FROZEN_RESUME_FORMULA_FP
        and rt_led.get("composition_sha256") == FM51_EXPECTED_RESUME_FORMULA_COMP_SHA256
    )
    checks["fm51_resume_formula_ledger_zero_drift"] = rt_ok
    rows.append(
        _row(
            check_id="fm51_resume_formula_ledger_zero_drift",
            layer="fm51_continuity",
            path=paths.fm49_residual_coverage_rel,
            expected=FM51_FROZEN_RESUME_FORMULA_FP,
            observed=str(rt_led.get("fingerprint_sha256")),
            ok=rt_ok,
            notes="ok" if rt_ok else "fm51_resume_formula_ledger_drift",
        )
    )

    cov_ok = (
        cov_led.get("fingerprint_sha256") == FM51_FROZEN_COVERAGE_FP
        and cov_led.get("composition_sha256") == FM51_EXPECTED_COVERAGE_COMP_SHA256
    )
    checks["fm51_coverage_ledger_zero_drift"] = cov_ok
    rows.append(
        _row(
            check_id="fm51_coverage_ledger_zero_drift",
            layer="fm51_continuity",
            path=paths.fm49_resume_taxonomy_disposition_rel,
            expected=FM51_FROZEN_COVERAGE_FP,
            observed=str(cov_led.get("fingerprint_sha256")),
            ok=cov_ok,
            notes="ok" if cov_ok else "fm51_coverage_ledger_drift",
        )
    )

    wall_ok = (
        wall_led.get("fingerprint_sha256") == FM51_FROZEN_WALL_META_FP
        and wall_led.get("bundle_sha256") == FM51_EXPECTED_WALL_META_SHA256
    )
    checks["fm51_wall_meta_ledger_zero_drift"] = wall_ok
    rows.append(
        _row(
            check_id="fm51_wall_meta_ledger_zero_drift",
            layer="fm51_continuity",
            path=paths.fm49_wall_meta_rel,
            expected=FM51_FROZEN_WALL_META_FP,
            observed=str(wall_led.get("fingerprint_sha256")),
            ok=wall_ok,
            notes="ok" if wall_ok else "fm51_wall_meta_ledger_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["fm51_continuity_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="fm51_continuity_all_pass",
            layer="fm51_continuity",
            expected="packet+fp+gate+3ledgers",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "fm51_continuity_incomplete",
        )
    )
    return rows, checks
...
def build_output_root_protection_rows(
    ...
    *,
    ...
    """output-root 保护：resume/harvest 写拒绝 + MOCK54 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    ...
    out_detail = ""
    try:
        assert_fm52_output_root(paths.output_root_rel, base_dir=base_dir)
        out_ok = True
        out_detail = "allowed"
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            expected="MOCK54_or_ephemeral_allowed",
            observed=out_detail,
            ok=out_ok,
...
def build_frozen_mock_isolation_rows(
    paths: FullMarketUniqueSurfaceAdditiveOverlapDeltaSurfaceDeltaWallMetaBundlePaths, *, base_dir: str = BASE_DIR
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """冻结 mock cohort 写隔离：MOCK3–53 拒绝 · MOCK54 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    load_frozen_mock_cohort_roots.cache_clear()
    ...
    try:
        assert_fm52_output_root(mock51_rel, base_dir=base_dir)
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            layer="frozen_mock_isolation",
            expected="MOCK3-53_block+MOCK54_allow",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
    ...
    *,
    ...
    rows.append(
        _row(
            ...
            layer="protected_csv_registry",
            expected="MOCK3–53+MOCK51+resume+auth+registered",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
def ensure_protected_roots_csv_fm52(
    *,
    csv_rel: str = PROTECTED_ROOTS_CSV_REL,
    base_dir: str = BASE_DIR,
) -> None:
    """注册 C-ROOT-MOCK54；加固 C-ROOT-002 unique/surface/additive/tier/dryrun 说明。"""
    ...
    _upsert(
        RESUME_HARVEST_ROOT_ID,
        {
            ...
            "notes": (
                ...
                "C-FM-24..51 scale/safety freezes + C-FM-52 full-market unique_surface_additive/overlap_delta/surface_delta-wall-meta-bundle; "
    ...
    _upsert(
        THIS_TASK_ROOT_ID,
        {
            ...
            "notes": (
                "C-FM-52 scale unique_surface_additive composition identity lock "
                "(2249/2251/2261) + overlap_delta composition identity lock "
                "(overlap_delta=12) + surface_delta composition identity lock "
                "(surface_delta=2) + cross_full_market_unique_surface_additive_"
                "overlap_delta_surface_delta_wall_meta_bundle identity lock + "
                "FM51 continuity; never production EXECUTE; "
                "must not overwrite MOCK3-53; seal_chain_extended=false"
            ),
        },
    )
...
def run_scale_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_safety(
    *,
    paths: FullMarketUniqueSurfaceAdditiveOverlapDeltaSurfaceDeltaWallMetaBundlePaths | None = None,
    base_dir: str = BASE_DIR,
) -> Dict[str, Any]:
    """执行 C-FM-52 规模 unique_surface_additive/overlap_delta/surface_delta-wall-meta-bundle 离线 QA。"""
    paths = paths or FullMarketUniqueSurfaceAdditiveOverlapDeltaSurfaceDeltaWallMetaBundlePaths()
    generated_at = _utc_now_iso()
    ensure_protected_roots_csv_fm52(
        csv_rel=paths.protected_roots_csv_rel, base_dir=base_dir
    )
    out_root = assert_fm52_output_root(paths.output_root_rel, base_dir=base_dir)

    matrix: List[Dict[str, str]] = []
    cont_rows, cont_checks = build_fm51_continuity_rows(paths, base_dir=base_dir)
    ...
    gates = {
        ...
        "fm51": load_json(_abs(FM51_GATE_JSON_REL, base_dir=base_dir)),
    }
    ...
    layer_gates = {
        "fm51_continuity": (
            "PASS_OFFLINE"
            if cont_checks.get("fm51_continuity_all_pass")
            else "FAIL_OFFLINE"
        ),
        ...
        "overlap_delta_composition_identity_lock": (
            "PASS_OFFLINE"
            if rt_checks.get("overlap_delta_composition_identity_lock_all_pass")
            else "FAIL_OFFLINE"
        ),
        "surface_delta_composition_identity_lock": (
            "PASS_OFFLINE"
            if rb_checks.get(
                "surface_delta_composition_identity_lock_all_pass"
            )
            else "FAIL_OFFLINE"
        ),
    ...
    rf_rel = _write_ledger(
        "unique_surface_additive_composition_identity_lock_ledger.json",
        {
            ...
            "unique_surface_additive_formula": rf_meta["unique_surface_additive_formula"],
    ...
    rt_rel = _write_ledger(
        "overlap_delta_composition_identity_lock_ledger.json",
        {
            ...
            "overlap_delta_formula": rt_meta["overlap_delta_formula"],
    ...
    rb_rel = _write_ledger(
        "surface_delta_composition_identity_lock_ledger.json",
        {
            ...
            "surface_delta_formula": rb_meta["surface_delta_formula"],
    ...
    packet_rel = _write_ledger(
        "scale_packet.json",
        {
            ...
            "notes": (
                ...
                "overlap_delta composition identity lock (overlap_delta=12) + "
                "surface_delta composition identity lock (surface_delta=2) + "
                "cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle identity lock + "
                "FM51 continuity + MOCK54; EXECUTE remains human-held; "
                "does not overwrite MOCK3-53"
            ),
        },
    )
    ...
    with open(_abs(readme_rel, base_dir=base_dir), "w", encoding="utf-8") as fh:
        fh.write(
            "\n".join(
                [
                    "# C-FM-52 mock scale lineage/drift/protected/repro-wall-meta-bundle safety root",
                    "",
                    f"task_id: {TASK_ID}",
                    f"gate: {overall}",
                    "cninfo_calls: 0",
                    ...
                    "",
                    "Isolation: MOCK3-53 frozen; this root is C-ROOT-MOCK54.",
    ...
    return {
        ...
        "cross_full_market_unique_surface_additive_overlap_delta_surface_delta_wall_meta_bundle_path": bundle_rel,
