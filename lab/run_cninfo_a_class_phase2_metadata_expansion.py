...
def parse_erad_a_slice2_case_range(case_range: str) -> Tuple[str, str]:
    ...
    # 不允许跨模式混用 … / 1101–1150 / 1151–1200 / 1201–1250
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if getattr(args, "erad_a_scale_500_slice2", False):
        ...
        if la_mode_count > 1:
            print(
                "ERROR: erad_a_listing_aware_s2_s3_s4_s5_s6_s7_s8_s9_s10_s11_s12_s13_s14_mutually_exclusive",
                file=sys.stderr,
            )
            return 2
        ...
        if args.mode == "dry_run":
            ...
            print(
                ...
                f"{' listing_aware_s14=yes' if listing_aware_s14 else ''}"
            )
