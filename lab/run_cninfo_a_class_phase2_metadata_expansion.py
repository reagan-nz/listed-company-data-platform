...
# A-FM-20：listing-aware S20（AD2E1501–1550 · 独立根 · 不得写入封闭 S1 / S2–S19 live 根）
DEFAULT_ERAD_LISTING_AWARE_S20_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_erad_next_scale_listing_aware_s20_plus50_universe_20260716.csv",
)
DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_erad_next_scale_listing_aware_s20",
)
REQUIRED_ERAD_LISTING_AWARE_S20_UNIVERSE_SIZE = 50
ERAD_LISTING_AWARE_S20_REQUEST_CAP = 120
ERAD_LISTING_AWARE_S20_COHORT = ERAD_LISTING_AWARE_S2_COHORT  # 同族 cohort 标签
ALLOWED_ERAD_LISTING_AWARE_S20_CASE_IDS: Set[str] = {
    f"AD2E{i:03d}" for i in range(1501, 1551)
}
ERAD_LISTING_AWARE_S20_INCLUDE_REASON = (
    "next_scale_listing_aware_s20;a_cumulative_disjoint;listing_period_gate;"
    "st_exclude;non_bse;prefix_concentration_cap;b_overlap_allowed_cross_track;"
    "metadata_only_no_pdf;excludes_listing_aware_s2_s3_s4_s5_s6_s7_s8_s9_s10_s11_s12_s13_s14_s15_s16_s17_s18_s19"
)
ERAD_LISTING_AWARE_S20_CLOSED_ROOT_WRITE_FORBIDDEN = (
    "listing_aware_s20_must_not_write_closed_slice2_s1_or_s2_or_s3_or_s4_or_s5_or_s6_or_s7_or_s8_or_s9_or_s10_or_s11_or_s12_or_s13_or_s14_or_s15_or_s16_or_s17_or_s18_or_s19_live_root"
)
ERAD_LISTING_AWARE_S20_UNIVERSE_CSV_REQUIRED = (
    "erad_a_listing_aware_s20_universe_csv_required"
)
ERAD_LISTING_AWARE_S20_UNIVERSE_SIZE_VIOLATION = (
    "erad_a_listing_aware_s20_universe_size_must_equal_50"
)
ERAD_LISTING_AWARE_S20_CASE_SET_VIOLATION = (
    "erad_a_listing_aware_s20_case_ids_must_be_AD2E1501_1550"
)
ERAD_LISTING_AWARE_S20_COHORT_INVALID = (
    "erad_a_listing_aware_s20_cohort_must_be_next_scale_listing_aware"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_S2_S1 = "erad_a_listing_aware_s20_overlap_a_slice2_s1"
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S2 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s2"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S3 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s3"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S4 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s4"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S5 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s5"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S6 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s6"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S7 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s7"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S8 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s8"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S9 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s9"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S10 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s10"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S11 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s11"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S12 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s12"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S13 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s13"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S14 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s14"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S15 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s15"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S16 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s16"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S17 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s17"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S18 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s18"
)
ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S19 = (
    "erad_a_listing_aware_s20_overlap_a_listing_aware_s19"
)
# S20 listing_period lint / gate 使用 A 轨 coverage overlay（非 C harvest 默认分母）
DEFAULT_ERAD_LISTING_AWARE_S20_PROFILE_DIR = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_basic_profile_coverage_overlay_fm06",
...
# A-FM-01：listing-aware S21（AD2E1551–1600 · 独立根 · 不得写入封闭 S1 / S2–S20 live 根）
DEFAULT_ERAD_LISTING_AWARE_S21_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_erad_next_scale_listing_aware_s21_plus50_universe_20260716.csv",
)
DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_erad_next_scale_listing_aware_s21",
)
REQUIRED_ERAD_LISTING_AWARE_S21_UNIVERSE_SIZE = 50
ERAD_LISTING_AWARE_S21_REQUEST_CAP = 120
ERAD_LISTING_AWARE_S21_COHORT = ERAD_LISTING_AWARE_S2_COHORT  # 同族 cohort 标签
ALLOWED_ERAD_LISTING_AWARE_S21_CASE_IDS: Set[str] = {
    f"AD2E{i:03d}" for i in range(1551, 1601)
}
ERAD_LISTING_AWARE_S21_INCLUDE_REASON = (
    "next_scale_listing_aware_s21;a_cumulative_disjoint;listing_period_gate;"
    "st_exclude;non_bse;prefix_concentration_cap;b_overlap_allowed_cross_track;"
    "metadata_only_no_pdf;excludes_listing_aware_s2_s3_s4_s5_s6_s7_s8_s9_s10_s11_s12_s13_s14_s15_s16_s17_s18_s19_s20"
)
ERAD_LISTING_AWARE_S21_CLOSED_ROOT_WRITE_FORBIDDEN = (
    "listing_aware_s21_must_not_write_closed_slice2_s1_or_s2_or_s3_or_s4_or_s5_or_s6_or_s7_or_s8_or_s9_or_s10_or_s11_or_s12_or_s13_or_s14_or_s15_or_s16_or_s17_or_s18_or_s19_or_s20_live_root"
)
ERAD_LISTING_AWARE_S21_UNIVERSE_CSV_REQUIRED = (
    "erad_a_listing_aware_s21_universe_csv_required"
)
ERAD_LISTING_AWARE_S21_UNIVERSE_SIZE_VIOLATION = (
    "erad_a_listing_aware_s21_universe_size_must_equal_50"
)
ERAD_LISTING_AWARE_S21_CASE_SET_VIOLATION = (
    "erad_a_listing_aware_s21_case_ids_must_be_AD2E1551_1600"
)
ERAD_LISTING_AWARE_S21_COHORT_INVALID = (
    "erad_a_listing_aware_s21_cohort_must_be_next_scale_listing_aware"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_S2_S1 = "erad_a_listing_aware_s21_overlap_a_slice2_s1"
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S2 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s2"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S3 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s3"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S4 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s4"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S5 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s5"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S6 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s6"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S7 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s7"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S8 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s8"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S9 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s9"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S10 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s10"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S11 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s11"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S12 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s12"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S13 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s13"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S14 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s14"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S15 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s15"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S16 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s16"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S17 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s17"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S18 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s18"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S19 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s19"
)
ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S20 = (
    "erad_a_listing_aware_s21_overlap_a_listing_aware_s20"
)
# S21 listing_period lint / gate 使用 A 轨 coverage overlay（非 C harvest 默认分母）
DEFAULT_ERAD_LISTING_AWARE_S21_PROFILE_DIR = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_basic_profile_coverage_overlay_fm06",
...
# A-FM-02：listing-aware S22（AD2E1601–1650 · 独立根 · 不得写入封闭 S1 / S2–S21 live 根）
DEFAULT_ERAD_LISTING_AWARE_S22_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_erad_next_scale_listing_aware_s22_plus50_universe_20260716.csv",
)
DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_erad_next_scale_listing_aware_s22",
)
REQUIRED_ERAD_LISTING_AWARE_S22_UNIVERSE_SIZE = 50
ERAD_LISTING_AWARE_S22_REQUEST_CAP = 120
ERAD_LISTING_AWARE_S22_COHORT = ERAD_LISTING_AWARE_S2_COHORT  # 同族 cohort 标签
ALLOWED_ERAD_LISTING_AWARE_S22_CASE_IDS: Set[str] = {
    f"AD2E{i:03d}" for i in range(1601, 1651)
}
ERAD_LISTING_AWARE_S22_INCLUDE_REASON = (
    "next_scale_listing_aware_s22;a_cumulative_disjoint;listing_period_gate;"
    "st_exclude;non_bse;prefix_concentration_cap;b_overlap_allowed_cross_track;"
    "metadata_only_no_pdf;excludes_listing_aware_s2_s3_s4_s5_s6_s7_s8_s9_s10_s11_s12_s13_s14_s15_s16_s17_s18_s19_s20_s21"
)
ERAD_LISTING_AWARE_S22_CLOSED_ROOT_WRITE_FORBIDDEN = (
    "listing_aware_s22_must_not_write_closed_slice2_s1_or_s2_or_s3_or_s4_or_s5_or_s6_or_s7_or_s8_or_s9_or_s10_or_s11_or_s12_or_s13_or_s14_or_s15_or_s16_or_s17_or_s18_or_s19_or_s20_or_s21_live_root"
)
ERAD_LISTING_AWARE_S22_UNIVERSE_CSV_REQUIRED = (
    "erad_a_listing_aware_s22_universe_csv_required"
)
ERAD_LISTING_AWARE_S22_UNIVERSE_SIZE_VIOLATION = (
    "erad_a_listing_aware_s22_universe_size_must_equal_50"
)
ERAD_LISTING_AWARE_S22_CASE_SET_VIOLATION = (
    "erad_a_listing_aware_s22_case_ids_must_be_AD2E1601_1650"
)
ERAD_LISTING_AWARE_S22_COHORT_INVALID = (
    "erad_a_listing_aware_s22_cohort_must_be_next_scale_listing_aware"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_S2_S1 = "erad_a_listing_aware_s22_overlap_a_slice2_s1"
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S2 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s2"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S3 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s3"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S4 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s4"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S5 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s5"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S6 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s6"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S7 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s7"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S8 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s8"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S9 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s9"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S10 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s10"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S11 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s11"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S12 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s12"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S13 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s13"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S14 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s14"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S15 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s15"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S16 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s16"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S17 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s17"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S18 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s18"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S19 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s19"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S20 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s20"
)
ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S21 = (
    "erad_a_listing_aware_s22_overlap_a_listing_aware_s21"
)
# note: S22 universe itself is not an overlap target for S22 mode
# S22 listing_period lint / gate 使用 A 轨 coverage overlay（非 C harvest 默认分母）
DEFAULT_ERAD_LISTING_AWARE_S22_PROFILE_DIR = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_basic_profile_coverage_overlay_fm06",
...
# A-FM-03：listing-aware S23（AD2E1651–1850 · ~200 · 独立根 · 不得写入封闭 S1 / S2–S22 live 根）
DEFAULT_ERAD_LISTING_AWARE_S23_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_erad_next_scale_listing_aware_s23_plus200_universe_20260716.csv",
)
DEFAULT_ERAD_LISTING_AWARE_S23_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_erad_next_scale_listing_aware_s23",
)
REQUIRED_ERAD_LISTING_AWARE_S23_UNIVERSE_SIZE = 200
ERAD_LISTING_AWARE_S23_REQUEST_CAP = 480
ERAD_LISTING_AWARE_S23_COHORT = ERAD_LISTING_AWARE_S2_COHORT
ALLOWED_ERAD_LISTING_AWARE_S23_CASE_IDS: Set[str] = {
    f"AD2E{i:03d}" for i in range(1651, 1851)
}
ERAD_LISTING_AWARE_S23_INCLUDE_REASON = (
    "next_scale_listing_aware_s23;a_cumulative_disjoint;listing_period_gate;"
    "st_exclude;non_bse;prefix_concentration_cap;b_overlap_allowed_cross_track;"
    "metadata_only_no_pdf;excludes_listing_aware_s2_through_s22;r19_excellence_ladder_200"
)
ERAD_LISTING_AWARE_S23_CLOSED_ROOT_WRITE_FORBIDDEN = (
    "listing_aware_s23_must_not_write_closed_slice2_s1_or_s2_through_s22_live_root"
)
ERAD_LISTING_AWARE_S23_UNIVERSE_CSV_REQUIRED = (
    "erad_a_listing_aware_s23_universe_csv_required"
)
ERAD_LISTING_AWARE_S23_UNIVERSE_SIZE_VIOLATION = (
    "erad_a_listing_aware_s23_universe_size_must_equal_200"
)
ERAD_LISTING_AWARE_S23_CASE_SET_VIOLATION = (
    "erad_a_listing_aware_s23_case_ids_must_be_AD2E1651_1850"
)
ERAD_LISTING_AWARE_S23_COHORT_INVALID = (
    "erad_a_listing_aware_s23_cohort_must_be_next_scale_listing_aware"
)
ERAD_LISTING_AWARE_S23_OVERLAP_A_S2_S1 = "erad_a_listing_aware_s23_overlap_a_slice2_s1"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S2 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s2"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S3 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s3"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S4 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s4"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S5 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s5"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S6 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s6"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S7 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s7"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S8 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s8"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S9 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s9"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S10 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s10"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S11 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s11"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S12 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s12"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S13 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s13"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S14 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s14"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S15 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s15"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S16 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s16"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S17 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s17"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S18 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s18"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S19 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s19"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S20 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s20"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S21 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s21"
ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S22 = "erad_a_listing_aware_s23_overlap_a_listing_aware_s22"
DEFAULT_ERAD_LISTING_AWARE_S23_PROFILE_DIR = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_a_class_basic_profile_coverage_overlay_fm06",
    ...
    with open(path, newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            ...
            include_reason = (
                ...
                if cohort == ERAD_LISTING_AWARE_S22_COHORT
                and case_id in ALLOWED_ERAD_LISTING_AWARE_S22_CASE_IDS
                else ERAD_LISTING_AWARE_S21_INCLUDE_REASON
                if cohort == ERAD_LISTING_AWARE_S21_COHORT
                and case_id in ALLOWED_ERAD_LISTING_AWARE_S21_CASE_IDS
                else ERAD_LISTING_AWARE_S20_INCLUDE_REASON
                if cohort == ERAD_LISTING_AWARE_S20_COHORT
                and case_id in ALLOWED_ERAD_LISTING_AWARE_S20_CASE_IDS
                else ERAD_LISTING_AWARE_S19_INCLUDE_REASON
...
def validate_erad_listing_aware_s23_case(case: EraDNextScaleSlice2UniverseCase) -> List[str]:
    ...
    issues: List[str] = []
    if case.case_id not in ALLOWED_ERAD_LISTING_AWARE_S23_CASE_IDS:
        issues.append(f"{ERAD_SLICE2_CASE_ID_NOT_ALLOWED}:{case.case_id}")
    case_num = (
        _erad_a_slice2_case_number(case.case_id)
        if ERAD_SCALE_200_CASE_ID_PATTERN.match(case.case_id)
    ...
    if case_num and case_num <= 1650:
        issues.append(f"{ERAD_SLICE2_PRIOR_CASE_FORBIDDEN}:{case.case_id}")
    if case.erad_include != "yes":
        issues.append(ERAD_SLICE2_INCLUDE_REQUIRED)
    if case.cohort != ERAD_LISTING_AWARE_S23_COHORT:
        issues.append(ERAD_LISTING_AWARE_S23_COHORT_INVALID)
    if case.prior_in_scale_200 != "no":
        issues.append(ERAD_SLICE2_PRIOR_SCALE_200_INVALID)
    if not case.company_code:
        issues.append("company_code_missing")
...
def validate_erad_listing_aware_s22_case(case: EraDNextScaleSlice2UniverseCase) -> List[str]:
    """listing-aware S22 单案校验（AD2E1601–1650 · cohort=next_scale_listing_aware）。"""
    issues: List[str] = []
    if case.case_id not in ALLOWED_ERAD_LISTING_AWARE_S22_CASE_IDS:
        issues.append(f"{ERAD_SLICE2_CASE_ID_NOT_ALLOWED}:{case.case_id}")
    case_num = (
        _erad_a_slice2_case_number(case.case_id)
        if ERAD_SCALE_200_CASE_ID_PATTERN.match(case.case_id)
    ...
    if case_num and case_num <= 1600:
        issues.append(f"{ERAD_SLICE2_PRIOR_CASE_FORBIDDEN}:{case.case_id}")
    if case.erad_include != "yes":
        issues.append(ERAD_SLICE2_INCLUDE_REQUIRED)
    if case.cohort != ERAD_LISTING_AWARE_S22_COHORT:
        issues.append(ERAD_LISTING_AWARE_S22_COHORT_INVALID)
    if case.prior_in_scale_200 != "no":
        issues.append(ERAD_SLICE2_PRIOR_SCALE_200_INVALID)
    if not case.company_code:
        issues.append("company_code_missing")
...
def validate_erad_listing_aware_s21_case(case: EraDNextScaleSlice2UniverseCase) -> List[str]:
    """listing-aware S21 单案校验（AD2E1551–1600 · cohort=next_scale_listing_aware）。"""
    issues: List[str] = []
    if case.case_id not in ALLOWED_ERAD_LISTING_AWARE_S21_CASE_IDS:
        issues.append(f"{ERAD_SLICE2_CASE_ID_NOT_ALLOWED}:{case.case_id}")
    case_num = (
        _erad_a_slice2_case_number(case.case_id)
        if ERAD_SCALE_200_CASE_ID_PATTERN.match(case.case_id)
    ...
    if case_num and case_num <= 1550:
        issues.append(f"{ERAD_SLICE2_PRIOR_CASE_FORBIDDEN}:{case.case_id}")
    if case.erad_include != "yes":
        issues.append(ERAD_SLICE2_INCLUDE_REQUIRED)
    if case.cohort != ERAD_LISTING_AWARE_S21_COHORT:
        issues.append(ERAD_LISTING_AWARE_S21_COHORT_INVALID)
    if case.prior_in_scale_200 != "no":
        issues.append(ERAD_SLICE2_PRIOR_SCALE_200_INVALID)
    if not case.company_code:
        issues.append("company_code_missing")
...
def validate_erad_listing_aware_s20_case(case: EraDNextScaleSlice2UniverseCase) -> List[str]:
    """listing-aware S20 单案校验（AD2E1501–1550 · cohort=next_scale_listing_aware）。"""
    issues: List[str] = []
    if case.case_id not in ALLOWED_ERAD_LISTING_AWARE_S20_CASE_IDS:
        issues.append(f"{ERAD_SLICE2_CASE_ID_NOT_ALLOWED}:{case.case_id}")
    case_num = (
        _erad_a_slice2_case_number(case.case_id)
        if ERAD_SCALE_200_CASE_ID_PATTERN.match(case.case_id)
    ...
    if case_num and case_num <= 1500:
        issues.append(f"{ERAD_SLICE2_PRIOR_CASE_FORBIDDEN}:{case.case_id}")
    if case.erad_include != "yes":
        issues.append(ERAD_SLICE2_INCLUDE_REQUIRED)
    if case.cohort != ERAD_LISTING_AWARE_S20_COHORT:
        issues.append(ERAD_LISTING_AWARE_S20_COHORT_INVALID)
    if case.prior_in_scale_200 != "no":
        issues.append(ERAD_SLICE2_PRIOR_SCALE_200_INVALID)
    if not case.company_code:
        issues.append("company_code_missing")
...
def validate_erad_next_scale_slice2_case(case: EraDNextScaleSlice2UniverseCase) -> List[str]:
    if case.cohort == ERAD_LISTING_AWARE_S2_COHORT:
        ...
        if case.case_id in ALLOWED_ERAD_LISTING_AWARE_S22_CASE_IDS:
            return validate_erad_listing_aware_s22_case(case)
        if case.case_id in ALLOWED_ERAD_LISTING_AWARE_S21_CASE_IDS:
            return validate_erad_listing_aware_s21_case(case)
        if case.case_id in ALLOWED_ERAD_LISTING_AWARE_S20_CASE_IDS:
            return validate_erad_listing_aware_s20_case(case)
...
def validate_erad_listing_aware_s23_universe_size(
    ...
    included = [c for c in cases if c.erad_include == "yes"]
    if len(included) != REQUIRED_ERAD_LISTING_AWARE_S23_UNIVERSE_SIZE:
        return (
            False,
            f"{ERAD_LISTING_AWARE_S23_UNIVERSE_SIZE_VIOLATION}: got {len(included)} "
            f"expected {REQUIRED_ERAD_LISTING_AWARE_S23_UNIVERSE_SIZE}",
        )
    case_ids = {c.case_id for c in included}
    if case_ids != ALLOWED_ERAD_LISTING_AWARE_S23_CASE_IDS:
        return False, f"{ERAD_LISTING_AWARE_S23_CASE_SET_VIOLATION}: got={sorted(case_ids)[:5]}..."
    return True, ""


def validate_erad_listing_aware_s22_universe_size(
    cases: List[EraDNextScaleSlice2UniverseCase],
) -> Tuple[bool, str]:
    included = [c for c in cases if c.erad_include == "yes"]
    if len(included) != REQUIRED_ERAD_LISTING_AWARE_S22_UNIVERSE_SIZE:
        return (
            False,
            f"{ERAD_LISTING_AWARE_S22_UNIVERSE_SIZE_VIOLATION}: got {len(included)} "
            f"expected {REQUIRED_ERAD_LISTING_AWARE_S22_UNIVERSE_SIZE}",
        )
    case_ids = {c.case_id for c in included}
    if case_ids != ALLOWED_ERAD_LISTING_AWARE_S22_CASE_IDS:
        return False, f"{ERAD_LISTING_AWARE_S22_CASE_SET_VIOLATION}: got={sorted(case_ids)[:5]}..."
    return True, ""

def validate_erad_listing_aware_s21_universe_size(
    cases: List[EraDNextScaleSlice2UniverseCase],
) -> Tuple[bool, str]:
    included = [c for c in cases if c.erad_include == "yes"]
    if len(included) != REQUIRED_ERAD_LISTING_AWARE_S21_UNIVERSE_SIZE:
        return (
            False,
            f"{ERAD_LISTING_AWARE_S21_UNIVERSE_SIZE_VIOLATION}: got {len(included)} "
            f"expected {REQUIRED_ERAD_LISTING_AWARE_S21_UNIVERSE_SIZE}",
        )
    case_ids = {c.case_id for c in included}
    if case_ids != ALLOWED_ERAD_LISTING_AWARE_S21_CASE_IDS:
        return False, f"{ERAD_LISTING_AWARE_S21_CASE_SET_VIOLATION}: got={sorted(case_ids)[:5]}..."
    return True, ""


def validate_erad_listing_aware_s20_universe_size(
    cases: List[EraDNextScaleSlice2UniverseCase],
) -> Tuple[bool, str]:
    included = [c for c in cases if c.erad_include == "yes"]
    if len(included) != REQUIRED_ERAD_LISTING_AWARE_S20_UNIVERSE_SIZE:
        return (
            False,
            f"{ERAD_LISTING_AWARE_S20_UNIVERSE_SIZE_VIOLATION}: got {len(included)} "
            f"expected {REQUIRED_ERAD_LISTING_AWARE_S20_UNIVERSE_SIZE}",
        )
    case_ids = {c.case_id for c in included}
    if case_ids != ALLOWED_ERAD_LISTING_AWARE_S20_CASE_IDS:
        return False, f"{ERAD_LISTING_AWARE_S20_CASE_SET_VIOLATION}: got={sorted(case_ids)[:5]}..."
    return True, ""
...
def validate_erad_next_scale_slice2_universe_size(
    ...
    if included and included[0].cohort == ERAD_LISTING_AWARE_S2_COHORT:
        ...
        if included[0].case_id in ALLOWED_ERAD_LISTING_AWARE_S22_CASE_IDS:
            return validate_erad_listing_aware_s22_universe_size(cases)
        if included[0].case_id in ALLOWED_ERAD_LISTING_AWARE_S21_CASE_IDS:
            return validate_erad_listing_aware_s21_universe_size(cases)
        if included[0].case_id in ALLOWED_ERAD_LISTING_AWARE_S20_CASE_IDS:
            return validate_erad_listing_aware_s20_universe_size(cases)
...
def lint_erad_listing_aware_s23_overlap(
    ...
    """
    listing-aware S23 overlap lint：A cumulative（含 S1 + listing-aware S2–S22）+ ST + L-D6。
    ...
    checks = (
        ...
        (a_s200, ERAD_SLICE2_OVERLAP_A_S200),
        (a_s1, ERAD_SLICE2_OVERLAP_A_S1),
        (a_s2_s1, ERAD_LISTING_AWARE_S23_OVERLAP_A_S2_S1),
        (a_la_s2, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S2),
        (a_la_s3, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S3),
        (a_la_s4, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S4),
        (a_la_s5, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S5),
        (a_la_s6, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S6),
        (a_la_s7, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S7),
        (a_la_s8, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S8),
        (a_la_s9, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S9),
        (a_la_s10, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S10),
        (a_la_s11, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S11),
        (a_la_s12, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S12),
        (a_la_s13, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S13),
        (a_la_s14, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S14),
        (a_la_s15, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S15),
        (a_la_s16, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S16),
        (a_la_s17, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S17),
        (a_la_s18, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S18),
        (a_la_s19, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S19),
        (a_la_s20, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S20),
        (a_la_s21, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S21),
        (a_la_s22, ERAD_LISTING_AWARE_S23_OVERLAP_A_LISTING_AWARE_S22),
    )
    for ref_codes, err_code in checks:
        overlap = slice2_codes & ref_codes
        if overlap:
    ...
    listing_blocking, _listing_flags = lint_erad_next_scale_slice2_listing_period(
        cases,
        profile_dir=DEFAULT_ERAD_LISTING_AWARE_S23_PROFILE_DIR,
        grandfather_case_ids=set(),
    )
    issues.extend(listing_blocking)
    return issues

def lint_erad_listing_aware_s22_overlap(
    cases: List[EraDNextScaleSlice2UniverseCase],
) -> List[str]:
    """
    listing-aware S22 overlap lint：A cumulative（含 S1 + listing-aware S2–S21）+ ST + L-D6。
    ...
    checks = (
        ...
        (a_s200, ERAD_SLICE2_OVERLAP_A_S200),
        (a_s1, ERAD_SLICE2_OVERLAP_A_S1),
        (a_s2_s1, ERAD_LISTING_AWARE_S22_OVERLAP_A_S2_S1),
        (a_la_s2, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S2),
        (a_la_s3, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S3),
        (a_la_s4, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S4),
        (a_la_s5, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S5),
        (a_la_s6, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S6),
        (a_la_s7, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S7),
        (a_la_s8, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S8),
        (a_la_s9, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S9),
        (a_la_s10, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S10),
        (a_la_s11, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S11),
        (a_la_s12, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S12),
        (a_la_s13, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S13),
        (a_la_s14, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S14),
        (a_la_s15, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S15),
        (a_la_s16, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S16),
        (a_la_s17, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S17),
        (a_la_s18, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S18),
        (a_la_s19, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S19),
        (a_la_s20, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S20),
        (a_la_s21, ERAD_LISTING_AWARE_S22_OVERLAP_A_LISTING_AWARE_S21),
    )
    for ref_codes, err_code in checks:
        overlap = slice2_codes & ref_codes
        if overlap:
    ...
    listing_blocking, _listing_flags = lint_erad_next_scale_slice2_listing_period(
        cases,
        profile_dir=DEFAULT_ERAD_LISTING_AWARE_S22_PROFILE_DIR,
        grandfather_case_ids=set(),
    )
    issues.extend(listing_blocking)
    return issues

def lint_erad_listing_aware_s21_overlap(
    cases: List[EraDNextScaleSlice2UniverseCase],
) -> List[str]:
    """
    listing-aware S21 overlap lint：A cumulative（含 S1 + listing-aware S2–S20）+ ST + L-D6。
    ...
    checks = (
        ...
        (a_s200, ERAD_SLICE2_OVERLAP_A_S200),
        (a_s1, ERAD_SLICE2_OVERLAP_A_S1),
        (a_s2_s1, ERAD_LISTING_AWARE_S21_OVERLAP_A_S2_S1),
        (a_la_s2, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S2),
        (a_la_s3, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S3),
        (a_la_s4, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S4),
        (a_la_s5, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S5),
        (a_la_s6, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S6),
        (a_la_s7, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S7),
        (a_la_s8, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S8),
        (a_la_s9, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S9),
        (a_la_s10, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S10),
        (a_la_s11, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S11),
        (a_la_s12, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S12),
        (a_la_s13, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S13),
        (a_la_s14, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S14),
        (a_la_s15, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S15),
        (a_la_s16, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S16),
        (a_la_s17, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S17),
        (a_la_s18, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S18),
        (a_la_s19, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S19),
        (a_la_s20, ERAD_LISTING_AWARE_S21_OVERLAP_A_LISTING_AWARE_S20),
    )
    for ref_codes, err_code in checks:
        overlap = slice2_codes & ref_codes
        if overlap:
    ...
    listing_blocking, _listing_flags = lint_erad_next_scale_slice2_listing_period(
        cases,
        profile_dir=DEFAULT_ERAD_LISTING_AWARE_S21_PROFILE_DIR,
        grandfather_case_ids=set(),
    )
    issues.extend(listing_blocking)
    return issues
...
def lint_erad_listing_aware_s20_overlap(
    cases: List[EraDNextScaleSlice2UniverseCase],
) -> List[str]:
    """
    listing-aware S20 overlap lint：A cumulative（含 S1 + listing-aware S2–S19）+ ST + L-D6。
    ...
    a_all = (
        a_s200 | a_s1 | a_s2_s1 | a_la_s2 | a_la_s3 | a_la_s4 | a_la_s5 | a_la_s6
        | a_la_s7 | a_la_s8 | a_la_s9 | a_la_s10 | a_la_s11 | a_la_s12 | a_la_s13
        | a_la_s14 | a_la_s15 | a_la_s16 | a_la_s17 | a_la_s18 | a_la_s19
    )
    a_cum_eff = _load_company_codes_from_csv(
        ERAD_NEXT_SCALE_SLICE2_SCALE200_EFFECTIVE_LEDGER, "company_code"
    ) | _load_company_codes_from_csv(
    ...
    checks = (
        ...
        (a_s200, ERAD_SLICE2_OVERLAP_A_S200),
        (a_s1, ERAD_SLICE2_OVERLAP_A_S1),
        (a_s2_s1, ERAD_LISTING_AWARE_S20_OVERLAP_A_S2_S1),
        (a_la_s2, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S2),
        (a_la_s3, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S3),
        (a_la_s4, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S4),
        (a_la_s5, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S5),
        (a_la_s6, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S6),
        (a_la_s7, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S7),
        (a_la_s8, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S8),
        (a_la_s9, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S9),
        (a_la_s10, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S10),
        (a_la_s11, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S11),
        (a_la_s12, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S12),
        (a_la_s13, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S13),
        (a_la_s14, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S14),
        (a_la_s15, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S15),
        (a_la_s16, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S16),
        (a_la_s17, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S17),
        (a_la_s18, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S18),
        (a_la_s19, ERAD_LISTING_AWARE_S20_OVERLAP_A_LISTING_AWARE_S19),
    )
    for ref_codes, err_code in checks:
        overlap = slice2_codes & ref_codes
        if overlap:
    ...
    listing_blocking, _listing_flags = lint_erad_next_scale_slice2_listing_period(
        cases,
        profile_dir=DEFAULT_ERAD_LISTING_AWARE_S20_PROFILE_DIR,
        grandfather_case_ids=set(),
    )
    issues.extend(listing_blocking)
    return issues
...
def lint_erad_next_scale_slice2_overlap(
    ...
    if included and any(c.cohort == ERAD_LISTING_AWARE_S2_COHORT for c in included):
        ...
        if any(c.case_id in ALLOWED_ERAD_LISTING_AWARE_S22_CASE_IDS for c in included):
            return lint_erad_listing_aware_s22_overlap(cases)
        if any(c.case_id in ALLOWED_ERAD_LISTING_AWARE_S21_CASE_IDS for c in included):
            return lint_erad_listing_aware_s21_overlap(cases)
        if any(c.case_id in ALLOWED_ERAD_LISTING_AWARE_S20_CASE_IDS for c in included):
            return lint_erad_listing_aware_s20_overlap(cases)
...
def validate_erad_listing_aware_s3_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s3"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s3"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s3"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s4_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s4"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s4"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s4"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s5_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s5"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s5"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s5"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s6_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s6"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s6"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s6"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s7_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s7"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s7"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s7"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s8_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s8"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s8"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s8"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s9_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s9"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s9"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s9"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s10_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s10"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s10"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s10"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s11_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s11"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s11"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s11"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s12_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s12"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s12"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s12"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s13_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s13"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s13"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s13"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def validate_erad_listing_aware_s14_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    closed_s20 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if root == closed_s20 or root.startswith(closed_s20 + os.sep):
        return False, "listing_aware_s20_root_forbidden_for_listing_aware_s14"
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s14"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s14"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
...
def is_erad_listing_aware_s23_mode(
    ...
    """判定是否为 AD2E1651–1850 listing-aware S23 模式。"""
    la_universe = os.path.normpath(
        os.path.abspath(DEFAULT_ERAD_LISTING_AWARE_S23_UNIVERSE_CSV)
    )
    la_root = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S23_OUTPUT_ROOT)
    if universe_csv:
        actual_u = os.path.normpath(os.path.abspath(universe_csv))
        if actual_u == la_universe:
            return True
...
def validate_erad_listing_aware_s23_universe_csv_path(universe_csv: str) -> Tuple[bool, str]:
    expected = os.path.normpath(os.path.abspath(DEFAULT_ERAD_LISTING_AWARE_S23_UNIVERSE_CSV))
    actual = os.path.normpath(os.path.abspath(universe_csv))
    if actual != expected:
        return False, ERAD_LISTING_AWARE_S23_UNIVERSE_CSV_REQUIRED
    return True, ""


def validate_erad_listing_aware_s23_output_root(output_root: str) -> Tuple[bool, str]:
    """listing-aware S23 输出仅允许独立根；禁止写入封闭 S1 / S2–S21 live 根。"""
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S23_OUTPUT_ROOT)
    closed_s1 = _normalize_output_root(DEFAULT_ERAD_NEXT_SCALE_SLICE2_S1_OUTPUT_ROOT)
    closed_s2 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S2_OUTPUT_ROOT)
    closed_s3 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S3_OUTPUT_ROOT)
    closed_s4 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S4_OUTPUT_ROOT)
    ...
    for closed in (
        ...
        if root == closed or root.startswith(closed + os.sep):
            return False, ERAD_LISTING_AWARE_S23_CLOSED_ROOT_WRITE_FORBIDDEN
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
        ...
        (
            DEFAULT_ERAD_SLICE2_ORGID_FALLBACK_RETRY_OUTPUT_ROOT,
            "orgid_fallback_retry_root_forbidden_for_listing_aware_s23",
        ),
        (C_CLASS_HARVEST_ROOT, "c_class_harvest_output_root_forbidden"),
        (B_CLASS_VALIDATION_PREFIX, "b_class_validation_output_root_forbidden"),
        (C_CLASS_VALIDATION_PREFIX, "c_class_validation_output_root_forbidden"),
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, "output_root_must_be_under_cninfo_a_class_erad_next_scale_listing_aware_s23"
def is_erad_listing_aware_s22_mode(
    universe_csv: Optional[str] = None,
    output_root: Optional[str] = None,
) -> bool:
    """判定是否为 AD2E1601–1650 listing-aware S22 模式。"""
    la_universe = os.path.normpath(
        os.path.abspath(DEFAULT_ERAD_LISTING_AWARE_S22_UNIVERSE_CSV)
    )
    la_root = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if universe_csv:
        actual_u = os.path.normpath(os.path.abspath(universe_csv))
        if actual_u == la_universe:
            return True
...
def validate_erad_listing_aware_s22_universe_csv_path(universe_csv: str) -> Tuple[bool, str]:
    expected = os.path.normpath(os.path.abspath(DEFAULT_ERAD_LISTING_AWARE_S22_UNIVERSE_CSV))
    actual = os.path.normpath(os.path.abspath(universe_csv))
    if actual != expected:
        return False, ERAD_LISTING_AWARE_S22_UNIVERSE_CSV_REQUIRED
    return True, ""


def validate_erad_listing_aware_s22_output_root(output_root: str) -> Tuple[bool, str]:
    """listing-aware S22 输出仅允许独立根；禁止写入封闭 S1 / S2–S21 live 根。"""
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    closed_s1 = _normalize_output_root(DEFAULT_ERAD_NEXT_SCALE_SLICE2_S1_OUTPUT_ROOT)
    closed_s2 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S2_OUTPUT_ROOT)
    closed_s3 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S3_OUTPUT_ROOT)
    closed_s4 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S4_OUTPUT_ROOT)
    ...
    for closed in (
        ...
        if root == closed or root.startswith(closed + os.sep):
            return False, ERAD_LISTING_AWARE_S22_CLOSED_ROOT_WRITE_FORBIDDEN
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
        ...
        (
            DEFAULT_ERAD_SLICE2_ORGID_FALLBACK_RETRY_OUTPUT_ROOT,
            "orgid_fallback_retry_root_forbidden_for_listing_aware_s22",
        ),
        (C_CLASS_HARVEST_ROOT, "c_class_harvest_output_root_forbidden"),
        (B_CLASS_VALIDATION_PREFIX, "b_class_validation_output_root_forbidden"),
        (C_CLASS_VALIDATION_PREFIX, "c_class_validation_output_root_forbidden"),
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, "output_root_must_be_under_cninfo_a_class_erad_next_scale_listing_aware_s22"

def is_erad_listing_aware_s21_mode(
    universe_csv: Optional[str] = None,
    output_root: Optional[str] = None,
) -> bool:
    """判定是否为 AD2E1551–1600 listing-aware S21 模式。"""
    la_universe = os.path.normpath(
        os.path.abspath(DEFAULT_ERAD_LISTING_AWARE_S21_UNIVERSE_CSV)
    )
    la_root = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if universe_csv:
        actual_u = os.path.normpath(os.path.abspath(universe_csv))
        if actual_u == la_universe:
            return True
...
def validate_erad_listing_aware_s21_universe_csv_path(universe_csv: str) -> Tuple[bool, str]:
    expected = os.path.normpath(os.path.abspath(DEFAULT_ERAD_LISTING_AWARE_S21_UNIVERSE_CSV))
    actual = os.path.normpath(os.path.abspath(universe_csv))
    if actual != expected:
        return False, ERAD_LISTING_AWARE_S21_UNIVERSE_CSV_REQUIRED
    return True, ""


def validate_erad_listing_aware_s21_output_root(output_root: str) -> Tuple[bool, str]:
    """listing-aware S21 输出仅允许独立根；禁止写入封闭 S1 / S2–S20 live 根。"""
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    closed_s1 = _normalize_output_root(DEFAULT_ERAD_NEXT_SCALE_SLICE2_S1_OUTPUT_ROOT)
    closed_s2 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S2_OUTPUT_ROOT)
    closed_s3 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S3_OUTPUT_ROOT)
    closed_s4 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S4_OUTPUT_ROOT)
    ...
    for closed in (
        closed_s1, closed_s2, closed_s3, closed_s4, closed_s5, closed_s6, closed_s7,
        closed_s8, closed_s9, closed_s10, closed_s11, closed_s12, closed_s13, closed_s14,
        closed_s15, closed_s16, closed_s17, closed_s18, closed_s19, closed_s20,
    ):
        if root == closed or root.startswith(closed + os.sep):
            return False, ERAD_LISTING_AWARE_S21_CLOSED_ROOT_WRITE_FORBIDDEN
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s21"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
        ...
        (
            DEFAULT_ERAD_SLICE2_ORGID_FALLBACK_RETRY_OUTPUT_ROOT,
            "orgid_fallback_retry_root_forbidden_for_listing_aware_s21",
        ),
        (C_CLASS_HARVEST_ROOT, "c_class_harvest_output_root_forbidden"),
        (B_CLASS_VALIDATION_PREFIX, "b_class_validation_output_root_forbidden"),
        (C_CLASS_VALIDATION_PREFIX, "c_class_validation_output_root_forbidden"),
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, "output_root_must_be_under_cninfo_a_class_erad_next_scale_listing_aware_s21"

def is_erad_listing_aware_s20_mode(
    universe_csv: Optional[str] = None,
    output_root: Optional[str] = None,
) -> bool:
    """判定是否为 AD2E1501–1550 listing-aware S20 模式。"""
    la_universe = os.path.normpath(
        os.path.abspath(DEFAULT_ERAD_LISTING_AWARE_S20_UNIVERSE_CSV)
    )
    la_root = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    if universe_csv:
        actual_u = os.path.normpath(os.path.abspath(universe_csv))
        if actual_u == la_universe:
            return True
...
def validate_erad_listing_aware_s20_universe_csv_path(universe_csv: str) -> Tuple[bool, str]:
    expected = os.path.normpath(os.path.abspath(DEFAULT_ERAD_LISTING_AWARE_S20_UNIVERSE_CSV))
    actual = os.path.normpath(os.path.abspath(universe_csv))
    if actual != expected:
        return False, ERAD_LISTING_AWARE_S20_UNIVERSE_CSV_REQUIRED
    return True, ""


def validate_erad_listing_aware_s20_output_root(output_root: str) -> Tuple[bool, str]:
    """listing-aware S20 输出仅允许独立根；禁止写入封闭 S1 / S2–S19 live 根。"""
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT)
    closed_s1 = _normalize_output_root(DEFAULT_ERAD_NEXT_SCALE_SLICE2_S1_OUTPUT_ROOT)
    closed_s2 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S2_OUTPUT_ROOT)
    closed_s3 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S3_OUTPUT_ROOT)
    closed_s4 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S4_OUTPUT_ROOT)
    ...
    for closed in (
        closed_s1, closed_s2, closed_s3, closed_s4, closed_s5, closed_s6, closed_s7,
        closed_s8, closed_s9, closed_s10, closed_s11, closed_s12, closed_s13, closed_s14,
        closed_s15, closed_s16, closed_s17, closed_s18, closed_s19,
    ):
        if root == closed or root.startswith(closed + os.sep):
            return False, ERAD_LISTING_AWARE_S20_CLOSED_ROOT_WRITE_FORBIDDEN
    closed_s21 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT)
    if root == closed_s21 or root.startswith(closed_s21 + os.sep):
        return False, "listing_aware_s21_root_forbidden_for_listing_aware_s20"
    closed_s22 = _normalize_output_root(DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT)
    if root == closed_s22 or root.startswith(closed_s22 + os.sep):
        return False, "listing_aware_s22_root_forbidden_for_listing_aware_s20"
    blocked = (
        (PHASE1_OUTPUT_ROOT, PHASE1_BASELINE_WRITE_FORBIDDEN),
        (DEFAULT_OUTPUT_ROOT, PHASE2_EXPANSION_WRITE_FORBIDDEN),
        (DEFAULT_RETRY_OUTPUT_ROOT, RETRY_V1_WRITE_FORBIDDEN),
        ...
        (
            DEFAULT_ERAD_SLICE2_ORGID_FALLBACK_RETRY_OUTPUT_ROOT,
            "orgid_fallback_retry_root_forbidden_for_listing_aware_s20",
        ),
        (C_CLASS_HARVEST_ROOT, "c_class_harvest_output_root_forbidden"),
        (B_CLASS_VALIDATION_PREFIX, "b_class_validation_output_root_forbidden"),
        (C_CLASS_VALIDATION_PREFIX, "c_class_validation_output_root_forbidden"),
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, "output_root_must_be_under_cninfo_a_class_erad_next_scale_listing_aware_s20"
...
def validate_erad_listing_aware_s19_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    for closed in (
        closed_s1, closed_s2, closed_s3, closed_s4, closed_s5, closed_s6, closed_s7,
        closed_s8, closed_s9, closed_s10, closed_s11, closed_s12, closed_s13, closed_s14,
        closed_s15, closed_s16, closed_s17, closed_s18, closed_s20, closed_s21, closed_s22,
    ):
        if root == closed or root.startswith(closed + os.sep):
...
def validate_erad_listing_aware_s18_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    for closed in (
        closed_s1, closed_s2, closed_s3, closed_s4, closed_s5, closed_s6, closed_s7,
        closed_s8, closed_s9, closed_s10, closed_s11, closed_s12, closed_s13, closed_s14,
        closed_s15, closed_s16, closed_s17, closed_s19, closed_s20, closed_s21, closed_s22,
    ):
        if root == closed or root.startswith(closed + os.sep):
...
def validate_erad_listing_aware_s17_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    for closed in (
        closed_s1, closed_s2, closed_s3, closed_s4, closed_s5, closed_s6, closed_s7,
        closed_s8, closed_s9, closed_s10, closed_s11, closed_s12, closed_s13, closed_s14,
        closed_s15, closed_s16, closed_s18, closed_s19, closed_s20, closed_s21, closed_s22,
    ):
        if root == closed or root.startswith(closed + os.sep):
...
def validate_erad_listing_aware_s16_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    for closed in (
        closed_s1, closed_s2, closed_s3, closed_s4, closed_s5, closed_s6, closed_s7,
        closed_s8, closed_s9, closed_s10, closed_s11, closed_s12, closed_s13, closed_s14,
        closed_s15, closed_s17, closed_s18, closed_s19, closed_s20, closed_s21, closed_s22,
    ):
        if root == closed or root.startswith(closed + os.sep):
...
def validate_erad_listing_aware_s15_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    for closed in (
        closed_s1, closed_s2, closed_s3, closed_s4, closed_s5, closed_s6, closed_s7,
        closed_s8, closed_s9, closed_s10, closed_s11, closed_s12, closed_s13, closed_s14,
        closed_s16, closed_s17, closed_s18, closed_s19, closed_s20, closed_s21, closed_s22,
    ):
        if root == closed or root.startswith(closed + os.sep):
...
def erad_slice2_request_cap_for_mode(
    *,
    ...
    caps = [
        (listing_aware_s2, ERAD_LISTING_AWARE_S2_REQUEST_CAP),
        (listing_aware_s3, ERAD_LISTING_AWARE_S3_REQUEST_CAP),
        (listing_aware_s4, ERAD_LISTING_AWARE_S4_REQUEST_CAP),
        (listing_aware_s5, ERAD_LISTING_AWARE_S5_REQUEST_CAP),
        (listing_aware_s6, ERAD_LISTING_AWARE_S6_REQUEST_CAP),
        (listing_aware_s7, ERAD_LISTING_AWARE_S7_REQUEST_CAP),
        (listing_aware_s8, ERAD_LISTING_AWARE_S8_REQUEST_CAP),
        (listing_aware_s9, ERAD_LISTING_AWARE_S9_REQUEST_CAP),
        (listing_aware_s10, ERAD_LISTING_AWARE_S10_REQUEST_CAP),
        (listing_aware_s11, ERAD_LISTING_AWARE_S11_REQUEST_CAP),
        (listing_aware_s12, ERAD_LISTING_AWARE_S12_REQUEST_CAP),
        (listing_aware_s13, ERAD_LISTING_AWARE_S13_REQUEST_CAP),
        (listing_aware_s14, ERAD_LISTING_AWARE_S14_REQUEST_CAP),
        (listing_aware_s15, ERAD_LISTING_AWARE_S15_REQUEST_CAP),
        (listing_aware_s16, ERAD_LISTING_AWARE_S16_REQUEST_CAP),
        (listing_aware_s17, ERAD_LISTING_AWARE_S17_REQUEST_CAP),
        (listing_aware_s18, ERAD_LISTING_AWARE_S18_REQUEST_CAP),
        (listing_aware_s19, ERAD_LISTING_AWARE_S19_REQUEST_CAP),
        (listing_aware_s20, ERAD_LISTING_AWARE_S20_REQUEST_CAP),
...
def validate_erad_next_scale_slice2_output_root(output_root: str) -> Tuple[bool, str]:
    ...
    blocked = (
        ...
        (
            DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT,
            "listing_aware_s20_root_forbidden_for_full_slice2_s1",
        ),
        (
            DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT,
            "listing_aware_s21_root_forbidden_for_full_slice2_s1",
        ),
        (
            DEFAULT_ERAD_LISTING_AWARE_S22_OUTPUT_ROOT,
            "listing_aware_s22_root_forbidden_for_full_slice2_s1",
        ),
        (C_CLASS_HARVEST_ROOT, "c_class_harvest_output_root_forbidden"),
        (B_CLASS_VALIDATION_PREFIX, "b_class_validation_output_root_forbidden"),
        (C_CLASS_VALIDATION_PREFIX, "c_class_validation_output_root_forbidden"),
...
def parse_erad_a_slice2_case_range(case_range: str) -> Tuple[str, str]:
    ...
    allowed = (
        ...
        | ALLOWED_ERAD_LISTING_AWARE_S20_CASE_IDS
    ...
    # 不允许跨模式混用 … / 1451–1500 / 1501–1550 / 1551–1600
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if getattr(args, "erad_a_scale_500_slice2", False):
        ...
        listing_aware_s20 = is_erad_listing_aware_s20_mode(
            args.universe_csv, args.output_root
        )
        listing_aware_s21 = is_erad_listing_aware_s21_mode(
            args.universe_csv, args.output_root
        )
        listing_aware_s22 = is_erad_listing_aware_s22_mode(
            args.universe_csv, args.output_root
        )
        ...
        if args.output_root is None:
            ...
            elif listing_aware_s20:
                args.output_root = DEFAULT_ERAD_LISTING_AWARE_S20_OUTPUT_ROOT
            elif listing_aware_s21:
                args.output_root = DEFAULT_ERAD_LISTING_AWARE_S21_OUTPUT_ROOT
            elif listing_aware_s22:
        ...
        if orgid_fb_retry:
            ...
            ok_csv, csv_err = validate_erad_listing_aware_s20_universe_csv_path(
                args.universe_csv
            )
            if not ok_csv:
                print(f"ERROR: {csv_err}", file=sys.stderr)
                return 2
            ok_root, root_err = validate_erad_listing_aware_s20_output_root(args.output_root)
            if not ok_root:
                print(f"ERROR: {root_err}", file=sys.stderr)
                return 2
        elif listing_aware_s21:
            ok_csv, csv_err = validate_erad_listing_aware_s21_universe_csv_path(
                args.universe_csv
            )
            if not ok_csv:
                print(f"ERROR: {csv_err}", file=sys.stderr)
                return 2
            ok_root, root_err = validate_erad_listing_aware_s21_output_root(args.output_root)
            if not ok_root:
                print(f"ERROR: {root_err}", file=sys.stderr)
                return 2
        elif listing_aware_s22:
            ok_csv, csv_err = validate_erad_listing_aware_s22_universe_csv_path(
                args.universe_csv
            )
            if not ok_csv:
                print(f"ERROR: {csv_err}", file=sys.stderr)
                return 2
            ok_root, root_err = validate_erad_listing_aware_s22_output_root(args.output_root)
            if not ok_root:
                print(f"ERROR: {root_err}", file=sys.stderr)
                return 2
        elif listing_aware_s23:
            ok_csv, csv_err = validate_erad_listing_aware_s23_universe_csv_path(
                args.universe_csv
            )
            if not ok_csv:
                print(f"ERROR: {csv_err}", file=sys.stderr)
                return 2
            ok_root, root_err = validate_erad_listing_aware_s23_output_root(args.output_root)
            if not ok_root:
                print(f"ERROR: {root_err}", file=sys.stderr)
                return 2
        elif listing_aware_s24:
        ...
        request_cap = erad_slice2_request_cap_for_mode(
            ...
            listing_aware_s20=listing_aware_s20,
        ...
        if args.limit is not None and not case_range:
            if orgid_fb_retry:
                ...
                expected_limit = REQUIRED_ERAD_LISTING_AWARE_S20_UNIVERSE_SIZE
            elif listing_aware_s21:
                expected_limit = REQUIRED_ERAD_LISTING_AWARE_S21_UNIVERSE_SIZE
            elif listing_aware_s22:
        ...
        if orgid_fb_retry:
            ...
            if not ok_size:
                print(f"ERROR: {size_err}", file=sys.stderr)
                return 2
        elif listing_aware_s20 and not case_range:
            ok_size, size_err = validate_erad_listing_aware_s20_universe_size(included)
            if not ok_size:
                print(f"ERROR: {size_err}", file=sys.stderr)
                return 2
        elif listing_aware_s21 and not case_range:
            ok_size, size_err = validate_erad_listing_aware_s21_universe_size(included)
            if not ok_size:
                print(f"ERROR: {size_err}", file=sys.stderr)
                return 2
        elif listing_aware_s22 and not case_range:
            ok_size, size_err = validate_erad_listing_aware_s22_universe_size(included)
            if not ok_size:
                print(f"ERROR: {size_err}", file=sys.stderr)
                return 2
        elif listing_aware_s23 and not case_range:
            ok_size, size_err = validate_erad_listing_aware_s23_universe_size(included)
            if not ok_size:
                print(f"ERROR: {size_err}", file=sys.stderr)
                return 2
        ...
        if orgid_fb_retry:
            ...
            mode_label = "erad_a_listing_aware_s20_live"
        elif listing_aware_s21:
            mode_label = "erad_a_listing_aware_s21_live"
        elif listing_aware_s22:
        ...
        if args.mode == "dry_run":
            ...
            # listing-aware / orgid-retry 使用模式 cap（S23=480）；勿被默认 slice2=240 误杀
            _use_mode_cap = (
                orgid_fb_retry
                or listing_aware_s2
                or listing_aware_s3
