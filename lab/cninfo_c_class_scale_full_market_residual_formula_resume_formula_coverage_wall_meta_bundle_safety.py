...
identity lock（离线 · C-FM-51）。

在 C-FM-50（risk_band_status/tier_coverage/combined_dryrun /
cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle）已 commit 且 EXECUTE 仍
human-held 之上，继续非 seal 规模/安全能力
（不新增 seal / decision-await / commit-boundary；非 extension↔drift 循环）：
  1) FM50 packet / fingerprint / gate / risk·tier·dryrun·wall ledgers 零漂移连续
  ...
  5) cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock：residual/resume/coverage 墙元捆绑
  6) output-root：MOCK3–52 冻结 · MOCK53 放行
  7) FM-01..05 + FM-12..50 gate battery（跳过 seal FM06–11）

禁止：CNINFO live · production EXECUTE · 覆盖 MOCK3–52 / 权威 dual-layer 索引 ·
...
from cninfo_c_class_scale_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_safety import (  # noqa: E402
    FROZEN_RISK_BAND_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM50_FROZEN_RISK_BAND_STATUS_FP,
    FROZEN_TIER_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM50_FROZEN_TIER_COVERAGE_FP,
    FROZEN_COMBINED_DRYRUN_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM50_FROZEN_COMBINED_DRYRUN_FP,
    FROZEN_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 as FM50_FROZEN_WALL_META_FP,
    EXPECTED_RISK_BAND_STATUS_PRIMARY_COMPOSITION_SHA256 as FM50_EXPECTED_RISK_BAND_STATUS_COMP_SHA256,
    EXPECTED_TIER_COVERAGE_PRIMARY_COMPOSITION_SHA256 as FM50_EXPECTED_TIER_COVERAGE_COMP_SHA256,
    EXPECTED_COMBINED_DRYRUN_PRIMARY_COMPOSITION_SHA256 as FM50_EXPECTED_COMBINED_DRYRUN_COMP_SHA256,
    EXPECTED_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE_SHA256 as FM50_EXPECTED_WALL_META_SHA256,
    EXPECTED_BATCH_PRIORITY as FM50_EXPECTED_BATCH_PRIORITY,
)
...
DEFAULT_MOCK_OUTPUT_ROOT_REL = (
    "outputs/validation/"
    "_mock_c_fm51_scale_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_safety"
)
...
FM50_PACKET_REL = f"{FM50_MOCK_ROOT_REL}/scale_packet.json"
FM50_FINGERPRINT_REL = f"{FM50_MOCK_ROOT_REL}/scale_fingerprint.json"
FM50_RISK_BAND_STATUS_REL = (
    f"{FM50_MOCK_ROOT_REL}/risk_band_status_composition_identity_lock_ledger.json"
)
FM50_TIER_COVERAGE_REL = (
    f"{FM50_MOCK_ROOT_REL}/tier_coverage_composition_identity_lock_ledger.json"
)
FM50_COMBINED_DRYRUN_REL = (
    f"{FM50_MOCK_ROOT_REL}/combined_dryrun_composition_identity_lock_ledger.json"
)
FM50_WALL_META_REL = (
    f"{FM50_MOCK_ROOT_REL}/"
    "cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle_identity_lock_ledger.json"
)# 兼容旧名（连续性别名）
FM49_GATE_JSON_REL = FM50_GATE_JSON_REL
FM49_MOCK_ROOT_REL = FM50_MOCK_ROOT_REL
FM49_PACKET_REL = FM50_PACKET_REL
FM49_FINGERPRINT_REL = FM50_FINGERPRINT_REL
FM49_UNION_STATUS_REL = FM50_RISK_BAND_STATUS_REL
FM49_RESIDUAL_COVERAGE_REL = FM50_TIER_COVERAGE_REL
FM49_RESUME_TAXONOMY_DISPOSITION_REL = FM50_COMBINED_DRYRUN_REL
FM49_WALL_META_REL = FM50_WALL_META_REL
FM48_GATE_JSON_REL = FM50_GATE_JSON_REL
FM48_MOCK_ROOT_REL = FM50_MOCK_ROOT_REL
FM48_PACKET_REL = FM50_PACKET_REL
FM48_FINGERPRINT_REL = FM50_FINGERPRINT_REL
FM48_OVERLAP_MEMBERSHIP_REL = FM50_RISK_BAND_STATUS_REL
FM48_DRY863_EXTRAS_REL = FM50_TIER_COVERAGE_REL
FM48_BATCH_PRIORITY_REL = FM50_COMBINED_DRYRUN_REL
FM48_WALL_META_REL = FM50_WALL_META_REL

# C-FM-51 本包冻结指纹（运行后由 fingerprint_* 锁定）
FROZEN_RESIDUAL_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "baea07ccde828e788ccc42bae4dc2dc163149cf5f7b466a99c8c98167b28e971"
)
FROZEN_RESUME_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "ba18faf57ae2653fb9f8a4eeea710ef637ae889d2afdc75da6a026b48c63d42c"
)
FROZEN_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "d07e6b8534590027979b90342f65aed2c2aa8a398bb08a14f1a1c92476763471"
)
FROZEN_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 = (
    "0c4887ff53108e477d3e5cd6f71894efef8def4998735c97c1ae52bf1a6ed080"
)

# 兼容旧主轴冻结名（FM50 风格别名 → 本包 residual/resume/coverage）
...
# FM50 连续锚点（只读）
FROZEN_FM50_RISK_BAND_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM50_FROZEN_RISK_BAND_STATUS_FP
FROZEN_FM50_TIER_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM50_FROZEN_TIER_COVERAGE_FP
FROZEN_FM50_COMBINED_DRYRUN_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM50_FROZEN_COMBINED_DRYRUN_FP
FROZEN_FM50_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 = (
    FM50_FROZEN_WALL_META_FP
)
# 兼容旧名
FROZEN_FM49_UNION_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FROZEN_FM50_RISK_BAND_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256
FROZEN_FM49_RESIDUAL_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FROZEN_FM50_TIER_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256
FROZEN_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FROZEN_FM50_COMBINED_DRYRUN_COMPOSITION_IDENTITY_LOCK_FP_SHA256
...
EXPECTED_FM50_RISK_BAND_STATUS_COMPOSITION_SHA256 = FM50_EXPECTED_RISK_BAND_STATUS_COMP_SHA256
EXPECTED_FM49_UNION_STATUS_COMPOSITION_SHA256 = EXPECTED_FM50_RISK_BAND_STATUS_COMPOSITION_SHA256
EXPECTED_FM50_TIER_COVERAGE_COMPOSITION_SHA256 = FM50_EXPECTED_TIER_COVERAGE_COMP_SHA256
EXPECTED_FM49_RESIDUAL_COVERAGE_COMPOSITION_SHA256 = EXPECTED_FM50_TIER_COVERAGE_COMPOSITION_SHA256
EXPECTED_FM50_COMBINED_DRYRUN_COMPOSITION_SHA256 = FM50_EXPECTED_COMBINED_DRYRUN_COMP_SHA256
EXPECTED_FM49_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_SHA256 = EXPECTED_FM50_COMBINED_DRYRUN_COMPOSITION_SHA256
EXPECTED_FM50_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE_SHA256 = (
    FM50_EXPECTED_WALL_META_SHA256
)
...
EXPECTED_RESIDUAL_FORMULA_PRIMARY_COMPOSITION_SHA256 = (
    "2c7068376f7bad023afb8d79e695ae95bb2ece1c07f0970c51b6a4db2099d2ea"
)
EXPECTED_RESUME_FORMULA_PRIMARY_COMPOSITION_SHA256 = (
    "e20603986a7df1980c21388d3dd213ecda7e16ab32c6037c4fa33fdb63b3c5a2"
)
EXPECTED_COVERAGE_PRIMARY_COMPOSITION_SHA256 = (
    "916baf44ac41c750343005be227423b1f3f2ee709168a886782ae882ac3c74b4"
)
# 兼容旧主轴名
EXPECTED_RISK_BAND_STATUS_PRIMARY_COMPOSITION_SHA256 = EXPECTED_RESIDUAL_FORMULA_PRIMARY_COMPOSITION_SHA256
EXPECTED_TIER_COVERAGE_PRIMARY_COMPOSITION_SHA256 = EXPECTED_RESUME_FORMULA_PRIMARY_COMPOSITION_SHA256
EXPECTED_COMBINED_DRYRUN_PRIMARY_COMPOSITION_SHA256 = EXPECTED_COVERAGE_PRIMARY_COMPOSITION_SHA256
# 兼容旧名（本包主轴）
...
EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_SHA256 = (
    "1b7ca472bee9b9d21520ceb5a523ea08f66e557402ec52abb4e5f581b772b143"
)
...
EXPECTED_RESIDUAL_FORMULA_PRIMARY_FORMULA = "106+9+2=117"
EXPECTED_RESUME_FORMULA_PRIMARY_FORMULA = "28+1+0=29"
EXPECTED_COVERAGE_PRIMARY_FORMULA = "coverage=117"
EXPECTED_RISK_BAND_STATUS_PRIMARY_FORMULA = EXPECTED_RESIDUAL_FORMULA_PRIMARY_FORMULA
EXPECTED_TIER_COVERAGE_PRIMARY_FORMULA = EXPECTED_RESUME_FORMULA_PRIMARY_FORMULA
EXPECTED_COMBINED_DRYRUN_PRIMARY_FORMULA = EXPECTED_COVERAGE_PRIMARY_FORMULA
...
EXPECTED_BATCH_PRIORITY = list(FM50_EXPECTED_BATCH_PRIORITY)
EXPECTED_FM51_PROTECTED_ROOT_REGISTRY_FORMULA = "MOCK3-52+MOCK53+resume+auth"
EXPECTED_FM51_PROTECTED_ROOT_REGISTRY_FORMULA = "MOCK3-52+MOCK53+resume+auth"
...
EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE = {
    "residual_formula_composition": {
        "formula": EXPECTED_RESIDUAL_FORMULA_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_RESIDUAL_FORMULA_PRIMARY_COMPOSITION_SHA256,
    ...
    "resume_formula_composition": {
        "formula": EXPECTED_RESUME_FORMULA_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_RESUME_FORMULA_PRIMARY_COMPOSITION_SHA256,
    ...
    "coverage_composition": {
        "formula": EXPECTED_COVERAGE_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_COVERAGE_PRIMARY_COMPOSITION_SHA256,
        "residual_safety_coverage": EXPECTED_RESIDUAL_SAFETY_COVERAGE,
    ...
    "cross_full_market_risk_band_status_tier_coverage_combined_dryrun_wall_meta_bundle": {
        "bundle_sha256": EXPECTED_FM50_CROSS_FULL_MARKET_RISK_BAND_STATUS_TIER_COVERAGE_COMBINED_DRYRUN_WALL_META_BUNDLE_SHA256,
    },
    "stable_metrics_wall": {
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "surface_unique": EXPECTED_SURFACE_UNIQUE,
...
THIS_TASK_ROOT_ID = "C-ROOT-MOCK53"
PRIOR_TASK_ROOT_ID = "C-ROOT-MOCK52"
RESUME_HARVEST_ROOT_ID = "C-ROOT-002"

FROZEN_ROOT_IDS_MUST_BLOCK = tuple(f"C-ROOT-MOCK{i}" for i in range(3, 53))
...
class FullMarketResidualFormulaResumeFormulaCoverageWallMetaBundlePaths:
    """只读输入与隔离写根路径规格。"""
    ...
    fm50_packet_rel: str = FM50_PACKET_REL
    fm49_packet_rel: str = FM49_PACKET_REL
    fm50_fingerprint_rel: str = FM50_FINGERPRINT_REL
...
def assert_fm51_output_root(
    output_root: str, *, base_dir: str = BASE_DIR
) -> str:
    """
    C-FM-51 写根：须 validation/_mock_*，不得覆盖 MOCK3–52，
    ...
    if root_id is not None and root_id != THIS_TASK_ROOT_ID:
        raise RuntimeError(
            ...
            f"(C-FM-51 only writes {THIS_TASK_ROOT_ID} or ephemeral _mock_*)"
        )
...
def fingerprint_residual_formula_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    ...
    doc = {
        ...
        "composition_sha256": EXPECTED_RESIDUAL_FORMULA_PRIMARY_COMPOSITION_SHA256,
        "residual_formula": EXPECTED_RESIDUAL_FORMULA,
        "residual_formula_primary": EXPECTED_RESIDUAL_FORMULA_PRIMARY_FORMULA,
...
def fingerprint_resume_formula_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """resume_formula composition identity lock 指纹（28+1+0=29）。"""
    doc = {
        "kind": "resume_formula_composition_identity_lock",
        "resume_improved": EXPECTED_RESUME_IMPROVED,
        "resume_same": EXPECTED_RESUME_SAME,
        "resume_worse": EXPECTED_RESUME_WORSE,
        "resume_total": EXPECTED_RESUME_TOTAL,
        ...
        "resume_formula": EXPECTED_RESUME_FORMULA,
        "resume_taxonomy_formula": EXPECTED_RESUME_TAXONOMY_FORMULA,
        "resume_formula_primary": EXPECTED_RESUME_FORMULA_PRIMARY_FORMULA,
        "deny_composition_mutate": True,
        "deny_inflate": True,
        "deny_deflate": True,
        "hold": "KEEP_EXECUTE_FALSE",
...
def fingerprint_coverage_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """coverage composition identity lock 指纹（coverage=117）。"""
    doc = {
        "kind": "coverage_composition_identity_lock",
        "residual_safety_coverage": EXPECTED_RESIDUAL_SAFETY_COVERAGE,
        "coverage_formula": EXPECTED_COVERAGE_FORMULA,
        "composition_sha256": EXPECTED_COVERAGE_PRIMARY_COMPOSITION_SHA256,
        "coverage_formula_primary": EXPECTED_COVERAGE_PRIMARY_FORMULA,
        "union_partial": EXPECTED_UNION_PARTIAL,
        "union_failed": EXPECTED_UNION_FAILED,
        "surface_harvest_delta_n": EXPECTED_SURFACE_HARVEST_DELTA_N,
        "deny_composition_mutate": True,
...
def fingerprint_cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """cross residual/resume/coverage wall-meta bundle identity lock 指纹。"""
    doc = {
        "kind": "cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock",
        "compositions": {
            k: dict(v)
            for k, v in EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE.items()
        },
        "bundle_sha256": EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_SHA256,
        "deny_composition_mutate": True,
...
fingerprint_overlap_membership_composition_identity_lock = fingerprint_residual_formula_composition_identity_lock
fingerprint_dry863_extras_composition_identity_lock = fingerprint_resume_formula_composition_identity_lock
fingerprint_batch_priority_composition_identity_lock = fingerprint_coverage_composition_identity_lock
fingerprint_union_status_composition_identity_lock = fingerprint_residual_formula_composition_identity_lock
fingerprint_residual_coverage_composition_identity_lock = fingerprint_resume_formula_composition_identity_lock
fingerprint_resume_taxonomy_disposition_composition_identity_lock = fingerprint_coverage_composition_identity_lock
fingerprint_residual_formula_composition_identity_lock = fingerprint_residual_formula_composition_identity_lock
fingerprint_resume_formula_composition_identity_lock = fingerprint_resume_formula_composition_identity_lock
fingerprint_coverage_composition_identity_lock = fingerprint_coverage_composition_identity_lock
fingerprint_cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock = (
    fingerprint_cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock
)
...
def evaluate_residual_formula_composition_mutation(
    *,
    ...
    matches = (
        ...
        and proposed_partial + proposed_failed + proposed_delta_n == proposed_coverage
    )
    return {
        "proposed": {
            "union_partial": proposed_partial,
            "union_failed": proposed_failed,
            "surface_harvest_delta_n": proposed_delta_n,
            "residual_safety_coverage": proposed_coverage,
        },
        "frozen": {
            "union_partial": EXPECTED_UNION_PARTIAL,
            "union_failed": EXPECTED_UNION_FAILED,
...
def evaluate_resume_formula_composition_mutation(
    *,
    proposed_improved: int,
    proposed_same: int,
    proposed_worse: int,
) -> Dict[str, Any]:
    """评估 28+1+0=29 组成变异；一律拒绝。"""
    matches = (
        proposed_improved == EXPECTED_RESUME_IMPROVED
        and proposed_same == EXPECTED_RESUME_SAME
        and proposed_worse == EXPECTED_RESUME_WORSE
        and proposed_improved + proposed_same + proposed_worse == EXPECTED_RESUME_TOTAL
    )
    return {
        "proposed": {
            "resume_improved": proposed_improved,
            "resume_same": proposed_same,
            "resume_worse": proposed_worse,
            "resume_total": proposed_improved + proposed_same + proposed_worse,
        },
        "frozen": {
            "resume_improved": EXPECTED_RESUME_IMPROVED,
            "resume_same": EXPECTED_RESUME_SAME,
        ...
        "matches_frozen": matches,
        "mutation_allowed": False,
        "reason": "resume_formula_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_coverage_composition_mutation(
    *,
    proposed_coverage: int,
    ...
    matches = (
        ...
        and proposed_formula == EXPECTED_COVERAGE_FORMULA
    )
    return {
        "proposed": {
            "residual_safety_coverage": proposed_coverage,
            "coverage_formula": proposed_formula,
        },
        "frozen": {
            "residual_safety_coverage": EXPECTED_RESIDUAL_SAFETY_COVERAGE,
            "coverage_formula": EXPECTED_COVERAGE_FORMULA,
        ...
        "matches_frozen": matches,
        "mutation_allowed": False,
        "reason": "coverage_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_mutation(
    *, proposed_compositions: Dict[str, Any]
) -> Dict[str, Any]:
    """评估 cross residual/resume/coverage wall-meta bundle 变异；一律拒绝。"""
    frozen = {
        k: dict(v)
        for k, v in EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE.items()
    }
    ...
    return {
        ...
        "mutation_allowed": False,
        "reason": (
            "cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_frozen_pre_execute"
        ),
        "hold": "KEEP_EXECUTE_FALSE",
    }


evaluate_overlap_membership_composition_mutation = evaluate_residual_formula_composition_mutation
evaluate_dry863_extras_composition_mutation = evaluate_resume_formula_composition_mutation
evaluate_batch_priority_composition_mutation = evaluate_coverage_composition_mutation
evaluate_union_status_composition_mutation = evaluate_residual_formula_composition_mutation
evaluate_residual_coverage_composition_mutation = evaluate_resume_formula_composition_mutation
evaluate_resume_taxonomy_disposition_composition_mutation = evaluate_coverage_composition_mutation
evaluate_risk_band_status_composition_mutation = evaluate_residual_formula_composition_mutation
evaluate_tier_coverage_composition_mutation = evaluate_resume_formula_composition_mutation
evaluate_combined_dryrun_composition_mutation = evaluate_coverage_composition_mutation
...
def build_residual_formula_composition_identity_lock_rows(
    ...
    *,
    ...
    comp_payload = {
        "kind": "residual_formula_composition",
        "union_partial": EXPECTED_UNION_PARTIAL,
        "union_failed": EXPECTED_UNION_FAILED,
        "surface_harvest_delta_n": EXPECTED_SURFACE_HARVEST_DELTA_N,
        "residual_safety_coverage": EXPECTED_RESIDUAL_SAFETY_COVERAGE,
    ...
    identity_ok = (
        ...
        and comp_sha == EXPECTED_RESIDUAL_FORMULA_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_RESIDUAL_FORMULA_PRIMARY_COMPOSITION_SHA256
    )
    ...
    rows.append(
        _row(
            ...
            observed=(
                f"formula={EXPECTED_RESIDUAL_FORMULA_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
    ...
    rows.append(
        _row(
            ...
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "residual_formula_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["residual_formula_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            ...
            ok=all_ok,
            notes="ok" if all_ok else "residual_formula_lock_incomplete",
        )
    )
    meta_out = {
        "fingerprint": fp,
        "composition_sha256": comp_sha,
        "residual_formula": EXPECTED_RESIDUAL_FORMULA_PRIMARY_FORMULA,
...
def build_resume_formula_composition_identity_lock_rows(
    paths: FullMarketResidualFormulaResumeFormulaCoverageWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """resume_formula composition identity lock（28+1+0=29）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_resume_formula_composition_identity_lock()

    comp_payload = {
        "kind": "resume_formula_composition",
        "resume_improved": EXPECTED_RESUME_IMPROVED,
        "resume_same": EXPECTED_RESUME_SAME,
        "resume_worse": EXPECTED_RESUME_WORSE,
        "resume_total": EXPECTED_RESUME_TOTAL,
    ...
    identity_ok = (
        ...
        and comp_sha == EXPECTED_RESUME_FORMULA_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_RESUME_FORMULA_PRIMARY_COMPOSITION_SHA256
    )
    checks["resume_formula_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="resume_formula_composition_identity",
            layer="resume_formula_composition_identity_lock",
            expected="28+1+0=29",
            observed=(
                f"formula={EXPECTED_RESUME_FORMULA_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "resume_formula_composition_drift",
        )
    )
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["resume_formula_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="resume_formula_composition_mutation_denied",
            layer="resume_formula_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_RESUME_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["resume_formula_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="resume_formula_composition_flags",
            layer="resume_formula_composition_identity_lock",
            expected=FROZEN_RESUME_FORMULA_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
    ...
    all_ok = all(checks.values()) if checks else False
    checks["resume_formula_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="resume_formula_composition_identity_lock_all_pass",
            layer="resume_formula_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "resume_formula_lock_incomplete",
        )
    )
    meta_out = {
        "fingerprint": fp,
        "composition_sha256": comp_sha,
        "resume_formula": EXPECTED_RESUME_FORMULA_PRIMARY_FORMULA,
        "sample_denials": sample_denials,
        "doc": doc,
    }
    return rows, checks, meta_out
...
def build_coverage_composition_identity_lock_rows(
    paths: FullMarketResidualFormulaResumeFormulaCoverageWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """coverage composition identity lock（coverage=117）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_coverage_composition_identity_lock()

    comp_payload = {
        "kind": "coverage_composition",
        "residual_safety_coverage": EXPECTED_RESIDUAL_SAFETY_COVERAGE,
        "coverage_formula": EXPECTED_COVERAGE_FORMULA,
        "union_partial": EXPECTED_UNION_PARTIAL,
        "union_failed": EXPECTED_UNION_FAILED,
    ...
    identity_ok = (
        ...
        and EXPECTED_COVERAGE_FORMULA == "coverage=117"
        and comp_sha == EXPECTED_COVERAGE_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_COVERAGE_PRIMARY_COMPOSITION_SHA256
    )
    checks["coverage_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="coverage_composition_identity",
            layer="coverage_composition_identity_lock",
            expected="coverage=117",
            observed=(
                f"formula={EXPECTED_COVERAGE_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "coverage_composition_drift",
        )
    )
    ...
    sample_denials = [
        evaluate_coverage_composition_mutation(
            ...
            proposed_formula=EXPECTED_COVERAGE_FORMULA,
        ),
        evaluate_coverage_composition_mutation(
            proposed_coverage=EXPECTED_RESIDUAL_SAFETY_COVERAGE,
            proposed_formula="coverage=116",
        ),
        evaluate_coverage_composition_mutation(
            proposed_coverage=0,
            proposed_formula="coverage=0",
        ),
        evaluate_coverage_composition_mutation(
            proposed_coverage=EXPECTED_RESIDUAL_SAFETY_COVERAGE,
            proposed_formula=EXPECTED_COVERAGE_FORMULA,
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["coverage_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="coverage_composition_mutation_denied",
            layer="coverage_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
            notes="ok" if mut_ok else "coverage_mutation_leak",
        )
    )
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["coverage_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="coverage_composition_flags",
            layer="coverage_composition_identity_lock",
            expected=FROZEN_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "coverage_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["coverage_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="coverage_composition_identity_lock_all_pass",
            layer="coverage_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
    ...
    meta_out = {
        "fingerprint": fp,
        "composition_sha256": comp_sha,
        "coverage_formula": EXPECTED_COVERAGE_PRIMARY_FORMULA,
        "sample_denials": sample_denials,
        "doc": doc,
    }
    return rows, checks, meta_out
...
def build_cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock_rows(
    paths: FullMarketResidualFormulaResumeFormulaCoverageWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """cross residual/resume/coverage wall-meta bundle identity lock。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock()
    ...
    identity_ok = (
        bundle_sha == EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_SHA256
        and doc["bundle_sha256"] == EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_SHA256
        and bundle["residual_formula_composition"]["formula"] == "106+9+2=117"
        and bundle["resume_formula_composition"]["formula"] == "28+1+0=29"
        and bundle["coverage_composition"]["formula"] == "coverage=117"
    )
    checks["cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity"] = identity_ok
    rows.append(
        _row(
            check_id="cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity",
            layer="cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock",
            expected=EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_SHA256,
            observed=bundle_sha,
            ok=identity_ok,
    ...
    inflated["coverage_composition"] = dict(inflated["coverage_composition"])
    inflated["coverage_composition"]["residual_safety_coverage"] = 118
    deflated = {
        k: dict(v)
        for k, v in EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE.items()
        if k != "coverage_composition"
    }
    mutated = {
        k: dict(v)
        for k, v in EXPECTED_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE.items()
    }
    mutated["residual_formula_composition"] = dict(mutated["residual_formula_composition"])
    mutated["residual_formula_composition"]["composition_sha256"] = "0" * 64
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_mutation_denied",
            layer="cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    flags_ok = (
        ...
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256
    )
    checks["cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_flags"] = flags_ok
    rows.append(
        _row(
            check_id="cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_flags",
            layer="cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock",
            expected=FROZEN_CROSS_FULL_MARKET_RESIDUAL_FORMULA_RESUME_FORMULA_COVERAGE_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
    ...
    all_ok = all(checks.values()) if checks else False
    checks["cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock_all_pass",
            layer="cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
build_overlap_membership_composition_identity_lock_rows = build_residual_formula_composition_identity_lock_rows
build_dry863_extras_composition_identity_lock_rows = build_resume_formula_composition_identity_lock_rows
build_batch_priority_composition_identity_lock_rows = build_coverage_composition_identity_lock_rows
build_union_status_composition_identity_lock_rows = build_residual_formula_composition_identity_lock_rows
build_residual_coverage_composition_identity_lock_rows = build_resume_formula_composition_identity_lock_rows
build_resume_taxonomy_disposition_composition_identity_lock_rows = build_coverage_composition_identity_lock_rows
build_residual_formula_composition_identity_lock_rows = build_residual_formula_composition_identity_lock_rows
build_resume_formula_composition_identity_lock_rows = build_resume_formula_composition_identity_lock_rows
build_coverage_composition_identity_lock_rows = build_coverage_composition_identity_lock_rows
...
build_fm50_continuity_rows = None  # set after def

def build_fm50_continuity_rows(
    paths: FullMarketResidualFormulaResumeFormulaCoverageWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """FM50 packet / fingerprint / gate / 四 ledger 零漂移。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}

    packet = load_json(_abs(getattr(paths, "fm50_packet_rel", paths.fm49_packet_rel), base_dir=base_dir))
    fp_doc = load_json(_abs(getattr(paths, "fm50_fingerprint_rel", paths.fm49_fingerprint_rel), base_dir=base_dir))
    ...
    pkt_primary_union = (
        packet.get("risk_band_status_composition_sha256")
        or packet.get("overlap_membership_composition_sha256")
        or packet.get("union_status_composition_sha256")
    )
    pkt_primary_residual = (
        packet.get("tier_coverage_composition_sha256")
        or packet.get("dry863_extras_composition_sha256")
        or packet.get("residual_coverage_composition_sha256")
    )
    pkt_primary_resume = (
        packet.get("combined_dryrun_composition_sha256")
        or packet.get("batch_priority_composition_sha256")
        or packet.get("resume_taxonomy_disposition_composition_sha256")
    )
    pkt_cross = (
        packet.get(
    ...
    all_ok = all(checks.values()) if checks else False
    checks["fm50_continuity_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="fm50_continuity_all_pass",
            layer="fm50_continuity",
            expected="packet+fp+gate+4ledgers",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "fm50_continuity_incomplete",
        )
    )
    return rows, checks
...
def build_output_root_protection_rows(
    ...
    *,
    ...
    """output-root 保护：resume/harvest 写拒绝 + MOCK53 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    ...
    out_detail = ""
    try:
        assert_fm51_output_root(paths.output_root_rel, base_dir=base_dir)
        out_ok = True
        out_detail = "allowed"
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            expected="MOCK53_or_ephemeral_allowed",
            observed=out_detail,
            ok=out_ok,
...
def build_frozen_mock_isolation_rows(
    paths: FullMarketResidualFormulaResumeFormulaCoverageWallMetaBundlePaths, *, base_dir: str = BASE_DIR
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """冻结 mock cohort 写隔离：MOCK3–52 拒绝 · MOCK53 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    load_frozen_mock_cohort_roots.cache_clear()
    ...
    try:
        assert_fm51_output_root(mock51_rel, base_dir=base_dir)
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            layer="frozen_mock_isolation",
            expected="MOCK3-52_block+MOCK53_allow",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
    ...
    *,
    ...
    rows.append(
        _row(
            ...
            layer="protected_csv_registry",
            expected="MOCK3–52+MOCK51+resume+auth+registered",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
def ensure_protected_roots_csv_fm51(
    *,
    csv_rel: str = PROTECTED_ROOTS_CSV_REL,
    base_dir: str = BASE_DIR,
) -> None:
    """注册 C-ROOT-MOCK53；加固 C-ROOT-002 unique/surface/additive/tier/dryrun 说明。"""
    ...
    _upsert(
        RESUME_HARVEST_ROOT_ID,
        {
            ...
            "notes": (
                ...
                "C-FM-24..50 scale/safety freezes + C-FM-51 full-market residual_formula/resume_formula/coverage-wall-meta-bundle; "
    ...
    _upsert(
        THIS_TASK_ROOT_ID,
        {
            ...
            "notes": (
                "C-FM-51 scale residual_formula composition identity lock "
                "(106+9+2=117) + resume_formula composition identity lock "
                "(28+1+0=29) + coverage composition identity lock "
                "(coverage=117) + cross_full_market_residual_formula_"
                "resume_formula_coverage_wall_meta_bundle identity lock + "
                "FM50 continuity; never production EXECUTE; "
                "must not overwrite MOCK3-52; seal_chain_extended=false"
            ),
        },
    )
...
def run_scale_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_safety(
    *,
    paths: FullMarketResidualFormulaResumeFormulaCoverageWallMetaBundlePaths | None = None,
    base_dir: str = BASE_DIR,
) -> Dict[str, Any]:
    """执行 C-FM-51 规模 residual_formula/resume_formula/coverage-wall-meta-bundle 离线 QA。"""
    paths = paths or FullMarketResidualFormulaResumeFormulaCoverageWallMetaBundlePaths()
    generated_at = _utc_now_iso()
    ensure_protected_roots_csv_fm51(
        csv_rel=paths.protected_roots_csv_rel, base_dir=base_dir
    )
    out_root = assert_fm51_output_root(paths.output_root_rel, base_dir=base_dir)

    matrix: List[Dict[str, str]] = []
    cont_rows, cont_checks = build_fm50_continuity_rows(paths, base_dir=base_dir)
    ...
    gates = {
        ...
        "fm50": load_json(_abs(FM50_GATE_JSON_REL, base_dir=base_dir)),
    }
    ...
    layer_gates = {
        "fm50_continuity": (
            "PASS_OFFLINE"
            if cont_checks.get("fm50_continuity_all_pass")
            else "FAIL_OFFLINE"
        ),
        ...
        "resume_formula_composition_identity_lock": (
            "PASS_OFFLINE"
            if rt_checks.get("resume_formula_composition_identity_lock_all_pass")
            else "FAIL_OFFLINE"
        ),
        "coverage_composition_identity_lock": (
            "PASS_OFFLINE"
            if rb_checks.get(
                "coverage_composition_identity_lock_all_pass"
            )
            else "FAIL_OFFLINE"
        ),
    ...
    rb_rel = _write_ledger(
        "coverage_composition_identity_lock_ledger.json",
        {
            ...
            "coverage_formula": rb_meta["coverage_formula"],
    ...
    packet_rel = _write_ledger(
        "scale_packet.json",
        {
            ...
            "notes": (
                ...
                "FM50 continuity + MOCK53; EXECUTE remains human-held; "
                "does not overwrite MOCK3-52"
            ),
        },
    )
    ...
    with open(_abs(readme_rel, base_dir=base_dir), "w", encoding="utf-8") as fh:
        fh.write(
            "\n".join(
                [
                    "# C-FM-51 mock scale lineage/drift/protected/repro-wall-meta-bundle safety root",
                    "",
                    f"task_id: {TASK_ID}",
                    f"gate: {overall}",
                    "cninfo_calls: 0",
                    ...
                    "",
                    "Isolation: MOCK3-52 frozen; this root is C-ROOT-MOCK53.",
    ...
    return {
        ...
        "cross_full_market_residual_formula_resume_formula_coverage_wall_meta_bundle_path": bundle_rel,
