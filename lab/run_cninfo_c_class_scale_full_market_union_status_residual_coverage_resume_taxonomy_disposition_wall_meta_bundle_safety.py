...
identity lock runner（离线 · C-FM-49）。

Usage:
    python3 lab/run_cninfo_c_class_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety.py
    python3 lab/run_cninfo_c_class_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety.py \\
      --output-root outputs/validation/_mock_c_fm49_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety
"""
...
REPORT_ROOT_REL = (
    "outputs/validation/"
    "cninfo_c_class_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety"
)
REPORT_MD_REL = (
    "outputs/validation/"
    "cninfo_c_class_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety_20260716.md"
)
REPORT_JSON_REL = (
    "outputs/validation/"
...
TASK_REPORT_REL = (
    "outputs/validation/"
    "cninfo_c_class_fm49_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety_20260716.md"
)
...
def write_reports(payload: Dict[str, Any]) -> Dict[str, str]:
    ...
    for key, name in (
        ...
        (
            "residual_coverage_path",
            "residual_coverage_composition_identity_lock_ledger.json",
        ),
        (
            "resume_taxonomy_disposition_path",
            "resume_taxonomy_disposition_composition_identity_lock_ledger.json",
        ),
        (
            "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_path",
    ...
    json_payload = {
        ...
        "resume_taxonomy_disposition_composition_sha256": payload[
            "resume_taxonomy_disposition_composition_sha256"
        ],
        "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_sha256": payload[
        ...
        "resume_taxonomy_disposition_formula": payload["resume_taxonomy_disposition_formula"],
        ...
        "union_status_path": payload["union_status_path"],
        "residual_coverage_path": payload["residual_coverage_path"],
        "resume_taxonomy_disposition_path": payload["resume_taxonomy_disposition_path"],
        "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_path": payload[
            "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_path"
        ],
    ...
    md_lines = [
        ...
        f"| resume_taxonomy_disposition_formula | **{payload['resume_taxonomy_disposition_formula']}** |",
        ...
        *layer_lines,
        ...
        "",
        "```",
        f"c_fm_49_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety_gate = "
        f"{payload['gate']}",
        "execute_production_snapshot_rebuild = false",
        "approved_for_snapshot_rebuild = false",
        "cninfo_calls = 0",
    ...
    task_lines = [
        ...
        "identity lock（overlap/dry863/batch_priority/repro 墙元捆绑）**、**FM47 连续 + MOCK50 隔离**；"
        "产物写入隔离 MOCK50（不覆盖 MOCK3–49）。",
        "",
        "## Capability gain",
        "",
        ...
        "6. output-root：MOCK3–50 冻结 · MOCK51 放行；harvest/resume 写拒绝",
        ...
        "| 路径 | 变更 |",
        "|------|------|",
        "| `lab/cninfo_c_class_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety.py` | **新增** 核心 |",
        "| `lab/run_cninfo_c_class_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety.py` | **新增** runner |",
        "| `lab/test_cninfo_c_class_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety.py` | **新增** 测试 |",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "C-FM-49 scale overlap/dry863/batch_priority/repro-wall-meta-bundle "
            "safety (offline)"
        )
    )
    parser.add_argument(
    ...
    if args.execute:
        print(
            ...
            "C-FM-49 is offline QA only; KEEP_EXECUTE_FALSE",
            file=sys.stderr,
        )
        return 2

    payload = run_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety(
        ...
        json.dumps(
            {
                ...
                "resume_taxonomy_disposition_formula": payload[
