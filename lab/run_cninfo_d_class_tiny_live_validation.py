...
DEFAULT_ABNORMAL_TRADING_NEXT_SLICE_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_abnormal_trading_next_slice",
)
DEFAULT_ABNORMAL_TRADING_NEXT_SLICE_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_abnormal_trading_next_slice_universe_lock_20260715.csv",
)
ABNORMAL_TRADING_NEXT_SLICE_FIXTURE_DIR = os.path.join(
    BASE_DIR,
    "fixtures",
    "d_class",
    "abnormal_trading_next_slice",
)
ABNORMAL_TRADING_NEXT_SLICE_DRYRUN_REPORT_CSV = os.path.join(
    DEFAULT_ABNORMAL_TRADING_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_abnormal_trading_next_slice_dryrun_report.csv",
)
ABNORMAL_TRADING_NEXT_SLICE_DRYRUN_SUMMARY_MD = os.path.join(
    DEFAULT_ABNORMAL_TRADING_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_abnormal_trading_next_slice_dryrun_summary.md",
)

ABNORMAL_TRADING_NEXT_SLICE_RUNNER_GATE = "READY_FOR_APPROVAL"
ABNORMAL_TRADING_NEXT_SLICE_LIVE_PATH_GATE = "READY_FOR_APPROVAL"
ABNORMAL_TRADING_NEXT_SLICE_LIVE_GATE = "NOT_APPROVED"
ABNORMAL_TRADING_NEXT_SLICE_EXECUTION_GATE_PASS = "PASS_WITH_CAVEAT"
ABNORMAL_TRADING_NEXT_SLICE_EXECUTION_GATE_FAIL = "FAIL_REVIEW_REQUIRED"
ABNORMAL_TRADING_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE = 5
ABNORMAL_TRADING_NEXT_SLICE_ALLOWED_CASE_IDS: Set[str] = {
    "DAT101",
    "DAT102",
    "DAT103",
    "DAT104",
...
ABNORMAL_TRADING_NEXT_SLICE_EXPECTED_COMPANY_CODES: Dict[str, str] = {
    "DAT101": "000895",
    "DAT102": "600000",
    "DAT103": "002415",
    "DAT104": "000001",
...
ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_COMPANY_CODES: Set[str] = {
    "688671",
    "301259",
}
ABNORMAL_TRADING_NEXT_SLICE_COMPONENT = "abnormal_trading"
ABNORMAL_TRADING_NEXT_SLICE_ANCHOR_TDATE = "2026-07-02"
ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE = "2026-07-03"
ABNORMAL_TRADING_NEXT_SLICE_QUERY_MODE = "single_day_paged"
ABNORMAL_TRADING_NEXT_SLICE_ENDPOINT = (
    "https://www.cninfo.com.cn/data/statis/getMarketStatisticsData"
)
ABNORMAL_TRADING_NEXT_SLICE_RECORDS_PATH = "marketList"
ABNORMAL_TRADING_NEXT_SLICE_PER_CASE_MAX_REQUESTS = 1
ABNORMAL_TRADING_NEXT_SLICE_TOTAL_MAX_REQUESTS = 5
ABNORMAL_TRADING_NEXT_SLICE_PLANNED_SHARED_REQUESTS = 1
ABNORMAL_TRADING_NEXT_SLICE_SHARED_PROBE_KEY = "single_day_paged_2026-07-02"
ABNORMAL_TRADING_NEXT_SLICE_CASE_FIXTURES: Dict[str, Tuple[str, ...]] = {
...
ABNORMAL_TRADING_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS: Tuple[str, ...] = (
    "exclude_688671",
    "exclude_301259",
...
ABNORMAL_TRADING_NEXT_SLICE_APPROVAL_REQUIRED = (
    "approve_d_class_abnormal_trading_next_slice_required"
)
ABNORMAL_TRADING_NEXT_SLICE_WRONG_APPROVAL_FLAG = (
    "wrong_approval_flag_for_abnormal_trading_next_slice"
)
ABNORMAL_TRADING_NEXT_SLICE_MIXED_MODE_BLOCKED = (
    "abnormal_trading_next_slice_incompatible_with_other_modes"
)
ABNORMAL_TRADING_NEXT_SLICE_UNIVERSE_CSV_REQUIRED = (
    "abnormal_trading_next_slice_requires_explicit_universe_csv"
)
ABNORMAL_TRADING_NEXT_SLICE_OUTPUT_ROOT_REQUIRED = (
    "abnormal_trading_next_slice_output_root_must_be_cninfo_d_class_abnormal_trading_next_slice"
)
ABNORMAL_TRADING_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v1_output_root_write_blocked_for_abnormal_trading_next_slice"
)
ABNORMAL_TRADING_NEXT_SLICE_V2_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v2_output_root_write_blocked_for_abnormal_trading_next_slice"
)
ABNORMAL_TRADING_NEXT_SLICE_REPLACEMENT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "replacement_output_root_write_blocked_for_abnormal_trading_next_slice"
)
ABNORMAL_TRADING_NEXT_SLICE_TARGETED_PROBE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "targeted_probe_output_root_write_blocked_for_abnormal_trading_next_slice"
)
ABNORMAL_TRADING_NEXT_SLICE_EXECUTIVE_SHAREHOLDING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "executive_shareholding_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_SHAREHOLDER_CHANGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_change_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_EQUITY_PLEDGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "equity_pledge_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_MARGIN_OUTPUT_ROOT_WRITE_BLOCKED = (
    "margin_trading_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_DISCLOSURE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "disclosure_schedule_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_BLOCK_TRADE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "block_trade_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_RSU_OUTPUT_ROOT_WRITE_BLOCKED = (
    "restricted_shares_unlock_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_FIRST_SLICE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_SHAREHOLDER_DATA_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_FUND_INDUSTRY_ALLOCATION_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_first_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_FUND_INDUSTRY_ALLOCATION_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_next_slice_output_root_write_blocked"
)
ABNORMAL_TRADING_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH = (
    "abnormal_trading_next_slice_universe_size_must_equal_5"
)
ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_CASE_ID = (
    "forbidden_case_id_in_abnormal_trading_next_slice_universe"
)
ABNORMAL_TRADING_NEXT_SLICE_WRONG_COMPONENT = (
    "abnormal_trading_next_slice_component_must_be_abnormal_trading"
)
ABNORMAL_TRADING_NEXT_SLICE_INCLUDE_REQUIRED = "next_slice_include_must_be_yes"
ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_COMPANY_CODE = (
    "forbidden_company_code_in_abnormal_trading_next_slice_universe"
)
ABNORMAL_TRADING_NEXT_SLICE_WRONG_COMPANY_CODE = (
    "abnormal_trading_next_slice_company_code_mismatch"
)
ABNORMAL_TRADING_NEXT_SLICE_WRONG_ANCHOR_TDATE = (
    "abnormal_trading_next_slice_anchor_tdate_mismatch"
)
ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_ANCHOR = (
    "abnormal_trading_next_slice_forbidden_anchor_tdate_20260703"
)
ABNORMAL_TRADING_NEXT_SLICE_WRONG_QUERY_MODE = (
    "abnormal_trading_next_slice_query_mode_mismatch"
)
ABNORMAL_TRADING_NEXT_SLICE_PER_CASE_CAP_EXCEEDED = (
    "abnormal_trading_next_slice_per_case_request_cap_exceeded"
)
ABNORMAL_TRADING_NEXT_SLICE_TOTAL_CAP_EXCEEDED = (
    "abnormal_trading_next_slice_total_request_cap_exceeded"
)
ABNORMAL_TRADING_NEXT_SLICE_SHARED_PLAN_MISMATCH = (
    "abnormal_trading_next_slice_shared_plan_must_equal_1"
)
ABNORMAL_TRADING_NEXT_SLICE_FIXTURE_MISSING = (
    "abnormal_trading_next_slice_tier1_fixture_missing"
)
ABNORMAL_TRADING_NEXT_SLICE_SHARED_REQUEST_REQUIRED = (
    "abnormal_trading_next_slice_shared_request_required"
)
ABNORMAL_TRADING_NEXT_SLICE_EXCLUDE_FLAG_MISSING = (
    "abnormal_trading_next_slice_exclude_flag_missing"
)

ABNORMAL_TRADING_NEXT_SLICE_DRYRUN_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
ABNORMAL_TRADING_NEXT_SLICE_LIVE_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
ABNORMAL_TRADING_NEXT_SLICE_QUALITY_REPORT_COLUMNS = [
    "case_id",
    "component",
    "query_mode",
    "anchor_tdate",
...
DEFAULT_SHAREHOLDER_DATA_NEXT_SLICE_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_shareholder_data_next_slice",
)
DEFAULT_SHAREHOLDER_DATA_NEXT_SLICE_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_shareholder_data_next_slice_universe_lock_20260715.csv",
)
SHAREHOLDER_DATA_NEXT_SLICE_FIXTURE_DIR = os.path.join(
    BASE_DIR,
    "fixtures",
    "d_class",
    "shareholder_data_next_slice",
)
SHAREHOLDER_DATA_NEXT_SLICE_DRYRUN_REPORT_CSV = os.path.join(
    DEFAULT_SHAREHOLDER_DATA_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_shareholder_data_next_slice_dryrun_report.csv",
)
SHAREHOLDER_DATA_NEXT_SLICE_DRYRUN_SUMMARY_MD = os.path.join(
    DEFAULT_SHAREHOLDER_DATA_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_shareholder_data_next_slice_dryrun_summary.md",
)

SHAREHOLDER_DATA_NEXT_SLICE_RUNNER_GATE = "READY_FOR_APPROVAL"
SHAREHOLDER_DATA_NEXT_SLICE_LIVE_PATH_GATE = "READY_FOR_APPROVAL"
SHAREHOLDER_DATA_NEXT_SLICE_LIVE_GATE = "NOT_APPROVED"
SHAREHOLDER_DATA_NEXT_SLICE_EXECUTION_GATE_PASS = "PASS_WITH_CAVEAT"
SHAREHOLDER_DATA_NEXT_SLICE_EXECUTION_GATE_FAIL = "FAIL_REVIEW_REQUIRED"
SHAREHOLDER_DATA_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE = 5
SHAREHOLDER_DATA_NEXT_SLICE_ALLOWED_CASE_IDS: Set[str] = {
    "DSD101",
    "DSD102",
    "DSD103",
    "DSD104",
...
SHAREHOLDER_DATA_NEXT_SLICE_EXPECTED_COMPANY_CODES: Dict[str, str] = {
    "DSD101": "000001",
    "DSD102": "000895",
    "DSD103": "600519",
    "DSD104": "002415",
...
SHAREHOLDER_DATA_NEXT_SLICE_EXPECTED_ANCHOR_RDATES: Dict[str, str] = {
    "DSD101": "20260331",
    "DSD102": "20260331",
    "DSD103": "20260331",
    "DSD104": "20251231",
...
SHAREHOLDER_DATA_NEXT_SLICE_FORBIDDEN_COMPANY_CODES: Set[str] = {
    "688671",
    "301259",
}
SHAREHOLDER_DATA_NEXT_SLICE_COMPONENT = "shareholder_data"
SHAREHOLDER_DATA_NEXT_SLICE_ALLOWED_RDATES: Set[str] = {"20260331", "20251231"}
SHAREHOLDER_DATA_NEXT_SLICE_QUERY_MODE = "rdate_report_period"
SHAREHOLDER_DATA_NEXT_SLICE_ENDPOINT = (
    "https://www.cninfo.com.cn/data20/shareholeder/data"
)
SHAREHOLDER_DATA_NEXT_SLICE_RECORDS_PATH = "data.records"
SHAREHOLDER_DATA_NEXT_SLICE_PER_CASE_MAX_REQUESTS = 1
SHAREHOLDER_DATA_NEXT_SLICE_TOTAL_MAX_REQUESTS = 5
SHAREHOLDER_DATA_NEXT_SLICE_PLANNED_SHARED_REQUESTS = 2
SHAREHOLDER_DATA_NEXT_SLICE_SHARED_PROBE_KEYS: Tuple[str, ...] = (
    "rdate_report_period_20260331",
    "rdate_report_period_20251231",
)
SHAREHOLDER_DATA_NEXT_SLICE_CASE_FIXTURES: Dict[str, Tuple[str, ...]] = {
...
SHAREHOLDER_DATA_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS: Tuple[str, ...] = (
    "exclude_688671",
    "exclude_301259",
    "exclude_first_slice_mutate",
    "allow_multi_rdate_next_slice_only",
)

SHAREHOLDER_DATA_NEXT_SLICE_APPROVAL_REQUIRED = (
    "approve_d_class_shareholder_data_next_slice_required"
)
SHAREHOLDER_DATA_NEXT_SLICE_WRONG_APPROVAL_FLAG = (
    "wrong_approval_flag_for_shareholder_data_next_slice"
)
SHAREHOLDER_DATA_NEXT_SLICE_MIXED_MODE_BLOCKED = (
    "shareholder_data_next_slice_incompatible_with_other_modes"
)
SHAREHOLDER_DATA_NEXT_SLICE_UNIVERSE_CSV_REQUIRED = (
    "shareholder_data_next_slice_requires_explicit_universe_csv"
)
SHAREHOLDER_DATA_NEXT_SLICE_OUTPUT_ROOT_REQUIRED = (
    "shareholder_data_next_slice_output_root_must_be_cninfo_d_class_shareholder_data_next_slice"
)
SHAREHOLDER_DATA_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v1_output_root_write_blocked_for_shareholder_data_next_slice"
)
SHAREHOLDER_DATA_NEXT_SLICE_V2_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v2_output_root_write_blocked_for_shareholder_data_next_slice"
)
SHAREHOLDER_DATA_NEXT_SLICE_REPLACEMENT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "replacement_output_root_write_blocked_for_shareholder_data_next_slice"
)
SHAREHOLDER_DATA_NEXT_SLICE_TARGETED_PROBE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "targeted_probe_output_root_write_blocked_for_shareholder_data_next_slice"
)
SHAREHOLDER_DATA_NEXT_SLICE_EXECUTIVE_SHAREHOLDING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "executive_shareholding_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_SHAREHOLDER_CHANGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_change_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_EQUITY_PLEDGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "equity_pledge_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_MARGIN_OUTPUT_ROOT_WRITE_BLOCKED = (
    "margin_trading_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_DISCLOSURE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "disclosure_schedule_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_BLOCK_TRADE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "block_trade_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_RSU_OUTPUT_ROOT_WRITE_BLOCKED = (
    "restricted_shares_unlock_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_ABNORMAL_TRADING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_ABNORMAL_TRADING_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_next_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_FIRST_SLICE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_FUND_INDUSTRY_ALLOCATION_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_first_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_FUND_INDUSTRY_ALLOCATION_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_next_slice_output_root_write_blocked"
)
SHAREHOLDER_DATA_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH = (
    "shareholder_data_next_slice_universe_size_must_equal_5"
)
SHAREHOLDER_DATA_NEXT_SLICE_FORBIDDEN_CASE_ID = (
    "forbidden_case_id_in_shareholder_data_next_slice_universe"
)
SHAREHOLDER_DATA_NEXT_SLICE_WRONG_COMPONENT = (
    "shareholder_data_next_slice_component_must_be_shareholder_data"
)
SHAREHOLDER_DATA_NEXT_SLICE_INCLUDE_REQUIRED = "next_slice_include_must_be_yes"
SHAREHOLDER_DATA_NEXT_SLICE_FORBIDDEN_COMPANY_CODE = (
    "forbidden_company_code_in_shareholder_data_next_slice_universe"
)
SHAREHOLDER_DATA_NEXT_SLICE_WRONG_COMPANY_CODE = (
    "shareholder_data_next_slice_company_code_mismatch"
)
SHAREHOLDER_DATA_NEXT_SLICE_WRONG_ANCHOR_RDATE = (
    "shareholder_data_next_slice_anchor_rdate_mismatch"
)
SHAREHOLDER_DATA_NEXT_SLICE_FORBIDDEN_ANCHOR_RDATE = (
    "shareholder_data_next_slice_anchor_rdate_not_in_allowed_set"
)
SHAREHOLDER_DATA_NEXT_SLICE_WRONG_QUERY_MODE = (
    "shareholder_data_next_slice_query_mode_mismatch"
)
SHAREHOLDER_DATA_NEXT_SLICE_PER_CASE_CAP_EXCEEDED = (
    "shareholder_data_next_slice_per_case_request_cap_exceeded"
)
SHAREHOLDER_DATA_NEXT_SLICE_TOTAL_CAP_EXCEEDED = (
    "shareholder_data_next_slice_total_request_cap_exceeded"
)
SHAREHOLDER_DATA_NEXT_SLICE_SHARED_PLAN_MISMATCH = (
    "shareholder_data_next_slice_shared_plan_must_equal_2"
)
SHAREHOLDER_DATA_NEXT_SLICE_FIXTURE_MISSING = (
    "shareholder_data_next_slice_tier1_fixture_missing"
)
SHAREHOLDER_DATA_NEXT_SLICE_SHARED_REQUEST_REQUIRED = (
    "shareholder_data_next_slice_shared_request_required"
)
SHAREHOLDER_DATA_NEXT_SLICE_EXCLUDE_FLAG_MISSING = (
    "shareholder_data_next_slice_exclude_flag_missing"
)

SHAREHOLDER_DATA_NEXT_SLICE_DRYRUN_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
SHAREHOLDER_DATA_NEXT_SLICE_LIVE_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
SHAREHOLDER_DATA_NEXT_SLICE_QUALITY_REPORT_COLUMNS = [
    "case_id",
    "component",
    "anchor_rdate",
    "expected_behavior",
...
# ---------------------------------------------------------------------------
# fund_industry_allocation next-slice（DFIA101–DFIA105 · D-FM-25）
# ---------------------------------------------------------------------------

DEFAULT_FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_fund_industry_allocation_next_slice",
)
DEFAULT_FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_fund_industry_allocation_next_slice_universe_lock_20260715.csv",
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FIXTURE_DIR = os.path.join(
    BASE_DIR,
    "fixtures",
    "d_class",
    "fund_industry_allocation_next_slice",
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_DRYRUN_REPORT_CSV = os.path.join(
    DEFAULT_FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_fund_industry_allocation_next_slice_dryrun_report.csv",
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_DRYRUN_SUMMARY_MD = os.path.join(
    DEFAULT_FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_fund_industry_allocation_next_slice_dryrun_summary.md",
)

FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_RUNNER_GATE = "READY_FOR_APPROVAL"
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_PATH_GATE = "READY_FOR_APPROVAL"
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_GATE = "NOT_APPROVED"
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXECUTION_GATE_PASS = "PASS_WITH_CAVEAT"
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXECUTION_GATE_FAIL = "FAIL_REVIEW_REQUIRED"
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE = 5
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_ALLOWED_CASE_IDS: Set[str] = {
    "DFIA101",
    "DFIA102",
    "DFIA103",
    "DFIA104",
...
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXPECTED_INDUSTRY_CODES: Dict[str, str] = {
    "DFIA101": "A",
    "DFIA102": "C",
    "DFIA103": "*",
    "DFIA104": "B",
...
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXPECTED_QUERY_MODES: Dict[str, str] = {
    "DFIA101": "default",
    "DFIA102": "default",
    "DFIA103": "rdate",
    "DFIA104": "rdate",
...
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXPECTED_ANCHOR_RDATES: Dict[str, str] = {
    "DFIA101": "",
    "DFIA102": "",
    "DFIA103": "20260331",
    "DFIA104": "20260331",
...
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FORBIDDEN_COMPANY_CODES: Set[str] = {
    "688671",
    "301259",
}
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_COMPONENT = "fund_industry_allocation"
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_ENDPOINT = (
    "https://www.cninfo.com.cn/data20/fund/industry"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_RECORDS_PATH = "data.records"
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PER_CASE_MAX_REQUESTS = 1
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_TOTAL_MAX_REQUESTS = 5
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PLANNED_SHARED_REQUESTS = 3
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_PROBE_KEYS: Tuple[str, ...] = (
    "default",
    "rdate_20260331",
    "rdate_20251231",
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_CASE_FIXTURES: Dict[str, Tuple[str, ...]] = {
    "DFIA101": (
        "DFIA101_found.json",
...
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS: Tuple[str, ...] = (
    "no_company_code",
    "exclude_company_event_schema",
    "exclude_688671",
    "exclude_301259",
    "exclude_first_slice_C26_sole_anchor",
)

FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_APPROVAL_REQUIRED = (
    "approve_d_class_fund_industry_allocation_next_slice_required"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_APPROVAL_FLAG = (
    "wrong_approval_flag_for_fund_industry_allocation_next_slice"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_MIXED_MODE_BLOCKED = (
    "fund_industry_allocation_next_slice_incompatible_with_other_modes"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_UNIVERSE_CSV_REQUIRED = (
    "fund_industry_allocation_next_slice_requires_explicit_universe_csv"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_OUTPUT_ROOT_REQUIRED = (
    "fund_industry_allocation_next_slice_output_root_must_be_cninfo_d_class_fund_industry_allocation_next_slice"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v1_output_root_write_blocked_for_fund_industry_allocation_next_slice"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_V2_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v2_output_root_write_blocked_for_fund_industry_allocation_next_slice"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_REPLACEMENT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "replacement_output_root_write_blocked_for_fund_industry_allocation_next_slice"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_TARGETED_PROBE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "targeted_probe_output_root_write_blocked_for_fund_industry_allocation_next_slice"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXECUTIVE_SHAREHOLDING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "executive_shareholding_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHAREHOLDER_CHANGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_change_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EQUITY_PLEDGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "equity_pledge_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_MARGIN_OUTPUT_ROOT_WRITE_BLOCKED = (
    "margin_trading_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_DISCLOSURE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "disclosure_schedule_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_BLOCK_TRADE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "block_trade_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_RSU_OUTPUT_ROOT_WRITE_BLOCKED = (
    "restricted_shares_unlock_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_ABNORMAL_TRADING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHAREHOLDER_DATA_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FIRST_SLICE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH = (
    "fund_industry_allocation_next_slice_universe_size_must_equal_5"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FORBIDDEN_CASE_ID = (
    "forbidden_case_id_in_fund_industry_allocation_next_slice_universe"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_COMPONENT = (
    "fund_industry_allocation_next_slice_component_must_be_fund_industry_allocation"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_INCLUDE_REQUIRED = "next_slice_include_must_be_yes"
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FORBIDDEN_COMPANY_CODE = (
    "forbidden_company_code_in_fund_industry_allocation_next_slice_universe"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_INDUSTRY_CODE = (
    "fund_industry_allocation_next_slice_industry_code_mismatch"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_QUERY_MODE = (
    "fund_industry_allocation_next_slice_query_mode_mismatch"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_ANCHOR_RDATE = (
    "fund_industry_allocation_next_slice_anchor_rdate_mismatch"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PER_CASE_CAP_EXCEEDED = (
    "fund_industry_allocation_next_slice_per_case_request_cap_exceeded"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_TOTAL_CAP_EXCEEDED = (
    "fund_industry_allocation_next_slice_total_request_cap_exceeded"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_PLAN_MISMATCH = (
    "fund_industry_allocation_next_slice_shared_plan_must_equal_3"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FIXTURE_MISSING = (
    "fund_industry_allocation_next_slice_tier1_fixture_missing"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_REQUEST_REQUIRED = (
    "fund_industry_allocation_next_slice_shared_request_required"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_COMPANY_CODE_FORBIDDEN = (
    "fund_industry_allocation_next_slice_company_code_field_forbidden"
)
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXCLUDE_FLAG_MISSING = (
    "fund_industry_allocation_next_slice_exclude_flag_missing"
)

FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_DRYRUN_REPORT_COLUMNS = [
    "case_id",
    "industry_code",
    "industry_name",
    "component",
...
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_REPORT_COLUMNS = [
    "case_id",
    "industry_code",
    "industry_name",
    "component",
...
FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_QUALITY_REPORT_COLUMNS = [
    "case_id",
    "component",
    "query_mode",
    "anchor_rdate",
...
# fund_industry_allocation further-scale（DFIA201–DFIA205 · D-FM-39）
# ---------------------------------------------------------------------------

DEFAULT_FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_fund_industry_allocation_further_scale",
)
DEFAULT_FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_fund_industry_allocation_further_scale_universe_lock_20260715.csv",
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FIXTURE_DIR = os.path.join(
    BASE_DIR,
    "fixtures",
    "d_class",
    "fund_industry_allocation_further_scale",
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_DRYRUN_REPORT_CSV = os.path.join(
    DEFAULT_FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_OUTPUT_ROOT,
    "reports",
    "d_class_fund_industry_allocation_further_scale_dryrun_report.csv",
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_DRYRUN_SUMMARY_MD = os.path.join(
    DEFAULT_FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_OUTPUT_ROOT,
    "reports",
    "d_class_fund_industry_allocation_further_scale_dryrun_summary.md",
)

FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_RUNNER_GATE = "READY_FOR_APPROVAL"
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_PATH_GATE = "READY_FOR_APPROVAL"
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_GATE = "NOT_APPROVED"
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXECUTION_GATE_PASS = "PASS_WITH_CAVEAT"
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXECUTION_GATE_FAIL = "FAIL_REVIEW_REQUIRED"
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXPECTED_UNIVERSE_SIZE = 5
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_ALLOWED_CASE_IDS: Set[str] = {
    "DFIA201",
    "DFIA202",
    "DFIA203",
    "DFIA204",
...
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXPECTED_INDUSTRY_CODES: Dict[str, str] = {
    "DFIA201": "B",
    "DFIA202": "A",
    "DFIA203": "*",
    "DFIA204": "A",
...
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXPECTED_QUERY_MODES: Dict[str, str] = {
    "DFIA201": "default",
    "DFIA202": "rdate",
    "DFIA203": "rdate",
    "DFIA204": "rdate",
...
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXPECTED_ANCHOR_RDATES: Dict[str, str] = {
    "DFIA201": "",
    "DFIA202": "20260331",
    "DFIA203": "20251231",
    "DFIA204": "20251231",
...
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FORBIDDEN_COMPANY_CODES: Set[str] = {
    "688671",
    "301259",
}
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_COMPONENT = "fund_industry_allocation"
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_ENDPOINT = (
    "https://www.cninfo.com.cn/data20/fund/industry"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_RECORDS_PATH = "data.records"
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PER_CASE_MAX_REQUESTS = 1
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_TOTAL_MAX_REQUESTS = 5
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PLANNED_SHARED_REQUESTS = 3
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_PROBE_KEYS: Tuple[str, ...] = (
    "default",
    "rdate_20260331",
    "rdate_20251231",
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_CASE_FIXTURES: Dict[str, Tuple[str, ...]] = {
    "DFIA201": (
        "DFIA201_found.json",
...
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_REQUIRED_EXCLUDE_FLAGS: Tuple[str, ...] = (
    "no_company_code",
    "exclude_company_event_schema",
    "exclude_688671",
    "exclude_301259",
    "exclude_first_slice_C26_sole_anchor",
    "exclude_mutate_next_slice_DFIA101_105",
    "exclude_mutate_at_sd_next_slice_dryrun",
)

FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_APPROVAL_REQUIRED = (
    "approve_d_class_fund_industry_allocation_further_scale_required"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_APPROVAL_FLAG = (
    "wrong_approval_flag_for_fund_industry_allocation_further_scale"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_MIXED_MODE_BLOCKED = (
    "fund_industry_allocation_further_scale_incompatible_with_other_modes"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_UNIVERSE_CSV_REQUIRED = (
    "fund_industry_allocation_further_scale_requires_explicit_universe_csv"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_OUTPUT_ROOT_REQUIRED = (
    "fund_industry_allocation_further_scale_output_root_must_be_cninfo_d_class_fund_industry_allocation_further_scale"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_V1_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v1_output_root_write_blocked_for_fund_industry_allocation_further_scale"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_V2_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v2_output_root_write_blocked_for_fund_industry_allocation_further_scale"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_REPLACEMENT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "replacement_output_root_write_blocked_for_fund_industry_allocation_further_scale"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_TARGETED_PROBE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "targeted_probe_output_root_write_blocked_for_fund_industry_allocation_further_scale"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXECUTIVE_SHAREHOLDING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "executive_shareholding_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHAREHOLDER_CHANGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_change_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EQUITY_PLEDGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "equity_pledge_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_MARGIN_OUTPUT_ROOT_WRITE_BLOCKED = (
    "margin_trading_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_DISCLOSURE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "disclosure_schedule_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_BLOCK_TRADE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "block_trade_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_RSU_OUTPUT_ROOT_WRITE_BLOCKED = (
    "restricted_shares_unlock_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_ABNORMAL_TRADING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHAREHOLDER_DATA_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FIRST_SLICE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_first_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_NEXT_SLICE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_next_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_AT_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_next_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SD_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_next_slice_output_root_write_blocked"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_UNIVERSE_SIZE_MISMATCH = (
    "fund_industry_allocation_further_scale_universe_size_must_equal_5"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FORBIDDEN_CASE_ID = (
    "forbidden_case_id_in_fund_industry_allocation_further_scale_universe"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_COMPONENT = (
    "fund_industry_allocation_further_scale_component_must_be_fund_industry_allocation"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_INCLUDE_REQUIRED = "further_scale_include_must_be_yes"
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FORBIDDEN_COMPANY_CODE = (
    "forbidden_company_code_in_fund_industry_allocation_further_scale_universe"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_INDUSTRY_CODE = (
    "fund_industry_allocation_further_scale_industry_code_mismatch"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_QUERY_MODE = (
    "fund_industry_allocation_further_scale_query_mode_mismatch"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_ANCHOR_RDATE = (
    "fund_industry_allocation_further_scale_anchor_rdate_mismatch"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PER_CASE_CAP_EXCEEDED = (
    "fund_industry_allocation_further_scale_per_case_request_cap_exceeded"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_TOTAL_CAP_EXCEEDED = (
    "fund_industry_allocation_further_scale_total_request_cap_exceeded"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_PLAN_MISMATCH = (
    "fund_industry_allocation_further_scale_shared_plan_must_equal_3"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FIXTURE_MISSING = (
    "fund_industry_allocation_further_scale_tier1_fixture_missing"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_REQUEST_REQUIRED = (
    "fund_industry_allocation_further_scale_shared_request_required"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_COMPANY_CODE_FORBIDDEN = (
    "fund_industry_allocation_further_scale_company_code_field_forbidden"
)
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXCLUDE_FLAG_MISSING = (
    "fund_industry_allocation_further_scale_exclude_flag_missing"
)

FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_DRYRUN_REPORT_COLUMNS = [
    "case_id",
    "industry_code",
    "industry_name",
    "component",
...
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_REPORT_COLUMNS = [
    "case_id",
    "industry_code",
    "industry_name",
    "component",
...
FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_QUALITY_REPORT_COLUMNS = [
    "case_id",
    "component",
    "query_mode",
    "anchor_rdate",
...
# equity_pledge next-slice（DEP101–DEP105 · D-FM-43）
DEFAULT_EQUITY_PLEDGE_NEXT_SLICE_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_equity_pledge_next_slice",
)
DEFAULT_EQUITY_PLEDGE_NEXT_SLICE_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_equity_pledge_next_slice_universe_lock_20260715.csv",
)
EQUITY_PLEDGE_NEXT_SLICE_FIXTURE_DIR = os.path.join(
    BASE_DIR,
    "fixtures",
    "d_class",
    "equity_pledge_next_slice",
)
EQUITY_PLEDGE_NEXT_SLICE_DRYRUN_REPORT_CSV = os.path.join(
    DEFAULT_EQUITY_PLEDGE_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_equity_pledge_next_slice_dryrun_report.csv",
)
EQUITY_PLEDGE_NEXT_SLICE_DRYRUN_SUMMARY_MD = os.path.join(
    DEFAULT_EQUITY_PLEDGE_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_equity_pledge_next_slice_dryrun_summary.md",
)

EQUITY_PLEDGE_NEXT_SLICE_RUNNER_GATE = "READY_FOR_APPROVAL"
EQUITY_PLEDGE_NEXT_SLICE_LIVE_PATH_GATE = "READY_FOR_APPROVAL"
EQUITY_PLEDGE_NEXT_SLICE_LIVE_GATE = "NOT_APPROVED"
EQUITY_PLEDGE_NEXT_SLICE_EXECUTION_GATE_PASS = "PASS_WITH_CAVEAT"
EQUITY_PLEDGE_NEXT_SLICE_EXECUTION_GATE_FAIL = "FAIL_REVIEW_REQUIRED"
EQUITY_PLEDGE_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE = 5
EQUITY_PLEDGE_NEXT_SLICE_ALLOWED_CASE_IDS: Set[str] = {
    "DEP101",
    "DEP102",
    "DEP103",
    "DEP104",
...
EQUITY_PLEDGE_NEXT_SLICE_EXPECTED_COMPANY_CODES: Dict[str, str] = {
    "DEP101": "000001",
    "DEP102": "000895",
    "DEP103": "600000",
    "DEP104": "002415",
...
EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_COMPANY_CODES: Set[str] = {
    "688671",
    "301259",
}
EQUITY_PLEDGE_NEXT_SLICE_COMPONENT = "equity_pledge"
EQUITY_PLEDGE_NEXT_SLICE_ANCHOR_TDATE = "2026-07-02"
EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE = "2026-07-03"
EQUITY_PLEDGE_NEXT_SLICE_QUERY_MODE = "tdate_daily"
EQUITY_PLEDGE_NEXT_SLICE_ENDPOINT = (
    "https://www.cninfo.com.cn/data20/equityPledge/list"
)
EQUITY_PLEDGE_NEXT_SLICE_RECORDS_PATH = "data.records"
EQUITY_PLEDGE_NEXT_SLICE_PER_CASE_MAX_REQUESTS = 1
EQUITY_PLEDGE_NEXT_SLICE_TOTAL_MAX_REQUESTS = 5
EQUITY_PLEDGE_NEXT_SLICE_PLANNED_SHARED_REQUESTS = 1
EQUITY_PLEDGE_NEXT_SLICE_SHARED_PROBE_KEY = "tdate_daily_2026-07-02"
EQUITY_PLEDGE_NEXT_SLICE_CASE_FIXTURES: Dict[str, Tuple[str, ...]] = {
...
EQUITY_PLEDGE_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS: Tuple[str, ...] = (
    "exclude_688671",
    "exclude_301259",
    "exclude_sparse_day_20260703_sole_found_anchor",
    "exclude_sole_needs_review",
    "exclude_first_slice_DEP001_005_mutate",
)

EQUITY_PLEDGE_NEXT_SLICE_APPROVAL_REQUIRED = (
    "approve_d_class_equity_pledge_next_slice_required"
)
EQUITY_PLEDGE_NEXT_SLICE_WRONG_APPROVAL_FLAG = (
    "wrong_approval_flag_for_equity_pledge_next_slice"
)
EQUITY_PLEDGE_NEXT_SLICE_MIXED_MODE_BLOCKED = (
    "equity_pledge_next_slice_incompatible_with_other_modes"
)
EQUITY_PLEDGE_NEXT_SLICE_UNIVERSE_CSV_REQUIRED = (
    "equity_pledge_next_slice_requires_explicit_universe_csv"
)
EQUITY_PLEDGE_NEXT_SLICE_OUTPUT_ROOT_REQUIRED = (
    "equity_pledge_next_slice_output_root_must_be_cninfo_d_class_equity_pledge_next_slice"
)
EQUITY_PLEDGE_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v1_output_root_write_blocked_for_equity_pledge_next_slice"
)
EQUITY_PLEDGE_NEXT_SLICE_V2_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v2_output_root_write_blocked_for_equity_pledge_next_slice"
)
EQUITY_PLEDGE_NEXT_SLICE_REPLACEMENT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "replacement_output_root_write_blocked_for_equity_pledge_next_slice"
)
EQUITY_PLEDGE_NEXT_SLICE_TARGETED_PROBE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "targeted_probe_output_root_write_blocked_for_equity_pledge_next_slice"
)
EQUITY_PLEDGE_NEXT_SLICE_EXECUTIVE_SHAREHOLDING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "executive_shareholding_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_SHAREHOLDER_CHANGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_change_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_EQUITY_PLEDGE_FIRST_OUTPUT_ROOT_WRITE_BLOCKED = (
    "equity_pledge_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_MARGIN_OUTPUT_ROOT_WRITE_BLOCKED = (
    "margin_trading_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_DISCLOSURE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "disclosure_schedule_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_BLOCK_TRADE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "block_trade_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_RSU_OUTPUT_ROOT_WRITE_BLOCKED = (
    "restricted_shares_unlock_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_ABNORMAL_TRADING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_SHAREHOLDER_DATA_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_FIA_FIRST_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_first_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_FIA_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_next_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_FIA_FURTHER_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_further_scale_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_AT_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_next_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_SD_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_next_slice_output_root_write_blocked"
)
EQUITY_PLEDGE_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH = (
    "equity_pledge_next_slice_universe_size_must_equal_5"
)
EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_CASE_ID = (
    "forbidden_case_id_in_equity_pledge_next_slice_universe"
)
EQUITY_PLEDGE_NEXT_SLICE_WRONG_COMPONENT = (
    "equity_pledge_next_slice_component_must_be_equity_pledge"
)
EQUITY_PLEDGE_NEXT_SLICE_INCLUDE_REQUIRED = "next_slice_include_must_be_yes"
EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_COMPANY_CODE = (
    "forbidden_company_code_in_equity_pledge_next_slice_universe"
)
EQUITY_PLEDGE_NEXT_SLICE_WRONG_COMPANY_CODE = (
    "equity_pledge_next_slice_company_code_mismatch"
)
EQUITY_PLEDGE_NEXT_SLICE_WRONG_ANCHOR_TDATE = (
    "equity_pledge_next_slice_anchor_tdate_mismatch"
)
EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_ANCHOR = (
    "equity_pledge_next_slice_forbidden_anchor_tdate_20260703"
)
EQUITY_PLEDGE_NEXT_SLICE_WRONG_QUERY_MODE = (
    "equity_pledge_next_slice_query_mode_mismatch"
)
EQUITY_PLEDGE_NEXT_SLICE_PER_CASE_CAP_EXCEEDED = (
    "equity_pledge_next_slice_per_case_request_cap_exceeded"
)
EQUITY_PLEDGE_NEXT_SLICE_TOTAL_CAP_EXCEEDED = (
    "equity_pledge_next_slice_total_request_cap_exceeded"
)
EQUITY_PLEDGE_NEXT_SLICE_SHARED_PLAN_MISMATCH = (
    "equity_pledge_next_slice_shared_plan_must_equal_1"
)
EQUITY_PLEDGE_NEXT_SLICE_FIXTURE_MISSING = (
    "equity_pledge_next_slice_tier1_fixture_missing"
)
EQUITY_PLEDGE_NEXT_SLICE_SHARED_REQUEST_REQUIRED = (
    "equity_pledge_next_slice_shared_request_required"
)
EQUITY_PLEDGE_NEXT_SLICE_EXCLUDE_FLAG_MISSING = (
    "equity_pledge_next_slice_exclude_flag_missing"
)

EQUITY_PLEDGE_NEXT_SLICE_DRYRUN_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
EQUITY_PLEDGE_NEXT_SLICE_LIVE_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
EQUITY_PLEDGE_NEXT_SLICE_QUALITY_REPORT_COLUMNS = [
    "case_id",
    "component",
    "query_mode",
    "anchor_tdate",
...
# restricted_shares_unlock next-slice（DRU101–DRU105 · D-FM-47）
DEFAULT_RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_restricted_shares_unlock_next_slice",
)
DEFAULT_RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_restricted_shares_unlock_next_slice_universe_lock_20260715.csv",
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FIXTURE_DIR = os.path.join(
    BASE_DIR,
    "fixtures",
    "d_class",
    "restricted_shares_unlock_next_slice",
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_DRYRUN_REPORT_CSV = os.path.join(
    DEFAULT_RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_restricted_shares_unlock_next_slice_dryrun_report.csv",
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_DRYRUN_SUMMARY_MD = os.path.join(
    DEFAULT_RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_restricted_shares_unlock_next_slice_dryrun_summary.md",
)

RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_RUNNER_GATE = "READY_FOR_APPROVAL"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_PATH_GATE = "READY_FOR_APPROVAL"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_GATE = "NOT_APPROVED"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXECUTION_GATE_PASS = "PASS_WITH_CAVEAT"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXECUTION_GATE_FAIL = "FAIL_REVIEW_REQUIRED"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE = 5
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ALLOWED_CASE_IDS: Set[str] = {
    "DRU101",
    "DRU102",
    "DRU103",
    "DRU104",
...
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXPECTED_COMPANY_CODES: Dict[str, str] = {
    "DRU101": "300992",
    "DRU102": "000895",
    "DRU103": "600000",
    "DRU104": "002415",
...
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_COMPANY_CODES: Set[str] = {
    "688671",
    "301259",
}
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_COMPONENT = "restricted_shares_unlock"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ANCHOR_TDATE = "2026-07-03"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE = "2026-06-08"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_QUERY_MODE = "tdate_daily"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ENDPOINT = (
    "https://www.cninfo.com.cn/data20/liftBan/detail"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_RECORDS_PATH = "data.records"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PER_CASE_MAX_REQUESTS = 1
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_TOTAL_MAX_REQUESTS = 5
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PLANNED_SHARED_REQUESTS = 1
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PROBE_KEY = "tdate_daily_2026-07-03"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_CASE_FIXTURES: Dict[str, Tuple[str, ...]] = {
...
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS: Tuple[str, ...] = (
    "exclude_688671",
    "exclude_301259",
    "exclude_sparse_day_20260608_sole_found_anchor",
    "exclude_sole_needs_review",
    "exclude_first_slice_DRU001_005_mutate",
)

RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_APPROVAL_REQUIRED = (
    "approve_d_class_restricted_shares_unlock_next_slice_required"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_APPROVAL_FLAG = (
    "wrong_approval_flag_for_restricted_shares_unlock_next_slice"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_MIXED_MODE_BLOCKED = (
    "restricted_shares_unlock_next_slice_incompatible_with_other_modes"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_UNIVERSE_CSV_REQUIRED = (
    "restricted_shares_unlock_next_slice_requires_explicit_universe_csv"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_OUTPUT_ROOT_REQUIRED = (
    "restricted_shares_unlock_next_slice_output_root_must_be_cninfo_d_class_restricted_shares_unlock_next_slice"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v1_output_root_write_blocked_for_restricted_shares_unlock_next_slice"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_V2_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v2_output_root_write_blocked_for_restricted_shares_unlock_next_slice"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_REPLACEMENT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "replacement_output_root_write_blocked_for_restricted_shares_unlock_next_slice"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_TARGETED_PROBE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "targeted_probe_output_root_write_blocked_for_restricted_shares_unlock_next_slice"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXECUTIVE_SHAREHOLDING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "executive_shareholding_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHAREHOLDER_CHANGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_change_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EQUITY_PLEDGE_FIRST_OUTPUT_ROOT_WRITE_BLOCKED = (
    "equity_pledge_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_MARGIN_OUTPUT_ROOT_WRITE_BLOCKED = (
    "margin_trading_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_DISCLOSURE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "disclosure_schedule_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_BLOCK_TRADE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "block_trade_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_RSU_OUTPUT_ROOT_WRITE_BLOCKED = (
    "restricted_shares_unlock_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ABNORMAL_TRADING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHAREHOLDER_DATA_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FIA_FIRST_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_first_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FIA_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_next_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FIA_FURTHER_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_further_scale_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_AT_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_next_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SD_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_next_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EP_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "equity_pledge_next_slice_output_root_write_blocked"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH = (
    "restricted_shares_unlock_next_slice_universe_size_must_equal_5"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_CASE_ID = (
    "forbidden_case_id_in_restricted_shares_unlock_next_slice_universe"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_COMPONENT = (
    "restricted_shares_unlock_next_slice_component_must_be_restricted_shares_unlock"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_INCLUDE_REQUIRED = "next_slice_include_must_be_yes"
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_COMPANY_CODE = (
    "forbidden_company_code_in_restricted_shares_unlock_next_slice_universe"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_COMPANY_CODE = (
    "restricted_shares_unlock_next_slice_company_code_mismatch"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_ANCHOR_TDATE = (
    "restricted_shares_unlock_next_slice_anchor_tdate_mismatch"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_ANCHOR = (
    "restricted_shares_unlock_next_slice_forbidden_anchor_tdate_20260608"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_QUERY_MODE = (
    "restricted_shares_unlock_next_slice_query_mode_mismatch"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PER_CASE_CAP_EXCEEDED = (
    "restricted_shares_unlock_next_slice_per_case_request_cap_exceeded"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_TOTAL_CAP_EXCEEDED = (
    "restricted_shares_unlock_next_slice_total_request_cap_exceeded"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PLAN_MISMATCH = (
    "restricted_shares_unlock_next_slice_shared_plan_must_equal_1"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FIXTURE_MISSING = (
    "restricted_shares_unlock_next_slice_tier1_fixture_missing"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_REQUEST_REQUIRED = (
    "restricted_shares_unlock_next_slice_shared_request_required"
)
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXCLUDE_FLAG_MISSING = (
    "restricted_shares_unlock_next_slice_exclude_flag_missing"
)

RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_DRYRUN_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_QUALITY_REPORT_COLUMNS = [
    "case_id",
    "component",
    "query_mode",
    "anchor_tdate",
...
# shareholder_change next-slice（DSC101–DSC105 · D-FM-51）
DEFAULT_SHAREHOLDER_CHANGE_NEXT_SLICE_OUTPUT_ROOT = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_shareholder_change_next_slice",
)
DEFAULT_SHAREHOLDER_CHANGE_NEXT_SLICE_UNIVERSE_CSV = os.path.join(
    BASE_DIR,
    "outputs",
    "validation",
    "cninfo_d_class_shareholder_change_next_slice_universe_lock_20260716.csv",
)
SHAREHOLDER_CHANGE_NEXT_SLICE_FIXTURE_DIR = os.path.join(
    BASE_DIR,
    "fixtures",
    "d_class",
    "shareholder_change_next_slice",
)
SHAREHOLDER_CHANGE_NEXT_SLICE_DRYRUN_REPORT_CSV = os.path.join(
    DEFAULT_SHAREHOLDER_CHANGE_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_shareholder_change_next_slice_dryrun_report.csv",
)
SHAREHOLDER_CHANGE_NEXT_SLICE_DRYRUN_SUMMARY_MD = os.path.join(
    DEFAULT_SHAREHOLDER_CHANGE_NEXT_SLICE_OUTPUT_ROOT,
    "reports",
    "d_class_shareholder_change_next_slice_dryrun_summary.md",
)

SHAREHOLDER_CHANGE_NEXT_SLICE_RUNNER_GATE = "READY_FOR_APPROVAL"
SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_PATH_GATE = "READY_FOR_APPROVAL"
SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_GATE = "NOT_APPROVED"
SHAREHOLDER_CHANGE_NEXT_SLICE_EXECUTION_GATE_PASS = "PASS_WITH_CAVEAT"
SHAREHOLDER_CHANGE_NEXT_SLICE_EXECUTION_GATE_FAIL = "FAIL_REVIEW_REQUIRED"
SHAREHOLDER_CHANGE_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE = 5
SHAREHOLDER_CHANGE_NEXT_SLICE_ALLOWED_CASE_IDS: Set[str] = {
    "DSC101",
    "DSC102",
    "DSC103",
    "DSC104",
...
SHAREHOLDER_CHANGE_NEXT_SLICE_EXPECTED_COMPANY_CODES: Dict[str, str] = {
    "DSC101": "000550",
    "DSC102": "000895",
    "DSC103": "600000",
    "DSC104": "002415",
...
SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_COMPANY_CODES: Set[str] = {
    "688671",
    "301259",
}
SHAREHOLDER_CHANGE_NEXT_SLICE_COMPONENT = "shareholder_change"
SHAREHOLDER_CHANGE_NEXT_SLICE_ANCHOR_TDATE = "2026-07-03"
SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_QUERY_TYPE = "inc"
SHAREHOLDER_CHANGE_NEXT_SLICE_QUERY_TYPE = "desc"
SHAREHOLDER_CHANGE_NEXT_SLICE_QUERY_MODE = "type_desc_tdate_daily"
SHAREHOLDER_CHANGE_NEXT_SLICE_ENDPOINT = (
    "https://www.cninfo.com.cn/data20/shareholeder/detail"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_RECORDS_PATH = "data.records"
SHAREHOLDER_CHANGE_NEXT_SLICE_PER_CASE_MAX_REQUESTS = 1
SHAREHOLDER_CHANGE_NEXT_SLICE_TOTAL_MAX_REQUESTS = 5
SHAREHOLDER_CHANGE_NEXT_SLICE_PLANNED_SHARED_REQUESTS = 1
SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PROBE_KEY = "type_desc_tdate_daily_2026-07-03"
SHAREHOLDER_CHANGE_NEXT_SLICE_CASE_FIXTURES: Dict[str, Tuple[str, ...]] = {
...
SHAREHOLDER_CHANGE_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS: Tuple[str, ...] = (
    "exclude_688671",
    "exclude_301259",
    "exclude_sparse_inc_20260703_sole_found_anchor",
    "exclude_sole_needs_review",
    "exclude_first_slice_DSC001_005_mutate",
    "exclude_dlc006r",
)

SHAREHOLDER_CHANGE_NEXT_SLICE_APPROVAL_REQUIRED = (
    "approve_d_class_shareholder_change_next_slice_required"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_APPROVAL_FLAG = (
    "wrong_approval_flag_for_shareholder_change_next_slice"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_MIXED_MODE_BLOCKED = (
    "shareholder_change_next_slice_incompatible_with_other_modes"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_UNIVERSE_CSV_REQUIRED = (
    "shareholder_change_next_slice_requires_explicit_universe_csv"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_OUTPUT_ROOT_REQUIRED = (
    "shareholder_change_next_slice_output_root_must_be_cninfo_d_class_shareholder_change_next_slice"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v1_output_root_write_blocked_for_shareholder_change_next_slice"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_V2_OUTPUT_ROOT_WRITE_BLOCKED = (
    "v2_output_root_write_blocked_for_shareholder_change_next_slice"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_REPLACEMENT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "replacement_output_root_write_blocked_for_shareholder_change_next_slice"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_TARGETED_PROBE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "targeted_probe_output_root_write_blocked_for_shareholder_change_next_slice"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_EXECUTIVE_SHAREHOLDING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "executive_shareholding_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_SHAREHOLDER_CHANGE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_change_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_EQUITY_PLEDGE_FIRST_OUTPUT_ROOT_WRITE_BLOCKED = (
    "equity_pledge_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_MARGIN_OUTPUT_ROOT_WRITE_BLOCKED = (
    "margin_trading_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_DISCLOSURE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "disclosure_schedule_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_BLOCK_TRADE_OUTPUT_ROOT_WRITE_BLOCKED = (
    "block_trade_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_RSU_FIRST_OUTPUT_ROOT_WRITE_BLOCKED = (
    "restricted_shares_unlock_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_RSU_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "restricted_shares_unlock_next_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_ABNORMAL_TRADING_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_SHAREHOLDER_DATA_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_FIA_FIRST_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_first_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_FIA_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_next_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_FIA_FURTHER_OUTPUT_ROOT_WRITE_BLOCKED = (
    "fund_industry_allocation_further_scale_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_AT_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "abnormal_trading_next_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_SD_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "shareholder_data_next_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_EP_NEXT_OUTPUT_ROOT_WRITE_BLOCKED = (
    "equity_pledge_next_slice_output_root_write_blocked"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH = (
    "shareholder_change_next_slice_universe_size_must_equal_5"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_CASE_ID = (
    "forbidden_case_id_in_shareholder_change_next_slice_universe"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_COMPONENT = (
    "shareholder_change_next_slice_component_must_be_shareholder_change"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_INCLUDE_REQUIRED = "next_slice_include_must_be_yes"
SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_COMPANY_CODE = (
    "forbidden_company_code_in_shareholder_change_next_slice_universe"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_COMPANY_CODE = (
    "shareholder_change_next_slice_company_code_mismatch"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_ANCHOR_TDATE = (
    "shareholder_change_next_slice_anchor_tdate_mismatch"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_QUERY_TYPE_TOKEN = (
    "shareholder_change_next_slice_forbidden_query_type_inc"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_QUERY_TYPE = (
    "shareholder_change_next_slice_query_type_must_be_desc"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_QUERY_MODE = (
    "shareholder_change_next_slice_query_mode_mismatch"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_PER_CASE_CAP_EXCEEDED = (
    "shareholder_change_next_slice_per_case_request_cap_exceeded"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_TOTAL_CAP_EXCEEDED = (
    "shareholder_change_next_slice_total_request_cap_exceeded"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PLAN_MISMATCH = (
    "shareholder_change_next_slice_shared_plan_must_equal_1"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_FIXTURE_MISSING = (
    "shareholder_change_next_slice_tier1_fixture_missing"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_REQUEST_REQUIRED = (
    "shareholder_change_next_slice_shared_request_required"
)
SHAREHOLDER_CHANGE_NEXT_SLICE_EXCLUDE_FLAG_MISSING = (
    "shareholder_change_next_slice_exclude_flag_missing"
)

SHAREHOLDER_CHANGE_NEXT_SLICE_DRYRUN_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_REPORT_COLUMNS = [
    "case_id",
    "company_code",
    "company_name",
    "component",
...
SHAREHOLDER_CHANGE_NEXT_SLICE_QUALITY_REPORT_COLUMNS = [
    "case_id",
    "component",
    "query_mode",
    "anchor_tdate",
...
@dataclass
class AbnormalTradingNextSliceRow:
    case_id: str
    probe_key: str
    company_code: str
    company_name: str
...
@dataclass
class ShareholderDataNextSliceRow:
    case_id: str
    probe_key: str
    company_code: str
    company_name: str
...
@dataclass
class FundIndustryAllocationNextSliceRow:
    case_id: str
    probe_key: str
    industry_code: str
    industry_name: str
...
@dataclass
class FundIndustryAllocationFurtherScaleRow:
    case_id: str
    probe_key: str
    industry_code: str
    industry_name: str
...
@dataclass
class EquityPledgeNextSliceRow:
    case_id: str
    probe_key: str
    company_code: str
    company_name: str
...
@dataclass
class RestrictedSharesUnlockNextSliceRow:
    case_id: str
    probe_key: str
    company_code: str
    company_name: str
...
@dataclass
class ShareholderChangeNextSliceRow:
    case_id: str
    probe_key: str
    company_code: str
    company_name: str
...
def load_abnormal_trading_next_slice_universe(
    path: str,
) -> List[AbnormalTradingNextSliceRow]:
    rows: List[AbnormalTradingNextSliceRow] = []
    with open(path, newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            rows.append(
                AbnormalTradingNextSliceRow(
                    case_id=str(row.get("case_id", "")).strip(),
...
def build_abnormal_trading_next_slice_plan() -> List[str]:
    """abnormal_trading next-slice：共享 1 次 denser-day marketList 探针。"""
    return [ABNORMAL_TRADING_NEXT_SLICE_SHARED_PROBE_KEY]


def _build_abnormal_trading_next_slice_shared_params() -> Dict[str, Any]:
    return {
        "sdate": ABNORMAL_TRADING_NEXT_SLICE_ANCHOR_TDATE,
        "edate": ABNORMAL_TRADING_NEXT_SLICE_ANCHOR_TDATE,
        "platecode": "",
        "orderby": "",
        "page": 1,
        "rows": 30,
...
def compute_abnormal_trading_next_slice_planned_shared() -> int:
    return len(build_abnormal_trading_next_slice_plan())


def compute_abnormal_trading_next_slice_planned_requests(
    row: AbnormalTradingNextSliceRow,
) -> int:
    """每案预算槽位（共享请求按案分摊预算 ≤1）。"""
    return 1


def resolve_abnormal_trading_next_slice_fixture_refs(case_id: str) -> List[str]:
    names = ABNORMAL_TRADING_NEXT_SLICE_CASE_FIXTURES.get(case_id, ())
    return [
        os.path.join(ABNORMAL_TRADING_NEXT_SLICE_FIXTURE_DIR, name) for name in names
    ]


def validate_abnormal_trading_next_slice_fixtures(
    rows: List[AbnormalTradingNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    for row in rows:
        refs = resolve_abnormal_trading_next_slice_fixture_refs(row.case_id)
        if not refs:
            issues.append(
                f"{ABNORMAL_TRADING_NEXT_SLICE_FIXTURE_MISSING}:{row.case_id}"
            )
            continue
        for ref in refs:
            if not os.path.isfile(ref):
                issues.append(
                    f"{ABNORMAL_TRADING_NEXT_SLICE_FIXTURE_MISSING}:"
                    f"{row.case_id}:{os.path.basename(ref)}"
                )
    return issues


def validate_abnormal_trading_next_slice_universe(
    rows: List[AbnormalTradingNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    if len(rows) != ABNORMAL_TRADING_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE:
        issues.append(
            f"{ABNORMAL_TRADING_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH}:got={len(rows)}"
        )
    seen_ids: Set[str] = set()
    budget_total = 0
    for row in rows:
        ...
        if case_id in seen_ids:
            issues.append(f"duplicate_case_id:{case_id}")
        seen_ids.add(case_id)
        if case_id not in ABNORMAL_TRADING_NEXT_SLICE_ALLOWED_CASE_IDS:
            issues.append(
                f"{ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_CASE_ID}:{case_id}"
            )
        for required_flag in ABNORMAL_TRADING_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS:
            if required_flag not in row.exclude_flags:
                issues.append(
                    f"{ABNORMAL_TRADING_NEXT_SLICE_EXCLUDE_FLAG_MISSING}:"
                    f"{case_id}:{required_flag}"
                )
        if row.company_code in ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_COMPANY_CODES:
            issues.append(
                f"{ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_COMPANY_CODE}:"
                f"{row.company_code}"
            )
        expected_code = ABNORMAL_TRADING_NEXT_SLICE_EXPECTED_COMPANY_CODES.get(case_id)
        if expected_code and row.company_code != expected_code:
            issues.append(
                f"{ABNORMAL_TRADING_NEXT_SLICE_WRONG_COMPANY_CODE}:"
                f"{case_id}={row.company_code}"
            )
        if row.component != ABNORMAL_TRADING_NEXT_SLICE_COMPONENT:
            issues.append(f"{ABNORMAL_TRADING_NEXT_SLICE_WRONG_COMPONENT}:{case_id}")
        if row.next_slice_include.lower() != "yes":
            issues.append(f"{ABNORMAL_TRADING_NEXT_SLICE_INCLUDE_REQUIRED}:{case_id}")
        if row.query_mode != ABNORMAL_TRADING_NEXT_SLICE_QUERY_MODE:
            issues.append(
                f"{ABNORMAL_TRADING_NEXT_SLICE_WRONG_QUERY_MODE}:"
                f"{case_id}={row.query_mode}"
            )
        if row.anchor_tdate == ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE:
            issues.append(
                f"{ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_ANCHOR}:{case_id}"
            )
        if row.anchor_tdate != ABNORMAL_TRADING_NEXT_SLICE_ANCHOR_TDATE:
            issues.append(
                f"{ABNORMAL_TRADING_NEXT_SLICE_WRONG_ANCHOR_TDATE}:"
                f"{case_id}={row.anchor_tdate}"
            )
        planned = compute_abnormal_trading_next_slice_planned_requests(row)
        if planned > ABNORMAL_TRADING_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            issues.append(
                f"{ABNORMAL_TRADING_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"{case_id}={planned}"
            )
        budget_total += planned
    for required_id in sorted(ABNORMAL_TRADING_NEXT_SLICE_ALLOWED_CASE_IDS):
        if required_id not in seen_ids:
            issues.append(f"missing_case_id:{required_id}")
    shared = compute_abnormal_trading_next_slice_planned_shared()
    if shared != ABNORMAL_TRADING_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{ABNORMAL_TRADING_NEXT_SLICE_SHARED_PLAN_MISMATCH}:got={shared}"
        )
    if shared > ABNORMAL_TRADING_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{ABNORMAL_TRADING_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:{shared}"
        )
    if budget_total > ABNORMAL_TRADING_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{ABNORMAL_TRADING_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:budget={budget_total}"
        )
    issues.extend(validate_abnormal_trading_next_slice_fixtures(rows))
    return issues


def validate_abnormal_trading_next_slice_output_root(
    output_root: str,
) -> Tuple[bool, str]:
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(DEFAULT_ABNORMAL_TRADING_NEXT_SLICE_OUTPUT_ROOT)
    blocked_pairs = [
        (
            _normalize_output_root(DEFAULT_OUTPUT_ROOT),
            ABNORMAL_TRADING_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED,
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, ABNORMAL_TRADING_NEXT_SLICE_OUTPUT_ROOT_REQUIRED


def enforce_abnormal_trading_next_slice_write_block_targets(
    output_paths: Dict[str, str],
) -> None:
    protected = [
        _normalize_output_root(DEFAULT_OUTPUT_ROOT),
    ...
    for key in ("root", "reports"):
        ...
        for blocked in protected:
            if target == blocked or target.startswith(blocked + os.sep):
                print(
                    f"ERROR: {ABNORMAL_TRADING_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED}:{key}",
                    file=sys.stderr,
                )
                sys.exit(2)


def enforce_abnormal_trading_next_slice_forbidden_options(
    args: argparse.Namespace,
) -> None:
    enforce_forbidden_options(args)
    mixed_modes = [
    ...
    for name, enabled in mixed_modes:
        if args.abnormal_trading_next_slice and enabled:
            print(
                f"ERROR: {ABNORMAL_TRADING_NEXT_SLICE_MIXED_MODE_BLOCKED}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    wrong_flags = [
    ...
    for name, enabled in wrong_flags:
        if args.abnormal_trading_next_slice and enabled:
            print(
                f"ERROR: {ABNORMAL_TRADING_NEXT_SLICE_WRONG_APPROVAL_FLAG}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    if (
        not args.abnormal_trading_next_slice
        and args.approve_d_class_abnormal_trading_next_slice
    ):
        print(
            f"ERROR: {ABNORMAL_TRADING_NEXT_SLICE_WRONG_APPROVAL_FLAG}:"
            "abnormal_trading_next_slice_flag_without_mode",
            file=sys.stderr,
        )
        sys.exit(2)
    for flag_name in ("pdf_download", "ocr", "extraction"):
...
def enforce_abnormal_trading_next_slice_live_approval_gate(
    args: argparse.Namespace,
) -> None:
    if args.mode == "live" and args.abnormal_trading_next_slice:
        if not args.approve_d_class_abnormal_trading_next_slice:
            print(
                f"ERROR: {ABNORMAL_TRADING_NEXT_SLICE_APPROVAL_REQUIRED}",
                file=sys.stderr,
            )
            sys.exit(2)


def build_abnormal_trading_next_slice_dryrun_rows(
    rows: List[AbnormalTradingNextSliceRow],
    output_root: str,
) -> List[Dict[str, str]]:
    dry_rows: List[Dict[str, str]] = []
    shared = compute_abnormal_trading_next_slice_planned_shared()
    plan = build_abnormal_trading_next_slice_plan()
    for row in rows:
        planned_requests = compute_abnormal_trading_next_slice_planned_requests(row)
        fixture_refs = resolve_abnormal_trading_next_slice_fixture_refs(row.case_id)
        dry_rows.append(
            {
                "case_id": row.case_id,
                "company_code": row.company_code,
                ...
                "expected_behavior": row.expected_behavior,
                "planned_request_count": str(planned_requests),
                "shared_probe_key": ABNORMAL_TRADING_NEXT_SLICE_SHARED_PROBE_KEY,
                "planned_output_root": output_root,
                "planned_endpoint": ABNORMAL_TRADING_NEXT_SLICE_ENDPOINT,
                "fixture_refs": ";".join(os.path.basename(r) for r in fixture_refs),
                "cninfo_call_planned": (
                ...
                "notes": (
                    f"anchor={row.anchor_tdate}; plan={','.join(plan)}; "
                    f"shared_probes={shared}; query_mode=single_day_paged; "
                    f"company_filter_offline=secCode; "
                    f"forbidden_anchor={ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE}; "
...
def write_abnormal_trading_next_slice_planned_snapshots(
    rows: List[AbnormalTradingNextSliceRow],
    output_paths: Dict[str, str],
) -> None:
    snap_dir = os.path.join(output_paths["root"], "planned_snapshots")
    os.makedirs(snap_dir, exist_ok=True)
    plan = build_abnormal_trading_next_slice_plan()
    params = _build_abnormal_trading_next_slice_shared_params()
    for row in rows:
        fixture_refs = resolve_abnormal_trading_next_slice_fixture_refs(row.case_id)
        payload = {
            "case_id": row.case_id,
            ...
            "planned_requests": plan,
            "query_params": params,
            "endpoint": ABNORMAL_TRADING_NEXT_SLICE_ENDPOINT,
            "records_path": ABNORMAL_TRADING_NEXT_SLICE_RECORDS_PATH,
            "shared_request": True,
            "company_filter_offline": True,
            "company_filter_field": "secCode",
            "filter_company_code": row.company_code,
            "forbidden_sole_found_anchor": ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE,
            "expected_behavior": row.expected_behavior,
            "fixture_refs": [
                os.path.relpath(r, BASE_DIR).replace("\\", "/") for r in fixture_refs
            ],
...
def write_abnormal_trading_next_slice_dryrun_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=ABNORMAL_TRADING_NEXT_SLICE_DRYRUN_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_abnormal_trading_next_slice_dryrun_summary(
    dry_rows: List[Dict[str, str]],
    output_paths: Dict[str, str],
    universe_csv: str,
) -> str:
    ...
    lines = [
        ...
        "",
        "- component: **abnormal_trading**",
        f"- endpoint: `{ABNORMAL_TRADING_NEXT_SLICE_ENDPOINT}`",
        "- query mode: **single_day_paged**",
        f"- shared probe: **sdate=edate={ABNORMAL_TRADING_NEXT_SLICE_ANCHOR_TDATE}** · page=1 · rows=30",
        f"- forbidden sole found anchor: **{ABNORMAL_TRADING_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE}**",
        f"- records_path: **{ABNORMAL_TRADING_NEXT_SLICE_RECORDS_PATH}**",
        ...
        "",
        "```text",
        f"d_class_abnormal_trading_next_slice_runner_extension_gate = {ABNORMAL_TRADING_NEXT_SLICE_RUNNER_GATE}",
        f"d_class_abnormal_trading_next_slice_live_path_gate = {ABNORMAL_TRADING_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_abnormal_trading_next_slice_live_gate = {ABNORMAL_TRADING_NEXT_SLICE_LIVE_GATE}",
        "approval_status = STANDING_SCOPE_AUTHORIZED_OFFLINE",
        "approved_for_live = false",
        "```",
        "",
...
def is_abnormal_trading_next_slice_acceptable(
    row: AbnormalTradingNextSliceRow,
    summary: Dict[str, str],
) -> bool:
    """next-slice acceptable；禁止 disclosure-only 升级；禁 2026-07-03 sole found 叙事。"""
    rs = summary.get("retrieval_status", "")
    qs = summary.get("quality_status", "")
    eb = row.expected_behavior
    try:
...
def assess_abnormal_trading_next_slice_failure_type(
    row: AbnormalTradingNextSliceRow,
    summary: Dict[str, str],
) -> str:
    if is_abnormal_trading_next_slice_acceptable(row, summary):
        return ""
    rs = summary.get("retrieval_status", "")
    if rs in ("http_error", "blocked"):
        return "transport_or_http_error"
...
def validate_abnormal_trading_next_slice_request_caps(stats: LiveStats) -> List[str]:
    issues: List[str] = []
    shared_key = ABNORMAL_TRADING_NEXT_SLICE_SHARED_PROBE_KEY
    for case_id, count in stats.case_request_counts.items():
        if case_id != shared_key and count > 0:
            issues.append(
                f"{ABNORMAL_TRADING_NEXT_SLICE_SHARED_REQUEST_REQUIRED}:"
    ...
    if stats.cninfo_requests > ABNORMAL_TRADING_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{ABNORMAL_TRADING_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:"
            f"{stats.cninfo_requests}"
        )
    if stats.cninfo_requests > ABNORMAL_TRADING_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{ABNORMAL_TRADING_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"cninfo_requests={stats.cninfo_requests}"
        )
    return issues


def assess_abnormal_trading_next_slice_shared_case(
    row: AbnormalTradingNextSliceRow,
    ...
    notes_parts: List[str] = [
        f"shared_probe={ABNORMAL_TRADING_NEXT_SLICE_SHARED_PROBE_KEY}",
        "company_filter=secCode",
        f"query_mode={row.query_mode}",
        f"anchor={row.anchor_tdate}",
    ...
    if last_error in ("rate_limited",) or last_error.startswith("network_error"):
        ...
        empty_but_valid = "yes"
        notes_parts.append(
            "marketList zero rows after secCode filter; legal empty per quality policy"
        )
    else:
...
def write_abnormal_trading_next_slice_live_snapshot(
    row: AbnormalTradingNextSliceRow,
    summary: Dict[str, str],
    output_paths: Dict[str, str],
) -> str:
        ...
        json.dump(
            {
                ...
                "shared_probe": ABNORMAL_TRADING_NEXT_SLICE_SHARED_PROBE_KEY,
                "cninfo_called": True,
                "detail_nested_deferred": True,
            },
            f,
...
def compute_abnormal_trading_next_slice_execution_gate(
    universe_rows: List[AbnormalTradingNextSliceRow],
    case_summaries: Dict[str, Dict[str, str]],
) -> str:
    acceptable = 0
    for row in universe_rows:
        ...
        if is_abnormal_trading_next_slice_acceptable(row, summary):
            acceptable += 1
    if acceptable >= 3:
        return ABNORMAL_TRADING_NEXT_SLICE_EXECUTION_GATE_PASS
    return ABNORMAL_TRADING_NEXT_SLICE_EXECUTION_GATE_FAIL


def build_abnormal_trading_next_slice_live_row(
    row: AbnormalTradingNextSliceRow,
    summary: Dict[str, str],
) -> Dict[str, str]:
    acceptable = is_abnormal_trading_next_slice_acceptable(row, summary)
    failure_type = assess_abnormal_trading_next_slice_failure_type(row, summary)
    return {
        "case_id": row.case_id,
        "company_code": row.company_code,
        "company_name": row.company_name,
        ...
        "needs_review": summary.get("needs_review", "no"),
        "endpoint_used": summary.get(
            "endpoint_used", ABNORMAL_TRADING_NEXT_SLICE_ENDPOINT
        ),
        "cninfo_request_count": summary.get("cninfo_request_count", "0"),
        "acceptable": "yes" if acceptable else "no",
        "failure_type": failure_type,
...
def write_abnormal_trading_next_slice_live_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=ABNORMAL_TRADING_NEXT_SLICE_LIVE_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_abnormal_trading_next_slice_quality_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    quality_rows = [
        {
    ...
    report_path = os.path.join(
        output_paths["reports"],
        "d_class_abnormal_trading_next_slice_quality_report.csv",
    )
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=ABNORMAL_TRADING_NEXT_SLICE_QUALITY_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(quality_rows)
    return report_path
...
def write_abnormal_trading_next_slice_live_summary(
    live_rows: List[Dict[str, str]],
    stats: LiveStats,
    gate: str,
    output_paths: Dict[str, str],
    ...
    acceptable = sum(1 for r in live_rows if r["acceptable"] == "yes")
    lines = [
        "# CNINFO D 类 abnormal_trading Next-Slice Live Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** abnormal_trading next-slice live path · **live_gate=NOT_APPROVED**",
        "",
        "## Counts",
        "",
        "| 指标 | 值 |",
        ...
        f"d_class_abnormal_trading_next_slice_live_path_gate = {ABNORMAL_TRADING_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_abnormal_trading_next_slice_live_gate = {ABNORMAL_TRADING_NEXT_SLICE_LIVE_GATE}",
        f"d_class_abnormal_trading_next_slice_execution_gate = {gate}",
        "```",
        "",
    ...
    summary_path = os.path.join(
        output_paths["reports"],
        "d_class_abnormal_trading_next_slice_live_summary.md",
    )
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    return summary_path
...
def execute_abnormal_trading_next_slice_live(
    universe_rows: List[AbnormalTradingNextSliceRow],
    output_paths: Dict[str, str],
) -> int:
    """abnormal_trading next-slice live：1 次共享 denser-day 探针 + 离线 secCode 过滤。"""
    endpoints = load_registry_endpoints()
    source_configs = load_table_source_configs()
    component_cfg = copy.deepcopy(
        source_configs.get(ABNORMAL_TRADING_NEXT_SLICE_COMPONENT, {})
    )
    endpoint = endpoints.get(
        ABNORMAL_TRADING_NEXT_SLICE_COMPONENT,
        component_cfg.get("api_url", ABNORMAL_TRADING_NEXT_SLICE_ENDPOINT),
    )
    ...
    for row in universe_rows:
        ...
        if planned > ABNORMAL_TRADING_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            print(
                f"ERROR: {ABNORMAL_TRADING_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"planned={planned}",
                file=sys.stderr,
            )
            return 2

    shared_plan = compute_abnormal_trading_next_slice_planned_shared()
    if shared_plan != ABNORMAL_TRADING_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        print(
            f"ERROR: {ABNORMAL_TRADING_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"got={shared_plan}",
            file=sys.stderr,
        )
        return 2
    ...
    for row in sorted(universe_rows, key=lambda r: r.case_id):
        ...
        summary = assess_abnormal_trading_next_slice_shared_case(
            row,
            company_records,
            http_status,
            last_error,
        ...
        write_abnormal_trading_next_slice_live_snapshot(row, summary, output_paths)
    ...
    cap_issues = validate_abnormal_trading_next_slice_request_caps(stats)
    if cap_issues:
        print(
            "ERROR: abnormal_trading next-slice request cap validation failed: "
            f"{cap_issues}",
            file=sys.stderr,
        )
        return 2

    gate = compute_abnormal_trading_next_slice_execution_gate(
        universe_rows, case_summaries
    )
    if stats.db_writes or stats.minio_writes or stats.rag_runs:
        gate = ABNORMAL_TRADING_NEXT_SLICE_EXECUTION_GATE_FAIL

    live_rows = [
        build_abnormal_trading_next_slice_live_row(row, case_summaries[row.case_id])
        for row in sorted(universe_rows, key=lambda r: r.case_id)
        if row.case_id in case_summaries
    ]

    report_path = write_abnormal_trading_next_slice_live_report(live_rows, output_paths)
    quality_path = write_abnormal_trading_next_slice_quality_report(
        live_rows, output_paths
    )
    summary_path = write_abnormal_trading_next_slice_live_summary(
        live_rows, stats, gate, output_paths
    )

    print(
        f"mode=abnormal_trading_next_slice_live cases={len(live_rows)} "
        f"cninfo_calls={stats.cninfo_requests} acceptable="
        f"{sum(1 for r in live_rows if r['acceptable'] == 'yes')}/{len(live_rows)}"
    )
    print(f"gate=d_class_abnormal_trading_next_slice_execution_gate={gate}")
    print(
        "live_path_gate=d_class_abnormal_trading_next_slice_live_path_gate="
        f"{ABNORMAL_TRADING_NEXT_SLICE_LIVE_PATH_GATE}"
    )
    print(
        "live_gate=d_class_abnormal_trading_next_slice_live_gate="
        f"{ABNORMAL_TRADING_NEXT_SLICE_LIVE_GATE}"
    )
    print(f"live_report={report_path}")
    print(f"quality_report={quality_path}")
    print(f"live_summary={summary_path}")
...
def run_abnormal_trading_next_slice(args: argparse.Namespace) -> int:
    enforce_abnormal_trading_next_slice_forbidden_options(args)
    enforce_abnormal_trading_next_slice_live_approval_gate(args)

    if args.universe_csv == DEFAULT_UNIVERSE_CSV:
        print(
            f"ERROR: {ABNORMAL_TRADING_NEXT_SLICE_UNIVERSE_CSV_REQUIRED}",
            file=sys.stderr,
        )
        return 2
    ...
    ok_root, root_err = validate_abnormal_trading_next_slice_output_root(args.output_root)
    if not ok_root:
        print(f"ERROR: {root_err}", file=sys.stderr)
        return 2

    universe_rows = load_abnormal_trading_next_slice_universe(args.universe_csv)
    universe_issues = validate_abnormal_trading_next_slice_universe(universe_rows)
    if universe_issues:
        print(
            "ERROR: abnormal_trading next-slice universe validation failed: "
            f"{universe_issues}",
            file=sys.stderr,
        )
        return 2
    ...
    output_root = _normalize_output_root(args.output_root)
    output_paths = ensure_output_layout(output_root, args.mode)
    enforce_abnormal_trading_next_slice_write_block_targets(output_paths)

    if args.mode == "live":
        return execute_abnormal_trading_next_slice_live(universe_rows, output_paths)

    dry_rows = build_abnormal_trading_next_slice_dryrun_rows(universe_rows, output_root)
    write_abnormal_trading_next_slice_planned_snapshots(universe_rows, output_paths)
    report_path = write_abnormal_trading_next_slice_dryrun_report(dry_rows, output_paths)
    summary_path = write_abnormal_trading_next_slice_dryrun_summary(
        dry_rows, output_paths, args.universe_csv
    )
    shared = compute_abnormal_trading_next_slice_planned_shared()
    print(
        f"mode=abnormal_trading_next_slice_dry_run cases={len(dry_rows)} "
        f"planned_request_count_total={shared} cninfo_calls=0"
    )
    print(
        "gate=d_class_abnormal_trading_next_slice_runner_extension_gate="
        f"{ABNORMAL_TRADING_NEXT_SLICE_RUNNER_GATE}"
    )
    print(
        "live_path_gate=d_class_abnormal_trading_next_slice_live_path_gate="
        f"{ABNORMAL_TRADING_NEXT_SLICE_LIVE_PATH_GATE}"
...
def load_equity_pledge_next_slice_universe(
    path: str,
) -> List[EquityPledgeNextSliceRow]:
    rows: List[EquityPledgeNextSliceRow] = []
    with open(path, newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            rows.append(
                EquityPledgeNextSliceRow(
                    case_id=str(row.get("case_id", "")).strip(),
                    probe_key=str(row.get("probe_key", "")).strip(),
                    company_code=str(row.get("company_code", "")).strip(),
                    company_name=str(row.get("company_name", "")).strip(),
...
def build_equity_pledge_next_slice_plan() -> List[str]:
    """equity_pledge next-slice：共享 1 次 denser-day tdate_daily 截面探针。"""
    return [EQUITY_PLEDGE_NEXT_SLICE_SHARED_PROBE_KEY]


def _build_equity_pledge_next_slice_shared_params() -> Dict[str, Any]:
    """equity_pledge next-slice：共享 denser-day tdate 参数。"""
    return {
        "tdate": EQUITY_PLEDGE_NEXT_SLICE_ANCHOR_TDATE,
    }


def compute_equity_pledge_next_slice_planned_shared() -> int:
    return len(build_equity_pledge_next_slice_plan())


def compute_equity_pledge_next_slice_planned_requests(
    row: EquityPledgeNextSliceRow,
) -> int:
    """每案预算槽位（共享请求按案分摊预算 ≤1）。"""
    return 1


def resolve_equity_pledge_next_slice_fixture_refs(case_id: str) -> List[str]:
    names = EQUITY_PLEDGE_NEXT_SLICE_CASE_FIXTURES.get(case_id, ())
    return [
        os.path.join(EQUITY_PLEDGE_NEXT_SLICE_FIXTURE_DIR, name) for name in names
    ]


def validate_equity_pledge_next_slice_fixtures(
    rows: List[EquityPledgeNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    for row in rows:
        refs = resolve_equity_pledge_next_slice_fixture_refs(row.case_id)
        if not refs:
            issues.append(
                f"{EQUITY_PLEDGE_NEXT_SLICE_FIXTURE_MISSING}:{row.case_id}"
            )
            continue
        for ref in refs:
            if not os.path.isfile(ref):
                issues.append(
                    f"{EQUITY_PLEDGE_NEXT_SLICE_FIXTURE_MISSING}:"
                    f"{row.case_id}:{os.path.basename(ref)}"
                )
    return issues


def validate_equity_pledge_next_slice_universe(
    rows: List[EquityPledgeNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    if len(rows) != EQUITY_PLEDGE_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE:
        issues.append(
            f"{EQUITY_PLEDGE_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH}:got={len(rows)}"
        )
    seen_ids: Set[str] = set()
    budget_total = 0
    for row in rows:
        ...
        if case_id in seen_ids:
            issues.append(f"duplicate_case_id:{case_id}")
        seen_ids.add(case_id)
        if case_id not in EQUITY_PLEDGE_NEXT_SLICE_ALLOWED_CASE_IDS:
            issues.append(
                f"{EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_CASE_ID}:{case_id}"
            )
        for required_flag in EQUITY_PLEDGE_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS:
            if required_flag not in row.exclude_flags:
                issues.append(
                    f"{EQUITY_PLEDGE_NEXT_SLICE_EXCLUDE_FLAG_MISSING}:"
                    f"{case_id}:{required_flag}"
                )
        if row.company_code in EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_COMPANY_CODES:
            issues.append(
                f"{EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_COMPANY_CODE}:"
                f"{row.company_code}"
            )
        expected_code = EQUITY_PLEDGE_NEXT_SLICE_EXPECTED_COMPANY_CODES.get(case_id)
        if expected_code and row.company_code != expected_code:
            issues.append(
                f"{EQUITY_PLEDGE_NEXT_SLICE_WRONG_COMPANY_CODE}:"
                f"{case_id}={row.company_code}"
            )
        if row.component != EQUITY_PLEDGE_NEXT_SLICE_COMPONENT:
            issues.append(f"{EQUITY_PLEDGE_NEXT_SLICE_WRONG_COMPONENT}:{case_id}")
        if row.next_slice_include.lower() != "yes":
            issues.append(f"{EQUITY_PLEDGE_NEXT_SLICE_INCLUDE_REQUIRED}:{case_id}")
        if row.query_mode != EQUITY_PLEDGE_NEXT_SLICE_QUERY_MODE:
            issues.append(
                f"{EQUITY_PLEDGE_NEXT_SLICE_WRONG_QUERY_MODE}:"
                f"{case_id}={row.query_mode}"
            )
        if row.anchor_tdate == EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE:
            issues.append(
                f"{EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_ANCHOR}:{case_id}"
            )
        if row.anchor_tdate != EQUITY_PLEDGE_NEXT_SLICE_ANCHOR_TDATE:
            issues.append(
                f"{EQUITY_PLEDGE_NEXT_SLICE_WRONG_ANCHOR_TDATE}:"
                f"{case_id}={row.anchor_tdate}"
            )
        planned = compute_equity_pledge_next_slice_planned_requests(row)
        if planned > EQUITY_PLEDGE_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            issues.append(
                f"{EQUITY_PLEDGE_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"{case_id}={planned}"
            )
        budget_total += planned
    for required_id in sorted(EQUITY_PLEDGE_NEXT_SLICE_ALLOWED_CASE_IDS):
        if required_id not in seen_ids:
            issues.append(f"missing_case_id:{required_id}")
    shared = compute_equity_pledge_next_slice_planned_shared()
    if shared != EQUITY_PLEDGE_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{EQUITY_PLEDGE_NEXT_SLICE_SHARED_PLAN_MISMATCH}:got={shared}"
        )
    if shared > EQUITY_PLEDGE_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{EQUITY_PLEDGE_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:{shared}"
        )
    if budget_total > EQUITY_PLEDGE_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{EQUITY_PLEDGE_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:budget={budget_total}"
        )
    issues.extend(validate_equity_pledge_next_slice_fixtures(rows))
    return issues


def validate_equity_pledge_next_slice_output_root(
    output_root: str,
) -> Tuple[bool, str]:
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(DEFAULT_EQUITY_PLEDGE_NEXT_SLICE_OUTPUT_ROOT)
    blocked_pairs = [
        (
            _normalize_output_root(DEFAULT_OUTPUT_ROOT),
            EQUITY_PLEDGE_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED,
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, EQUITY_PLEDGE_NEXT_SLICE_OUTPUT_ROOT_REQUIRED


def enforce_equity_pledge_next_slice_write_block_targets(
    output_paths: Dict[str, str],
) -> None:
    protected = [
        _normalize_output_root(DEFAULT_OUTPUT_ROOT),
    ...
    for key in ("root", "reports"):
        ...
        for blocked in protected:
            if target == blocked or target.startswith(blocked + os.sep):
                print(
                    f"ERROR: {EQUITY_PLEDGE_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED}:{key}",
                    file=sys.stderr,
                )
                sys.exit(2)


def enforce_equity_pledge_next_slice_forbidden_options(
    args: argparse.Namespace,
) -> None:
    enforce_forbidden_options(args)
    mixed_modes = [
    ...
    for name, enabled in mixed_modes:
        if args.equity_pledge_next_slice and enabled:
            print(
                f"ERROR: {EQUITY_PLEDGE_NEXT_SLICE_MIXED_MODE_BLOCKED}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    wrong_flags = [
    ...
    for name, enabled in wrong_flags:
        if args.equity_pledge_next_slice and enabled:
            print(
                f"ERROR: {EQUITY_PLEDGE_NEXT_SLICE_WRONG_APPROVAL_FLAG}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    if (
        not args.equity_pledge_next_slice
        and args.approve_d_class_equity_pledge_next_slice
    ):
        print(
            f"ERROR: {EQUITY_PLEDGE_NEXT_SLICE_WRONG_APPROVAL_FLAG}:"
            "equity_pledge_next_slice_flag_without_mode",
            file=sys.stderr,
        )
        sys.exit(2)
    for flag_name in ("pdf_download", "ocr", "extraction"):
...
def enforce_equity_pledge_next_slice_live_approval_gate(
    args: argparse.Namespace,
) -> None:
    if args.mode == "live" and args.equity_pledge_next_slice:
        if not args.approve_d_class_equity_pledge_next_slice:
            print(
                f"ERROR: {EQUITY_PLEDGE_NEXT_SLICE_APPROVAL_REQUIRED}",
                file=sys.stderr,
            )
            sys.exit(2)


def build_equity_pledge_next_slice_dryrun_rows(
    rows: List[EquityPledgeNextSliceRow],
    output_root: str,
) -> List[Dict[str, str]]:
    dry_rows: List[Dict[str, str]] = []
    shared = compute_equity_pledge_next_slice_planned_shared()
    plan = build_equity_pledge_next_slice_plan()
    for row in rows:
        planned_requests = compute_equity_pledge_next_slice_planned_requests(row)
        fixture_refs = resolve_equity_pledge_next_slice_fixture_refs(row.case_id)
        dry_rows.append(
            {
                "case_id": row.case_id,
                "company_code": row.company_code,
                ...
                "expected_behavior": row.expected_behavior,
                "planned_request_count": str(planned_requests),
                "shared_probe_key": EQUITY_PLEDGE_NEXT_SLICE_SHARED_PROBE_KEY,
                "planned_output_root": output_root,
                "planned_endpoint": EQUITY_PLEDGE_NEXT_SLICE_ENDPOINT,
                "fixture_refs": ";".join(os.path.basename(r) for r in fixture_refs),
                "cninfo_call_planned": (
                    "shared" if row.next_slice_include.lower() == "yes" else "no"
                ),
                ...
                "notes": (
                    f"anchor={row.anchor_tdate}; plan={','.join(plan)}; "
                    f"shared_probes={shared}; query_mode=tdate_daily; "
                    f"company_filter_offline=SECCODE; "
                    f"forbidden_anchor={EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE}; "
                    f""
                    f"empty_but_valid_allowed=yes; tier1_fixtures={len(fixture_refs)}"
                ),
            }
...
def write_equity_pledge_next_slice_planned_snapshots(
    rows: List[EquityPledgeNextSliceRow],
    output_paths: Dict[str, str],
) -> None:
    snap_dir = os.path.join(output_paths["root"], "planned_snapshots")
    os.makedirs(snap_dir, exist_ok=True)
    plan = build_equity_pledge_next_slice_plan()
    params = _build_equity_pledge_next_slice_shared_params()
    for row in rows:
        fixture_refs = resolve_equity_pledge_next_slice_fixture_refs(row.case_id)
        payload = {
            "case_id": row.case_id,
            ...
            "planned_requests": plan,
            "query_params": params,
            "endpoint": EQUITY_PLEDGE_NEXT_SLICE_ENDPOINT,
            "records_path": EQUITY_PLEDGE_NEXT_SLICE_RECORDS_PATH,
            "shared_request": True,
            "company_filter_offline": True,
            "company_filter_field": "SECCODE",
            "filter_company_code": row.company_code,
            "forbidden_sole_found_anchor": EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE,
            "expected_behavior": row.expected_behavior,
            "fixture_refs": [
                os.path.relpath(r, BASE_DIR).replace("\\", "/") for r in fixture_refs
            ],
        ...
        out = os.path.join(snap_dir, f"{row.case_id}_equity_pledge.json")
        with open(out, "w", encoding="utf-8") as f:
            json.dump(payload, f, ensure_ascii=False, indent=2)
            f.write("\n")


def write_equity_pledge_next_slice_dryrun_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=EQUITY_PLEDGE_NEXT_SLICE_DRYRUN_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_equity_pledge_next_slice_dryrun_summary(
    dry_rows: List[Dict[str, str]],
    output_paths: Dict[str, str],
    universe_csv: str,
) -> str:
    ...
    budget_total = sum(int(r["planned_request_count"]) for r in dry_rows)
    lines = [
        "# CNINFO D 类 equity_pledge Next-Slice Dry-run Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** equity_pledge next-slice dry-run only · **CNINFO calls = 0** · **NOT APPROVED for live**",
        "",
        "## Counts",
        "",
        "| 指标 | 值 |",
        ...
        f"- endpoint: `{EQUITY_PLEDGE_NEXT_SLICE_ENDPOINT}`",
        "- query mode: **tdate_daily**",
        f"- shared probe: **tdate={EQUITY_PLEDGE_NEXT_SLICE_ANCHOR_TDATE}** · method POST",
        f"- forbidden sole found anchor: **{EQUITY_PLEDGE_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE}**",
        f"- records_path: **{EQUITY_PLEDGE_NEXT_SLICE_RECORDS_PATH}**",
        "- company filter: **offline SECCODE**",
        ...
        "",
        "```text",
        f"d_class_equity_pledge_next_slice_runner_extension_gate = {EQUITY_PLEDGE_NEXT_SLICE_RUNNER_GATE}",
        f"d_class_equity_pledge_next_slice_live_path_gate = {EQUITY_PLEDGE_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_equity_pledge_next_slice_live_gate = {EQUITY_PLEDGE_NEXT_SLICE_LIVE_GATE}",
        "approval_status = STANDING_SCOPE_AUTHORIZED_OFFLINE",
        "approved_for_live = false",
        "```",
        "",
...
def is_equity_pledge_next_slice_acceptable(
    row: EquityPledgeNextSliceRow,
    summary: Dict[str, str],
) -> bool:
    """next-slice acceptable；禁止 disclosure-only 升级；禁 2026-07-03 sole found 叙事；与 first-slice DEP001–005 隔离。"""
    rs = summary.get("retrieval_status", "")
    qs = summary.get("quality_status", "")
    eb = row.expected_behavior
    try:
...
def assess_equity_pledge_next_slice_failure_type(
    row: EquityPledgeNextSliceRow,
    summary: Dict[str, str],
) -> str:
    if is_equity_pledge_next_slice_acceptable(row, summary):
        return ""
    rs = summary.get("retrieval_status", "")
    if rs in ("http_error", "blocked"):
        return "transport_or_http_error"
...
def validate_equity_pledge_next_slice_request_caps(stats: LiveStats) -> List[str]:
    issues: List[str] = []
    shared_key = EQUITY_PLEDGE_NEXT_SLICE_SHARED_PROBE_KEY
    for case_id, count in stats.case_request_counts.items():
        if case_id != shared_key and count > 0:
            issues.append(
                f"{EQUITY_PLEDGE_NEXT_SLICE_SHARED_REQUEST_REQUIRED}:"
                f"non_shared_case={case_id}={count}"
            )
        if case_id == shared_key and count > 1:
            issues.append(
    ...
    if stats.cninfo_requests > EQUITY_PLEDGE_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{EQUITY_PLEDGE_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:"
            f"{stats.cninfo_requests}"
        )
    if stats.cninfo_requests > EQUITY_PLEDGE_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{EQUITY_PLEDGE_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"cninfo_requests={stats.cninfo_requests}"
        )
    return issues


def assess_equity_pledge_next_slice_shared_case(
    row: EquityPledgeNextSliceRow,
    company_records: List[Dict[str, Any]],
    http_status: int,
    last_error: str,
    ...
    needs_review = "no"
    notes_parts: List[str] = [
        f"shared_probe={EQUITY_PLEDGE_NEXT_SLICE_SHARED_PROBE_KEY}",
        "company_filter=SECCODE",
        f"query_mode={row.query_mode}",
        f"anchor={row.anchor_tdate}",
            ]
    ...
    if last_error in ("rate_limited",) or last_error.startswith("network_error"):
        ...
        empty_but_valid = "yes"
        notes_parts.append(
            "equityPledge zero rows after SECCODE filter; legal empty per quality policy"
        )
    else:
        retrieval_status = "found"
        lineage_status = "discovered"
...
def write_equity_pledge_next_slice_live_snapshot(
    row: EquityPledgeNextSliceRow,
    summary: Dict[str, str],
    output_paths: Dict[str, str],
) -> str:
        ...
        json.dump(
            {
                ...
                "query_params": used_params,
                "sample_records": sample_records,
                "shared_probe": EQUITY_PLEDGE_NEXT_SLICE_SHARED_PROBE_KEY,
                "cninfo_called": True,
                            },
            f,
            ensure_ascii=False,
...
def compute_equity_pledge_next_slice_execution_gate(
    universe_rows: List[EquityPledgeNextSliceRow],
    case_summaries: Dict[str, Dict[str, str]],
) -> str:
    acceptable = 0
    for row in universe_rows:
        ...
        if is_equity_pledge_next_slice_acceptable(row, summary):
            acceptable += 1
    if acceptable >= 3:
        return EQUITY_PLEDGE_NEXT_SLICE_EXECUTION_GATE_PASS
    return EQUITY_PLEDGE_NEXT_SLICE_EXECUTION_GATE_FAIL


def build_equity_pledge_next_slice_live_row(
    row: EquityPledgeNextSliceRow,
    summary: Dict[str, str],
) -> Dict[str, str]:
    acceptable = is_equity_pledge_next_slice_acceptable(row, summary)
    failure_type = assess_equity_pledge_next_slice_failure_type(row, summary)
    return {
        "case_id": row.case_id,
        "company_code": row.company_code,
        "company_name": row.company_name,
        ...
        "needs_review": summary.get("needs_review", "no"),
        "endpoint_used": summary.get(
            "endpoint_used", EQUITY_PLEDGE_NEXT_SLICE_ENDPOINT
        ),
        "cninfo_request_count": summary.get("cninfo_request_count", "0"),
        "acceptable": "yes" if acceptable else "no",
        "failure_type": failure_type,
...
def write_equity_pledge_next_slice_live_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=EQUITY_PLEDGE_NEXT_SLICE_LIVE_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_equity_pledge_next_slice_quality_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    quality_rows = [
        {
    ...
    report_path = os.path.join(
        output_paths["reports"],
        "d_class_equity_pledge_next_slice_quality_report.csv",
    )
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=EQUITY_PLEDGE_NEXT_SLICE_QUALITY_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(quality_rows)
    return report_path
...
def write_equity_pledge_next_slice_live_summary(
    live_rows: List[Dict[str, str]],
    stats: LiveStats,
    gate: str,
    output_paths: Dict[str, str],
    ...
    acceptable = sum(1 for r in live_rows if r["acceptable"] == "yes")
    lines = [
        "# CNINFO D 类 equity_pledge Next-Slice Live Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** equity_pledge next-slice live path · **live_gate=NOT_APPROVED**",
        "",
        "## Counts",
        "",
        "| 指标 | 值 |",
        ...
        f"d_class_equity_pledge_next_slice_live_path_gate = {EQUITY_PLEDGE_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_equity_pledge_next_slice_live_gate = {EQUITY_PLEDGE_NEXT_SLICE_LIVE_GATE}",
        f"d_class_equity_pledge_next_slice_execution_gate = {gate}",
        "```",
        "",
        "**NOT verified** · **NOT production_ready** · **NOT bare PASS**",
        "",
    ...
    summary_path = os.path.join(
        output_paths["reports"],
        "d_class_equity_pledge_next_slice_live_summary.md",
    )
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    return summary_path
...
def execute_equity_pledge_next_slice_live(
    universe_rows: List[EquityPledgeNextSliceRow],
    output_paths: Dict[str, str],
) -> int:
    """equity_pledge next-slice live：1 次共享 denser-day 探针 + 离线 SECCODE 过滤。"""
    endpoints = load_registry_endpoints()
    source_configs = load_table_source_configs()
    component_cfg = copy.deepcopy(
        source_configs.get(EQUITY_PLEDGE_NEXT_SLICE_COMPONENT, {})
    )
    endpoint = endpoints.get(
        EQUITY_PLEDGE_NEXT_SLICE_COMPONENT,
        component_cfg.get("api_url", EQUITY_PLEDGE_NEXT_SLICE_ENDPOINT),
    )
    component_cfg["api_url"] = endpoint
    ...
    for row in universe_rows:
        ...
        if planned > EQUITY_PLEDGE_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            print(
                f"ERROR: {EQUITY_PLEDGE_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"planned={planned}",
                file=sys.stderr,
            )
            return 2

    shared_plan = compute_equity_pledge_next_slice_planned_shared()
    if shared_plan != EQUITY_PLEDGE_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        print(
            f"ERROR: {EQUITY_PLEDGE_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"got={shared_plan}",
            file=sys.stderr,
        )
        return 2
    ...
    for row in sorted(universe_rows, key=lambda r: r.case_id):
        company_records = _filter_company_records(all_records, row.company_code)
        summary = assess_equity_pledge_next_slice_shared_case(
            row,
            company_records,
            http_status,
            last_error,
        ...
        write_equity_pledge_next_slice_live_snapshot(row, summary, output_paths)
        public_summary = {k: v for k, v in summary.items() if not k.startswith("_")}
        case_summaries[row.case_id] = public_summary
        print(
            f"{row.case_id} {public_summary['retrieval_status']}: "
    ...
    cap_issues = validate_equity_pledge_next_slice_request_caps(stats)
    if cap_issues:
        print(
            "ERROR: equity_pledge next-slice request cap validation failed: "
            f"{cap_issues}",
            file=sys.stderr,
        )
        return 2

    gate = compute_equity_pledge_next_slice_execution_gate(
        universe_rows, case_summaries
    )
    if stats.db_writes or stats.minio_writes or stats.rag_runs:
        gate = EQUITY_PLEDGE_NEXT_SLICE_EXECUTION_GATE_FAIL

    live_rows = [
        build_equity_pledge_next_slice_live_row(row, case_summaries[row.case_id])
        for row in sorted(universe_rows, key=lambda r: r.case_id)
        if row.case_id in case_summaries
    ]

    report_path = write_equity_pledge_next_slice_live_report(live_rows, output_paths)
    quality_path = write_equity_pledge_next_slice_quality_report(
        live_rows, output_paths
    )
    summary_path = write_equity_pledge_next_slice_live_summary(
        live_rows, stats, gate, output_paths
    )

    print(
        f"mode=equity_pledge_next_slice_live cases={len(live_rows)} "
        f"cninfo_calls={stats.cninfo_requests} acceptable="
        f"{sum(1 for r in live_rows if r['acceptable'] == 'yes')}/{len(live_rows)}"
    )
    print(f"gate=d_class_equity_pledge_next_slice_execution_gate={gate}")
    print(
        "live_path_gate=d_class_equity_pledge_next_slice_live_path_gate="
        f"{EQUITY_PLEDGE_NEXT_SLICE_LIVE_PATH_GATE}"
    )
    print(
        "live_gate=d_class_equity_pledge_next_slice_live_gate="
        f"{EQUITY_PLEDGE_NEXT_SLICE_LIVE_GATE}"
    )
    print(f"live_report={report_path}")
    print(f"quality_report={quality_path}")
    print(f"live_summary={summary_path}")
...
def run_equity_pledge_next_slice(args: argparse.Namespace) -> int:
    enforce_equity_pledge_next_slice_forbidden_options(args)
    enforce_equity_pledge_next_slice_live_approval_gate(args)

    if args.universe_csv == DEFAULT_UNIVERSE_CSV:
        print(
            f"ERROR: {EQUITY_PLEDGE_NEXT_SLICE_UNIVERSE_CSV_REQUIRED}",
            file=sys.stderr,
        )
        return 2
    ...
    ok_root, root_err = validate_equity_pledge_next_slice_output_root(args.output_root)
    if not ok_root:
        print(f"ERROR: {root_err}", file=sys.stderr)
        return 2

    universe_rows = load_equity_pledge_next_slice_universe(args.universe_csv)
    universe_issues = validate_equity_pledge_next_slice_universe(universe_rows)
    if universe_issues:
        print(
            "ERROR: equity_pledge next-slice universe validation failed: "
            f"{universe_issues}",
            file=sys.stderr,
        )
        return 2
    ...
    output_root = _normalize_output_root(args.output_root)
    output_paths = ensure_output_layout(output_root, args.mode)
    enforce_equity_pledge_next_slice_write_block_targets(output_paths)

    if args.mode == "live":
        return execute_equity_pledge_next_slice_live(universe_rows, output_paths)

    dry_rows = build_equity_pledge_next_slice_dryrun_rows(universe_rows, output_root)
    write_equity_pledge_next_slice_planned_snapshots(universe_rows, output_paths)
    report_path = write_equity_pledge_next_slice_dryrun_report(dry_rows, output_paths)
    summary_path = write_equity_pledge_next_slice_dryrun_summary(
        dry_rows, output_paths, args.universe_csv
    )
    shared = compute_equity_pledge_next_slice_planned_shared()
    print(
        f"mode=equity_pledge_next_slice_dry_run cases={len(dry_rows)} "
        f"planned_request_count_total={shared} cninfo_calls=0"
    )
    print(
        "gate=d_class_equity_pledge_next_slice_runner_extension_gate="
        f"{EQUITY_PLEDGE_NEXT_SLICE_RUNNER_GATE}"
    )
    print(
        "live_path_gate=d_class_equity_pledge_next_slice_live_path_gate="
        f"{EQUITY_PLEDGE_NEXT_SLICE_LIVE_PATH_GATE}"
...
def load_restricted_shares_unlock_next_slice_universe(
    path: str,
) -> List[RestrictedSharesUnlockNextSliceRow]:
    rows: List[RestrictedSharesUnlockNextSliceRow] = []
    with open(path, newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            rows.append(
                RestrictedSharesUnlockNextSliceRow(
                    case_id=str(row.get("case_id", "")).strip(),
                    probe_key=str(row.get("probe_key", "")).strip(),
                    company_code=str(row.get("company_code", "")).strip(),
                    company_name=str(row.get("company_name", "")).strip(),
...
def build_restricted_shares_unlock_next_slice_plan() -> List[str]:
    """restricted_shares_unlock next-slice：共享 1 次 denser-day tdate_daily 截面探针。"""
    return [RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PROBE_KEY]


def _build_restricted_shares_unlock_next_slice_shared_params() -> Dict[str, Any]:
    """restricted_shares_unlock next-slice：共享 denser-day tdate 参数。"""
    return {
        "tdate": RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ANCHOR_TDATE,
    }


def compute_restricted_shares_unlock_next_slice_planned_shared() -> int:
    return len(build_restricted_shares_unlock_next_slice_plan())


def compute_restricted_shares_unlock_next_slice_planned_requests(
    row: RestrictedSharesUnlockNextSliceRow,
) -> int:
    """每案预算槽位（共享请求按案分摊预算 ≤1）。"""
    return 1


def resolve_restricted_shares_unlock_next_slice_fixture_refs(case_id: str) -> List[str]:
    names = RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_CASE_FIXTURES.get(case_id, ())
    return [
        os.path.join(RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FIXTURE_DIR, name) for name in names
    ]


def validate_restricted_shares_unlock_next_slice_fixtures(
    rows: List[RestrictedSharesUnlockNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    for row in rows:
        refs = resolve_restricted_shares_unlock_next_slice_fixture_refs(row.case_id)
        if not refs:
            issues.append(
                f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FIXTURE_MISSING}:{row.case_id}"
            )
            continue
        for ref in refs:
            if not os.path.isfile(ref):
                issues.append(
                    f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FIXTURE_MISSING}:"
                    f"{row.case_id}:{os.path.basename(ref)}"
                )
    return issues


def validate_restricted_shares_unlock_next_slice_universe(
    rows: List[RestrictedSharesUnlockNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    if len(rows) != RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE:
        issues.append(
            f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH}:got={len(rows)}"
        )
    seen_ids: Set[str] = set()
    budget_total = 0
    for row in rows:
        ...
        if case_id in seen_ids:
            issues.append(f"duplicate_case_id:{case_id}")
        seen_ids.add(case_id)
        if case_id not in RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ALLOWED_CASE_IDS:
            issues.append(
                f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_CASE_ID}:{case_id}"
            )
        for required_flag in RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS:
            if required_flag not in row.exclude_flags:
                issues.append(
                    f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXCLUDE_FLAG_MISSING}:"
                    f"{case_id}:{required_flag}"
                )
        if row.company_code in RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_COMPANY_CODES:
            issues.append(
                f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_COMPANY_CODE}:"
                f"{row.company_code}"
            )
        expected_code = RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXPECTED_COMPANY_CODES.get(case_id)
        if expected_code and row.company_code != expected_code:
            issues.append(
                f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_COMPANY_CODE}:"
                f"{case_id}={row.company_code}"
            )
        if row.component != RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_COMPONENT:
            issues.append(f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_COMPONENT}:{case_id}")
        if row.next_slice_include.lower() != "yes":
            issues.append(f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_INCLUDE_REQUIRED}:{case_id}")
        if row.query_mode != RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_QUERY_MODE:
            issues.append(
                f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_QUERY_MODE}:"
                f"{case_id}={row.query_mode}"
            )
        if row.anchor_tdate == RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE:
            issues.append(
                f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_ANCHOR}:{case_id}"
            )
        if row.anchor_tdate != RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ANCHOR_TDATE:
            issues.append(
                f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_ANCHOR_TDATE}:"
                f"{case_id}={row.anchor_tdate}"
            )
        planned = compute_restricted_shares_unlock_next_slice_planned_requests(row)
        if planned > RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            issues.append(
                f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"{case_id}={planned}"
            )
        budget_total += planned
    for required_id in sorted(RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ALLOWED_CASE_IDS):
        if required_id not in seen_ids:
            issues.append(f"missing_case_id:{required_id}")
    shared = compute_restricted_shares_unlock_next_slice_planned_shared()
    if shared != RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PLAN_MISMATCH}:got={shared}"
        )
    if shared > RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:{shared}"
        )
    if budget_total > RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:budget={budget_total}"
        )
    issues.extend(validate_restricted_shares_unlock_next_slice_fixtures(rows))
    return issues


def validate_restricted_shares_unlock_next_slice_output_root(
    output_root: str,
) -> Tuple[bool, str]:
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(DEFAULT_RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_OUTPUT_ROOT)
    blocked_pairs = [
        (
            _normalize_output_root(DEFAULT_OUTPUT_ROOT),
            RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED,
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_OUTPUT_ROOT_REQUIRED


def enforce_restricted_shares_unlock_next_slice_write_block_targets(
    output_paths: Dict[str, str],
) -> None:
    protected = [
        _normalize_output_root(DEFAULT_OUTPUT_ROOT),
    ...
    for key in ("root", "reports"):
        ...
        for blocked in protected:
            if target == blocked or target.startswith(blocked + os.sep):
                print(
                    f"ERROR: {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED}:{key}",
                    file=sys.stderr,
                )
                sys.exit(2)


def enforce_restricted_shares_unlock_next_slice_forbidden_options(
    args: argparse.Namespace,
) -> None:
    enforce_forbidden_options(args)
    mixed_modes = [
    ...
    for name, enabled in mixed_modes:
        if args.restricted_shares_unlock_next_slice and enabled:
            print(
                f"ERROR: {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_MIXED_MODE_BLOCKED}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    wrong_flags = [
    ...
    for name, enabled in wrong_flags:
        if args.restricted_shares_unlock_next_slice and enabled:
            print(
                f"ERROR: {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_APPROVAL_FLAG}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    if (
        not args.restricted_shares_unlock_next_slice
        and args.approve_d_class_restricted_shares_unlock_next_slice
    ):
        print(
            f"ERROR: {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_WRONG_APPROVAL_FLAG}:"
            "restricted_shares_unlock_next_slice_flag_without_mode",
            file=sys.stderr,
        )
        sys.exit(2)
    for flag_name in ("pdf_download", "ocr", "extraction"):
...
def enforce_restricted_shares_unlock_next_slice_live_approval_gate(
    args: argparse.Namespace,
) -> None:
    if args.mode == "live" and args.restricted_shares_unlock_next_slice:
        if not args.approve_d_class_restricted_shares_unlock_next_slice:
            print(
                f"ERROR: {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_APPROVAL_REQUIRED}",
                file=sys.stderr,
            )
            sys.exit(2)


def build_restricted_shares_unlock_next_slice_dryrun_rows(
    rows: List[RestrictedSharesUnlockNextSliceRow],
    output_root: str,
) -> List[Dict[str, str]]:
    dry_rows: List[Dict[str, str]] = []
    shared = compute_restricted_shares_unlock_next_slice_planned_shared()
    plan = build_restricted_shares_unlock_next_slice_plan()
    for row in rows:
        planned_requests = compute_restricted_shares_unlock_next_slice_planned_requests(row)
        fixture_refs = resolve_restricted_shares_unlock_next_slice_fixture_refs(row.case_id)
        dry_rows.append(
            {
                "case_id": row.case_id,
                "company_code": row.company_code,
                ...
                "expected_behavior": row.expected_behavior,
                "planned_request_count": str(planned_requests),
                "shared_probe_key": RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PROBE_KEY,
                "planned_output_root": output_root,
                "planned_endpoint": RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ENDPOINT,
                "fixture_refs": ";".join(os.path.basename(r) for r in fixture_refs),
                "cninfo_call_planned": (
                    "shared" if row.next_slice_include.lower() == "yes" else "no"
                ),
                ...
                "notes": (
                    ...
                    f"shared_probes={shared}; query_mode=tdate_daily; "
                    f"company_filter_offline=SECCODE; "
                    f"forbidden_anchor={RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE}; "
                    f""
                    f"empty_but_valid_allowed=yes; tier1_fixtures={len(fixture_refs)}"
                ),
            }
...
def write_restricted_shares_unlock_next_slice_planned_snapshots(
    rows: List[RestrictedSharesUnlockNextSliceRow],
    output_paths: Dict[str, str],
) -> None:
    snap_dir = os.path.join(output_paths["root"], "planned_snapshots")
    os.makedirs(snap_dir, exist_ok=True)
    plan = build_restricted_shares_unlock_next_slice_plan()
    params = _build_restricted_shares_unlock_next_slice_shared_params()
    for row in rows:
        fixture_refs = resolve_restricted_shares_unlock_next_slice_fixture_refs(row.case_id)
        payload = {
            "case_id": row.case_id,
            ...
            "planned_requests": plan,
            "query_params": params,
            "endpoint": RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ENDPOINT,
            "records_path": RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_RECORDS_PATH,
            "shared_request": True,
            "company_filter_offline": True,
            "company_filter_field": "SECCODE",
            "filter_company_code": row.company_code,
            "forbidden_sole_found_anchor": RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE,
            "expected_behavior": row.expected_behavior,
            "fixture_refs": [
                os.path.relpath(r, BASE_DIR).replace("\\", "/") for r in fixture_refs
            ],
...
def write_restricted_shares_unlock_next_slice_dryrun_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_DRYRUN_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_restricted_shares_unlock_next_slice_dryrun_summary(
    dry_rows: List[Dict[str, str]],
    output_paths: Dict[str, str],
    universe_csv: str,
) -> str:
    ...
    lines = [
        ...
        "",
        "- component: **restricted_shares_unlock**",
        f"- endpoint: `{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ENDPOINT}`",
        "- query mode: **tdate_daily**",
        f"- shared probe: **tdate={RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ANCHOR_TDATE}** · method POST",
        f"- forbidden sole found anchor: **{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_FORBIDDEN_ANCHOR_TDATE}**",
        f"- records_path: **{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_RECORDS_PATH}**",
        "- company filter: **offline SECCODE**",
        ...
        "",
        "```text",
        f"d_class_restricted_shares_unlock_next_slice_runner_extension_gate = {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_RUNNER_GATE}",
        f"d_class_restricted_shares_unlock_next_slice_live_path_gate = {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_restricted_shares_unlock_next_slice_live_gate = {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_GATE}",
        "approval_status = STANDING_SCOPE_AUTHORIZED_OFFLINE",
        "approved_for_live = false",
        "```",
        "",
...
def is_restricted_shares_unlock_next_slice_acceptable(
    row: RestrictedSharesUnlockNextSliceRow,
    summary: Dict[str, str],
) -> bool:
    """next-slice acceptable；禁止 disclosure-only 升级；禁 2026-07-03 sole found 叙事；与 first-slice DRU001–005 隔离。"""
    rs = summary.get("retrieval_status", "")
    qs = summary.get("quality_status", "")
    eb = row.expected_behavior
    try:
...
def assess_restricted_shares_unlock_next_slice_failure_type(
    row: RestrictedSharesUnlockNextSliceRow,
    summary: Dict[str, str],
) -> str:
    if is_restricted_shares_unlock_next_slice_acceptable(row, summary):
        return ""
    rs = summary.get("retrieval_status", "")
    if rs in ("http_error", "blocked"):
        return "transport_or_http_error"
...
def validate_restricted_shares_unlock_next_slice_request_caps(stats: LiveStats) -> List[str]:
    issues: List[str] = []
    shared_key = RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PROBE_KEY
    for case_id, count in stats.case_request_counts.items():
        if case_id != shared_key and count > 0:
            issues.append(
                f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_REQUEST_REQUIRED}:"
                f"non_shared_case={case_id}={count}"
            )
        if case_id == shared_key and count > 1:
            issues.append(
    ...
    if stats.cninfo_requests > RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:"
            f"{stats.cninfo_requests}"
        )
    if stats.cninfo_requests > RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"cninfo_requests={stats.cninfo_requests}"
        )
    return issues


def assess_restricted_shares_unlock_next_slice_shared_case(
    row: RestrictedSharesUnlockNextSliceRow,
    company_records: List[Dict[str, Any]],
    http_status: int,
    last_error: str,
    ...
    needs_review = "no"
    notes_parts: List[str] = [
        f"shared_probe={RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PROBE_KEY}",
        "company_filter=SECCODE",
        f"query_mode={row.query_mode}",
        f"anchor={row.anchor_tdate}",
            ]
    ...
    if last_error in ("rate_limited",) or last_error.startswith("network_error"):
        ...
        empty_but_valid = "yes"
        notes_parts.append(
            "liftBan zero rows after SECCODE filter; legal empty per quality policy"
        )
    else:
        retrieval_status = "found"
        lineage_status = "discovered"
...
def write_restricted_shares_unlock_next_slice_live_snapshot(
    row: RestrictedSharesUnlockNextSliceRow,
    summary: Dict[str, str],
    output_paths: Dict[str, str],
) -> str:
        ...
        json.dump(
            {
                ...
                "query_params": used_params,
                "sample_records": sample_records,
                "shared_probe": RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PROBE_KEY,
                "cninfo_called": True,
                            },
            f,
            ensure_ascii=False,
...
def compute_restricted_shares_unlock_next_slice_execution_gate(
    universe_rows: List[RestrictedSharesUnlockNextSliceRow],
    case_summaries: Dict[str, Dict[str, str]],
) -> str:
    acceptable = 0
    for row in universe_rows:
        ...
        if is_restricted_shares_unlock_next_slice_acceptable(row, summary):
            acceptable += 1
    if acceptable >= 3:
        return RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXECUTION_GATE_PASS
    return RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXECUTION_GATE_FAIL


def build_restricted_shares_unlock_next_slice_live_row(
    row: RestrictedSharesUnlockNextSliceRow,
    summary: Dict[str, str],
) -> Dict[str, str]:
    acceptable = is_restricted_shares_unlock_next_slice_acceptable(row, summary)
    failure_type = assess_restricted_shares_unlock_next_slice_failure_type(row, summary)
    return {
        "case_id": row.case_id,
        "company_code": row.company_code,
        "company_name": row.company_name,
        ...
        "needs_review": summary.get("needs_review", "no"),
        "endpoint_used": summary.get(
            "endpoint_used", RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ENDPOINT
        ),
        "cninfo_request_count": summary.get("cninfo_request_count", "0"),
        "acceptable": "yes" if acceptable else "no",
        "failure_type": failure_type,
...
def write_restricted_shares_unlock_next_slice_live_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_restricted_shares_unlock_next_slice_quality_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    quality_rows = [
        {
    ...
    report_path = os.path.join(
        output_paths["reports"],
        "d_class_restricted_shares_unlock_next_slice_quality_report.csv",
    )
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_QUALITY_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(quality_rows)
    return report_path
...
def write_restricted_shares_unlock_next_slice_live_summary(
    live_rows: List[Dict[str, str]],
    stats: LiveStats,
    gate: str,
    output_paths: Dict[str, str],
    ...
    acceptable = sum(1 for r in live_rows if r["acceptable"] == "yes")
    lines = [
        "# CNINFO D 类 restricted_shares_unlock Next-Slice Live Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** restricted_shares_unlock next-slice live path · **live_gate=NOT_APPROVED**",
        "",
        "## Counts",
        "",
        "| 指标 | 值 |",
        ...
        f"d_class_restricted_shares_unlock_next_slice_live_path_gate = {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_restricted_shares_unlock_next_slice_live_gate = {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_GATE}",
        f"d_class_restricted_shares_unlock_next_slice_execution_gate = {gate}",
        "```",
        "",
        "**NOT verified** · **NOT production_ready** · **NOT bare PASS**",
        "",
    ...
    summary_path = os.path.join(
        output_paths["reports"],
        "d_class_restricted_shares_unlock_next_slice_live_summary.md",
    )
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    return summary_path
...
def execute_restricted_shares_unlock_next_slice_live(
    universe_rows: List[RestrictedSharesUnlockNextSliceRow],
    output_paths: Dict[str, str],
) -> int:
    """restricted_shares_unlock next-slice live：1 次共享 denser-day 探针 + 离线 SECCODE 过滤。"""
    endpoints = load_registry_endpoints()
    source_configs = load_table_source_configs()
    component_cfg = copy.deepcopy(
        source_configs.get(RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_COMPONENT, {})
    )
    endpoint = endpoints.get(
        RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_COMPONENT,
        component_cfg.get("api_url", RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_ENDPOINT),
    )
    component_cfg["api_url"] = endpoint
    ...
    for row in universe_rows:
        ...
        if planned > RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            print(
                f"ERROR: {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"planned={planned}",
                file=sys.stderr,
            )
            return 2

    shared_plan = compute_restricted_shares_unlock_next_slice_planned_shared()
    if shared_plan != RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        print(
            f"ERROR: {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"got={shared_plan}",
            file=sys.stderr,
        )
        return 2
    ...
    for row in sorted(universe_rows, key=lambda r: r.case_id):
        company_records = _filter_company_records(all_records, row.company_code)
        summary = assess_restricted_shares_unlock_next_slice_shared_case(
            row,
            company_records,
            http_status,
            last_error,
        ...
        write_restricted_shares_unlock_next_slice_live_snapshot(row, summary, output_paths)
        public_summary = {k: v for k, v in summary.items() if not k.startswith("_")}
        case_summaries[row.case_id] = public_summary
        print(
            f"{row.case_id} {public_summary['retrieval_status']}: "
    ...
    cap_issues = validate_restricted_shares_unlock_next_slice_request_caps(stats)
    if cap_issues:
        print(
            "ERROR: restricted_shares_unlock next-slice request cap validation failed: "
            f"{cap_issues}",
            file=sys.stderr,
        )
        return 2

    gate = compute_restricted_shares_unlock_next_slice_execution_gate(
        universe_rows, case_summaries
    )
    if stats.db_writes or stats.minio_writes or stats.rag_runs:
        gate = RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_EXECUTION_GATE_FAIL

    live_rows = [
        build_restricted_shares_unlock_next_slice_live_row(row, case_summaries[row.case_id])
        for row in sorted(universe_rows, key=lambda r: r.case_id)
        if row.case_id in case_summaries
    ]

    report_path = write_restricted_shares_unlock_next_slice_live_report(live_rows, output_paths)
    quality_path = write_restricted_shares_unlock_next_slice_quality_report(
        live_rows, output_paths
    )
    summary_path = write_restricted_shares_unlock_next_slice_live_summary(
        live_rows, stats, gate, output_paths
    )

    print(
        f"mode=restricted_shares_unlock_next_slice_live cases={len(live_rows)} "
        f"cninfo_calls={stats.cninfo_requests} acceptable="
        f"{sum(1 for r in live_rows if r['acceptable'] == 'yes')}/{len(live_rows)}"
    )
    print(f"gate=d_class_restricted_shares_unlock_next_slice_execution_gate={gate}")
    print(
        "live_path_gate=d_class_restricted_shares_unlock_next_slice_live_path_gate="
        f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_PATH_GATE}"
    )
    print(
        "live_gate=d_class_restricted_shares_unlock_next_slice_live_gate="
        f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_GATE}"
    )
    print(f"live_report={report_path}")
    print(f"quality_report={quality_path}")
    print(f"live_summary={summary_path}")
...
def run_restricted_shares_unlock_next_slice(args: argparse.Namespace) -> int:
    enforce_restricted_shares_unlock_next_slice_forbidden_options(args)
    enforce_restricted_shares_unlock_next_slice_live_approval_gate(args)

    if args.universe_csv == DEFAULT_UNIVERSE_CSV:
        print(
            f"ERROR: {RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_UNIVERSE_CSV_REQUIRED}",
            file=sys.stderr,
        )
        return 2
    ...
    ok_root, root_err = validate_restricted_shares_unlock_next_slice_output_root(args.output_root)
    if not ok_root:
        print(f"ERROR: {root_err}", file=sys.stderr)
        return 2

    universe_rows = load_restricted_shares_unlock_next_slice_universe(args.universe_csv)
    universe_issues = validate_restricted_shares_unlock_next_slice_universe(universe_rows)
    if universe_issues:
        print(
            "ERROR: restricted_shares_unlock next-slice universe validation failed: "
            f"{universe_issues}",
            file=sys.stderr,
        )
        return 2
    ...
    output_root = _normalize_output_root(args.output_root)
    output_paths = ensure_output_layout(output_root, args.mode)
    enforce_restricted_shares_unlock_next_slice_write_block_targets(output_paths)

    if args.mode == "live":
        return execute_restricted_shares_unlock_next_slice_live(universe_rows, output_paths)

    dry_rows = build_restricted_shares_unlock_next_slice_dryrun_rows(universe_rows, output_root)
    write_restricted_shares_unlock_next_slice_planned_snapshots(universe_rows, output_paths)
    report_path = write_restricted_shares_unlock_next_slice_dryrun_report(dry_rows, output_paths)
    summary_path = write_restricted_shares_unlock_next_slice_dryrun_summary(
        dry_rows, output_paths, args.universe_csv
    )
    shared = compute_restricted_shares_unlock_next_slice_planned_shared()
    print(
        f"mode=restricted_shares_unlock_next_slice_dry_run cases={len(dry_rows)} "
        f"planned_request_count_total={shared} cninfo_calls=0"
    )
    print(
        "gate=d_class_restricted_shares_unlock_next_slice_runner_extension_gate="
        f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_RUNNER_GATE}"
    )
    print(
        "live_path_gate=d_class_restricted_shares_unlock_next_slice_live_path_gate="
        f"{RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_LIVE_PATH_GATE}"
...
def load_shareholder_change_next_slice_universe(
    path: str,
) -> List[ShareholderChangeNextSliceRow]:
    rows: List[ShareholderChangeNextSliceRow] = []
    with open(path, newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            rows.append(
                ShareholderChangeNextSliceRow(
                    case_id=str(row.get("case_id", "")).strip(),
                    probe_key=str(row.get("probe_key", "")).strip(),
                    company_code=str(row.get("company_code", "")).strip(),
                    company_name=str(row.get("company_name", "")).strip(),
...
def build_shareholder_change_next_slice_plan() -> List[str]:
    """shareholder_change next-slice：共享 1 次 denser-mode type_desc_tdate_daily 截面探针。"""
    return [SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PROBE_KEY]


def _build_shareholder_change_next_slice_shared_params() -> Dict[str, Any]:
    """shareholder_change next-slice：共享 denser-mode type=desc + tdate 参数。"""
    return {
        "type": SHAREHOLDER_CHANGE_NEXT_SLICE_QUERY_TYPE,
        "tdate": SHAREHOLDER_CHANGE_NEXT_SLICE_ANCHOR_TDATE,
    }


def compute_shareholder_change_next_slice_planned_shared() -> int:
    return len(build_shareholder_change_next_slice_plan())


def compute_shareholder_change_next_slice_planned_requests(
    row: ShareholderChangeNextSliceRow,
) -> int:
    """每案预算槽位（共享请求按案分摊预算 ≤1）。"""
    return 1


def resolve_shareholder_change_next_slice_fixture_refs(case_id: str) -> List[str]:
    names = SHAREHOLDER_CHANGE_NEXT_SLICE_CASE_FIXTURES.get(case_id, ())
    return [
        os.path.join(SHAREHOLDER_CHANGE_NEXT_SLICE_FIXTURE_DIR, name) for name in names
    ]


def validate_shareholder_change_next_slice_fixtures(
    rows: List[ShareholderChangeNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    for row in rows:
        refs = resolve_shareholder_change_next_slice_fixture_refs(row.case_id)
        if not refs:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_FIXTURE_MISSING}:{row.case_id}"
            )
            continue
        for ref in refs:
            if not os.path.isfile(ref):
                issues.append(
                    f"{SHAREHOLDER_CHANGE_NEXT_SLICE_FIXTURE_MISSING}:"
                    f"{row.case_id}:{os.path.basename(ref)}"
                )
    return issues


def validate_shareholder_change_next_slice_universe(
    rows: List[ShareholderChangeNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    if len(rows) != SHAREHOLDER_CHANGE_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE:
        issues.append(
            f"{SHAREHOLDER_CHANGE_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH}:got={len(rows)}"
        )
    seen_ids: Set[str] = set()
    budget_total = 0
    for row in rows:
        ...
        if case_id in seen_ids:
            issues.append(f"duplicate_case_id:{case_id}")
        seen_ids.add(case_id)
        if case_id not in SHAREHOLDER_CHANGE_NEXT_SLICE_ALLOWED_CASE_IDS:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_CASE_ID}:{case_id}"
            )
        for required_flag in SHAREHOLDER_CHANGE_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS:
            if required_flag not in row.exclude_flags:
                issues.append(
                    f"{SHAREHOLDER_CHANGE_NEXT_SLICE_EXCLUDE_FLAG_MISSING}:"
                    f"{case_id}:{required_flag}"
                )
        if row.company_code in SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_COMPANY_CODES:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_COMPANY_CODE}:"
                f"{row.company_code}"
            )
        expected_code = SHAREHOLDER_CHANGE_NEXT_SLICE_EXPECTED_COMPANY_CODES.get(case_id)
        if expected_code and row.company_code != expected_code:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_COMPANY_CODE}:"
                f"{case_id}={row.company_code}"
            )
        if row.component != SHAREHOLDER_CHANGE_NEXT_SLICE_COMPONENT:
            issues.append(f"{SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_COMPONENT}:{case_id}")
        if row.next_slice_include.lower() != "yes":
            issues.append(f"{SHAREHOLDER_CHANGE_NEXT_SLICE_INCLUDE_REQUIRED}:{case_id}")
        if row.query_mode != SHAREHOLDER_CHANGE_NEXT_SLICE_QUERY_MODE:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_QUERY_MODE}:"
                f"{case_id}={row.query_mode}"
            )
        if row.query_type == SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_QUERY_TYPE:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_QUERY_TYPE_TOKEN}:{case_id}"
            )
        if row.query_type != SHAREHOLDER_CHANGE_NEXT_SLICE_QUERY_TYPE:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_QUERY_TYPE}:"
                f"{case_id}={row.query_type}"
            )
        if row.anchor_tdate != SHAREHOLDER_CHANGE_NEXT_SLICE_ANCHOR_TDATE:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_ANCHOR_TDATE}:"
                f"{case_id}={row.anchor_tdate}"
            )
        planned = compute_shareholder_change_next_slice_planned_requests(row)
        if planned > SHAREHOLDER_CHANGE_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"{case_id}={planned}"
            )
        budget_total += planned
    for required_id in sorted(SHAREHOLDER_CHANGE_NEXT_SLICE_ALLOWED_CASE_IDS):
        if required_id not in seen_ids:
            issues.append(f"missing_case_id:{required_id}")
    shared = compute_shareholder_change_next_slice_planned_shared()
    if shared != SHAREHOLDER_CHANGE_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PLAN_MISMATCH}:got={shared}"
        )
    if shared > SHAREHOLDER_CHANGE_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_CHANGE_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:{shared}"
        )
    if budget_total > SHAREHOLDER_CHANGE_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_CHANGE_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:budget={budget_total}"
        )
    issues.extend(validate_shareholder_change_next_slice_fixtures(rows))
    return issues


def validate_shareholder_change_next_slice_output_root(
    output_root: str,
) -> Tuple[bool, str]:
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(DEFAULT_SHAREHOLDER_CHANGE_NEXT_SLICE_OUTPUT_ROOT)
    blocked_pairs = [
        (
            _normalize_output_root(DEFAULT_OUTPUT_ROOT),
            SHAREHOLDER_CHANGE_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED,
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, SHAREHOLDER_CHANGE_NEXT_SLICE_OUTPUT_ROOT_REQUIRED


def enforce_shareholder_change_next_slice_write_block_targets(
    output_paths: Dict[str, str],
) -> None:
    protected = [
        _normalize_output_root(DEFAULT_OUTPUT_ROOT),
    ...
    for key in ("root", "reports"):
        ...
        for blocked in protected:
            if target == blocked or target.startswith(blocked + os.sep):
                print(
                    f"ERROR: {SHAREHOLDER_CHANGE_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED}:{key}",
                    file=sys.stderr,
                )
                sys.exit(2)


def enforce_shareholder_change_next_slice_forbidden_options(
    args: argparse.Namespace,
) -> None:
    enforce_forbidden_options(args)
    mixed_modes = [
    ...
    for name, enabled in mixed_modes:
        if args.shareholder_change_next_slice and enabled:
            print(
                f"ERROR: {SHAREHOLDER_CHANGE_NEXT_SLICE_MIXED_MODE_BLOCKED}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    wrong_flags = [
    ...
    for name, enabled in wrong_flags:
        if args.shareholder_change_next_slice and enabled:
            print(
                f"ERROR: {SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_APPROVAL_FLAG}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    if (
        not args.shareholder_change_next_slice
        and args.approve_d_class_shareholder_change_next_slice
    ):
        print(
            f"ERROR: {SHAREHOLDER_CHANGE_NEXT_SLICE_WRONG_APPROVAL_FLAG}:"
            "shareholder_change_next_slice_flag_without_mode",
            file=sys.stderr,
        )
        sys.exit(2)
    for flag_name in ("pdf_download", "ocr", "extraction"):
...
def enforce_shareholder_change_next_slice_live_approval_gate(
    args: argparse.Namespace,
) -> None:
    if args.mode == "live" and args.shareholder_change_next_slice:
        if not args.approve_d_class_shareholder_change_next_slice:
            print(
                f"ERROR: {SHAREHOLDER_CHANGE_NEXT_SLICE_APPROVAL_REQUIRED}",
                file=sys.stderr,
            )
            sys.exit(2)


def build_shareholder_change_next_slice_dryrun_rows(
    rows: List[ShareholderChangeNextSliceRow],
    output_root: str,
) -> List[Dict[str, str]]:
    dry_rows: List[Dict[str, str]] = []
    shared = compute_shareholder_change_next_slice_planned_shared()
    plan = build_shareholder_change_next_slice_plan()
    for row in rows:
        planned_requests = compute_shareholder_change_next_slice_planned_requests(row)
        fixture_refs = resolve_shareholder_change_next_slice_fixture_refs(row.case_id)
        dry_rows.append(
            {
                "case_id": row.case_id,
                "company_code": row.company_code,
                ...
                "expected_behavior": row.expected_behavior,
                "planned_request_count": str(planned_requests),
                "shared_probe_key": SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PROBE_KEY,
                "planned_output_root": output_root,
                "planned_endpoint": SHAREHOLDER_CHANGE_NEXT_SLICE_ENDPOINT,
                "fixture_refs": ";".join(os.path.basename(r) for r in fixture_refs),
                "cninfo_call_planned": (
                    "shared" if row.next_slice_include.lower() == "yes" else "no"
                ),
                ...
                "notes": (
                    f"anchor={row.anchor_tdate}; plan={','.join(plan)}; "
                    f"shared_probes={shared}; query_mode=type_desc_tdate_daily; "
                    f"query_type={row.query_type}; "
                    f"company_filter_offline=SECCODE; "
                    f"forbidden_sole_found=type={SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_QUERY_TYPE}"
                    f"+{SHAREHOLDER_CHANGE_NEXT_SLICE_ANCHOR_TDATE}; "
                    f"empty_but_valid_allowed=yes; tier1_fixtures={len(fixture_refs)}"
                ),
            }
        )
...
def write_shareholder_change_next_slice_planned_snapshots(
    rows: List[ShareholderChangeNextSliceRow],
    output_paths: Dict[str, str],
) -> None:
    snap_dir = os.path.join(output_paths["root"], "planned_snapshots")
    os.makedirs(snap_dir, exist_ok=True)
    plan = build_shareholder_change_next_slice_plan()
    params = _build_shareholder_change_next_slice_shared_params()
    for row in rows:
        fixture_refs = resolve_shareholder_change_next_slice_fixture_refs(row.case_id)
        payload = {
            "case_id": row.case_id,
            ...
            "planned_requests": plan,
            "query_params": params,
            "endpoint": SHAREHOLDER_CHANGE_NEXT_SLICE_ENDPOINT,
            "records_path": SHAREHOLDER_CHANGE_NEXT_SLICE_RECORDS_PATH,
            "shared_request": True,
            "company_filter_offline": True,
            "company_filter_field": "SECCODE",
            "filter_company_code": row.company_code,
            "forbidden_sole_found_anchor": (
                f"type={SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_QUERY_TYPE}"
                f"+{SHAREHOLDER_CHANGE_NEXT_SLICE_ANCHOR_TDATE}"
            ),
            "expected_behavior": row.expected_behavior,
            "fixture_refs": [
...
def write_shareholder_change_next_slice_dryrun_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=SHAREHOLDER_CHANGE_NEXT_SLICE_DRYRUN_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_shareholder_change_next_slice_dryrun_summary(
    dry_rows: List[Dict[str, str]],
    output_paths: Dict[str, str],
    universe_csv: str,
) -> str:
    ...
    lines = [
        ...
        f"- endpoint: `{SHAREHOLDER_CHANGE_NEXT_SLICE_ENDPOINT}`",
        "- query mode: **type_desc_tdate_daily**",
        f"- query type: **{SHAREHOLDER_CHANGE_NEXT_SLICE_QUERY_TYPE}**",
        f"- shared probe: **type={SHAREHOLDER_CHANGE_NEXT_SLICE_QUERY_TYPE}** · "
        f"**tdate={SHAREHOLDER_CHANGE_NEXT_SLICE_ANCHOR_TDATE}** · method POST",
        f"- forbidden sole found: **type={SHAREHOLDER_CHANGE_NEXT_SLICE_FORBIDDEN_QUERY_TYPE}** + "
        f"**{SHAREHOLDER_CHANGE_NEXT_SLICE_ANCHOR_TDATE}**",
        f"- records_path: **{SHAREHOLDER_CHANGE_NEXT_SLICE_RECORDS_PATH}**",
        "- company filter: **offline SECCODE**",
        ...
        "",
        "```text",
        f"d_class_shareholder_change_next_slice_runner_extension_gate = {SHAREHOLDER_CHANGE_NEXT_SLICE_RUNNER_GATE}",
        f"d_class_shareholder_change_next_slice_live_path_gate = {SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_shareholder_change_next_slice_live_gate = {SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_GATE}",
        "approval_status = STANDING_SCOPE_AUTHORIZED_OFFLINE",
        "approved_for_live = false",
        "```",
        "",
...
def is_shareholder_change_next_slice_acceptable(
    row: ShareholderChangeNextSliceRow,
    summary: Dict[str, str],
) -> bool:
...
def assess_shareholder_change_next_slice_failure_type(
    row: ShareholderChangeNextSliceRow,
    summary: Dict[str, str],
) -> str:
    if is_shareholder_change_next_slice_acceptable(row, summary):
        return ""
    rs = summary.get("retrieval_status", "")
    if rs in ("http_error", "blocked"):
        return "transport_or_http_error"
...
def validate_shareholder_change_next_slice_request_caps(stats: LiveStats) -> List[str]:
    issues: List[str] = []
    shared_key = SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PROBE_KEY
    for case_id, count in stats.case_request_counts.items():
        if case_id != shared_key and count > 0:
            issues.append(
                f"{SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_REQUEST_REQUIRED}:"
                f"non_shared_case={case_id}={count}"
            )
        if case_id == shared_key and count > 1:
            issues.append(
    ...
    if stats.cninfo_requests > SHAREHOLDER_CHANGE_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_CHANGE_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:"
            f"{stats.cninfo_requests}"
        )
    if stats.cninfo_requests > SHAREHOLDER_CHANGE_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"cninfo_requests={stats.cninfo_requests}"
        )
    return issues


def assess_shareholder_change_next_slice_shared_case(
    row: ShareholderChangeNextSliceRow,
    company_records: List[Dict[str, Any]],
    http_status: int,
    last_error: str,
    ...
    needs_review = "no"
    notes_parts: List[str] = [
        f"shared_probe={SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PROBE_KEY}",
        "company_filter=SECCODE",
        f"query_mode={row.query_mode}",
        f"anchor={row.anchor_tdate}",
            ]
    ...
    if last_error in ("rate_limited",) or last_error.startswith("network_error"):
        ...
        empty_but_valid = "yes"
        notes_parts.append(
            "shareholeder zero rows after SECCODE filter; legal empty per quality policy"
        )
    else:
        retrieval_status = "found"
        lineage_status = "discovered"
...
def write_shareholder_change_next_slice_live_snapshot(
    row: ShareholderChangeNextSliceRow,
    summary: Dict[str, str],
    output_paths: Dict[str, str],
) -> str:
        ...
        json.dump(
            {
                ...
                "query_params": used_params,
                "sample_records": sample_records,
                "shared_probe": SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PROBE_KEY,
                "cninfo_called": True,
                            },
            f,
            ensure_ascii=False,
...
def compute_shareholder_change_next_slice_execution_gate(
    universe_rows: List[ShareholderChangeNextSliceRow],
    case_summaries: Dict[str, Dict[str, str]],
) -> str:
    acceptable = 0
    for row in universe_rows:
        ...
        if is_shareholder_change_next_slice_acceptable(row, summary):
            acceptable += 1
    if acceptable >= 3:
        return SHAREHOLDER_CHANGE_NEXT_SLICE_EXECUTION_GATE_PASS
    return SHAREHOLDER_CHANGE_NEXT_SLICE_EXECUTION_GATE_FAIL


def build_shareholder_change_next_slice_live_row(
    row: ShareholderChangeNextSliceRow,
    summary: Dict[str, str],
) -> Dict[str, str]:
    acceptable = is_shareholder_change_next_slice_acceptable(row, summary)
    failure_type = assess_shareholder_change_next_slice_failure_type(row, summary)
    return {
        "case_id": row.case_id,
        "company_code": row.company_code,
        "company_name": row.company_name,
        ...
        "needs_review": summary.get("needs_review", "no"),
        "endpoint_used": summary.get(
            "endpoint_used", SHAREHOLDER_CHANGE_NEXT_SLICE_ENDPOINT
        ),
        "cninfo_request_count": summary.get("cninfo_request_count", "0"),
        "acceptable": "yes" if acceptable else "no",
        "failure_type": failure_type,
...
def write_shareholder_change_next_slice_live_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_shareholder_change_next_slice_quality_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    quality_rows = [
        {
    ...
    report_path = os.path.join(
        output_paths["reports"],
        "d_class_shareholder_change_next_slice_quality_report.csv",
    )
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=SHAREHOLDER_CHANGE_NEXT_SLICE_QUALITY_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(quality_rows)
    return report_path
...
def write_shareholder_change_next_slice_live_summary(
    live_rows: List[Dict[str, str]],
    stats: LiveStats,
    gate: str,
    output_paths: Dict[str, str],
    ...
    acceptable = sum(1 for r in live_rows if r["acceptable"] == "yes")
    lines = [
        "# CNINFO D 类 shareholder_change Next-Slice Live Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** shareholder_change next-slice live path · **live_gate=NOT_APPROVED**",
        "",
        "## Counts",
        "",
        "| 指标 | 值 |",
        ...
        f"d_class_shareholder_change_next_slice_live_path_gate = {SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_shareholder_change_next_slice_live_gate = {SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_GATE}",
        f"d_class_shareholder_change_next_slice_execution_gate = {gate}",
        "```",
        "",
        "**NOT verified** · **NOT production_ready** · **NOT bare PASS**",
        "",
    ...
    summary_path = os.path.join(
        output_paths["reports"],
        "d_class_shareholder_change_next_slice_live_summary.md",
    )
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    return summary_path
...
def execute_shareholder_change_next_slice_live(
    universe_rows: List[ShareholderChangeNextSliceRow],
    output_paths: Dict[str, str],
) -> int:
    """shareholder_change next-slice live：1 次共享 denser-mode type=desc 探针 + 离线 SECCODE 过滤。"""
    endpoints = load_registry_endpoints()
    source_configs = load_table_source_configs()
    component_cfg = copy.deepcopy(
        source_configs.get(SHAREHOLDER_CHANGE_NEXT_SLICE_COMPONENT, {})
    )
    endpoint = endpoints.get(
        SHAREHOLDER_CHANGE_NEXT_SLICE_COMPONENT,
        component_cfg.get("api_url", SHAREHOLDER_CHANGE_NEXT_SLICE_ENDPOINT),
    )
    component_cfg["api_url"] = endpoint
    ...
    for row in universe_rows:
        ...
        if planned > SHAREHOLDER_CHANGE_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            print(
                f"ERROR: {SHAREHOLDER_CHANGE_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"planned={planned}",
                file=sys.stderr,
            )
            return 2

    shared_plan = compute_shareholder_change_next_slice_planned_shared()
    if shared_plan != SHAREHOLDER_CHANGE_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        print(
            f"ERROR: {SHAREHOLDER_CHANGE_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"got={shared_plan}",
            file=sys.stderr,
        )
        return 2
    ...
    for row in sorted(universe_rows, key=lambda r: r.case_id):
        company_records = _filter_company_records(all_records, row.company_code)
        summary = assess_shareholder_change_next_slice_shared_case(
            row,
            company_records,
            http_status,
            last_error,
        ...
        write_shareholder_change_next_slice_live_snapshot(row, summary, output_paths)
        public_summary = {k: v for k, v in summary.items() if not k.startswith("_")}
        case_summaries[row.case_id] = public_summary
        print(
            f"{row.case_id} {public_summary['retrieval_status']}: "
    ...
    cap_issues = validate_shareholder_change_next_slice_request_caps(stats)
    if cap_issues:
        print(
            "ERROR: shareholder_change next-slice request cap validation failed: "
            f"{cap_issues}",
            file=sys.stderr,
        )
        return 2

    gate = compute_shareholder_change_next_slice_execution_gate(
        universe_rows, case_summaries
    )
    if stats.db_writes or stats.minio_writes or stats.rag_runs:
        gate = SHAREHOLDER_CHANGE_NEXT_SLICE_EXECUTION_GATE_FAIL

    live_rows = [
        build_shareholder_change_next_slice_live_row(row, case_summaries[row.case_id])
        for row in sorted(universe_rows, key=lambda r: r.case_id)
        if row.case_id in case_summaries
    ]

    report_path = write_shareholder_change_next_slice_live_report(live_rows, output_paths)
    quality_path = write_shareholder_change_next_slice_quality_report(
        live_rows, output_paths
    )
    summary_path = write_shareholder_change_next_slice_live_summary(
        live_rows, stats, gate, output_paths
    )

    print(
        f"mode=shareholder_change_next_slice_live cases={len(live_rows)} "
        f"cninfo_calls={stats.cninfo_requests} acceptable="
        f"{sum(1 for r in live_rows if r['acceptable'] == 'yes')}/{len(live_rows)}"
    )
    print(f"gate=d_class_shareholder_change_next_slice_execution_gate={gate}")
    print(
        "live_path_gate=d_class_shareholder_change_next_slice_live_path_gate="
        f"{SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_PATH_GATE}"
    )
    print(
        "live_gate=d_class_shareholder_change_next_slice_live_gate="
        f"{SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_GATE}"
    )
    print(f"live_report={report_path}")
    print(f"quality_report={quality_path}")
    print(f"live_summary={summary_path}")
...
def run_shareholder_change_next_slice(args: argparse.Namespace) -> int:
    enforce_shareholder_change_next_slice_forbidden_options(args)
    enforce_shareholder_change_next_slice_live_approval_gate(args)

    if args.universe_csv == DEFAULT_UNIVERSE_CSV:
        print(
            f"ERROR: {SHAREHOLDER_CHANGE_NEXT_SLICE_UNIVERSE_CSV_REQUIRED}",
            file=sys.stderr,
        )
        return 2
    ...
    ok_root, root_err = validate_shareholder_change_next_slice_output_root(args.output_root)
    if not ok_root:
        print(f"ERROR: {root_err}", file=sys.stderr)
        return 2

    universe_rows = load_shareholder_change_next_slice_universe(args.universe_csv)
    universe_issues = validate_shareholder_change_next_slice_universe(universe_rows)
    if universe_issues:
        print(
            "ERROR: shareholder_change next-slice universe validation failed: "
            f"{universe_issues}",
            file=sys.stderr,
        )
        return 2
    ...
    output_root = _normalize_output_root(args.output_root)
    output_paths = ensure_output_layout(output_root, args.mode)
    enforce_shareholder_change_next_slice_write_block_targets(output_paths)

    if args.mode == "live":
        return execute_shareholder_change_next_slice_live(universe_rows, output_paths)

    dry_rows = build_shareholder_change_next_slice_dryrun_rows(universe_rows, output_root)
    write_shareholder_change_next_slice_planned_snapshots(universe_rows, output_paths)
    report_path = write_shareholder_change_next_slice_dryrun_report(dry_rows, output_paths)
    summary_path = write_shareholder_change_next_slice_dryrun_summary(
        dry_rows, output_paths, args.universe_csv
    )
    shared = compute_shareholder_change_next_slice_planned_shared()
    print(
        f"mode=shareholder_change_next_slice_dry_run cases={len(dry_rows)} "
        f"planned_request_count_total={shared} cninfo_calls=0"
    )
    print(
        "gate=d_class_shareholder_change_next_slice_runner_extension_gate="
        f"{SHAREHOLDER_CHANGE_NEXT_SLICE_RUNNER_GATE}"
    )
    print(
        "live_path_gate=d_class_shareholder_change_next_slice_live_path_gate="
        f"{SHAREHOLDER_CHANGE_NEXT_SLICE_LIVE_PATH_GATE}"
...
def load_shareholder_data_next_slice_universe(
    path: str,
) -> List[ShareholderDataNextSliceRow]:
    rows: List[ShareholderDataNextSliceRow] = []
    with open(path, newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            rows.append(
                ShareholderDataNextSliceRow(
                    case_id=str(row.get("case_id", "")).strip(),
                    probe_key=str(row.get("probe_key", "")).strip(),
                    company_code=str(row.get("company_code", "")).strip(),
                    company_name=str(row.get("company_name", "")).strip(),
...
def build_shareholder_data_next_slice_plan() -> List[str]:
    """shareholder_data next-slice：共享 2 次 rdate 全市场截面探针。"""
    return list(SHAREHOLDER_DATA_NEXT_SLICE_SHARED_PROBE_KEYS)


def resolve_shareholder_data_next_slice_shared_probe_key(
    row: ShareholderDataNextSliceRow,
) -> str:
    if row.anchor_rdate in SHAREHOLDER_DATA_NEXT_SLICE_ALLOWED_RDATES:
        return f"rdate_report_period_{row.anchor_rdate}"
    return ""


def _build_shareholder_data_next_slice_params_for_probe(
    probe_key: str,
) -> Dict[str, Any]:
    prefix = "rdate_report_period_"
    if probe_key.startswith(prefix):
        return {"rdate": probe_key[len(prefix) :]}
    raise ValueError(f"unknown_shared_probe_key:{probe_key}")


def compute_shareholder_data_next_slice_planned_shared() -> int:
    return len(build_shareholder_data_next_slice_plan())


def compute_shareholder_data_next_slice_planned_requests(
    row: ShareholderDataNextSliceRow,
) -> int:
    """每案预算槽位（共享请求按案分摊预算 ≤1）。"""
    return 1
...
def resolve_shareholder_data_next_slice_fixture_refs(case_id: str) -> List[str]:
    names = SHAREHOLDER_DATA_NEXT_SLICE_CASE_FIXTURES.get(case_id, ())
    return [
        os.path.join(SHAREHOLDER_DATA_NEXT_SLICE_FIXTURE_DIR, name) for name in names
    ]


def validate_shareholder_data_next_slice_fixtures(
    rows: List[ShareholderDataNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    for row in rows:
        refs = resolve_shareholder_data_next_slice_fixture_refs(row.case_id)
        if not refs:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_FIXTURE_MISSING}:{row.case_id}"
            )
            continue
        for ref in refs:
            if not os.path.isfile(ref):
                issues.append(
                    f"{SHAREHOLDER_DATA_NEXT_SLICE_FIXTURE_MISSING}:"
                    f"{row.case_id}:{os.path.basename(ref)}"
                )
    return issues


def validate_shareholder_data_next_slice_universe(
    rows: List[ShareholderDataNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    if len(rows) != SHAREHOLDER_DATA_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE:
        issues.append(
            f"{SHAREHOLDER_DATA_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH}:got={len(rows)}"
        )
    seen_ids: Set[str] = set()
    budget_total = 0
    for row in rows:
        ...
        if case_id in seen_ids:
            issues.append(f"duplicate_case_id:{case_id}")
        seen_ids.add(case_id)
        if case_id not in SHAREHOLDER_DATA_NEXT_SLICE_ALLOWED_CASE_IDS:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_FORBIDDEN_CASE_ID}:{case_id}"
            )
        for required_flag in SHAREHOLDER_DATA_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS:
            if required_flag not in row.exclude_flags:
                issues.append(
                    f"{SHAREHOLDER_DATA_NEXT_SLICE_EXCLUDE_FLAG_MISSING}:"
                    f"{case_id}:{required_flag}"
                )
        if row.company_code in SHAREHOLDER_DATA_NEXT_SLICE_FORBIDDEN_COMPANY_CODES:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_FORBIDDEN_COMPANY_CODE}:"
                f"{row.company_code}"
            )
        expected_code = SHAREHOLDER_DATA_NEXT_SLICE_EXPECTED_COMPANY_CODES.get(case_id)
        if expected_code and row.company_code != expected_code:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_WRONG_COMPANY_CODE}:"
                f"{case_id}={row.company_code}"
            )
        if row.component != SHAREHOLDER_DATA_NEXT_SLICE_COMPONENT:
            issues.append(f"{SHAREHOLDER_DATA_NEXT_SLICE_WRONG_COMPONENT}:{case_id}")
        if row.next_slice_include.lower() != "yes":
            issues.append(f"{SHAREHOLDER_DATA_NEXT_SLICE_INCLUDE_REQUIRED}:{case_id}")
        if row.query_mode and row.query_mode != SHAREHOLDER_DATA_NEXT_SLICE_QUERY_MODE:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_WRONG_QUERY_MODE}:"
                f"{case_id}={row.query_mode}"
            )
        if row.anchor_rdate not in SHAREHOLDER_DATA_NEXT_SLICE_ALLOWED_RDATES:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_FORBIDDEN_ANCHOR_RDATE}:"
                f"{case_id}={row.anchor_rdate}"
            )
        expected_rdate = SHAREHOLDER_DATA_NEXT_SLICE_EXPECTED_ANCHOR_RDATES.get(case_id)
        if expected_rdate and row.anchor_rdate != expected_rdate:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_WRONG_ANCHOR_RDATE}:"
                f"{case_id}={row.anchor_rdate}"
            )
        probe_key = resolve_shareholder_data_next_slice_shared_probe_key(row)
        if probe_key not in SHAREHOLDER_DATA_NEXT_SLICE_SHARED_PROBE_KEYS:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
                f"{case_id}={probe_key}"
            )
        planned = compute_shareholder_data_next_slice_planned_requests(row)
        if planned > SHAREHOLDER_DATA_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"{case_id}={planned}"
            )
        budget_total += planned
    for required_id in sorted(SHAREHOLDER_DATA_NEXT_SLICE_ALLOWED_CASE_IDS):
        if required_id not in seen_ids:
            issues.append(f"missing_case_id:{required_id}")
    shared = compute_shareholder_data_next_slice_planned_shared()
    if shared != SHAREHOLDER_DATA_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_DATA_NEXT_SLICE_SHARED_PLAN_MISMATCH}:got={shared}"
        )
    if shared > SHAREHOLDER_DATA_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_DATA_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:{shared}"
        )
    if budget_total > SHAREHOLDER_DATA_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_DATA_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:budget={budget_total}"
        )
    issues.extend(validate_shareholder_data_next_slice_fixtures(rows))
    return issues


def validate_shareholder_data_next_slice_output_root(
    output_root: str,
) -> Tuple[bool, str]:
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(DEFAULT_SHAREHOLDER_DATA_NEXT_SLICE_OUTPUT_ROOT)
    blocked_pairs = [
        (
            _normalize_output_root(DEFAULT_OUTPUT_ROOT),
            SHAREHOLDER_DATA_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED,
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, SHAREHOLDER_DATA_NEXT_SLICE_OUTPUT_ROOT_REQUIRED


def enforce_shareholder_data_next_slice_write_block_targets(
    output_paths: Dict[str, str],
) -> None:
    protected = [
        _normalize_output_root(DEFAULT_OUTPUT_ROOT),
    ...
    for key in ("root", "reports"):
        ...
        for blocked in protected:
            if target == blocked or target.startswith(blocked + os.sep):
                print(
                    f"ERROR: {SHAREHOLDER_DATA_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED}:{key}",
                    file=sys.stderr,
                )
                sys.exit(2)


def enforce_shareholder_data_next_slice_forbidden_options(
    args: argparse.Namespace,
) -> None:
    enforce_forbidden_options(args)
    mixed_modes = [
    ...
    for name, enabled in mixed_modes:
        if args.shareholder_data_next_slice and enabled:
            print(
                f"ERROR: {SHAREHOLDER_DATA_NEXT_SLICE_MIXED_MODE_BLOCKED}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    wrong_flags = [
    ...
    for name, enabled in wrong_flags:
        if args.shareholder_data_next_slice and enabled:
            print(
                f"ERROR: {SHAREHOLDER_DATA_NEXT_SLICE_WRONG_APPROVAL_FLAG}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    if (
        not args.shareholder_data_next_slice
        and args.approve_d_class_shareholder_data_next_slice
    ):
        print(
            f"ERROR: {SHAREHOLDER_DATA_NEXT_SLICE_WRONG_APPROVAL_FLAG}:"
            "shareholder_data_next_slice_flag_without_mode",
            file=sys.stderr,
        )
        sys.exit(2)
    for flag_name in ("pdf_download", "ocr", "extraction"):
...
def enforce_shareholder_data_next_slice_live_approval_gate(
    args: argparse.Namespace,
) -> None:
    if args.mode == "live" and args.shareholder_data_next_slice:
        if not args.approve_d_class_shareholder_data_next_slice:
            print(
                f"ERROR: {SHAREHOLDER_DATA_NEXT_SLICE_APPROVAL_REQUIRED}",
                file=sys.stderr,
            )
            sys.exit(2)


def build_shareholder_data_next_slice_dryrun_rows(
    rows: List[ShareholderDataNextSliceRow],
    output_root: str,
) -> List[Dict[str, str]]:
    dry_rows: List[Dict[str, str]] = []
    shared = compute_shareholder_data_next_slice_planned_shared()
    plan = build_shareholder_data_next_slice_plan()
    for row in rows:
        planned_requests = compute_shareholder_data_next_slice_planned_requests(row)
        probe_key = resolve_shareholder_data_next_slice_shared_probe_key(row)
        fixture_refs = resolve_shareholder_data_next_slice_fixture_refs(row.case_id)
        dry_rows.append(
            {
                "case_id": row.case_id,
                "company_code": row.company_code,
                ...
                "planned_output_root": output_root,
                "planned_endpoint": SHAREHOLDER_DATA_NEXT_SLICE_ENDPOINT,
                "fixture_refs": ";".join(os.path.basename(r) for r in fixture_refs),
                "cninfo_call_planned": (
                    "shared" if row.next_slice_include.lower() == "yes" else "no"
                ),
                ...
                "dryrun_status": "planned_ok",
                "notes": (
                    f"anchor_rdate={row.anchor_rdate}; probe_key={probe_key}; "
                    f"plan={','.join(plan)}; "
                    f"query_mode={SHAREHOLDER_DATA_NEXT_SLICE_QUERY_MODE}; "
                    f"shared_rdates={shared}; seccode_filter_offline=yes; "
                    f"multi_rdate_next_slice_only=yes; "
                    f"empty_but_valid_allowed=yes; "
                    f"live_found_path_20251231=NOT_PROVEN; "
                    f"tier1_fixtures={len(fixture_refs)}"
                ),
            }
        )
...
def write_shareholder_data_next_slice_planned_snapshots(
    rows: List[ShareholderDataNextSliceRow],
    output_paths: Dict[str, str],
) -> None:
    snap_dir = os.path.join(output_paths["root"], "planned_snapshots")
    ...
    for row in rows:
        probe_key = resolve_shareholder_data_next_slice_shared_probe_key(row)
        params = _build_shareholder_data_next_slice_params_for_probe(probe_key)
        fixture_refs = resolve_shareholder_data_next_slice_fixture_refs(row.case_id)
        payload = {
            "case_id": row.case_id,
            "probe_key": row.probe_key,
            ...
            "component": row.component,
            "anchor_rdate": row.anchor_rdate,
            "query_mode": SHAREHOLDER_DATA_NEXT_SLICE_QUERY_MODE,
            "shared_probe_key": probe_key,
            "planned_requests": plan,
            "query_params": params,
            "endpoint": SHAREHOLDER_DATA_NEXT_SLICE_ENDPOINT,
            "records_path": SHAREHOLDER_DATA_NEXT_SLICE_RECORDS_PATH,
            "shared_request": True,
            "seccode_filter_offline": True,
            "filter_seccode": row.company_code,
            "multi_rdate_slice": True,
            "expected_behavior": row.expected_behavior,
            "fixture_refs": [
                os.path.relpath(r, BASE_DIR).replace("\\", "/") for r in fixture_refs
            ],
...
def write_shareholder_data_next_slice_dryrun_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=SHAREHOLDER_DATA_NEXT_SLICE_DRYRUN_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_shareholder_data_next_slice_dryrun_summary(
    dry_rows: List[Dict[str, str]],
    output_paths: Dict[str, str],
    universe_csv: str,
) -> str:
    ...
    lines = [
        ...
        "",
        "- component: **shareholder_data**",
        f"- endpoint: `{SHAREHOLDER_DATA_NEXT_SLICE_ENDPOINT}`",
        f"- query mode: **{SHAREHOLDER_DATA_NEXT_SLICE_QUERY_MODE}**",
        "- shared probes: **rdate=20260331** · **rdate=20251231**",
        f"- records_path: **{SHAREHOLDER_DATA_NEXT_SLICE_RECORDS_PATH}**",
        "- company filter: offline SECCODE",
        ...
        "",
        "```text",
        f"d_class_shareholder_data_next_slice_runner_extension_gate = {SHAREHOLDER_DATA_NEXT_SLICE_RUNNER_GATE}",
        f"d_class_shareholder_data_next_slice_live_path_gate = {SHAREHOLDER_DATA_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_shareholder_data_next_slice_live_gate = {SHAREHOLDER_DATA_NEXT_SLICE_LIVE_GATE}",
        "approval_status = STANDING_SCOPE_AUTHORIZED_OFFLINE",
        "approved_for_live = false",
        "```",
        "",
...
def is_shareholder_data_next_slice_acceptable(
    row: ShareholderDataNextSliceRow,
    summary: Dict[str, str],
) -> bool:
    """next-slice acceptable 判定；禁止 disclosure-only 升级为 captured_normal。"""
    rs = summary.get("retrieval_status", "")
    qs = summary.get("quality_status", "")
    eb = row.expected_behavior
    try:
...
def assess_shareholder_data_next_slice_failure_type(
    row: ShareholderDataNextSliceRow,
    summary: Dict[str, str],
) -> str:
    if is_shareholder_data_next_slice_acceptable(row, summary):
        return ""
    rs = summary.get("retrieval_status", "")
    if rs in ("http_error", "blocked"):
        return "transport_or_http_error"
...
def validate_shareholder_data_next_slice_request_caps(stats: LiveStats) -> List[str]:
    issues: List[str] = []
    allowed_shared = set(SHAREHOLDER_DATA_NEXT_SLICE_SHARED_PROBE_KEYS)
    for case_id, count in stats.case_request_counts.items():
        if case_id not in allowed_shared and count > 0:
            issues.append(
                f"{SHAREHOLDER_DATA_NEXT_SLICE_SHARED_REQUEST_REQUIRED}:"
                f"non_shared_case={case_id}={count}"
            )
    ...
    if stats.cninfo_requests > SHAREHOLDER_DATA_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_DATA_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:"
            f"{stats.cninfo_requests}"
        )
    if stats.cninfo_requests > SHAREHOLDER_DATA_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{SHAREHOLDER_DATA_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"cninfo_requests={stats.cninfo_requests}"
        )
...
def assess_shareholder_data_next_slice_shared_case(
    row: ShareholderDataNextSliceRow,
    company_records: List[Dict[str, Any]],
    http_status: int,
    last_error: str,
    ...
    """基于共享 rdate 截面 + SECCODE 过滤结果，生成单案 live summary。"""
    record_count = len(company_records)
    empty_but_valid = "no"
    needs_review = "no"
    notes_parts: List[str] = [
        ...
        "seccode_filter=yes",
        f"query_mode={SHAREHOLDER_DATA_NEXT_SLICE_QUERY_MODE}",
        f"anchor_rdate={row.anchor_rdate}",
    ]
...
def write_shareholder_data_next_slice_live_snapshot(
    row: ShareholderDataNextSliceRow,
    summary: Dict[str, str],
    output_paths: Dict[str, str],
) -> str:
        ...
        json.dump(
            {
                ...
                "component": row.component,
                "endpoint": summary.get(
                    "endpoint_used", SHAREHOLDER_DATA_NEXT_SLICE_ENDPOINT
                ),
                "anchor_rdate": row.anchor_rdate,
...
def compute_shareholder_data_next_slice_execution_gate(
    rows: List[ShareholderDataNextSliceRow],
    case_summaries: Dict[str, Dict[str, str]],
) -> str:
    acceptable = 0
    for row in rows:
        summary = case_summaries.get(row.case_id)
        if summary and is_shareholder_data_next_slice_acceptable(row, summary):
            acceptable += 1
    if acceptable >= 3:
        return SHAREHOLDER_DATA_NEXT_SLICE_EXECUTION_GATE_PASS
    return SHAREHOLDER_DATA_NEXT_SLICE_EXECUTION_GATE_FAIL


def build_shareholder_data_next_slice_live_row(
    row: ShareholderDataNextSliceRow,
    summary: Dict[str, str],
) -> Dict[str, str]:
    acceptable = is_shareholder_data_next_slice_acceptable(row, summary)
    failure_type = assess_shareholder_data_next_slice_failure_type(row, summary)
    return {
        "case_id": row.case_id,
        "company_code": row.company_code,
        "company_name": row.company_name,
...
def write_shareholder_data_next_slice_live_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=SHAREHOLDER_DATA_NEXT_SLICE_LIVE_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_shareholder_data_next_slice_quality_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    quality_rows = [
        {
    ...
    report_path = os.path.join(
        output_paths["reports"],
        "d_class_shareholder_data_next_slice_quality_report.csv",
    )
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=SHAREHOLDER_DATA_NEXT_SLICE_QUALITY_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(quality_rows)
    return report_path
...
def write_shareholder_data_next_slice_live_summary(
    live_rows: List[Dict[str, str]],
    stats: LiveStats,
    gate: str,
    output_paths: Dict[str, str],
    ...
    acceptable = sum(1 for r in live_rows if r["acceptable"] == "yes")
    lines = [
        "# CNINFO D 类 shareholder_data Next-Slice Live Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** shareholder_data next-slice live path · **live_gate=NOT_APPROVED**",
        "",
        "| 指标 | 值 |",
        "|------|-----|",
        f"| cases | **{len(live_rows)}** |",
        ...
        f"| shared_probes | **{SHAREHOLDER_DATA_NEXT_SLICE_PLANNED_SHARED_REQUESTS}** |",
        "",
        "```text",
        f"d_class_shareholder_data_next_slice_live_path_gate = {SHAREHOLDER_DATA_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_shareholder_data_next_slice_live_gate = {SHAREHOLDER_DATA_NEXT_SLICE_LIVE_GATE}",
        f"d_class_shareholder_data_next_slice_execution_gate = {gate}",
        "```",
        "",
    ]
    summary_path = os.path.join(
        output_paths["reports"],
        "d_class_shareholder_data_next_slice_live_summary.md",
    )
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    return summary_path
...
def execute_shareholder_data_next_slice_live(
    universe_rows: List[ShareholderDataNextSliceRow],
    output_paths: Dict[str, str],
) -> int:
    """shareholder_data next-slice live：2 次共享 rdate 截面 + 离线 SECCODE 过滤。"""
    endpoints = load_registry_endpoints()
    source_configs = load_table_source_configs()
    component_cfg = copy.deepcopy(
        source_configs.get(SHAREHOLDER_DATA_NEXT_SLICE_COMPONENT, {})
    )
    endpoint = endpoints.get(
        SHAREHOLDER_DATA_NEXT_SLICE_COMPONENT,
        component_cfg.get("api_url", SHAREHOLDER_DATA_NEXT_SLICE_ENDPOINT),
    )
    component_cfg["api_url"] = endpoint
    ...
    for row in universe_rows:
        ...
        if planned > SHAREHOLDER_DATA_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            print(
                f"ERROR: {SHAREHOLDER_DATA_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"planned={planned}",
                file=sys.stderr,
            )
            return 2

    shared_plan = compute_shareholder_data_next_slice_planned_shared()
    if shared_plan != SHAREHOLDER_DATA_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        print(
            f"ERROR: {SHAREHOLDER_DATA_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"got={shared_plan}",
            file=sys.stderr,
        )
        return 2
    ...
    for probe_key in build_shareholder_data_next_slice_plan():
        params = _build_shareholder_data_next_slice_params_for_probe(probe_key)
        payload, http_status, last_error = _cninfo_request(
            session,
            component_cfg,
    ...
    for row in sorted(universe_rows, key=lambda r: r.case_id):
        ...
        all_records = _extract_records(payload) if payload is not None else []
        company_records = _filter_company_records(all_records, row.company_code)
        summary = assess_shareholder_data_next_slice_shared_case(
            row,
            company_records,
            http_status,
            last_error,
        ...
        write_shareholder_data_next_slice_live_snapshot(row, summary, output_paths)
        public_summary = {
    ...
    cap_issues = validate_shareholder_data_next_slice_request_caps(stats)
    if cap_issues:
        print(
            "ERROR: shareholder_data next-slice request cap validation failed: "
            f"{cap_issues}",
            file=sys.stderr,
        )
        return 2

    gate = compute_shareholder_data_next_slice_execution_gate(
        universe_rows, case_summaries
    )
    if stats.db_writes or stats.minio_writes or stats.rag_runs:
        gate = SHAREHOLDER_DATA_NEXT_SLICE_EXECUTION_GATE_FAIL

    live_rows = [
        build_shareholder_data_next_slice_live_row(
            row, case_summaries[row.case_id]
        )
        for row in sorted(universe_rows, key=lambda r: r.case_id)
        if row.case_id in case_summaries
    ...
    report_path = write_shareholder_data_next_slice_live_report(
        live_rows, output_paths
    )
    quality_path = write_shareholder_data_next_slice_quality_report(
        live_rows, output_paths
    )
    summary_path = write_shareholder_data_next_slice_live_summary(
        live_rows, stats, gate, output_paths
    )

    print(
        f"mode=shareholder_data_next_slice_live cases={len(live_rows)} "
        f"acceptable={sum(1 for r in live_rows if r['acceptable'] == 'yes')}/"
        f"{len(live_rows)} cninfo_calls={stats.cninfo_requests} "
        f"shared_request=2"
    )
    print(
        f"gate=d_class_shareholder_data_next_slice_execution_gate={gate}"
    )
    print(
        "live_path_gate=d_class_shareholder_data_next_slice_live_path_gate="
        f"{SHAREHOLDER_DATA_NEXT_SLICE_LIVE_PATH_GATE}"
    )
    print(
        "live_gate=d_class_shareholder_data_next_slice_live_gate="
        f"{SHAREHOLDER_DATA_NEXT_SLICE_LIVE_GATE}"
    )
    print(f"live_report={report_path}")
    print(f"quality_report={quality_path}")
    print(f"live_summary={summary_path}")
    return 0 if gate == SHAREHOLDER_DATA_NEXT_SLICE_EXECUTION_GATE_PASS else 1


def run_shareholder_data_next_slice(args: argparse.Namespace) -> int:
    enforce_shareholder_data_next_slice_forbidden_options(args)
    enforce_shareholder_data_next_slice_live_approval_gate(args)

    if args.universe_csv == DEFAULT_UNIVERSE_CSV:
        print(
            f"ERROR: {SHAREHOLDER_DATA_NEXT_SLICE_UNIVERSE_CSV_REQUIRED}",
            file=sys.stderr,
        )
        return 2
    ...
    ok_root, root_err = validate_shareholder_data_next_slice_output_root(args.output_root)
    if not ok_root:
        print(f"ERROR: {root_err}", file=sys.stderr)
        return 2

    universe_rows = load_shareholder_data_next_slice_universe(args.universe_csv)
    universe_issues = validate_shareholder_data_next_slice_universe(universe_rows)
    if universe_issues:
        print(
            "ERROR: shareholder_data next-slice universe validation failed: "
            f"{universe_issues}",
            file=sys.stderr,
        )
        return 2
    ...
    output_root = _normalize_output_root(args.output_root)
    output_paths = ensure_output_layout(output_root, args.mode)
    enforce_shareholder_data_next_slice_write_block_targets(output_paths)

    if args.mode == "live":
        return execute_shareholder_data_next_slice_live(universe_rows, output_paths)

    dry_rows = build_shareholder_data_next_slice_dryrun_rows(universe_rows, output_root)
    write_shareholder_data_next_slice_planned_snapshots(universe_rows, output_paths)
    report_path = write_shareholder_data_next_slice_dryrun_report(dry_rows, output_paths)
    summary_path = write_shareholder_data_next_slice_dryrun_summary(
        dry_rows, output_paths, args.universe_csv
    )
    shared = compute_shareholder_data_next_slice_planned_shared()
    print(
        f"mode=shareholder_data_next_slice_dry_run cases={len(dry_rows)} "
        f"planned_request_count_total={shared} cninfo_calls=0"
    )
    print(
        "gate=d_class_shareholder_data_next_slice_runner_extension_gate="
        f"{SHAREHOLDER_DATA_NEXT_SLICE_RUNNER_GATE}"
    )
    print(
        "live_path_gate=d_class_shareholder_data_next_slice_live_path_gate="
        f"{SHAREHOLDER_DATA_NEXT_SLICE_LIVE_PATH_GATE}"
...
def load_fund_industry_allocation_next_slice_universe(
    path: str,
) -> List[FundIndustryAllocationNextSliceRow]:
    rows: List[FundIndustryAllocationNextSliceRow] = []
    with open(path, newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            rows.append(
                FundIndustryAllocationNextSliceRow(
                    case_id=str(row.get("case_id", "")).strip(),
                    probe_key=str(row.get("probe_key", "")).strip(),
                    industry_code=str(row.get("industry_code", "")).strip(),
                    industry_name=str(row.get("industry_name", "")).strip(),
...
def build_fund_industry_allocation_next_slice_plan() -> List[str]:
    """fund_industry_allocation next-slice：≤3 共享探针 default / rdate×2。"""
    return list(FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_PROBE_KEYS)


def resolve_fund_industry_allocation_next_slice_shared_probe_key(
    row: FundIndustryAllocationNextSliceRow,
) -> str:
    if row.query_mode == "default":
        return "default"
    if row.query_mode == "rdate" and row.anchor_rdate:
...
def _build_fund_industry_allocation_next_slice_params_for_probe(
    probe_key: str,
) -> Dict[str, Any]:
    if probe_key == "default":
        return {}
...
def compute_fund_industry_allocation_next_slice_planned_shared() -> int:
    return len(build_fund_industry_allocation_next_slice_plan())


def compute_fund_industry_allocation_next_slice_planned_requests(
    row: FundIndustryAllocationNextSliceRow,
) -> int:
    """每案预算槽位（共享请求按案分摊预算 ≤1）。"""
    return 1
...
def resolve_fund_industry_allocation_next_slice_fixture_refs(
    case_id: str,
) -> List[str]:
    names = FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_CASE_FIXTURES.get(case_id, ())
    return [
        os.path.join(FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FIXTURE_DIR, name)
        for name in names
    ]


def validate_fund_industry_allocation_next_slice_fixtures(
    rows: List[FundIndustryAllocationNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    for row in rows:
        refs = resolve_fund_industry_allocation_next_slice_fixture_refs(row.case_id)
        if not refs:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FIXTURE_MISSING}:{row.case_id}"
            )
            continue
        for ref in refs:
            if not os.path.isfile(ref):
                issues.append(
                    f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FIXTURE_MISSING}:"
                    f"{row.case_id}:{os.path.basename(ref)}"
                )
    return issues


def validate_fund_industry_allocation_next_slice_universe(
    rows: List[FundIndustryAllocationNextSliceRow],
) -> List[str]:
    issues: List[str] = []
    if len(rows) != FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXPECTED_UNIVERSE_SIZE:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_UNIVERSE_SIZE_MISMATCH}:"
            f"got={len(rows)}"
        )
    seen_ids: Set[str] = set()
    budget_total = 0
    for row in rows:
        ...
        if case_id in seen_ids:
            issues.append(f"duplicate_case_id:{case_id}")
        seen_ids.add(case_id)
        if case_id not in FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_ALLOWED_CASE_IDS:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FORBIDDEN_CASE_ID}:{case_id}"
            )
        for required_flag in FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_REQUIRED_EXCLUDE_FLAGS:
            if required_flag not in row.exclude_flags:
                issues.append(
                    f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXCLUDE_FLAG_MISSING}:"
                    f"{case_id}:{required_flag}"
                )
        for forbidden in FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FORBIDDEN_COMPANY_CODES:
            if f"exclude_{forbidden}" not in row.exclude_flags:
                issues.append(
                    f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_FORBIDDEN_COMPANY_CODE}:"
                    f"missing_exclude_{forbidden}"
                )
        expected_code = FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXPECTED_INDUSTRY_CODES.get(
            case_id
        )
        if expected_code is not None and row.industry_code != expected_code:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_INDUSTRY_CODE}:"
                f"{case_id}={row.industry_code}"
            )
        expected_mode = FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXPECTED_QUERY_MODES.get(
            case_id
        )
        if expected_mode is not None and row.query_mode != expected_mode:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_QUERY_MODE}:"
                f"{case_id}={row.query_mode}"
            )
        expected_rdate = FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXPECTED_ANCHOR_RDATES.get(
            case_id
        )
        if expected_rdate is not None and row.anchor_rdate != expected_rdate:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_ANCHOR_RDATE}:"
                f"{case_id}={row.anchor_rdate}"
            )
        if row.component != FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_COMPONENT:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_COMPONENT}:{case_id}"
            )
        if row.next_slice_include.lower() != "yes":
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_INCLUDE_REQUIRED}:{case_id}"
            )
        probe_key = resolve_fund_industry_allocation_next_slice_shared_probe_key(row)
        if probe_key not in FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_PROBE_KEYS:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
                f"{case_id}={probe_key}"
            )
        planned = compute_fund_industry_allocation_next_slice_planned_requests(row)
        if planned > FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"{case_id}={planned}"
            )
        budget_total += planned
    for required_id in sorted(FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_ALLOWED_CASE_IDS):
        if required_id not in seen_ids:
            issues.append(f"missing_case_id:{required_id}")
    shared = compute_fund_industry_allocation_next_slice_planned_shared()
    if shared != FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_PLAN_MISMATCH}:got={shared}"
        )
    if shared > FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:{shared}"
        )
    if budget_total > FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:"
            f"budget={budget_total}"
        )
    issues.extend(validate_fund_industry_allocation_next_slice_fixtures(rows))
    return issues


def validate_fund_industry_allocation_next_slice_output_root(
    output_root: str,
) -> Tuple[bool, str]:
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_OUTPUT_ROOT_REQUIRED


def enforce_fund_industry_allocation_next_slice_write_block_targets(
    output_paths: Dict[str, str],
) -> None:
    protected = [
        _normalize_output_root(DEFAULT_OUTPUT_ROOT),
    ...
    for key in ("root", "reports"):
        ...
        for blocked in protected:
            if target == blocked or target.startswith(blocked + os.sep):
                print(
                    f"ERROR: {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_V1_OUTPUT_ROOT_WRITE_BLOCKED}:{key}",
                    file=sys.stderr,
                )
                sys.exit(2)


def enforce_fund_industry_allocation_next_slice_forbidden_options(
    args: argparse.Namespace,
) -> None:
    enforce_forbidden_options(args)
    mixed_modes = [
    ...
    for name, enabled in mixed_modes:
        if args.fund_industry_allocation_next_slice and enabled:
            print(
                f"ERROR: {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_MIXED_MODE_BLOCKED}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    wrong_flags = [
    ...
    for name, enabled in wrong_flags:
        if args.fund_industry_allocation_next_slice and enabled:
            print(
                f"ERROR: {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_APPROVAL_FLAG}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    if (
        not args.fund_industry_allocation_next_slice
        and args.approve_d_class_fund_industry_allocation_next_slice
    ):
        print(
            f"ERROR: {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_WRONG_APPROVAL_FLAG}:"
            "fund_industry_allocation_next_slice_flag_without_mode",
            file=sys.stderr,
        )
        sys.exit(2)
    for flag_name in ("pdf_download", "ocr", "extraction"):
...
def enforce_fund_industry_allocation_next_slice_live_approval_gate(
    args: argparse.Namespace,
) -> None:
    if args.mode == "live" and args.fund_industry_allocation_next_slice:
        if not args.approve_d_class_fund_industry_allocation_next_slice:
            print(
                f"ERROR: {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_APPROVAL_REQUIRED}",
                file=sys.stderr,
            )
            sys.exit(2)


def build_fund_industry_allocation_next_slice_dryrun_rows(
    rows: List[FundIndustryAllocationNextSliceRow],
    output_root: str,
) -> List[Dict[str, str]]:
    dry_rows: List[Dict[str, str]] = []
    shared = compute_fund_industry_allocation_next_slice_planned_shared()
    plan = build_fund_industry_allocation_next_slice_plan()
    for row in rows:
        planned_requests = compute_fund_industry_allocation_next_slice_planned_requests(
            row
        )
        probe_key = resolve_fund_industry_allocation_next_slice_shared_probe_key(row)
        fixture_refs = resolve_fund_industry_allocation_next_slice_fixture_refs(
            row.case_id
        )
        dry_rows.append(
            {
                ...
                "shared_probe_key": probe_key,
                "planned_output_root": output_root,
                "planned_endpoint": FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_ENDPOINT,
                "fixture_refs": ";".join(os.path.basename(r) for r in fixture_refs),
                "cninfo_call_planned": (
                    "shared" if row.next_slice_include.lower() == "yes" else "no"
                ),
                ...
                "notes": (
                    f"probe_key={probe_key}; plan={','.join(plan)}; "
                    f"shared_probes={shared}; industry_filter_offline=coarse_A_B_C; "
                    f"schema=d_industry_aggregate; no_company_code=yes; "
                    f"empty_but_valid_allowed=yes; tier1_fixtures={len(fixture_refs)}"
                ),
            }
...
def write_fund_industry_allocation_next_slice_planned_snapshots(
    rows: List[FundIndustryAllocationNextSliceRow],
    output_paths: Dict[str, str],
) -> None:
    snap_dir = os.path.join(output_paths["root"], "planned_snapshots")
    ...
    for row in rows:
        probe_key = resolve_fund_industry_allocation_next_slice_shared_probe_key(row)
        params = _build_fund_industry_allocation_next_slice_params_for_probe(probe_key)
        fixture_refs = resolve_fund_industry_allocation_next_slice_fixture_refs(
            row.case_id
        )
        payload = {
            ...
            "planned_requests": plan,
            "query_params": params,
            "endpoint": FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_ENDPOINT,
            "records_path": FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_RECORDS_PATH,
            "shared_request": True,
            "industry_filter_offline": True,
            "industry_filter_mode": "coarse_A_B_C_or_star",
            "filter_industry_code": row.industry_code,
            "expected_logical_table": "d_industry_aggregate",
            "expected_behavior": row.expected_behavior,
            "fixture_refs": [
...
def write_fund_industry_allocation_next_slice_dryrun_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_DRYRUN_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_fund_industry_allocation_next_slice_dryrun_summary(
    dry_rows: List[Dict[str, str]],
    output_paths: Dict[str, str],
    universe_csv: str,
) -> str:
    ...
    budget_total = sum(int(r["planned_request_count"]) for r in dry_rows)
    lines = [
        "# CNINFO D 类 fund_industry_allocation Next-Slice Dry-run Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** fund_industry_allocation next-slice dry-run only · **CNINFO calls = 0** · **NOT APPROVED for live**",
        "",
        "## Counts",
        "",
        "| 指标 | 值 |",
        ...
        "",
        "- component: **fund_industry_allocation**",
        f"- endpoint: `{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_ENDPOINT}`",
        "- query modes: **default** · **rdate**",
        "- shared probes: **default** · **rdate=20260331** · **rdate=20251231**",
        f"- records_path: **{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_RECORDS_PATH}**",
        "- schema: **d_industry_aggregate** · offline coarse F001V filter (A/B/C/*) · **no company_code**",
        "- fixture root: `fixtures/d_class/fund_industry_allocation_next_slice/`",
        "",
        "## Gates",
        "",
        "```text",
        f"d_class_fund_industry_allocation_next_slice_runner_extension_gate = {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_RUNNER_GATE}",
        f"d_class_fund_industry_allocation_next_slice_live_path_gate = {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_fund_industry_allocation_next_slice_live_gate = {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_GATE}",
        "approval_status = STANDING_SCOPE_AUTHORIZED_OFFLINE",
        "approved_for_live = false",
        "```",
        "",
...
def _filter_industry_records_coarse(
    records: List[Dict[str, Any]], industry_code: str
) -> List[Dict[str, Any]]:
    """next-slice 粗粒度过滤：* 全截面；A/B/C 精确或 F001V 前缀匹配（如 C26→C）。"""
    if industry_code in ("*", "", "ALL"):
        return list(records)
    matched: List[Dict[str, Any]] = []
    for rec in records:
        code = str(rec.get("F001V") or rec.get("f001v") or "").strip()
        if code == industry_code or (
            len(industry_code) == 1 and code.startswith(industry_code)
        ):
            matched.append(rec)
    return matched


def is_fund_industry_allocation_next_slice_acceptable(
    row: FundIndustryAllocationNextSliceRow,
    summary: Dict[str, str],
) -> bool:
    rs = summary.get("retrieval_status", "")
...
def assess_fund_industry_allocation_next_slice_failure_type(
    row: FundIndustryAllocationNextSliceRow,
    summary: Dict[str, str],
) -> str:
    if is_fund_industry_allocation_next_slice_acceptable(row, summary):
        return ""
    rs = summary.get("retrieval_status", "")
    if rs in ("http_error", "blocked"):
        return "transport_or_http_error"
...
def validate_fund_industry_allocation_next_slice_request_caps(
    stats: LiveStats,
) -> List[str]:
    issues: List[str] = []
    allowed_shared = set(FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_PROBE_KEYS)
    for case_id, count in stats.case_request_counts.items():
        if case_id not in allowed_shared and count > 0:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_REQUEST_REQUIRED}:"
                f"non_shared_case={case_id}={count}"
            )
        if case_id in allowed_shared and count > 1:
            issues.append(
    ...
    if stats.cninfo_requests > FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_TOTAL_CAP_EXCEEDED}:"
            f"{stats.cninfo_requests}"
        )
    if stats.cninfo_requests > FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"cninfo_requests={stats.cninfo_requests}"
        )
...
def assess_fund_industry_allocation_next_slice_shared_case(
    row: FundIndustryAllocationNextSliceRow,
    industry_records: List[Dict[str, Any]],
    http_status: int,
    last_error: str,
    ...
    if last_error in ("rate_limited",) or last_error.startswith("network_error"):
        ...
        empty_but_valid = "yes"
        notes_parts.append(
            "industry-level zero rows after coarse F001V filter; legal empty per quality policy"
        )
    else:
        retrieval_status = "found"
        lineage_status = "discovered"
        quality_status = "pass"
        notes_parts.append(f"found {record_count} row(s) for coarse industry filter")
...
def write_fund_industry_allocation_next_slice_live_snapshot(
    row: FundIndustryAllocationNextSliceRow,
    summary: Dict[str, str],
    output_paths: Dict[str, str],
) -> str:
...
def compute_fund_industry_allocation_next_slice_execution_gate(
    universe_rows: List[FundIndustryAllocationNextSliceRow],
    case_summaries: Dict[str, Dict[str, str]],
) -> str:
    acceptable = 0
    for row in universe_rows:
        ...
        if is_fund_industry_allocation_next_slice_acceptable(row, summary):
            acceptable += 1
    if acceptable >= 3:
        return FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXECUTION_GATE_PASS
    return FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXECUTION_GATE_FAIL


def build_fund_industry_allocation_next_slice_live_row(
    row: FundIndustryAllocationNextSliceRow,
    summary: Dict[str, str],
) -> Dict[str, str]:
    acceptable = is_fund_industry_allocation_next_slice_acceptable(row, summary)
    failure_type = assess_fund_industry_allocation_next_slice_failure_type(
        row, summary
    )
    return {
        "case_id": row.case_id,
...
def write_fund_industry_allocation_next_slice_live_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_fund_industry_allocation_next_slice_quality_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    quality_rows = [
        {
    ...
    report_path = os.path.join(
        output_paths["reports"],
        "d_class_fund_industry_allocation_next_slice_quality_report.csv",
    )
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_QUALITY_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(quality_rows)
    return report_path
...
def write_fund_industry_allocation_next_slice_live_summary(
    live_rows: List[Dict[str, str]],
    stats: LiveStats,
    gate: str,
    output_paths: Dict[str, str],
    ...
    acceptable = sum(1 for r in live_rows if r["acceptable"] == "yes")
    lines = [
        "# CNINFO D 类 fund_industry_allocation Next-Slice Live Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** fund_industry_allocation next-slice live path · **live_gate=NOT_APPROVED**",
        "",
        "## Counts",
        "",
        "| 指标 | 值 |",
        ...
        f"d_class_fund_industry_allocation_next_slice_live_path_gate = {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_PATH_GATE}",
        f"d_class_fund_industry_allocation_next_slice_live_gate = {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_GATE}",
        f"d_class_fund_industry_allocation_next_slice_execution_gate = {gate}",
        "```",
        "",
        "**NOT verified** · **NOT production_ready** · **NOT bare PASS**",
        "",
    ...
    summary_path = os.path.join(
        output_paths["reports"],
        "d_class_fund_industry_allocation_next_slice_live_summary.md",
    )
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    return summary_path
...
def execute_fund_industry_allocation_next_slice_live(
    universe_rows: List[FundIndustryAllocationNextSliceRow],
    output_paths: Dict[str, str],
) -> int:
    """fund_industry_allocation next-slice live：≤3 共享探针 + 离线粗粒度 F001V 过滤。"""
    endpoints = load_registry_endpoints()
    source_configs = load_table_source_configs()
    component_cfg = copy.deepcopy(
        source_configs.get(FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_COMPONENT, {})
    )
    endpoint = endpoints.get(
        FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_COMPONENT,
        component_cfg.get("api_url", FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_ENDPOINT),
    )
    component_cfg["api_url"] = endpoint
    # next-slice 共享探针依赖 rdate override；registry params_location=none 会静默丢弃参数
    if str(component_cfg.get("params_location") or "").lower() == "none":
        component_cfg["params_location"] = "form"
    ...
    for row in universe_rows:
        ...
        if planned > FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PER_CASE_MAX_REQUESTS:
            print(
                f"ERROR: {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PER_CASE_CAP_EXCEEDED}:"
                f"planned={planned}",
                file=sys.stderr,
            )
            return 2

    shared_plan = compute_fund_industry_allocation_next_slice_planned_shared()
    if shared_plan != FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_PLANNED_SHARED_REQUESTS:
        print(
            f"ERROR: {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_SHARED_PLAN_MISMATCH}:"
            f"got={shared_plan}",
            file=sys.stderr,
        )
        return 2
    ...
    stats = LiveStats()
    probe_payloads: Dict[str, Tuple[Any, int, str, Dict[str, Any]]] = {}
    for probe_key in build_fund_industry_allocation_next_slice_plan():
        params = _build_fund_industry_allocation_next_slice_params_for_probe(probe_key)
        payload, http_status, last_error = _cninfo_request(
            session,
            component_cfg,
    ...
    for row in sorted(universe_rows, key=lambda r: r.case_id):
        ...
        payload, http_status, last_error, used_params = probe_payloads[probe_key]
        all_records = _extract_records(payload) if payload is not None else []
        industry_records = _filter_industry_records_coarse(
            all_records, row.industry_code
        )
        summary = assess_fund_industry_allocation_next_slice_shared_case(
            row,
            industry_records,
            http_status,
            last_error,
        ...
        write_fund_industry_allocation_next_slice_live_snapshot(
            row, summary, output_paths
        )
        public_summary = {
            k: v for k, v in summary.items() if not k.startswith("_")
    ...
    cap_issues = validate_fund_industry_allocation_next_slice_request_caps(stats)
    if cap_issues:
        print(
            "ERROR: fund_industry_allocation next-slice request cap validation failed: "
            f"{cap_issues}",
            file=sys.stderr,
        )
        return 2

    gate = compute_fund_industry_allocation_next_slice_execution_gate(
        universe_rows, case_summaries
    )
    if stats.db_writes or stats.minio_writes or stats.rag_runs:
        gate = FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_EXECUTION_GATE_FAIL

    live_rows = [
        build_fund_industry_allocation_next_slice_live_row(
            row, case_summaries[row.case_id]
        )
        for row in sorted(universe_rows, key=lambda r: r.case_id)
        if row.case_id in case_summaries
    ...
    report_path = write_fund_industry_allocation_next_slice_live_report(
        live_rows, output_paths
    )
    quality_path = write_fund_industry_allocation_next_slice_quality_report(
        live_rows, output_paths
    )
    summary_path = write_fund_industry_allocation_next_slice_live_summary(
        live_rows, stats, gate, output_paths
    )

    print(
        f"mode=fund_industry_allocation_next_slice_live cases={len(live_rows)} "
        f"cninfo_calls={stats.cninfo_requests} acceptable="
        f"{sum(1 for r in live_rows if r['acceptable'] == 'yes')}/{len(live_rows)}"
    )
    print(
        f"gate=d_class_fund_industry_allocation_next_slice_execution_gate={gate}"
    )
    print(
        "live_path_gate=d_class_fund_industry_allocation_next_slice_live_path_gate="
        f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_PATH_GATE}"
    )
    print(
        "live_gate=d_class_fund_industry_allocation_next_slice_live_gate="
        f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_GATE}"
    )
    print(f"live_report={report_path}")
    print(f"quality_report={quality_path}")
    print(f"live_summary={summary_path}")
...
def run_fund_industry_allocation_next_slice(args: argparse.Namespace) -> int:
    enforce_fund_industry_allocation_next_slice_forbidden_options(args)
    enforce_fund_industry_allocation_next_slice_live_approval_gate(args)

    if args.universe_csv == DEFAULT_UNIVERSE_CSV:
        print(
            f"ERROR: {FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_UNIVERSE_CSV_REQUIRED}",
            file=sys.stderr,
        )
        return 2
    ...
    ok_root, root_err = validate_fund_industry_allocation_next_slice_output_root(
        args.output_root
    )
    if not ok_root:
        print(f"ERROR: {root_err}", file=sys.stderr)
    ...
    universe_rows = load_fund_industry_allocation_next_slice_universe(args.universe_csv)
    universe_issues = validate_fund_industry_allocation_next_slice_universe(
        universe_rows
    )
    if universe_issues:
        print(
            "ERROR: fund_industry_allocation next-slice universe validation failed: "
            f"{universe_issues}",
            file=sys.stderr,
        )
        return 2
    ...
    output_root = _normalize_output_root(args.output_root)
    output_paths = ensure_output_layout(output_root, args.mode)
    enforce_fund_industry_allocation_next_slice_write_block_targets(output_paths)

    if args.mode == "live":
        return execute_fund_industry_allocation_next_slice_live(
            universe_rows, output_paths
        )

    dry_rows = build_fund_industry_allocation_next_slice_dryrun_rows(
        universe_rows, output_root
    )
    write_fund_industry_allocation_next_slice_planned_snapshots(
        universe_rows, output_paths
    )
    report_path = write_fund_industry_allocation_next_slice_dryrun_report(
        dry_rows, output_paths
    )
    summary_path = write_fund_industry_allocation_next_slice_dryrun_summary(
        dry_rows, output_paths, args.universe_csv
    )
    shared = compute_fund_industry_allocation_next_slice_planned_shared()
    print(
        f"mode=fund_industry_allocation_next_slice_dry_run cases={len(dry_rows)} "
        f"planned_request_count_total={shared} cninfo_calls=0"
    )
    print(
        "gate=d_class_fund_industry_allocation_next_slice_runner_extension_gate="
        f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_RUNNER_GATE}"
    )
    print(
        "live_path_gate=d_class_fund_industry_allocation_next_slice_live_path_gate="
        f"{FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_LIVE_PATH_GATE}"
...
def load_fund_industry_allocation_further_scale_universe(
    path: str,
) -> List[FundIndustryAllocationFurtherScaleRow]:
    rows: List[FundIndustryAllocationFurtherScaleRow] = []
    with open(path, newline="", encoding="utf-8") as f:
        for row in csv.DictReader(f):
            rows.append(
                FundIndustryAllocationFurtherScaleRow(
                    case_id=str(row.get("case_id", "")).strip(),
                    probe_key=str(row.get("probe_key", "")).strip(),
                    industry_code=str(row.get("industry_code", "")).strip(),
                    industry_name=str(row.get("industry_name", "")).strip(),
...
def build_fund_industry_allocation_further_scale_plan() -> List[str]:
    """fund_industry_allocation further-scale：≤3 共享探针 default / rdate×2。"""
    return list(FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_PROBE_KEYS)


def resolve_fund_industry_allocation_further_scale_shared_probe_key(
    row: FundIndustryAllocationFurtherScaleRow,
) -> str:
    if row.query_mode == "default":
        return "default"
    if row.query_mode == "rdate" and row.anchor_rdate:
...
def _build_fund_industry_allocation_further_scale_params_for_probe(
    probe_key: str,
) -> Dict[str, Any]:
    if probe_key == "default":
        return {}
...
def compute_fund_industry_allocation_further_scale_planned_shared() -> int:
    return len(build_fund_industry_allocation_further_scale_plan())


def compute_fund_industry_allocation_further_scale_planned_requests(
    row: FundIndustryAllocationFurtherScaleRow,
) -> int:
    """每案预算槽位（共享请求按案分摊预算 ≤1）。"""
    return 1
...
def resolve_fund_industry_allocation_further_scale_fixture_refs(
    case_id: str,
) -> List[str]:
    names = FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_CASE_FIXTURES.get(case_id, ())
    return [
        os.path.join(FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FIXTURE_DIR, name)
        for name in names
    ]


def validate_fund_industry_allocation_further_scale_fixtures(
    rows: List[FundIndustryAllocationFurtherScaleRow],
) -> List[str]:
    issues: List[str] = []
    for row in rows:
        refs = resolve_fund_industry_allocation_further_scale_fixture_refs(row.case_id)
        if not refs:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FIXTURE_MISSING}:{row.case_id}"
            )
            continue
        for ref in refs:
            if not os.path.isfile(ref):
                issues.append(
                    f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FIXTURE_MISSING}:"
                    f"{row.case_id}:{os.path.basename(ref)}"
                )
    return issues


def validate_fund_industry_allocation_further_scale_universe(
    rows: List[FundIndustryAllocationFurtherScaleRow],
) -> List[str]:
    issues: List[str] = []
    if len(rows) != FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXPECTED_UNIVERSE_SIZE:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_UNIVERSE_SIZE_MISMATCH}:"
            f"got={len(rows)}"
        )
    seen_ids: Set[str] = set()
    budget_total = 0
    for row in rows:
        ...
        if case_id in seen_ids:
            issues.append(f"duplicate_case_id:{case_id}")
        seen_ids.add(case_id)
        if case_id not in FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_ALLOWED_CASE_IDS:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FORBIDDEN_CASE_ID}:{case_id}"
            )
        for required_flag in FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_REQUIRED_EXCLUDE_FLAGS:
            if required_flag not in row.exclude_flags:
                issues.append(
                    f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXCLUDE_FLAG_MISSING}:"
                    f"{case_id}:{required_flag}"
                )
        for forbidden in FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FORBIDDEN_COMPANY_CODES:
            if f"exclude_{forbidden}" not in row.exclude_flags:
                issues.append(
                    f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_FORBIDDEN_COMPANY_CODE}:"
                    f"missing_exclude_{forbidden}"
                )
        expected_code = FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXPECTED_INDUSTRY_CODES.get(
            case_id
        )
        if expected_code is not None and row.industry_code != expected_code:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_INDUSTRY_CODE}:"
                f"{case_id}={row.industry_code}"
            )
        expected_mode = FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXPECTED_QUERY_MODES.get(
            case_id
        )
        if expected_mode is not None and row.query_mode != expected_mode:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_QUERY_MODE}:"
                f"{case_id}={row.query_mode}"
            )
        expected_rdate = FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXPECTED_ANCHOR_RDATES.get(
            case_id
        )
        if expected_rdate is not None and row.anchor_rdate != expected_rdate:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_ANCHOR_RDATE}:"
                f"{case_id}={row.anchor_rdate}"
            )
        if row.component != FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_COMPONENT:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_COMPONENT}:{case_id}"
            )
        if row.further_scale_include.lower() != "yes":
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_INCLUDE_REQUIRED}:{case_id}"
            )
        probe_key = resolve_fund_industry_allocation_further_scale_shared_probe_key(row)
        if probe_key not in FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_PROBE_KEYS:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_PLAN_MISMATCH}:"
                f"{case_id}={probe_key}"
            )
        planned = compute_fund_industry_allocation_further_scale_planned_requests(row)
        if planned > FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PER_CASE_MAX_REQUESTS:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PER_CASE_CAP_EXCEEDED}:"
                f"{case_id}={planned}"
            )
        budget_total += planned
    for required_id in sorted(FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_ALLOWED_CASE_IDS):
        if required_id not in seen_ids:
            issues.append(f"missing_case_id:{required_id}")
    shared = compute_fund_industry_allocation_further_scale_planned_shared()
    if shared != FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_PLAN_MISMATCH}:got={shared}"
        )
    if shared > FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_TOTAL_CAP_EXCEEDED}:{shared}"
        )
    if budget_total > FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_TOTAL_CAP_EXCEEDED}:"
            f"budget={budget_total}"
        )
    issues.extend(validate_fund_industry_allocation_further_scale_fixtures(rows))
    return issues


def validate_fund_industry_allocation_further_scale_output_root(
    output_root: str,
) -> Tuple[bool, str]:
    root = _normalize_output_root(output_root)
    allowed = _normalize_output_root(
    ...
    if root == allowed or root.startswith(allowed + os.sep):
        return True, ""
    return False, FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_OUTPUT_ROOT_REQUIRED


def enforce_fund_industry_allocation_further_scale_write_block_targets(
    output_paths: Dict[str, str],
) -> None:
    protected = [
        _normalize_output_root(DEFAULT_OUTPUT_ROOT),
    ...
    for key in ("root", "reports"):
        ...
        for blocked in protected:
            if target == blocked or target.startswith(blocked + os.sep):
                print(
                    f"ERROR: {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_V1_OUTPUT_ROOT_WRITE_BLOCKED}:{key}",
                    file=sys.stderr,
                )
                sys.exit(2)


def enforce_fund_industry_allocation_further_scale_forbidden_options(
    args: argparse.Namespace,
) -> None:
    enforce_forbidden_options(args)
    mixed_modes = [
    ...
    for name, enabled in mixed_modes:
        if args.fund_industry_allocation_further_scale and enabled:
            print(
                f"ERROR: {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_MIXED_MODE_BLOCKED}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    wrong_flags = [
    ...
    for name, enabled in wrong_flags:
        if args.fund_industry_allocation_further_scale and enabled:
            print(
                f"ERROR: {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_APPROVAL_FLAG}:{name}",
                file=sys.stderr,
            )
            sys.exit(2)
    if (
        not args.fund_industry_allocation_further_scale
        and args.approve_d_class_fund_industry_allocation_further_scale
    ):
        print(
            f"ERROR: {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_WRONG_APPROVAL_FLAG}:"
            "fund_industry_allocation_further_scale_flag_without_mode",
            file=sys.stderr,
        )
        sys.exit(2)
    for flag_name in ("pdf_download", "ocr", "extraction"):
...
def enforce_fund_industry_allocation_further_scale_live_approval_gate(
    args: argparse.Namespace,
) -> None:
    if args.mode == "live" and args.fund_industry_allocation_further_scale:
        if not args.approve_d_class_fund_industry_allocation_further_scale:
            print(
                f"ERROR: {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_APPROVAL_REQUIRED}",
                file=sys.stderr,
            )
            sys.exit(2)


def build_fund_industry_allocation_further_scale_dryrun_rows(
    rows: List[FundIndustryAllocationFurtherScaleRow],
    output_root: str,
) -> List[Dict[str, str]]:
    dry_rows: List[Dict[str, str]] = []
    shared = compute_fund_industry_allocation_further_scale_planned_shared()
    plan = build_fund_industry_allocation_further_scale_plan()
    for row in rows:
        planned_requests = compute_fund_industry_allocation_further_scale_planned_requests(
            row
        )
        probe_key = resolve_fund_industry_allocation_further_scale_shared_probe_key(row)
        fixture_refs = resolve_fund_industry_allocation_further_scale_fixture_refs(
            row.case_id
        )
        dry_rows.append(
            {
                ...
                "shared_probe_key": probe_key,
                "planned_output_root": output_root,
                "planned_endpoint": FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_ENDPOINT,
                "fixture_refs": ";".join(os.path.basename(r) for r in fixture_refs),
                "cninfo_call_planned": (
                    "shared" if row.further_scale_include.lower() == "yes" else "no"
                ),
                "pdf_download": "no",
                "ocr": "no",
                "extraction": "no",
                ...
                "notes": (
                    f"probe_key={probe_key}; plan={','.join(plan)}; "
                    f"shared_probes={shared}; industry_filter_offline=coarse_A_B_star; "
                    f"schema=d_industry_aggregate; no_company_code=yes; "
                    f"empty_but_valid_allowed=yes; tier1_fixtures={len(fixture_refs)}"
                ),
            }
...
def write_fund_industry_allocation_further_scale_planned_snapshots(
    rows: List[FundIndustryAllocationFurtherScaleRow],
    output_paths: Dict[str, str],
) -> None:
    snap_dir = os.path.join(output_paths["root"], "planned_snapshots")
    ...
    for row in rows:
        probe_key = resolve_fund_industry_allocation_further_scale_shared_probe_key(row)
        params = _build_fund_industry_allocation_further_scale_params_for_probe(probe_key)
        fixture_refs = resolve_fund_industry_allocation_further_scale_fixture_refs(
            row.case_id
        )
        payload = {
            ...
            "planned_requests": plan,
            "query_params": params,
            "endpoint": FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_ENDPOINT,
            "records_path": FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_RECORDS_PATH,
            "shared_request": True,
            "industry_filter_offline": True,
            "industry_filter_mode": "coarse_A_B_star",
            "filter_industry_code": row.industry_code,
            "expected_logical_table": "d_industry_aggregate",
            "expected_behavior": row.expected_behavior,
            "fixture_refs": [
...
def write_fund_industry_allocation_further_scale_dryrun_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_DRYRUN_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_fund_industry_allocation_further_scale_dryrun_summary(
    dry_rows: List[Dict[str, str]],
    output_paths: Dict[str, str],
    universe_csv: str,
) -> str:
    ...
    budget_total = sum(int(r["planned_request_count"]) for r in dry_rows)
    lines = [
        "# CNINFO D 类 fund_industry_allocation Further-Scale Dry-run Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** fund_industry_allocation further-scale dry-run only · **CNINFO calls = 0** · **NOT APPROVED for live**",
        "",
        "## Counts",
        "",
        "| 指标 | 值 |",
        ...
        "",
        "- component: **fund_industry_allocation**",
        f"- endpoint: `{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_ENDPOINT}`",
        "- query modes: **default** · **rdate**",
        "- shared probes: **default** · **rdate=20260331** · **rdate=20251231**",
        f"- records_path: **{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_RECORDS_PATH}**",
        "- schema: **d_industry_aggregate** · offline coarse F001V filter (A/B/*) · **no company_code**",
        "- fixture root: `fixtures/d_class/fund_industry_allocation_further_scale/`",
        "",
        "## Gates",
        "",
        "```text",
        f"d_class_fund_industry_allocation_further_scale_runner_extension_gate = {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_RUNNER_GATE}",
        f"d_class_fund_industry_allocation_further_scale_live_path_gate = {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_PATH_GATE}",
        f"d_class_fund_industry_allocation_further_scale_live_gate = {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_GATE}",
        "approval_status = STANDING_SCOPE_AUTHORIZED_OFFLINE",
        "approved_for_live = false",
        "```",
        "",
...
def _filter_industry_records_coarse(
    ...
    """further-scale 粗粒度过滤：* 全截面；A/B/C 精确或 F001V 前缀匹配（如 C26→C）。"""
    if industry_code in ("*", "", "ALL"):
        return list(records)
    matched: List[Dict[str, Any]] = []
    for rec in records:
...
def is_fund_industry_allocation_further_scale_acceptable(
    row: FundIndustryAllocationFurtherScaleRow,
    summary: Dict[str, str],
) -> bool:
    rs = summary.get("retrieval_status", "")
...
def assess_fund_industry_allocation_further_scale_failure_type(
    row: FundIndustryAllocationFurtherScaleRow,
    summary: Dict[str, str],
) -> str:
    if is_fund_industry_allocation_further_scale_acceptable(row, summary):
        return ""
    rs = summary.get("retrieval_status", "")
    if rs in ("http_error", "blocked"):
        return "transport_or_http_error"
...
def validate_fund_industry_allocation_further_scale_request_caps(
    stats: LiveStats,
) -> List[str]:
    issues: List[str] = []
    allowed_shared = set(FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_PROBE_KEYS)
    for case_id, count in stats.case_request_counts.items():
        if case_id not in allowed_shared and count > 0:
            issues.append(
                f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_REQUEST_REQUIRED}:"
                f"non_shared_case={case_id}={count}"
            )
        if case_id in allowed_shared and count > 1:
            issues.append(
    ...
    if stats.cninfo_requests > FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_TOTAL_MAX_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_TOTAL_CAP_EXCEEDED}:"
            f"{stats.cninfo_requests}"
        )
    if stats.cninfo_requests > FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PLANNED_SHARED_REQUESTS:
        issues.append(
            f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_PLAN_MISMATCH}:"
            f"cninfo_requests={stats.cninfo_requests}"
        )
...
def assess_fund_industry_allocation_further_scale_shared_case(
    row: FundIndustryAllocationFurtherScaleRow,
    industry_records: List[Dict[str, Any]],
    http_status: int,
    last_error: str,
...
def write_fund_industry_allocation_further_scale_live_snapshot(
    row: FundIndustryAllocationFurtherScaleRow,
    summary: Dict[str, str],
    output_paths: Dict[str, str],
) -> str:
...
def compute_fund_industry_allocation_further_scale_execution_gate(
    universe_rows: List[FundIndustryAllocationFurtherScaleRow],
    case_summaries: Dict[str, Dict[str, str]],
) -> str:
    acceptable = 0
    for row in universe_rows:
        ...
        if is_fund_industry_allocation_further_scale_acceptable(row, summary):
            acceptable += 1
    if acceptable >= 3:
        return FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXECUTION_GATE_PASS
    return FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXECUTION_GATE_FAIL


def build_fund_industry_allocation_further_scale_live_row(
    row: FundIndustryAllocationFurtherScaleRow,
    summary: Dict[str, str],
) -> Dict[str, str]:
    acceptable = is_fund_industry_allocation_further_scale_acceptable(row, summary)
    failure_type = assess_fund_industry_allocation_further_scale_failure_type(
        row, summary
    )
    return {
        "case_id": row.case_id,
...
def write_fund_industry_allocation_further_scale_live_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    report_path = os.path.join(
        output_paths["reports"],
    ...
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(rows)
    return report_path
...
def write_fund_industry_allocation_further_scale_quality_report(
    rows: List[Dict[str, str]], output_paths: Dict[str, str]
) -> str:
    quality_rows = [
        {
    ...
    report_path = os.path.join(
        output_paths["reports"],
        "d_class_fund_industry_allocation_further_scale_quality_report.csv",
    )
    with open(report_path, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f, fieldnames=FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_QUALITY_REPORT_COLUMNS
        )
        writer.writeheader()
        writer.writerows(quality_rows)
    return report_path
...
def write_fund_industry_allocation_further_scale_live_summary(
    live_rows: List[Dict[str, str]],
    stats: LiveStats,
    gate: str,
    output_paths: Dict[str, str],
    ...
    acceptable = sum(1 for r in live_rows if r["acceptable"] == "yes")
    lines = [
        "# CNINFO D 类 fund_industry_allocation Further-Scale Live Summary",
        "",
        f"_生成时间：{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S')} UTC_",
        "",
        "> **性质：** fund_industry_allocation further-scale live path · **live_gate=NOT_APPROVED**",
        "",
        "## Counts",
        "",
        "| 指标 | 值 |",
        ...
        f"d_class_fund_industry_allocation_further_scale_live_path_gate = {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_PATH_GATE}",
        f"d_class_fund_industry_allocation_further_scale_live_gate = {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_GATE}",
        f"d_class_fund_industry_allocation_further_scale_execution_gate = {gate}",
        "```",
        "",
        "**NOT verified** · **NOT production_ready** · **NOT bare PASS**",
        "",
    ...
    summary_path = os.path.join(
        output_paths["reports"],
        "d_class_fund_industry_allocation_further_scale_live_summary.md",
    )
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    return summary_path
...
def execute_fund_industry_allocation_further_scale_live(
    universe_rows: List[FundIndustryAllocationFurtherScaleRow],
    output_paths: Dict[str, str],
) -> int:
    """fund_industry_allocation further-scale live：≤3 共享探针 + 离线粗粒度 F001V 过滤。"""
    endpoints = load_registry_endpoints()
    source_configs = load_table_source_configs()
    component_cfg = copy.deepcopy(
        source_configs.get(FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_COMPONENT, {})
    )
    endpoint = endpoints.get(
        FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_COMPONENT,
        component_cfg.get("api_url", FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_ENDPOINT),
    )
    component_cfg["api_url"] = endpoint
    # further-scale 共享探针依赖 rdate override；registry params_location=none 会静默丢弃参数
    if str(component_cfg.get("params_location") or "").lower() == "none":
        component_cfg["params_location"] = "form"
    ...
    for row in universe_rows:
        ...
        if planned > FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PER_CASE_MAX_REQUESTS:
            print(
                f"ERROR: {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PER_CASE_CAP_EXCEEDED}:"
                f"planned={planned}",
                file=sys.stderr,
            )
            return 2

    shared_plan = compute_fund_industry_allocation_further_scale_planned_shared()
    if shared_plan != FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_PLANNED_SHARED_REQUESTS:
        print(
            f"ERROR: {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_SHARED_PLAN_MISMATCH}:"
            f"got={shared_plan}",
            file=sys.stderr,
        )
        return 2
    ...
    stats = LiveStats()
    probe_payloads: Dict[str, Tuple[Any, int, str, Dict[str, Any]]] = {}
    for probe_key in build_fund_industry_allocation_further_scale_plan():
        params = _build_fund_industry_allocation_further_scale_params_for_probe(probe_key)
        payload, http_status, last_error = _cninfo_request(
            session,
            component_cfg,
    ...
    for row in sorted(universe_rows, key=lambda r: r.case_id):
        ...
        summary = assess_fund_industry_allocation_further_scale_shared_case(
            row,
            industry_records,
            http_status,
            last_error,
        ...
        write_fund_industry_allocation_further_scale_live_snapshot(
            row, summary, output_paths
        )
        public_summary = {
            k: v for k, v in summary.items() if not k.startswith("_")
    ...
    cap_issues = validate_fund_industry_allocation_further_scale_request_caps(stats)
    if cap_issues:
        print(
            "ERROR: fund_industry_allocation further-scale request cap validation failed: "
            f"{cap_issues}",
            file=sys.stderr,
        )
        return 2

    gate = compute_fund_industry_allocation_further_scale_execution_gate(
        universe_rows, case_summaries
    )
    if stats.db_writes or stats.minio_writes or stats.rag_runs:
        gate = FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_EXECUTION_GATE_FAIL

    live_rows = [
        build_fund_industry_allocation_further_scale_live_row(
            row, case_summaries[row.case_id]
        )
        for row in sorted(universe_rows, key=lambda r: r.case_id)
        if row.case_id in case_summaries
    ...
    report_path = write_fund_industry_allocation_further_scale_live_report(
        live_rows, output_paths
    )
    quality_path = write_fund_industry_allocation_further_scale_quality_report(
        live_rows, output_paths
    )
    summary_path = write_fund_industry_allocation_further_scale_live_summary(
        live_rows, stats, gate, output_paths
    )

    print(
        f"mode=fund_industry_allocation_further_scale_live cases={len(live_rows)} "
        f"cninfo_calls={stats.cninfo_requests} acceptable="
        f"{sum(1 for r in live_rows if r['acceptable'] == 'yes')}/{len(live_rows)}"
    )
    print(
        f"gate=d_class_fund_industry_allocation_further_scale_execution_gate={gate}"
    )
    print(
        "live_path_gate=d_class_fund_industry_allocation_further_scale_live_path_gate="
        f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_PATH_GATE}"
    )
    print(
        "live_gate=d_class_fund_industry_allocation_further_scale_live_gate="
        f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_GATE}"
    )
    print(f"live_report={report_path}")
    print(f"quality_report={quality_path}")
    print(f"live_summary={summary_path}")
...
def run_fund_industry_allocation_further_scale(args: argparse.Namespace) -> int:
    enforce_fund_industry_allocation_further_scale_forbidden_options(args)
    enforce_fund_industry_allocation_further_scale_live_approval_gate(args)

    if args.universe_csv == DEFAULT_UNIVERSE_CSV:
        print(
            f"ERROR: {FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_UNIVERSE_CSV_REQUIRED}",
            file=sys.stderr,
        )
        return 2
    ...
    ok_root, root_err = validate_fund_industry_allocation_further_scale_output_root(
        args.output_root
    )
    if not ok_root:
        print(f"ERROR: {root_err}", file=sys.stderr)
    ...
    universe_rows = load_fund_industry_allocation_further_scale_universe(args.universe_csv)
    universe_issues = validate_fund_industry_allocation_further_scale_universe(
        universe_rows
    )
    if universe_issues:
        print(
            "ERROR: fund_industry_allocation further-scale universe validation failed: "
            f"{universe_issues}",
            file=sys.stderr,
        )
        return 2
    ...
    output_root = _normalize_output_root(args.output_root)
    output_paths = ensure_output_layout(output_root, args.mode)
    enforce_fund_industry_allocation_further_scale_write_block_targets(output_paths)

    if args.mode == "live":
        return execute_fund_industry_allocation_further_scale_live(
            universe_rows, output_paths
        )

    dry_rows = build_fund_industry_allocation_further_scale_dryrun_rows(
        universe_rows, output_root
    )
    write_fund_industry_allocation_further_scale_planned_snapshots(
        universe_rows, output_paths
    )
    report_path = write_fund_industry_allocation_further_scale_dryrun_report(
        dry_rows, output_paths
    )
    summary_path = write_fund_industry_allocation_further_scale_dryrun_summary(
        dry_rows, output_paths, args.universe_csv
    )
    shared = compute_fund_industry_allocation_further_scale_planned_shared()
    print(
        f"mode=fund_industry_allocation_further_scale_dry_run cases={len(dry_rows)} "
        f"planned_request_count_total={shared} cninfo_calls=0"
    )
    print(
        "gate=d_class_fund_industry_allocation_further_scale_runner_extension_gate="
        f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_RUNNER_GATE}"
    )
    print(
        "live_path_gate=d_class_fund_industry_allocation_further_scale_live_path_gate="
        f"{FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_LIVE_PATH_GATE}"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="启用 equity_pledge next-slice 模式（仅 DEP101–DEP105）",
    )
    parser.add_argument(
        "--approve-d-class-equity-pledge-next-slice",
        action="store_true",
        help="显式批准 equity_pledge next-slice live（须人工批准 · 本任务未授权）",
    )
    parser.add_argument(
        "--restricted-shares-unlock-next-slice",
        action="store_true",
        help="启用 restricted_shares_unlock next-slice 模式（仅 DRU101–DRU105）",
    )
    parser.add_argument(
        "--approve-d-class-restricted-shares-unlock-next-slice",
        action="store_true",
        help="显式批准 restricted_shares_unlock next-slice live（须人工批准 · 本任务未授权）",
    )
    parser.add_argument(
        "--shareholder-change-next-slice",
        action="store_true",
        help="启用 shareholder_change next-slice 模式（仅 DSC101–DSC105）",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="启用 abnormal_trading next-slice 模式（仅 DAT101–DAT105）",
    )
    parser.add_argument(
        "--approve-d-class-abnormal-trading-next-slice",
        action="store_true",
        help="显式批准 abnormal_trading next-slice live（须人工批准 · 本任务未授权）",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="启用 shareholder_data next-slice 模式（仅 DSD101–DSD105）",
    )
    parser.add_argument(
        "--approve-d-class-shareholder-data-next-slice",
        action="store_true",
        help="显式批准 shareholder_data next-slice live（须人工批准 · 本任务未授权）",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="启用 fund_industry_allocation next-slice 模式（仅 DFIA101–DFIA105）",
    )
    parser.add_argument(
        "--approve-d-class-fund-industry-allocation-next-slice",
        action="store_true",
        help="显式批准 fund_industry_allocation next-slice live（须人工批准 · 本任务未授权）",
    )
    parser.add_argument(
        "--fund-industry-allocation-further-scale",
        action="store_true",
        help="启用 fund_industry_allocation further-scale 模式（仅 DFIA201–DFIA205）",
    )
    parser.add_argument(
        "--approve-d-class-fund-industry-allocation-further-scale",
        action="store_true",
        help="显式批准 fund_industry_allocation further-scale live（须人工批准 · 本任务未授权）",
    )
    return parser
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if args.shareholder_change_next_slice:
        if args.output_root is None:
            args.output_root = DEFAULT_SHAREHOLDER_CHANGE_NEXT_SLICE_OUTPUT_ROOT
        return run_shareholder_change_next_slice(args)

    if args.restricted_shares_unlock_next_slice:
        if args.output_root is None:
            args.output_root = DEFAULT_RESTRICTED_SHARES_UNLOCK_NEXT_SLICE_OUTPUT_ROOT
        return run_restricted_shares_unlock_next_slice(args)

    if args.equity_pledge_next_slice:
        if args.output_root is None:
            args.output_root = DEFAULT_EQUITY_PLEDGE_NEXT_SLICE_OUTPUT_ROOT
        return run_equity_pledge_next_slice(args)

    if args.abnormal_trading_next_slice:
        if args.output_root is None:
            args.output_root = DEFAULT_ABNORMAL_TRADING_NEXT_SLICE_OUTPUT_ROOT
        return run_abnormal_trading_next_slice(args)

    if args.shareholder_data_next_slice:
        if args.output_root is None:
            args.output_root = DEFAULT_SHAREHOLDER_DATA_NEXT_SLICE_OUTPUT_ROOT
        return run_shareholder_data_next_slice(args)

    if args.fund_industry_allocation_further_scale:
        if args.output_root is None:
            args.output_root = DEFAULT_FUND_INDUSTRY_ALLOCATION_FURTHER_SCALE_OUTPUT_ROOT
        return run_fund_industry_allocation_further_scale(args)

    if args.fund_industry_allocation_next_slice:
        if args.output_root is None:
            args.output_root = DEFAULT_FUND_INDUSTRY_ALLOCATION_NEXT_SLICE_OUTPUT_ROOT
        return run_fund_industry_allocation_next_slice(args)
