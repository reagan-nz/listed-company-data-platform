"""
CNINFO C-class — 规模 union_status composition identity lock +
residual_coverage composition identity lock + resume_taxonomy_disposition
composition identity lock + cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle
identity lock（离线 · C-FM-49）。

在 C-FM-48（overlap/dry863/batch_priority / combined_dryrun_cohort / company_coverage_scale /
cross_full_market_scale_repro_wall_meta_bundle）已 commit 且 EXECUTE 仍
human-held 之上，继续非 seal 规模/安全能力
（不新增 seal / decision-await / commit-boundary；非 extension↔drift 循环）：
  1) FM48 packet / fingerprint / gate / unique·dryrun·coverage·wall ledgers 零漂移连续
  2) union_status_composition_identity_lock：2134/106/9 组成身份锁
  3) residual_coverage_composition_identity_lock：coverage=117 组成身份锁
  4) resume_taxonomy_disposition_composition_identity_lock：28/1/0 disposition 组成身份锁
  5) cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock：union/residual/resume disposition 墙元捆绑
  6) output-root：MOCK3–50 冻结 · MOCK51 放行
  7) FM-01..05 + FM-12..47 gate battery（跳过 seal FM06–11）

禁止：CNINFO live · production EXECUTE · 覆盖 MOCK3–50 / 权威 dual-layer 索引 ·
...
from cninfo_c_class_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety import (  # noqa: E402
    FROZEN_OVERLAP_MEMBERSHIP_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM48_FROZEN_OVERLAP_FP,
    FROZEN_DRY863_EXTRAS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM48_FROZEN_DRY863_FP,
    FROZEN_BATCH_PRIORITY_COMPOSITION_IDENTITY_LOCK_FP_SHA256 as FM48_FROZEN_BATCH_FP,
    FROZEN_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 as FM48_FROZEN_WALL_META_FP,
    EXPECTED_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256 as FM48_EXPECTED_OVERLAP_COMP_SHA256,
    EXPECTED_DRY863_EXTRAS_COMPOSITION_SHA256 as FM48_EXPECTED_DRY863_COMP_SHA256,
    EXPECTED_BATCH_PRIORITY_COMPOSITION_SHA256 as FM48_EXPECTED_BATCH_COMP_SHA256,
    EXPECTED_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_SHA256 as FM48_EXPECTED_WALL_META_SHA256,
    EXPECTED_BATCH_PRIORITY as FM48_EXPECTED_BATCH_PRIORITY,
)
...
FM48_MOCK_ROOT_REL = (
    "outputs/validation/"
    "_mock_c_fm48_scale_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_safety"
)
FM48_PACKET_REL = f"{FM48_MOCK_ROOT_REL}/scale_packet.json"
FM48_FINGERPRINT_REL = f"{FM48_MOCK_ROOT_REL}/scale_fingerprint.json"
FM48_OVERLAP_MEMBERSHIP_REL = (
    f"{FM48_MOCK_ROOT_REL}/overlap_membership_composition_identity_lock_ledger.json"
)
FM48_DRY863_EXTRAS_REL = (
    f"{FM48_MOCK_ROOT_REL}/dry863_extras_composition_identity_lock_ledger.json"
)
FM48_BATCH_PRIORITY_REL = (
    f"{FM48_MOCK_ROOT_REL}/batch_priority_composition_identity_lock_ledger.json"
)
FM48_WALL_META_REL = (
    f"{FM48_MOCK_ROOT_REL}/"
    "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_identity_lock_ledger.json"
)

# C-FM-49 本包冻结指纹（运行后由 fingerprint_* 锁定）
FROZEN_UNION_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "3ffa72a457a8359678bb8f1fe43b61b3a2b78b9c78e721b12b73bbc8d0f79660"
)
FROZEN_RESIDUAL_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "37bdf47697d186ed2c7bf79637dc76fd4cec7ee8869ccb6ebc90a6360807ae98"
)
FROZEN_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = (
    "c7f4001f4c5f01e35e2a8057ec3d3ddf524147a1efab0bd4b49575b2d8dea10e"
)
FROZEN_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 = (
    "01f3e967dc7f83d86f5ff38fe4c7476ef0b2a50d8bb65fa3e3c6f0f86852b176"
)
# FM48 连续锚点（只读）
FROZEN_FM48_OVERLAP_MEMBERSHIP_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM48_FROZEN_OVERLAP_FP
FROZEN_FM48_DRY863_EXTRAS_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM48_FROZEN_DRY863_FP
FROZEN_FM48_BATCH_PRIORITY_COMPOSITION_IDENTITY_LOCK_FP_SHA256 = FM48_FROZEN_BATCH_FP
FROZEN_FM48_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256 = (
    FM48_FROZEN_WALL_META_FP
)
...
EXPECTED_FM48_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256 = FM48_EXPECTED_OVERLAP_COMP_SHA256
EXPECTED_FM48_DRY863_EXTRAS_COMPOSITION_SHA256 = FM48_EXPECTED_DRY863_COMP_SHA256
EXPECTED_FM48_BATCH_PRIORITY_COMPOSITION_SHA256 = FM48_EXPECTED_BATCH_COMP_SHA256
EXPECTED_FM48_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_SHA256 = (
    FM48_EXPECTED_WALL_META_SHA256
)
EXPECTED_UNION_STATUS_PRIMARY_COMPOSITION_SHA256 = (
    "1256457149f34b438186ec40c73b46785bf2b78b66bfa327ff31869f8238b521"
)
...
EXPECTED_RESIDUAL_COVERAGE_PRIMARY_COMPOSITION_SHA256 = (
    "6f01a0ffde2a90804807af2ba1389af6a24cf4b5a049cd04f5b161b6c4b3c481"
)
...
EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_COMPOSITION_SHA256 = (
    "cfa0690ef9f53df05bcaeb698efd89a55ceea5125045bf8b7357778d698561bf"
)
# 兼容旧名（本包主轴）
EXPECTED_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256 = EXPECTED_UNION_STATUS_PRIMARY_COMPOSITION_SHA256
EXPECTED_DRY863_EXTRAS_COMPOSITION_SHA256 = EXPECTED_RESIDUAL_COVERAGE_PRIMARY_COMPOSITION_SHA256
EXPECTED_BATCH_PRIORITY_COMPOSITION_SHA256 = EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_COMPOSITION_SHA256
...
EXPECTED_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_SHA256 = (
    "11ef5db5b9469daa35adb16e59d6822c695426438065002573f1fae3e3857096"
)
...
EXPECTED_OVERLAP_MEMBERSHIP_FORMULA = EXPECTED_UNION_STATUS_PRIMARY_FORMULA
EXPECTED_DRY863_EXTRAS_FORMULA = EXPECTED_RESIDUAL_COVERAGE_PRIMARY_FORMULA
EXPECTED_BATCH_PRIORITY_FORMULA = EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_FORMULA
EXPECTED_BATCH_PRIORITY = list(FM48_EXPECTED_BATCH_PRIORITY)
EXPECTED_FM49_PROTECTED_ROOT_REGISTRY_FORMULA = "MOCK3-50+MOCK51+resume+auth"
EXPECTED_FM49_PROTECTED_ROOT_REGISTRY_FORMULA = "MOCK3-50+MOCK51+resume+auth"
...
EXPECTED_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE = {
    "union_status_composition": {
        "formula": EXPECTED_UNION_STATUS_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_UNION_STATUS_PRIMARY_COMPOSITION_SHA256,
        "union_complete": EXPECTED_UNION_COMPLETE,
        "union_partial": EXPECTED_UNION_PARTIAL,
        "union_failed": EXPECTED_UNION_FAILED,
    },
    "residual_coverage_composition": {
        "formula": EXPECTED_RESIDUAL_COVERAGE_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_RESIDUAL_COVERAGE_PRIMARY_COMPOSITION_SHA256,
        "residual_safety_coverage": EXPECTED_RESIDUAL_SAFETY_COVERAGE,
        "residual_formula": EXPECTED_RESIDUAL_FORMULA,
    },
    "resume_taxonomy_disposition_composition": {
        "formula": EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_FORMULA,
        "composition_sha256": EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_COMPOSITION_SHA256,
        "resume_improved": EXPECTED_RESUME_IMPROVED,
        "resume_same": EXPECTED_RESUME_SAME,
        "resume_worse": EXPECTED_RESUME_WORSE,
        "disposition": "resume_taxonomy_disposition",
    },
    "cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle": {
        "bundle_sha256": EXPECTED_FM48_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_SHA256,
    },
    "stable_metrics_wall": {
        "harvest_unique_union": EXPECTED_HARVEST_UNIQUE_UNION,
        "surface_unique": EXPECTED_SURFACE_UNIQUE,
...
THIS_TASK_ROOT_ID = "C-ROOT-MOCK51"
PRIOR_TASK_ROOT_ID = "C-ROOT-MOCK50"
RESUME_HARVEST_ROOT_ID = "C-ROOT-002"

FROZEN_ROOT_IDS_MUST_BLOCK = tuple(f"C-ROOT-MOCK{i}" for i in range(3, 51))
...
class FullMarketUnionStatusResidualCoverageResumeTaxonomyDispositionWallMetaBundlePaths:
    """只读输入与隔离写根路径规格。"""
    ...
    fm48_gate_json_rel: str = FM48_GATE_JSON_REL
    fm48_packet_rel: str = FM48_PACKET_REL
    fm48_fingerprint_rel: str = FM48_FINGERPRINT_REL
    fm48_overlap_membership_rel: str = FM48_OVERLAP_MEMBERSHIP_REL
    fm48_dry863_extras_rel: str = FM48_DRY863_EXTRAS_REL
    fm48_batch_priority_rel: str = FM48_BATCH_PRIORITY_REL
    fm48_wall_meta_rel: str = FM48_WALL_META_REL
...
def assert_fm49_output_root(
    output_root: str, *, base_dir: str = BASE_DIR
) -> str:
    """
    C-FM-49 写根：须 validation/_mock_*，不得覆盖 MOCK3–50，
    ...
    if root_id is not None and root_id != THIS_TASK_ROOT_ID:
        raise RuntimeError(
            ...
            f"(C-FM-49 only writes {THIS_TASK_ROOT_ID} or ephemeral _mock_*)"
        )
...
def fingerprint_residual_coverage_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """residual_coverage composition identity lock 指纹（coverage=117）。"""
    doc = {
        "kind": "residual_coverage_composition_identity_lock",
        "union_partial": EXPECTED_UNION_PARTIAL,
        "union_failed": EXPECTED_UNION_FAILED,
...
def fingerprint_resume_taxonomy_disposition_composition_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """resume_taxonomy_disposition composition identity lock 指纹（28/1/0）。"""
    doc = {
        "kind": "resume_taxonomy_disposition_composition_identity_lock",
        "resume_improved": EXPECTED_RESUME_IMPROVED,
        "resume_same": EXPECTED_RESUME_SAME,
        "resume_worse": EXPECTED_RESUME_WORSE,
        "resume_total": EXPECTED_RESUME_TOTAL,
        "composition_sha256": EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_COMPOSITION_SHA256,
        "resume_taxonomy_disposition_formula": EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_FORMULA,
        "disposition": "resume_taxonomy_disposition",
        "deny_composition_mutate": True,
        "deny_inflate": True,
        "deny_deflate": True,
...
def fingerprint_cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock() -> Tuple[str, Dict[str, Any]]:
    """cross union/residual/resume disposition wall-meta bundle identity lock 指纹。"""
    doc = {
        "kind": "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock",
        "compositions": {
            k: dict(v)
            for k, v in EXPECTED_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE.items()
        },
        "bundle_sha256": EXPECTED_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_SHA256,
        "deny_composition_mutate": True,
...
# 兼容别名
fingerprint_overlap_membership_composition_identity_lock = fingerprint_union_status_composition_identity_lock
fingerprint_dry863_extras_composition_identity_lock = fingerprint_residual_coverage_composition_identity_lock
fingerprint_batch_priority_composition_identity_lock = fingerprint_resume_taxonomy_disposition_composition_identity_lock
...
def evaluate_union_status_composition_mutation(
    *,
    proposed_union_complete: int,
    proposed_union_partial: int,
    proposed_union_failed: int,
) -> Dict[str, Any]:
    """评估 2134/106/9 组成变异；一律拒绝。"""
    matches = (
        proposed_union_complete == EXPECTED_UNION_COMPLETE
        and proposed_union_partial == EXPECTED_UNION_PARTIAL
        and proposed_union_failed == EXPECTED_UNION_FAILED
    )
    return {
        "proposed": {
            "union_complete": proposed_union_complete,
            "union_partial": proposed_union_partial,
            "union_failed": proposed_union_failed,
        },
        "frozen": {
            "union_complete": EXPECTED_UNION_COMPLETE,
            "union_partial": EXPECTED_UNION_PARTIAL,
...
def evaluate_residual_coverage_composition_mutation(
    *,
    proposed_residual_safety_coverage: int,
    proposed_residual_formula: str,
) -> Dict[str, Any]:
    """评估 coverage=117 组成变异；一律拒绝。"""
    matches = (
        proposed_residual_safety_coverage == EXPECTED_RESIDUAL_SAFETY_COVERAGE
        and proposed_residual_formula == EXPECTED_RESIDUAL_FORMULA
    )
    return {
        "proposed": {
            "residual_safety_coverage": proposed_residual_safety_coverage,
            "residual_formula": proposed_residual_formula,
        },
        "frozen": {
            "residual_safety_coverage": EXPECTED_RESIDUAL_SAFETY_COVERAGE,
            "residual_formula": EXPECTED_RESIDUAL_FORMULA,
        ...
        "matches_frozen": matches,
        "mutation_allowed": False,
        "reason": "residual_coverage_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_resume_taxonomy_disposition_composition_mutation(
    *,
    proposed_resume_improved: int,
    proposed_resume_same: int,
    proposed_resume_worse: int,
) -> Dict[str, Any]:
    """评估 28/1/0 disposition 组成变异；一律拒绝。"""
    matches = (
        proposed_resume_improved == EXPECTED_RESUME_IMPROVED
        and proposed_resume_same == EXPECTED_RESUME_SAME
        and proposed_resume_worse == EXPECTED_RESUME_WORSE
    )
    return {
        "proposed": {
            "resume_improved": proposed_resume_improved,
            "resume_same": proposed_resume_same,
            "resume_worse": proposed_resume_worse,
        },
        "frozen": {
            "resume_improved": EXPECTED_RESUME_IMPROVED,
            "resume_same": EXPECTED_RESUME_SAME,
        ...
        "matches_frozen": matches,
        "mutation_allowed": False,
        "reason": "resume_taxonomy_disposition_composition_identity_frozen_pre_execute",
        "hold": "KEEP_EXECUTE_FALSE",
    }


def evaluate_cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_mutation(
    *, proposed_compositions: Dict[str, Any]
) -> Dict[str, Any]:
    """评估 cross union/residual/resume disposition wall-meta bundle 变异；一律拒绝。"""
    frozen = {
        k: dict(v)
        for k, v in EXPECTED_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE.items()
    }
    ...
    return {
        ...
        "mutation_allowed": False,
        "reason": (
            "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_frozen_pre_execute"
        ),
        "hold": "KEEP_EXECUTE_FALSE",
    }
...
# 兼容别名
evaluate_overlap_membership_composition_mutation = evaluate_union_status_composition_mutation
evaluate_dry863_extras_composition_mutation = evaluate_residual_coverage_composition_mutation
evaluate_batch_priority_composition_mutation = evaluate_resume_taxonomy_disposition_composition_mutation
...
def build_union_status_composition_identity_lock_rows(
    paths: FullMarketUnionStatusResidualCoverageResumeTaxonomyDispositionWallMetaBundlePaths,
    *,
    ...
    identity_ok = (
        ...
        == EXPECTED_HARVEST_UNIQUE_UNION
        and comp_sha == EXPECTED_UNION_STATUS_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_UNION_STATUS_PRIMARY_COMPOSITION_SHA256
    )
    ...
    rows.append(
        _row(
            ...
            expected="2134/106/9",
            observed=(
                f"formula={EXPECTED_UNION_STATUS_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
    ...
    sample_denials = [
        evaluate_union_status_composition_mutation(
            proposed_union_complete=2133,
            proposed_union_partial=EXPECTED_UNION_PARTIAL,
            proposed_union_failed=EXPECTED_UNION_FAILED,
        ),
        evaluate_union_status_composition_mutation(
            proposed_union_complete=EXPECTED_UNION_COMPLETE,
            proposed_union_partial=0,
            proposed_union_failed=EXPECTED_UNION_FAILED,
        ),
        evaluate_union_status_composition_mutation(
            proposed_union_complete=0,
            proposed_union_partial=0,
            proposed_union_failed=0,
        ),
        evaluate_union_status_composition_mutation(
            proposed_union_complete=EXPECTED_UNION_COMPLETE,
            proposed_union_partial=EXPECTED_UNION_PARTIAL,
    ...
    flags_ok = (
        ...
        and fp == FROZEN_UNION_STATUS_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["union_status_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="union_status_composition_flags",
            layer="union_status_composition_identity_lock",
    ...
    rows.append(
        _row(
            ...
            ok=all_ok,
            notes="ok" if all_ok else "union_status_lock_incomplete",
        )
    )
    meta = {
        "fingerprint": fp,
...
def build_residual_coverage_composition_identity_lock_rows(
    paths: FullMarketUnionStatusResidualCoverageResumeTaxonomyDispositionWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """residual_coverage composition identity lock（coverage=117）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_residual_coverage_composition_identity_lock()

    comp_payload = {
        "kind": "residual_coverage_composition",
        "union_partial": EXPECTED_UNION_PARTIAL,
        "union_failed": EXPECTED_UNION_FAILED,
        "surface_harvest_delta_n": EXPECTED_SURFACE_HARVEST_DELTA_N,
        "residual_safety_coverage": EXPECTED_RESIDUAL_SAFETY_COVERAGE,
    ...
    identity_ok = (
        EXPECTED_RESIDUAL_COVERAGE_PRIMARY_FORMULA == "coverage=117"
        and EXPECTED_RESIDUAL_SAFETY_COVERAGE == 117
        and EXPECTED_UNION_PARTIAL + EXPECTED_UNION_FAILED + EXPECTED_SURFACE_HARVEST_DELTA_N
        == EXPECTED_RESIDUAL_SAFETY_COVERAGE
        and comp_sha == EXPECTED_RESIDUAL_COVERAGE_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_RESIDUAL_COVERAGE_PRIMARY_COMPOSITION_SHA256
    )
    checks["residual_coverage_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="residual_coverage_composition_identity",
            layer="residual_coverage_composition_identity_lock",
            expected="coverage=117",
            observed=(
                f"formula={EXPECTED_RESIDUAL_COVERAGE_PRIMARY_FORMULA};"
                f"n={EXPECTED_RESIDUAL_SAFETY_COVERAGE};sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "residual_coverage_composition_drift",
        )
    )

    sample_denials = [
        evaluate_residual_coverage_composition_mutation(
            proposed_residual_safety_coverage=116,
            proposed_residual_formula=EXPECTED_RESIDUAL_FORMULA,
        ),
        evaluate_residual_coverage_composition_mutation(
            proposed_residual_safety_coverage=EXPECTED_RESIDUAL_SAFETY_COVERAGE,
            proposed_residual_formula="0+0+0=0",
        ),
        evaluate_residual_coverage_composition_mutation(
            proposed_residual_safety_coverage=0,
            proposed_residual_formula="x",
        ),
        evaluate_residual_coverage_composition_mutation(
            proposed_residual_safety_coverage=EXPECTED_RESIDUAL_SAFETY_COVERAGE,
            proposed_residual_formula=EXPECTED_RESIDUAL_FORMULA,
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["residual_coverage_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="residual_coverage_composition_mutation_denied",
            layer="residual_coverage_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_RESIDUAL_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["residual_coverage_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="residual_coverage_composition_flags",
            layer="residual_coverage_composition_identity_lock",
            expected=FROZEN_RESIDUAL_COVERAGE_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "residual_coverage_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["residual_coverage_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="residual_coverage_composition_identity_lock_all_pass",
            layer="residual_coverage_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "residual_coverage_lock_incomplete",
        )
    )
    meta = {
        "fingerprint": fp,
...
def build_resume_taxonomy_disposition_composition_identity_lock_rows(
    paths: FullMarketUnionStatusResidualCoverageResumeTaxonomyDispositionWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    """resume_taxonomy_disposition composition identity lock（28/1/0）。"""
    del paths, base_dir
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    fp, doc = fingerprint_resume_taxonomy_disposition_composition_identity_lock()

    comp_payload = {
        "kind": "resume_taxonomy_disposition_composition",
        "resume_improved": EXPECTED_RESUME_IMPROVED,
        "resume_same": EXPECTED_RESUME_SAME,
        "resume_worse": EXPECTED_RESUME_WORSE,
        "resume_total": EXPECTED_RESUME_TOTAL,
    ...
    identity_ok = (
        EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_FORMULA == "28/1/0"
        and EXPECTED_RESUME_IMPROVED + EXPECTED_RESUME_SAME + EXPECTED_RESUME_WORSE
        == EXPECTED_RESUME_TOTAL
        and comp_sha == EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_COMPOSITION_SHA256
        and doc["composition_sha256"] == EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_COMPOSITION_SHA256
    )
    checks["resume_taxonomy_disposition_composition_identity"] = identity_ok
    rows.append(
        _row(
            check_id="resume_taxonomy_disposition_composition_identity",
            layer="resume_taxonomy_disposition_composition_identity_lock",
            expected="28/1/0",
            observed=(
                f"formula={EXPECTED_RESUME_TAXONOMY_DISPOSITION_PRIMARY_FORMULA};"
                f"sha={comp_sha[:12]}"
            ),
            ok=identity_ok,
            notes="ok" if identity_ok else "resume_taxonomy_disposition_composition_drift",
        )
    )

    sample_denials = [
        evaluate_resume_taxonomy_disposition_composition_mutation(
            proposed_resume_improved=27,
            proposed_resume_same=EXPECTED_RESUME_SAME,
            proposed_resume_worse=EXPECTED_RESUME_WORSE,
        ),
        evaluate_resume_taxonomy_disposition_composition_mutation(
            proposed_resume_improved=EXPECTED_RESUME_IMPROVED,
            proposed_resume_same=0,
            proposed_resume_worse=EXPECTED_RESUME_WORSE,
        ),
        evaluate_resume_taxonomy_disposition_composition_mutation(
            proposed_resume_improved=0,
            proposed_resume_same=0,
            proposed_resume_worse=0,
        ),
        evaluate_resume_taxonomy_disposition_composition_mutation(
            proposed_resume_improved=EXPECTED_RESUME_IMPROVED,
            proposed_resume_same=EXPECTED_RESUME_SAME,
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks["resume_taxonomy_disposition_composition_mutation_denied"] = mut_ok
    rows.append(
        _row(
            check_id="resume_taxonomy_disposition_composition_mutation_denied",
            layer="resume_taxonomy_disposition_composition_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
            notes="ok" if mut_ok else "resume_taxonomy_disposition_mutation_leak",
        )
    )
    ...
    flags_ok = (
        ...
        and doc["deny_deflate"] is True
        and doc["hold"] == "KEEP_EXECUTE_FALSE"
        and fp == FROZEN_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_IDENTITY_LOCK_FP_SHA256
    )
    checks["resume_taxonomy_disposition_composition_flags"] = flags_ok
    rows.append(
        _row(
            check_id="resume_taxonomy_disposition_composition_flags",
            layer="resume_taxonomy_disposition_composition_identity_lock",
            expected=FROZEN_RESUME_TAXONOMY_DISPOSITION_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
            notes="ok" if flags_ok else "resume_taxonomy_disposition_flags_drift",
        )
    )

    all_ok = all(checks.values()) if checks else False
    checks["resume_taxonomy_disposition_composition_identity_lock_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="resume_taxonomy_disposition_composition_identity_lock_all_pass",
            layer="resume_taxonomy_disposition_composition_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "resume_taxonomy_disposition_lock_incomplete",
        )
    )
    meta = {
        "fingerprint": fp,
...
def build_cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock_rows(
    paths: FullMarketUnionStatusResidualCoverageResumeTaxonomyDispositionWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool], Dict[str, Any]]:
    ...
    identity_ok = (
        ...
        and compositions["union_status_composition"]["formula"] == "2134/106/9"
        and compositions["residual_coverage_composition"]["residual_safety_coverage"] == 117
        and compositions["resume_taxonomy_disposition_composition"]["formula"] == "28/1/0"
    )
    checks[
        "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity"
    ] = identity_ok
    rows.append(
        _row(
            check_id="cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity",
            layer="cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock",
            expected="2134/106/9+coverage=117+28/1/0+disposition_wall",
    ...
    mutated["union_status_composition"] = {
        "formula": "0/0/0",
        "composition_sha256": EXPECTED_UNION_STATUS_PRIMARY_COMPOSITION_SHA256,
        "union_complete": 0,
        "union_partial": 0,
    ...
    mut_ok = all(d["mutation_allowed"] is False for d in sample_denials)
    checks[
        "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_mutation_denied"
    ] = mut_ok
    rows.append(
        _row(
            check_id="cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_mutation_denied",
            layer="cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock",
            expected="mutation_allowed=false",
            observed=f"samples={len(sample_denials)};all_denied={mut_ok}",
            ok=mut_ok,
    ...
    checks[
        "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_flags"
    ] = flags_ok
    rows.append(
        _row(
            check_id="cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_flags",
            layer="cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock",
            expected=FROZEN_CROSS_FULL_MARKET_UNION_STATUS_RESIDUAL_COVERAGE_RESUME_TAXONOMY_DISPOSITION_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256,
            observed=fp,
            ok=flags_ok,
    ...
    all_ok = all(checks.values()) if checks else False
    checks[
        "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock_all_pass"
    ] = all_ok
    rows.append(
        _row(
            check_id="cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock_all_pass",
            layer="cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock",
            expected="identity+deny+flags",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
# 兼容别名
build_overlap_membership_composition_identity_lock_rows = build_union_status_composition_identity_lock_rows
build_dry863_extras_composition_identity_lock_rows = build_residual_coverage_composition_identity_lock_rows
build_batch_priority_composition_identity_lock_rows = build_resume_taxonomy_disposition_composition_identity_lock_rows
...
def build_fm48_continuity_rows(
    paths: FullMarketUnionStatusResidualCoverageResumeTaxonomyDispositionWallMetaBundlePaths,
    *,
    base_dir: str = BASE_DIR,
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """FM48 packet / fingerprint / gate / 四 ledger 零漂移。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}

    packet = load_json(_abs(paths.fm48_packet_rel, base_dir=base_dir))
    fp_doc = load_json(_abs(paths.fm48_fingerprint_rel, base_dir=base_dir))
    gate_doc = load_json(_abs(paths.fm48_gate_json_rel, base_dir=base_dir))
    us_led = load_json(_abs(paths.fm48_overlap_membership_rel, base_dir=base_dir))
    od_led = load_json(_abs(paths.fm48_dry863_extras_rel, base_dir=base_dir))
    sd_led = load_json(_abs(paths.fm48_batch_priority_rel, base_dir=base_dir))
    wall_led = load_json(_abs(paths.fm48_wall_meta_rel, base_dir=base_dir))
    ...
    pkt_ok = (
        ...
        and packet.get("overlap_membership_composition_sha256")
        == EXPECTED_FM48_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256
        and packet.get("dry863_extras_composition_sha256")
        == EXPECTED_FM48_DRY863_EXTRAS_COMPOSITION_SHA256
        and packet.get("batch_priority_composition_sha256")
        == EXPECTED_FM48_BATCH_PRIORITY_COMPOSITION_SHA256
        and packet.get("cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_sha256")
        == EXPECTED_FM48_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_SHA256
    ...
    checks["fm48_packet_zero_drift"] = pkt_ok
    rows.append(
        _row(
            check_id="fm48_packet_zero_drift",
            layer="fm48_continuity",
            path=paths.fm48_packet_rel,
            expected="PASS_OFFLINE+stable_metrics+compositions",
            observed=f"gate={packet.get('gate')};unique={packet.get('harvest_unique_union')}",
            ok=pkt_ok,
            notes="ok" if pkt_ok else "fm48_packet_drift",
        )
    )
    ...
    fp_ok = (
        ...
        and fp_doc.get("overlap_membership_composition_sha256")
        == EXPECTED_FM48_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256
        and fp_doc.get("dry863_extras_composition_sha256")
        == EXPECTED_FM48_DRY863_EXTRAS_COMPOSITION_SHA256
        and fp_doc.get("batch_priority_composition_sha256")
        == EXPECTED_FM48_BATCH_PRIORITY_COMPOSITION_SHA256
        and fp_doc.get("cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_sha256")
        == EXPECTED_FM48_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_SHA256
        and fp_doc.get("seal_chain_extended") is False
    )
    checks["fm48_fingerprint_zero_drift"] = fp_ok
    rows.append(
        _row(
            check_id="fm48_fingerprint_zero_drift",
            layer="fm48_continuity",
            path=paths.fm48_fingerprint_rel,
            expected="stable_metrics+fm47_fps",
            observed=f"unique={fp_doc.get('harvest_unique_union')}",
            ok=fp_ok,
            notes="ok" if fp_ok else "fm48_fingerprint_drift",
        )
    )
    ...
    gate_ok = (
        ...
        and gate_doc.get("cross_full_market_overlap_dry863_batch_priority_repro_wall_meta_bundle_sha256")
        == EXPECTED_FM48_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_SHA256
        and gate_doc.get("seal_chain_extended") is False
    )
    checks["fm48_gate_zero_drift"] = gate_ok
    rows.append(
        _row(
            check_id="fm48_gate_zero_drift",
            layer="fm48_continuity",
            path=paths.fm48_gate_json_rel,
            expected="PASS_OFFLINE+KEEP_EXECUTE_FALSE",
            observed=f"gate={gate_doc.get('gate')}",
            ok=gate_ok,
            notes="ok" if gate_ok else "fm48_gate_drift",
        )
    )

    us_ok = (
        us_led.get("fingerprint_sha256")
        == FROZEN_FM48_OVERLAP_MEMBERSHIP_COMPOSITION_IDENTITY_LOCK_FP_SHA256
        and us_led.get("composition_sha256")
        == EXPECTED_FM48_OVERLAP_MEMBERSHIP_COMPOSITION_SHA256
    )
    checks["fm48_overlap_membership_ledger_zero_drift"] = us_ok
    rows.append(
        _row(
            check_id="fm48_overlap_membership_ledger_zero_drift",
            layer="fm48_continuity",
            path=paths.fm48_overlap_membership_rel,
            expected=FROZEN_FM48_OVERLAP_MEMBERSHIP_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=str(us_led.get("fingerprint_sha256")),
            ok=us_ok,
            notes="ok" if us_ok else "fm48_overlap_ledger_drift",
        )
    )

    od_ok = (
        od_led.get("fingerprint_sha256")
        == FROZEN_FM48_DRY863_EXTRAS_COMPOSITION_IDENTITY_LOCK_FP_SHA256
        and od_led.get("composition_sha256")
        == EXPECTED_FM48_DRY863_EXTRAS_COMPOSITION_SHA256
    )
    checks["fm48_dry863_extras_ledger_zero_drift"] = od_ok
    rows.append(
        _row(
            check_id="fm48_dry863_extras_ledger_zero_drift",
            layer="fm48_continuity",
            path=paths.fm48_dry863_extras_rel,
            expected=FROZEN_FM48_DRY863_EXTRAS_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=str(od_led.get("fingerprint_sha256")),
            ok=od_ok,
            notes="ok" if od_ok else "fm48_dry863_ledger_drift",
        )
    )

    sd_ok = (
        sd_led.get("fingerprint_sha256")
        == FROZEN_FM48_BATCH_PRIORITY_COMPOSITION_IDENTITY_LOCK_FP_SHA256
        and sd_led.get("composition_sha256")
        == EXPECTED_FM48_BATCH_PRIORITY_COMPOSITION_SHA256
    )
    checks["fm48_batch_priority_ledger_zero_drift"] = sd_ok
    rows.append(
        _row(
            check_id="fm48_batch_priority_ledger_zero_drift",
            layer="fm48_continuity",
            path=paths.fm48_batch_priority_rel,
            expected=FROZEN_FM48_BATCH_PRIORITY_COMPOSITION_IDENTITY_LOCK_FP_SHA256,
            observed=str(sd_led.get("fingerprint_sha256")),
            ok=sd_ok,
            notes="ok" if sd_ok else "fm48_batch_ledger_drift",
        )
    )
    ...
    checks["fm48_wall_meta_ledger_zero_drift"] = wall_ok
    rows.append(
        _row(
            check_id="fm48_wall_meta_ledger_zero_drift",
            layer="fm48_continuity",
            path=paths.fm48_wall_meta_rel,
            expected=FROZEN_FM48_CROSS_FULL_MARKET_OVERLAP_DRY863_BATCH_PRIORITY_REPRO_WALL_META_BUNDLE_IDENTITY_LOCK_FP_SHA256,
    ...
    all_ok = all(checks.values()) if checks else False
    checks["fm48_continuity_all_pass"] = all_ok
    rows.append(
        _row(
            check_id="fm48_continuity_all_pass",
            layer="fm48_continuity",
            expected="packet+fp+gate+4ledgers",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
            notes="ok" if all_ok else "fm48_continuity_incomplete",
        )
    )
    return rows, checks
...
def build_output_root_protection_rows(
    ...
    *,
    ...
    """output-root 保护：resume/harvest 写拒绝 + MOCK51 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    ...
    out_detail = ""
    try:
        assert_fm49_output_root(paths.output_root_rel, base_dir=base_dir)
        out_ok = True
        out_detail = "allowed"
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            expected="MOCK51_or_ephemeral_allowed",
            observed=out_detail,
            ok=out_ok,
...
def build_frozen_mock_isolation_rows(
    paths: FullMarketUnionStatusResidualCoverageResumeTaxonomyDispositionWallMetaBundlePaths, *, base_dir: str = BASE_DIR
) -> Tuple[List[Dict[str, str]], Dict[str, bool]]:
    """冻结 mock cohort 写隔离：MOCK3–50 拒绝 · MOCK51 放行。"""
    rows: List[Dict[str, str]] = []
    checks: Dict[str, bool] = {}
    load_frozen_mock_cohort_roots.cache_clear()
    ...
    mock50_rel = FM48_MOCK_ROOT_REL
    mock48_blocked = False
    try:
        assert_fm49_output_root(mock50_rel, base_dir=base_dir)
    except RuntimeError as exc:
    ...
    rows.append(
        _row(
            ...
            layer="frozen_mock_isolation",
            expected="MOCK3-50_block+MOCK51_allow",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
    ...
    *,
    ...
    rows.append(
        _row(
            ...
            layer="protected_csv_registry",
            expected="MOCK3–50+MOCK51+resume+auth+registered",
            observed=f"pass={sum(1 for v in checks.values() if v)}/{len(checks)}",
            ok=all_ok,
...
def ensure_protected_roots_csv_fm49(
    *,
    csv_rel: str = PROTECTED_ROOTS_CSV_REL,
    base_dir: str = BASE_DIR,
) -> None:
    """注册 C-ROOT-MOCK51；加固 C-ROOT-002 unique/surface/additive/tier/dryrun 说明。"""
    ...
    _upsert(
        RESUME_HARVEST_ROOT_ID,
        {
            ...
            "notes": (
                ...
                "C-FM-24..48 scale/safety freezes + C-FM-49 full-market union_status/"
                "residual_coverage/resume_taxonomy_disposition-wall-meta-bundle; "
                "只读直至人批重跑"
            ),
        },
    )
    _upsert(
        THIS_TASK_ROOT_ID,
        {
            ...
            "notes": (
                "C-FM-49 scale union_status composition identity lock "
                "(2134/106/9) + residual_coverage composition identity lock "
                "(coverage=117) + resume_taxonomy_disposition composition identity lock "
                "(28/1/0) + cross_full_market_union_status_residual_coverage_"
                "resume_taxonomy_disposition_wall_meta_bundle identity lock + "
                "FM48 continuity; never production EXECUTE; "
                "must not overwrite MOCK3-50; seal_chain_extended=false"
            ),
        },
    )
...
def run_scale_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_safety(
    *,
    paths: FullMarketUnionStatusResidualCoverageResumeTaxonomyDispositionWallMetaBundlePaths | None = None,
    base_dir: str = BASE_DIR,
) -> Dict[str, Any]:
    """执行 C-FM-49 规模 unique/surface/additive/tier/dryrun-wall-meta-bundle 离线 QA。"""
    paths = paths or FullMarketUnionStatusResidualCoverageResumeTaxonomyDispositionWallMetaBundlePaths()
    generated_at = _utc_now_iso()
    ensure_protected_roots_csv_fm49(
        csv_rel=paths.protected_roots_csv_rel, base_dir=base_dir
    )
    out_root = assert_fm49_output_root(paths.output_root_rel, base_dir=base_dir)

    matrix: List[Dict[str, str]] = []
    cont_rows, cont_checks = build_fm48_continuity_rows(paths, base_dir=base_dir)
    ...
    gates = {
        ...
        "fm48": load_json(_abs(paths.fm48_gate_json_rel, base_dir=base_dir)),
    }
    ...
    layer_gates = {
        "fm48_continuity": (
            "PASS_OFFLINE"
            if cont_checks.get("fm48_continuity_all_pass")
            else "FAIL_OFFLINE"
        ),
        "union_status_composition_identity_lock": (
            "PASS_OFFLINE"
            if rf_checks.get("union_status_composition_identity_lock_all_pass")
            else "FAIL_OFFLINE"
        ),
        "residual_coverage_composition_identity_lock": (
            "PASS_OFFLINE"
            if rt_checks.get("residual_coverage_composition_identity_lock_all_pass")
            else "FAIL_OFFLINE"
        ),
        "resume_taxonomy_disposition_composition_identity_lock": (
            "PASS_OFFLINE"
            if rb_checks.get(
                "resume_taxonomy_disposition_composition_identity_lock_all_pass"
            )
            else "FAIL_OFFLINE"
        ),
        "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle_identity_lock": (
            "PASS_OFFLINE"
    ...
    packet_rel = _write_ledger(
        "scale_packet.json",
        {
            ...
            "coverage_formula": EXPECTED_COVERAGE_FORMULA,
            "notes": (
                "overlap_membership composition identity lock (unique=2249) + "
                "dry863_extras composition identity lock (combined_dryrun=1053) + "
                "batch_priority composition identity lock (tiers=7;coverage_sum=3314) + "
                "cross_full_market_union_status_residual_coverage_resume_taxonomy_disposition_wall_meta_bundle identity lock + "
                "FM48 continuity + MOCK51; EXECUTE remains human-held; "
                "does not overwrite MOCK3-50"
            ),
        },
    )
    ...
    return {
        ...
        "observed_fps": observed_fps,
        "inputs": {
            "fm48_packet": paths.fm48_packet_rel,
            "fm48_fingerprint": paths.fm48_fingerprint_rel,
            "fm48_gate": paths.fm48_gate_json_rel,
