...
| **P2-B probe** | [P2-B plan](plans/cninfo_c_class_p2b_probe_plan.md) · [checklist](plans/cninfo_c_class_p2b_probe_checklist.md) · [P2-B probe records](fixtures/c_class/probe/records/c_class_p2b_probe_records.yaml)（**12** · `manual_probe_pending`） |
...
| 50 | ~~C 类 P2-B probe plan + records 初始化~~ → **已完成**（12 `manual_probe_pending`） |
| 51 | P2-B manual DevTools probe（首发 `c_p2b_dividend_financing_600000`） |
| 52 | **暂不全量抓取、暂不入库** |
