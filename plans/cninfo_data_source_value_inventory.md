...
| 半年报 | 定期报告 PDF | 全文 PDF、报告期、中期财务与经营披露 | 补半年度文档流与字段；支持中期变化追踪 | P1 | **类年报验证已完成**（semi 55 success；`testing / partial`） |
| 季报 | 定期报告 PDF | 全文 PDF、报告期、季度财务与经营披露 | 补季度文档流；支持更高频字段变化 | P1 | **类年报验证已完成**（Q1 113 / Q3 102 success；`testing / partial`） |
