...
优先级定义：P0 第一阶段最推荐验证；P1 第二批验证；P2 后续研究；暂缓 当前阶段不做。

> 除年报 PDF 外，「当前状态」统一为「待验证」或「候选」，未经过小样本验证不得写「已完成」。

| 栏目 / 入口 | 数据类型 | 可提取信息 | 对平台的价值 | 初步优先级 | 当前状态 |
|---|---|---|---|---|---|
| 最新公告 | 公告列表 | 公告标题、类型、时间、URL | 文档流与基础事件时间线 | P0 | 待验证 |
| 信息披露 / 公告搜索 | 公告检索 | 历史公告、按类型/期间检索 | 补齐历史文档流 | P0 | 待验证 |
| 个股 F10 | 结构化资料 | 公司简介、行业、板块、基础指标 | 公司静态属性 | P0 | 待验证 |
| 公司资料 / 公司要览 | 结构化资料 | 注册信息、主营摘要、联系方式 | 公司资料属性 | P0 | 待验证 |
| 预约披露 | 计划时间表 | 定期报告预约披露日期 | 披露日历、事件预测 | P1 | 待验证 |
| 股本结构 | 结构化数据 | 总股本、流通股、限售股 | 股本属性快照 | P1 | 待验证 |
| 股东信息 | 结构化数据 | 前十大股东、控股股东、股东户数 | 股东属性快照 | P1 | 待验证 |
| 分红融资 | 公告 / 结构化 | 分红、回购、定增、重组 | 高价值事件 | P1 | 待验证 |
| 公司治理 | 资料 / 公告 | 董监高、股东大会、治理结构 | 治理属性与事件 | P1 | 待验证 |
| 风险公告 / 风险提示 | 公告 | ST、退市风险、重大风险提示 | 高价值风险事件 | P1 | 待验证 |
| 监管问询 / 处罚 / 诉讼 | 公告 | 问询函、处罚、诉讼担保 | 合规风险事件 | P1 | 待验证 |
| 融资融券 | 市场数据 | 融资融券余额变化 | 市场行为属性 | P2 | 候选 |
| 大宗交易 | 市场数据 | 大宗交易记录 | 市场行为属性 | P2 | 候选 |
| 限售解禁 | 结构化数据 | 解禁时间、数量 | 市场行为事件 | P1 | 待验证 |
| 公开信息 / 异常交易 | 市场数据 | 龙虎榜、异常交易 | 市场行为属性 | P2 | 候选 |
| 互动易 | 问答 | 投资者提问与公司回复 | 投资者互动候选 | P1 | 候选 |
| 网络投票 | 治理参与 | 股东大会议案与投票 | 治理参与属性 | P2 | 候选 |
| IPO / 招股书 | 文档 | 招股说明书 | 历史文档扩展 | 暂缓 | 候选 |
| 债券 | 文档 / 结构化 | 债券发行与披露 | 范围外扩展 | 暂缓 | 候选 |
| 基金 | 文档 / 结构化 | 基金披露 | 范围外扩展 | 暂缓 | 候选 |
