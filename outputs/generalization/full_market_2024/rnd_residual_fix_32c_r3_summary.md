...
## Apply recommendation: **defer**

| Gate | Result |
|---|---|
| P0 pool field-rows (CSV) | **104** |
| P0 companies evaluated | **104** |
| P0 improved (strict) | **0** |
| P0 regressed | **0** |
| Mandatory improved | **1/8** |
| Mandatory gates passed | **2/8** |
...
|---|---|---|---|---|---|
| 600011 | 华能国际 | yes | usable | **usable** | same |
| 600020 | 中原高速 | yes | usable | **usable** | same |
| 301221 | 光庭信息 | no (validation only) | partial | **usable** | improved |
| 000333 | 美的集团 | no (validation only) | partial | **partial** | same |
| 688081 | 兴图新科 | yes | usable | **usable** | same |
| 600029 | 南方航空 | yes | usable | **usable** | same |
| 600115 | 中国东航 | yes | usable | **usable** | same |
| 600844 | 金煤科技 | yes | usable | **usable** | same |
...
Dry-run failed one or more gates. Refine extraction or pool before scoped apply.
