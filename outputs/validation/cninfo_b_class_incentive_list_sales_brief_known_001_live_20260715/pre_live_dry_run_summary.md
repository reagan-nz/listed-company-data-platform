...
| 来源 | 路径 |
|------|------|
| Known-document cases | `outputs/validation/cninfo_b_class_incentive_list_sales_brief_known_001_live_20260715/known_document_retrieval_cases_live_allowlist.yaml` |
| Category-sample cases | `outputs/validation/cninfo_b_class_incentive_list_sales_brief_known_001_live_20260715/category_sample_cases_live_empty.yaml` |
