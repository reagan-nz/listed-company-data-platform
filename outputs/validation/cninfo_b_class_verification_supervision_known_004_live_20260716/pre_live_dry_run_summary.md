...
| 来源 | 路径 |
|------|------|
| Known-document cases | `outputs/validation/cninfo_b_class_verification_supervision_known_004_live_20260716/known_document_retrieval_cases_live_allowlist.yaml` |
| Category-sample cases | `outputs/validation/cninfo_b_class_verification_supervision_known_004_live_20260716/category_sample_cases_live_empty.yaml` |
