...
| 项 | 路径 |
|----|------|
| approval package | `../cninfo_d_class_abnormal_trading_first_slice_approval_package_20260715.md` |
| universe lock | `../cninfo_d_class_abnormal_trading_first_slice_universe_lock_20260715.csv` |
| validation rules | `../cninfo_d_class_abnormal_trading_validation_rules_20260715.md` |
| sample prep | `../cninfo_d_class_abnormal_trading_sample_prep_20260715.md` |
| command draft | `../cninfo_d_class_abnormal_trading_first_slice_command_draft_20260715.md` |
| offline checklist | `../cninfo_d_class_abnormal_trading_offline_prep_checklist_20260715.csv` |
| fixture VR matrix | `../cninfo_d_class_abnormal_trading_fixture_vr_matrix_20260715.csv` |
...
| planned snapshots | `planned_snapshots/` |
| Tier-1 fixtures | `fixtures/d_class/abnormal_trading_first_slice/` |

Tests：`lab/test_cninfo_d_class_abnormal_trading_fixtures.py` · `lab/test_cninfo_d_class_abnormal_trading_first_slice_runner.py`
