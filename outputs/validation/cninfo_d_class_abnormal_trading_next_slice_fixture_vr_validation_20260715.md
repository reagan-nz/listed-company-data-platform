...
| universe lock | `cninfo_d_class_abnormal_trading_next_slice_universe_lock_20260715.csv` |
| fixtures | **9** |
| matrix rows | **14** |
...
- matrix: `outputs/validation/cninfo_d_class_abnormal_trading_next_slice_fixture_vr_matrix_20260715.csv`
- summary: `outputs/validation/cninfo_d_class_abnormal_trading_next_slice_fixture_vr_validation_20260715.md`
