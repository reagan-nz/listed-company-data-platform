...
| 来源 | 路径 |
|------|------|
| Ready known-document cases | `outputs/validation/cninfo_b_class_warning_letter_promotion_live_20260715/known_document_retrieval_cases_live_allowlist.yaml` |
...
Ready case IDs: `regulatory_known_001`, `inquiry_sample_001`
...
|---------|------------------------|---------------|--------------|---------|-------|-------------|
| `regulatory_known_001` | 关于收到浙江证监局警示函的公告 | 关于收到浙江证监局警示函的公告 | 2025-06-23 | true | cninfo_inquiry_reply_pdf / classified_correctly | **pass** |
| `inquiry_sample_001` | 警示函 | 关于收到广东证监局对公司采取责令改正措施并对黄裕辉等采取出具警示函措施的决定的公… | 2025-06-24 | true | cninfo_inquiry_reply_pdf / classified_correctly | **pass** |
