...
| `test_failed_residual_fingerprint_frozen` | **PASS** |
| `test_fm25_continuity_and_new_layers` | **PASS** |
| `test_frozen_isolation_blocks_mock27_allows_mock28` | **PASS** |
...
```
c_fm_26_scale_residual_status_triage_surface_delta_safety_test_gate = PASS_OFFLINE
cninfo_calls = 0
