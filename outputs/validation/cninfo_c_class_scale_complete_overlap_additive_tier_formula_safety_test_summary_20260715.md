...
| `test_complete_codes_membership_mutation_denied` | **PASS** |
| `test_overlap_delta_membership_mutation_denied` | **PASS** |
| `test_additive_formula_mutation_denied` | **PASS** |
| `test_tier_coverage_formula_mutation_denied` | **PASS** |
| `test_fm37_continuity` | **PASS** |
...
```
c_fm_38_scale_complete_overlap_additive_tier_formula_safety_test_gate = PASS_OFFLINE
cninfo_calls = 0
