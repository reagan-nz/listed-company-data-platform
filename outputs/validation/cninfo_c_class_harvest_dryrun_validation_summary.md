...
| check | result |
|-------|--------|
| company_count | **863** (expected 863) |
| hold_overlap | **0** |
| planned_http_cases | **6041** (expected 6041) |
| preflight_gate | **PASS** |

## Planned cases

- **companies:** 863
- **matrix_rows:** 8630 (863 × 10)
...
- `outputs/harvest/cninfo_c_class/raw/basic_profile/{company_code}.json`
- `outputs/harvest/cninfo_c_class/raw/dividend_history/{company_code}.jsonl`

### normalized destination（示例）

- `outputs/harvest/cninfo_c_class/normalized/company_basic_profile/{company_code}.json`
- `outputs/harvest/cninfo_c_class/normalized/dividend_history/{company_code}.jsonl`
...
- `outputs/harvest/cninfo_c_class/quality/hold_company_list.csv`
