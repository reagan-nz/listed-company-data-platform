...
_生成时间：2026-07-15 12:24:46 UTC_
...
| failed | 0 |
| needs_review | 0 |
| CNINFO requests | 22 (cap ≤ 240) |
| matching_logic | **v2** |
| execution gate | `PASS_WITH_CAVEAT` |
| acceptance threshold | ≥9/10 → PASS_WITH_CAVEAT |
...
- metadata only: **yes**
- output isolation: `/Users/zhao/Desktop/97/实操/数据收集测试/listed_company_data_collector/outputs/validation/cninfo_a_class_erad_next_scale_listing_aware_s6/retry_timeout_801_810`
- verified: **no**
- production_ready: **no**
