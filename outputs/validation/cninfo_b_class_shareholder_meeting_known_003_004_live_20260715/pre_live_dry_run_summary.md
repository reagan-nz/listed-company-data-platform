...
| 来源 | 路径 |
|------|------|
| Known-document cases | `outputs/validation/cninfo_b_class_shareholder_meeting_known_003_004_live_20260715/known_document_retrieval_cases_live_allowlist.yaml` |
| Category-sample cases | `outputs/validation/cninfo_b_class_shareholder_meeting_known_003_004_live_20260715/category_sample_cases_live_empty.yaml` |
