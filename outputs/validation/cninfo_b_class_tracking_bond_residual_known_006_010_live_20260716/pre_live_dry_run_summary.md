...
| 来源 | 路径 |
|------|------|
| Known-document cases | `outputs/validation/cninfo_b_class_tracking_bond_residual_known_006_010_live_20260716/known_document_retrieval_cases_live_allowlist.yaml` |
| Category-sample cases | `outputs/validation/cninfo_b_class_tracking_bond_residual_known_006_010_live_20260716/category_sample_cases_live_empty.yaml` |
