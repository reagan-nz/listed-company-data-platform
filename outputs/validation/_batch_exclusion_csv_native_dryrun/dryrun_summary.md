...
snapshot_path: `outputs/validation/_batch_exclusion_csv_native_dryrun/{company_code}.json`

quality_path: `outputs/validation/_batch_exclusion_csv_native_dryrun/quality/`

planned_modules: **18**

# Resume Design

- status file: `outputs/validation/_batch_exclusion_csv_native_dryrun/quality/company_snapshot_status.csv`
...
- error file: `outputs/validation/_batch_exclusion_csv_native_dryrun/quality/company_snapshot_error.csv`
