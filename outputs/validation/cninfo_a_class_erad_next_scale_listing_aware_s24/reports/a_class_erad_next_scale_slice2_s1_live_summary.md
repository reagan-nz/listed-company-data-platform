...
_生成时间：2026-07-16 03:42:55 UTC_
...
| universe size | 371 |
| expected case count | 371 |
| acceptable | 371 |
| failed | 0 |
| needs_review | 0 |
| CNINFO requests | 754 (cap ≤ 240) |
| matching_logic | **v2** |
| execution gate | `PASS_WITH_CAVEAT` |
| acceptance threshold | ≥90/371 → PASS_WITH_CAVEAT |
...
- metadata only: **yes**
- output isolation: `/Users/zhao/Desktop/97/实操/数据收集测试/listed_company_data_collector/outputs/validation/cninfo_a_class_erad_next_scale_listing_aware_s24`
- verified: **no**
- production_ready: **no**
