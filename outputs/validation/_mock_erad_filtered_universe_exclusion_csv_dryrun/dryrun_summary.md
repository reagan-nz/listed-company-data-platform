...
snapshot_path: `outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/{company_code}.json`

quality_path: `outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/quality/`

planned_modules: **18**

# Resume Design

- status file: `outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/quality/company_snapshot_status.csv`
...
- error file: `outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/quality/company_snapshot_error.csv`
