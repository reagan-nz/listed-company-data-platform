...
| 项 | 值 |
|----|-----|
| sample mode | `exclusion_csv_filter` |
| sample file | `outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/filtered_universe_included.yaml` |
...
| mock output root | `outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun` |
...
python3 lab/run_cninfo_c_class_filtered_universe_mock_root_dryrun.py \
  --filtered-universe outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/filtered_universe_included.yaml \
...
- [outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/dryrun_report.csv](dryrun_report.csv)
- [outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/dryrun_summary.md](dryrun_summary.md)
- [outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/mock_root_dryrun_capability_summary.md](mock_root_dryrun_capability_summary.md)
- [outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/run_meta.json](run_meta.json)
- [outputs/validation/_mock_erad_filtered_universe_exclusion_csv_dryrun/quality/company_snapshot_status.csv](quality/company_snapshot_status.csv)
