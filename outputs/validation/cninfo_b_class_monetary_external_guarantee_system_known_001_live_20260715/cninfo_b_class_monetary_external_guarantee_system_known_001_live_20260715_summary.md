...
| 来源 | 路径 |
|------|------|
| Ready known-document cases | `outputs/validation/cninfo_b_class_monetary_external_guarantee_system_known_001_live_20260715/known_document_retrieval_cases_live_allowlist.yaml` |
...
Ready case IDs: `monetary_funds_management_system_known_001`, `external_guarantee_management_system_known_001`
...
|---------|------------------------|---------------|--------------|---------|-------|-------------|
| `monetary_funds_management_system_known_001` | 货币资金管理制度 | 货币资金管理制度 | 2025-05-29 | true | cninfo_general_announcement_pdf / classified_correctly | **pass** |
| `external_guarantee_management_system_known_001` | 对外担保管理制度 | 海量数据对外担保管理制度 | 2025-06-26 | true | cninfo_general_announcement_pdf / classified_correctly | **pass** |
