...
- **Total planned HTTP cases:** **3500**
- **Matrix rows（含 derived）:** **5000**（500 × 10）

## Source counts

- **direct:** 6 sources · 3000 matrix rows
- **derived:** 3 sources · 1500 matrix rows
- **observe_only:** 1 source · 500 matrix rows
