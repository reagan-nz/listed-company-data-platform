...
| 来源 | 路径 |
|------|------|
| Ready known-document cases | `outputs/validation/cninfo_b_class_residual_scale200_retry_v2_live_20260716/known_document_retrieval_cases_live_allowlist.yaml` |
...
Ready case IDs: `tracking_rating_report_known_023`
...
|---------|------------------------|---------------|--------------|---------|-------|-------------|
| `tracking_rating_report_known_023` | 浙江荣晟环保纸业股份有限公司关于 | 浙江荣晟环保纸业股份有限公司关于“荣23转债”2025年跟踪评级结果的公告 | 2025-04-18 | true | cninfo_general_announcement_pdf / classified_correctly | **pass** |
