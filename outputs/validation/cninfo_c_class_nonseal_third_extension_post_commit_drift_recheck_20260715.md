...
_生成时间：2026-07-15T13:29:42Z · offline · CNINFO=0_
...
| layer `fm20_artifact_presence` | `PASS_OFFLINE` |
...
| fail_count | **0** / 89 |
| mock output | `outputs/validation/_mock_c_fm21_nonseal_third_extension_post_commit_drift_recheck` |
| frozen third-extension fp | `f5ff5720b4812350abe7d0bf4830a452f8bb0821722a3296a0ee6292a245e8fb` |
| recomputed third-extension fp | `f5ff5720b4812350abe7d0bf4830a452f8bb0821722a3296a0ee6292a245e8fb` |
| drift_detected | **False** |
| drift fingerprint | `2f3f667bb7500db0998a520ce64edb2a67cdb8fad3dde5943afe98313a31596e` |
...
| `fm20_gate_json` | `outputs/validation/cninfo_c_class_nonseal_cross_fm_mock_cohort_third_extension_20260715.json` |
| `fm20_mock_root` | `outputs/validation/_mock_c_fm20_nonseal_cross_fm_mock_cohort_third_extension` |
...
```
c_fm_21_nonseal_third_extension_post_commit_drift_recheck_gate = PASS_OFFLINE
...
- [outputs/validation/_mock_c_fm21_nonseal_third_extension_post_commit_drift_recheck/drift_matrix.csv](_mock_c_fm21_nonseal_third_extension_post_commit_drift_recheck/drift_matrix.csv)
- [outputs/validation/cninfo_c_class_nonseal_third_extension_post_commit_drift_recheck/drift_matrix.csv](cninfo_c_class_nonseal_third_extension_post_commit_drift_recheck/drift_matrix.csv)
- [outputs/validation/cninfo_c_class_nonseal_third_extension_post_commit_drift_recheck_20260715.json](cninfo_c_class_nonseal_third_extension_post_commit_drift_recheck_20260715.json)
