...
| 来源 | 路径 |
|------|------|
| Ready known-document cases | `outputs/validation/cninfo_b_class_shareholder_meeting_sample_promotion_live_20260715/known_document_retrieval_cases_live_empty.yaml` |
...
Ready case IDs: `meeting_sample_002`
...
|---------|------------------------|---------------|--------------|---------|-------|-------------|
| `meeting_sample_002` | 股东大会通知 | 关于召开2024年度股东大会通知的提示性公告 | 2025-06-26 | true | cninfo_general_announcement_pdf / classified_correctly | **pass** |
