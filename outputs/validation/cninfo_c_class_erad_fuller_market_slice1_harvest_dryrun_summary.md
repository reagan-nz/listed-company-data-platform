...
- **Total planned HTTP cases:** **1400**
- **Matrix rows（含 derived）:** **2000**（200 × 10）

## Source counts

- **direct:** 6 sources · 1200 matrix rows
- **derived:** 3 sources · 600 matrix rows
- **observe_only:** 1 source · 200 matrix rows
