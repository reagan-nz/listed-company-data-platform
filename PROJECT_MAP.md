...
| `validate_cninfo_c_class_live_sources.py` | **Phase 4**：C 类 P1 basic/security live validation（`--dry-run` 默认；`--live` 3 家） | 是 |
...
5. **下一步**：basic_profile **mapper 草案**；P2 probe；E/F 暂缓。
