...
5. **C 类** · **Era D** [slice1 live execution](outputs/validation/cninfo_c_class_erad_fuller_market_slice1_live_execution_summary.md) · **193+7** · CNINFO **~1400** · gate **`PASS_WITH_CAVEAT`** · C-line **continues**。
