...
5. **下一步**：P2-B `contact_profile` probe（`c_p2b_contact_600000`）或 dividend YAML backfill decision；dividend **3/3** 见 [P2-B plan](plans/cninfo_c_class_p2b_probe_plan.md) §2.3。
