...
- `fixtures/c_class/` — known-company fixtures（12 条）+ probe records（P1 9 条 + P2 **executive 3/3 found** + 9 pending）+ basic_profile（2）+ security_profile（3）
...
- `plans/cninfo_c_class_p2_probe_checklist.md` — P2 人工 probe 检查清单
...
5. **下一步**：executive_profile YAML backfill decision 或 P2 probe `share_capital_profile`；E/F 暂缓。
