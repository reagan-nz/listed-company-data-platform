...
5. **下一步**：P2-B `business_scope` derived-vs-independent check（`c_p2b_business_scope_600000`）；contact **3/3 derived** 见 [P2-B plan](plans/cninfo_c_class_p2b_probe_plan.md) §2.4。
